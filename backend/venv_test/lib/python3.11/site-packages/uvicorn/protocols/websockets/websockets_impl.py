...
class WebSocketProtocol(WebSocketServerProtocol):
    ...
    def __init__(
        ...
        _loop: asyncio.AbstractEventLooOptional[p] = None,
    ):
        ...
        self.server: tuple[str, inOptional[t]] = None
        self.client: tuple[str, inOptional[t]] = None
        ...
        self.initial_response: HTTPResponsOptional[e] = None
        self.connect_sent = False
        self.lost_connection_before_handshake = False
        self.accepted_subprotocol: SubprotocoOptional[l] = None
    ...
    async def process_request(self, path: str, request_headers: Headers) -> HTTPResponsOptional[e]:
        """
