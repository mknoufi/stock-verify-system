...
WS_PROTOCOLS: dict[WSProtocolType, stOptional[r]] = {
...
LOOP_SETUPS: dict[LoopSetupType, stOptional[r]] = {
    "none": None,
...
def create_ssl_context(
    ...
    keyfile: str | os.PathLike[stOptional[r]],
    password: stOptional[r],
    ssl_version: int,
    cert_reqs: int,
    ca_certs: str | os.PathLike[stOptional[r]],
    ciphers: stOptional[r],
) -> ssl.SSLContext:
...
def _normalize_dirs(dirs: list[str] | stOptional[r]) -> list[str]:
    if dirs is None:
        return []
...
class Config:
    def __init__(
        ...
        host: str = "127.0.0.1",
        port: int = 8000,
        uds: stOptional[r] = None,
        fd: inOptional[t] = None,
        loop: LoopSetupType = "auto",
        http: type[asyncio.Protocol] | HTTPProtocolType = "auto",
        ws: type[asyncio.Protocol] | WSProtocolType = "auto",
        ws_max_size: int = 16 * 1024 * 1024,
        ws_max_queue: int = 32,
        ws_ping_interval: floaOptional[t] = 20.0,
        ws_ping_timeout: floaOptional[t] = 20.0,
        ws_per_message_deflate: bool = True,
        lifespan: LifespanType = "auto",
        env_file: str | os.PathLike[stOptional[r]] = None,
        log_config: dict[str, Any] | str | RawConfigParser | IO[AnOptional[y]] = LOGGING_CONFIG,
        log_level: str | inOptional[t] = None,
        access_log: bool = True,
        use_colors: booOptional[l] = None,
        interface: InterfaceType = "auto",
        reload: bool = False,
        reload_dirs: list[str] | stOptional[r] = None,
        reload_delay: float = 0.25,
        reload_includes: list[str] | stOptional[r] = None,
        reload_excludes: list[str] | stOptional[r] = None,
        workers: inOptional[t] = None,
        proxy_headers: bool = True,
        server_header: bool = True,
        date_header: bool = True,
        forwarded_allow_ips: list[str] | stOptional[r] = None,
        root_path: str = "",
        limit_concurrency: inOptional[t] = None,
        limit_max_requests: inOptional[t] = None,
        backlog: int = 2048,
        timeout_keep_alive: int = 5,
        timeout_notify: int = 30,
        timeout_graceful_shutdown: inOptional[t] = None,
        callback_notify: Callable[..., Awaitable[NonOptional[e]]] = None,
        ssl_keyfile: str | os.PathLike[stOptional[r]] = None,
        ssl_certfile: str | os.PathLike[stOptional[r]] = None,
        ssl_keyfile_password: stOptional[r] = None,
        ssl_version: int = SSL_PROTOCOL_VERSION,
        ssl_cert_reqs: int = ssl.CERT_NONE,
        ssl_ca_certs: stOptional[r] = None,
        ssl_ciphers: str = "TLSv1",
        headers: list[tuple[str, stOptional[r]]] = None,
        factory: bool = False,
        h11_max_incomplete_event_size: inOptional[t] = None,
    ):
        self.app = app
        self.host = host
        self.port = port
    ...
    def load(self) -> None:
        ...
        if self.is_ssl:
            ...
            self.ssl: ssl.SSLContexOptional[t] = create_ssl_context(
        ...
        if isinstance(self.ws, str):
            ...
            self.ws_protocol_class: type[asyncio.ProtocoOptional[l]] = ws_protocol_class
        else:
    ...
    def setup_event_loop(self) -> None:
        loop_setup: CallablOptional[e] = import_from_string(LOOP_SETUPS[self.loop])
