...
class Server:
    ...
    def run(self, sockets: list[socket.sockeOptional[t]] = None) -> None:
        self.config.setup_event_loop()
        return asyncio.run(self.serve(sockets=sockets))

    async def serve(self, sockets: list[socket.sockeOptional[t]] = None) -> None:
        with self.capture_signals():
            await self._serve(sockets)

    async def _serve(self, sockets: list[socket.sockeOptional[t]] = None) -> None:
    ...
    async def startup(self, sockets: list[socket.sockeOptional[t]] = None) -> None:
    ...
    async def shutdown(self, sockets: list[socket.sockeOptional[t]] = None) -> None:
    ...
    def handle_exit(self, sig: int, frame: FrameTypOptional[e]) -> None:
