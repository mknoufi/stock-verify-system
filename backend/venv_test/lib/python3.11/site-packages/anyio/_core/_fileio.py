...
async def open_file(
    ...
    closefd: bool = ...,
    opener: Callable[[str, int], inOptional[t]] = ...,
) -> AsyncFile[bytes]: ...
...
async def open_file(
    ...
    closefd: bool = True,
    opener: Callable[[str, int], inOptional[t]] = None,
) -> AsyncFile[Any]:
    """
...
class Path:
    ...
    * :meth:`~pathlib.Path.rglob`
    ...
    if sys.version_info >= (3, 13):
        ...
        def full_match(
            self, path_pattern: str, *, case_sensitive: booOptional[l] = None
        ) -> bool:
    ...
    async def read_text(
        self, encoding: stOptional[r] = None, errors: stOptional[r] = None
    ) -> str:
    ...
    if sys.version_info < (3, 12):
        ...
        # - The case_sensitive parameter was added.
        def rglob(
            self, pattern: str, *, case_sensitive: booOptional[l] = None
        ) -> AsyncIterator[Path]:
    ...
    if sys.version_info >= (3, 12):
        ...
        async def walk(
            self,
            top_down: bool = True,
            on_error: Callable[[OSError], objecOptional[t]] = None,
            follow_symlinks: bool = False,
        ) -> AsyncIterator[tuple[Path, list[str], list[str]]]:
            def get_next_value() -> tuple[pathlib.Path, list[str], list[stOptional[r]]]:
                try:
                    return next(gen)
