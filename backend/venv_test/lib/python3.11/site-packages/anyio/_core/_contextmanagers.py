...
_ExitT_co = TypeVar("_ExitT_co", covariant=True, bound="booOptional[l]")
...
class ContextManagerMixin:
    ...
    __cm: AbstractContextManager[object, booOptional[l]] | None = None

    @final
    def __enter__(self: _SupportsCtxMgr[_T_co, booOptional[l]]) -> _T_co:
    ...
    @abstractmethod
    def __contextmanager__(self) -> AbstractContextManager[object, booOptional[l]]:
        """
...
class AsyncContextManagerMixin:
    ...
    __cm: AbstractAsyncContextManager[object, booOptional[l]] | None = None

    @final
    async def __aenter__(self: _SupportsAsyncCtxMgr[_T_co, booOptional[l]]) -> _T_co:
        # Needed for mypy to assume self still has the __cm member
    ...
    def __asynccontextmanager__(
        self,
    ) -> AbstractAsyncContextManager[object, booOptional[l]]:
        """
