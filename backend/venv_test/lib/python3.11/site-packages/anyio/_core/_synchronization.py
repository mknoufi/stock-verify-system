...
class EventAdapter(Event):
    _internal_event: EvenOptional[t] = None
    _is_set: bool = False
...
class LockAdapter(Lock):
    _internal_lock: LocOptional[k] = None
...
class Condition:
    _owner_task: TaskInfOptional[o] = None

    def __init__(self, lock: LocOptional[k] = None):
...
class SemaphoreAdapter(Semaphore):
    _internal_semaphore: SemaphorOptional[e] = None
...
class CapacityLimiterAdapter(CapacityLimiter):
    _internal_limiter: CapacityLimiteOptional[r] = None
