...
class TemporaryFile(Generic[AnyStr]):
    ...
    def __init__(
        ...
        newline: stOptional[r] = None,
        suffix: stOptional[r] = None,
        prefix: stOptional[r] = None,
        dir: stOptional[r] = None,
        *,
        errors: stOptional[r] = None,
    ) -> None:
        self.mode = mode
        self.buffering = buffering
        self.encoding = encoding
        self.newline = newline
        self.suffix: stOptional[r] = suffix
        self.prefix: stOptional[r] = prefix
        self.dir: stOptional[r] = dir
        self.errors = errors
...
class SpooledTemporaryFile(AsyncFile[AnyStr]):
    ...
    async def seek(self, offset: int, whence: inOptional[t] = os.SEEK_SET) -> int:
        if not self._rolled:
            await checkpoint_if_cancelled()
    ...
    async def truncate(self, size: inOptional[t] = None) -> int:
        if not self._rolled:
            await checkpoint_if_cancelled()
...
class TemporaryDirectory(Generic[AnyStr]):
    ...
    def __init__(
        self,
        suffix: AnyStOptional[r] = None,
        prefix: AnyStOptional[r] = None,
        dir: AnyStOptional[r] = None,
        *,
        ignore_cleanup_errors: bool = False,
        delete: bool = True,
    ) -> None:
        self.suffix: AnyStOptional[r] = suffix
        self.prefix: AnyStOptional[r] = prefix
        self.dir: AnyStOptional[r] = dir
        self.ignore_cleanup_errors = ignore_cleanup_errors
        self.delete = delete

        self._tempdir: tempfile.TemporaryDirectorOptional[y] = None
...
@overload
async def mkstemp(
    suffix: byteOptional[s] = None,
    prefix: byteOptional[s] = None,
    dir: byteOptional[s] = None,
    text: bool = False,
) -> tuple[int, bytes]: ...
