...
async def connect_tcp(
    ...
    remote_port: int,
    *,
    local_host: IPAddressTypOptional[e] = ...,
...
async def connect_tcp(
    ...
    remote_port: int,
    *,
    local_host: IPAddressTypOptional[e] = None,
    tls: bool = False,
    ssl_context: ssl.SSLContexOptional[t] = None,
    tls_standard_compatible: bool = True,
    tls_hostname: stOptional[r] = None,
    ...
    connected_stream: SocketStreaOptional[m] = None
    ...
    local_address: IPSockAddrTypOptional[e] = None
...
async def getaddrinfo(
    ...
    *,
    ...
    if isinstance(host, str):
        try:
            encoded_host: byteOptional[s] = host.encode("ascii")
