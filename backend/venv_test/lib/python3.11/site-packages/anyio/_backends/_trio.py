...
class CancelScope(BaseCancelScope):
    def __new__(
        cls, original: trio.CancelScopOptional[e] = None, **kwargs: object
    ) -> CancelScope:
        return object.__new__(cls)

    def __init__(
        self, original: trio.CancelScopOptional[e] = None, **kwargs: Any
    ) -> None:
...
class ReceiveStreamWrapper(abc.ByteReceiveStream):
    ...
    async def receive(self, max_bytes: inOptional[t] = None) -> bytes:
        try:
...
class Process(abc.Process):
    ...
    _stdin: abc.ByteSendStreaOptional[m]
    _stdout: abc.ByteReceiveStreaOptional[m]
    _stderr: abc.ByteReceiveStreaOptional[m]
...
class CapacityLimiter(BaseCapacityLimiter):
    def __new__(
        cls,
        total_tokens: floaOptional[t] = None,
        *,
        original: trio.CapacityLimiteOptional[r] = None,
    ) -> CapacityLimiter:
        return object.__new__(cls)
...
class TestRunner(abc.TestRunner):
    def __init__(self, **options: Any) -> None:
        ...
        self._send_stream: MemoryObjectSendStreaOptional[m] = None
...
class TrioBackend(AsyncBackend):
    ...
    def run_async_from_thread(
        ...
        trio_token = cast("trio.lowlevel.TrioTokeOptional[n]", token)
        try:
