...
class TLSAttribute(TypedAttributeSet):
    ...
    alpn_protocol: stOptional[r] = typed_attribute()
    ...
    peer_certificate_binary: byteOptional[s] = typed_attribute()
    #: ``True`` if this is the server side of the connection
    server_side: bool = typed_attribute()
    #: ciphers shared by the client during the TLS handshake (``None`` if this is the
    #: client side)
    shared_ciphers: list[tuple[str, str, inOptional[t]]] = typed_attribute()
...
class TLSStream(ByteStream):
    ...
    async def wrap(
        ...
        transport_stream: AnyByteStream,
        *,
        server_side: booOptional[l] = None,
...
class TLSListener(Listener[TLSStream]):
    ...
    async def serve(
        ...
        task_group: TaskGrouOptional[p] = None,
    ) -> None:
        @wraps(handler)
