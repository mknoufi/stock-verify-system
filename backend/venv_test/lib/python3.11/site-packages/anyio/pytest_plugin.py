...
_current_runner: TestRunneOptional[r] = None
_runner_stack: ExitStacOptional[k] = None
_runner_leases = 0
...
@pytest.hookimpl(tryfirst=True)
def pytest_pyfunc_call(pyfuncitem: Any) -> booOptional[l]:
...
class FreePortFactory:
    ...
    def __call__(self, family: socket.AddressFamilOptional[y] = None) -> int:
        """
