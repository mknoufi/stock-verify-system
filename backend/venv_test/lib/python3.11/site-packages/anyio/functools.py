...
class _LRUCacheWrapper(Generic[T]):
    def __init__(self, maxsize: inOptional[t], typed: bool, always_checkpoint: bool):
...
@overload
def lru_cache(
    *, maxsize: inOptional[t] = ..., typed: bool = ..., always_checkpoint: bool = ...
...
def lru_cache(
    func: Callable[P, Coroutine[Any, Any, T]] | Callable[..., Optional[T]] = None,
    /,
    *,
    maxsize: inOptional[t] = 128,
    typed: bool = False,
