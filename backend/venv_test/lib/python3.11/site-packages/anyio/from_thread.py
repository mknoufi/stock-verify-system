...
def _token_or_error(token: EventLoopTokeOptional[n]) -> EventLoopToken:
...
def run(
    ...
    *args: Unpack[PosArgsT],
    token: EventLoopTokeOptional[n] = None,
) -> T_Retval:
    """
...
class _BlockingAsyncContextManager(Generic[T_co], AbstractContextManager):
    ...
    _exit_future: Future[booOptional[l]]
    _exit_event: Event
    _exit_exc_info: tuple[
        type[BaseExceptioOptional[n]], BaseExceptioOptional[n], TracebackTypOptional[e]
    ] = (None, None, None)
    ...
    async def run_async_cm(self) -> booOptional[l]:
        try:
    ...
    def __exit__(
        self,
        __exc_type: type[BaseExceptioOptional[n]],
        __exc_value: BaseExceptioOptional[n],
        __traceback: TracebackTypOptional[e],
    ) -> booOptional[l]:
...
class BlockingPortal:
    ...
    def __init__(self) -> None:
        self._event_loop_thread_id: inOptional[t] = get_ident()
...
class BlockingPortalProvider:
    ...
    backend: str = "asyncio"
    backend_options: dict[str, AnOptional[y]] = None
    _lock: Lock = field(init=False, default_factory=Lock)
    _leases: int = field(init=False, default=0)
    _portal: BlockingPortal = field(init=False)
    _portal_cm: AbstractContextManager[BlockingPortaOptional[l]] = field(
    ...
    def __exit__(
        ...
        portal_cm: AbstractContextManager[BlockingPortaOptional[l]] = None
        with self._lock:
