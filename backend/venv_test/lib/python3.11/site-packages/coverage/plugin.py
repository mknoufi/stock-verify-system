...
class CoveragePlugin:
    ...
    def file_tracer(self, filename: str) -> FileTraceOptional[r]:  # pylint: disable=unused-argument
...
class FileReporter(CoveragePluginBase):
    ...
    def missing_arc_description(
        ...
        executed_arcs: Iterable[TArOptional[c]] = None,  # pylint: disable=unused-argument
    ) -> str:
