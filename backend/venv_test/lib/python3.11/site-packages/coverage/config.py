...
class HandyConfigParser(configparser.ConfigParser):
    ...
    def read(  # type: ignore[override]
        ...
        encoding_unused: stOptional[r] = None,
    ) -> list[str]:
        """Read a file name as UTF-8 configuration data."""
        return super().read(filenames, encoding="utf-8")

    def real_section(self, section: str) -> stOptional[r]:
...
class CoverageConfig(TConfigurable, TPluginConfig):
    ...
    def __init__(self) -> None:
        ...
        self.config_file: stOptional[r] = None
        self._config_contents: byteOptional[s] = None
        ...
        # Defaults for [run]
        self.branch = False
        self.command_line: stOptional[r] = None
        self.concurrency: list[str] = []
        self.context: stOptional[r] = None
        self.core: stOptional[r] = None
        self.cover_pylib = False
        self.data_file = ".coverage"
        self.debug: list[str] = []
        self.debug_file: stOptional[r] = None
        self.disable_warnings: list[str] = []
        self.dynamic_context: stOptional[r] = None
        self.parallel = False
        self.patch: list[str] = []
        ...
        self.sigterm = False
        self.source: list[stOptional[r]] = None
        self.source_pkgs: list[str] = []
        self.source_dirs: list[str] = []
        self.timid = False
        self._crash: stOptional[r] = None

        # Defaults for [report]
        self.exclude_list = DEFAULT_EXCLUDE[:]
        self.exclude_also: list[str] = []
        self.fail_under = 0.0
        self.format: stOptional[r] = None
        self.ignore_errors = False
        self.include_namespace_packages = False
        self.report_include: list[stOptional[r]] = None
        self.report_omit: list[stOptional[r]] = None
        self.partial_always_list = DEFAULT_PARTIAL_ALWAYS[:]
        self.partial_list = DEFAULT_PARTIAL[:]
        self.partial_also: list[str] = []
        self.precision = 0
        self.report_contexts: list[stOptional[r]] = None
        self.show_missing = False
        self.skip_covered = False
        self.skip_empty = False
        self.sort: stOptional[r] = None

        # Defaults for [html]
        self.extra_css: stOptional[r] = None
        self.html_dir = "htmlcov"
        self.html_skip_covered: booOptional[l] = None
        self.html_skip_empty: booOptional[l] = None
