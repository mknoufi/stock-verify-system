...
class Collector:
    ...
    def __init__(
        ...
        self.threading = None
        self.static_context: stOptional[r] = None
    ...
    def use_data(self, covdata: CoverageData, context: stOptional[r]) -> None:
    ...
    def _start_tracer(self) -> TTraceFOptional[n]:
    ...
    def _installation_trace(self, frame: FrameType, event: str, arg: Any) -> TTraceFOptional[n]:
        """Called on new threads, installs the real tracer."""
        # Remove ourselves as the trace function.
        sys.settrace(None)
        # Install the real tracer.
        fn: TTraceFOptional[n] = self._start_tracer()
    ...
    def switch_context(self, new_context: stOptional[r]) -> None:
        """Switch to a new dynamic context."""
        context: stOptional[r]
        self.flush_data()
