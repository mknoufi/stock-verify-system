...
class Coverage(TConfigurable):
    ...
    @classmethod
    def current(cls) -> CoveragOptional[e]:
    ...
    def __init__(  # pylint: disable=too-many-arguments
        self,
        data_file: FilePath | DefaultValuOptional[e] = DEFAULT_DATAFILE,
        data_suffix: str | booOptional[l] = None,
        cover_pylib: booOptional[l] = None,
        auto_data: bool = False,
        timid: booOptional[l] = None,
        branch: booOptional[l] = None,
        config_file: FilePath | bool = True,
        source: Iterable[stOptional[r]] = None,
        source_pkgs: Iterable[stOptional[r]] = None,
        source_dirs: Iterable[stOptional[r]] = None,
        omit: str | Iterable[stOptional[r]] = None,
        include: str | Iterable[stOptional[r]] = None,
        debug: Iterable[stOptional[r]] = None,
        concurrency: str | Iterable[stOptional[r]] = None,
        check_preimported: bool = False,
        context: stOptional[r] = None,
        messages: bool = False,
        plugins: Iterable[Callable[..., NonOptional[e]]] = None,
    ) -> None:
        """
        ...
        self._debug_file: IO[stOptional[r]] = None
        ...
        self._inorout: InOrOuOptional[t] = None
        self._plugins: Plugins = Plugins()
        self._plugin_override = cast(Iterable[TCoverageIniOptional[t]], plugins)
        self._data: CoverageDatOptional[a] = None
        self._data_to_close: list[CoverageData] = []
        self._core: CorOptional[e] = None
        self._collector: CollectoOptional[r] = None
        self._metacov = False

        self._file_mapper: Callable[[str], str] = abs_file
        self._data_suffix = self._run_suffix = None
        self._exclude_re: dict[str, str] = {}
        self._old_sigterm: Callable[[int, FrameTypOptional[e]], AnOptional[y]] = None
    ...
    def _warn(self, msg: str, slug: stOptional[r] = None, once: bool = False) -> None:
    ...
    def get_option(self, option_name: str) -> TConfigValueOuOptional[t]:
    ...
    def _init_data(self, suffix: str | booOptional[l]) -> None:
    ...
    def _on_sigterm(self, signum_unused: int, frame_unused: FrameTypOptional[e]) -> None:
    ...
    def combine(
        self,
        data_paths: Iterable[stOptional[r]] = None,
        strict: bool = False,
        keep: bool = False,
    ) -> None:
    ...
    def _get_file_reporters(
        self,
        morfs: Iterable[TMorOptional[f]] = None,
    ...
    def report(
        self,
        morfs: Iterable[TMorOptional[f]] = None,
        show_missing: booOptional[l] = None,
        ignore_errors: booOptional[l] = None,
        file: IO[stOptional[r]] = None,
        omit: str | list[stOptional[r]] = None,
        include: str | list[stOptional[r]] = None,
        skip_covered: booOptional[l] = None,
        contexts: list[stOptional[r]] = None,
        skip_empty: booOptional[l] = None,
        precision: inOptional[t] = None,
        sort: stOptional[r] = None,
        output_format: stOptional[r] = None,
    ) -> float:
    ...
    def html_report(
        ...
        omit: str | list[stOptional[r]] = None,
        include: str | list[stOptional[r]] = None,
        extra_css: stOptional[r] = None,
        title: stOptional[r] = None,
        skip_covered: booOptional[l] = None,
        show_contexts: booOptional[l] = None,
        contexts: list[stOptional[r]] = None,
        skip_empty: booOptional[l] = None,
        precision: inOptional[t] = None,
    ) -> float:
    ...
    def json_report(
        ...
        include: str | list[stOptional[r]] = None,
        contexts: list[stOptional[r]] = None,
        pretty_print: booOptional[l] = None,
        show_contexts: booOptional[l] = None,
    ) -> float:
