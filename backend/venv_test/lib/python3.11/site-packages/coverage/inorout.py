...
def name_for_module(filename: str, frame: FrameTypOptional[e]) -> stOptional[r]:
    ...
    dunder_name: stOptional[r] = module_globals.get("__name__", None)
...
def file_and_path_for_module(modulename: str) -> tuple[stOptional[r], list[str]]:
...
class InOrOut:
    ...
    def should_trace(self, filename: str, frame: FrameTypOptional[e] = None) -> TFileDisposition:
    ...
    def check_include_omit_etc(self, filename: str, frame: FrameTypOptional[e]) -> stOptional[r]:
    ...
    def find_possibly_unexecuted_files(self) -> Iterable[tuple[str, stOptional[r]]]:
    ...
    def _find_executable_files(self, src_dir: str) -> Iterable[tuple[str, stOptional[r]]]:
