...
class CoverageData:
    ...
    * **file tracer names**: the module names of the file tracer plugins that
    ...
    def __init__(
        self,
        basename: FilePatOptional[h] = None,
        suffix: str | booOptional[l] = None,
        no_disk: bool = False,
        warn: TWarnFOptional[n] = None,
        debug: TDebugCtOptional[l] = None,
    ) -> None:
        ...
        self._current_context: stOptional[r] = None
        self._current_context_id: inOptional[t] = None
        self._query_context_ids: list[inOptional[t]] = None
    ...
    def _file_id(self, filename: str, add: bool = False) -> inOptional[t]:
    ...
    def _context_id(self, context: str) -> inOptional[t]:
    ...
    @_locked
    def set_context(self, context: stOptional[r]) -> None:
    ...
    def touch_files(self, filenames: Collection[str], plugin_name: stOptional[r] = None) -> None:
    ...
    def update(
        ...
        map_path: Callable[[str], stOptional[r]] = None,
    ) -> None:
    ...
    def file_tracer(self, filename: str) -> stOptional[r]:
    ...
    def set_query_contexts(self, contexts: Sequence[stOptional[r]]) -> None:
    ...
    def lines(self, filename: str) -> list[TLineNOptional[o]]:
    ...
    def arcs(self, filename: str) -> list[TArOptional[c]]:
...
def filename_suffix(suffix: str | booOptional[l]) -> stOptional[r]:
