...
if LOG:  # pragma: debugging
    ...
    def panopticon(*names: stOptional[r]) -> AnyCallable:
...
class CodeInfo:
    ...
    tracing: bool
    file_data: TTraceFileDatOptional[a]
    byte_to_line: dict[TOffset, TLineNOptional[o]]
...
class SysMonitor(Tracer):
    ...
    def __init__(self, tool_id: int) -> None:
        ...
        self.stats: dict[str, inOptional[t]] = None
        if COLLECT_STATS:
    ...
    def sysmon_py_start(self, code: CodeType, instruction_offset: TOffset) -> MonitorReturn:
        ...
        tracing_code: booOptional[l] = None
        file_data: TTraceFileDatOptional[a] = None
