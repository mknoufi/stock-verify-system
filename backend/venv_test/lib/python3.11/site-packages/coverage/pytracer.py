...
class PyTracer(Tracer):
    ...
    def __init__(self) -> None:
        ...
        self.should_trace_cache: dict[str, TFileDispositioOptional[n]]
        self.should_start_context: TShouldStartContextFOptional[n] = None
        self.switch_context: Callable[[stOptional[r]], NonOptional[e]] = None
        self.lock_data: Callable[[], None]
        self.unlock_data: Callable[[], None]
        self.warn: TWarnFn

        # The threading module to use, if any.
        self.threading: ModuleTypOptional[e] = None

        self.cur_file_data: TTraceFileDatOptional[a] = None
        self.last_line: TLineNo = 0
        self.cur_file_name: stOptional[r] = None
        ...
        self.data_stack: list[tuple[TTraceFileDatOptional[a], stOptional[r], TLineNo, bool]] = []
        self.thread: threading.ThreaOptional[d] = None
        self.stopped = False
    ...
    def _trace(
        ...
        lineno: TLineNOptional[o] = None,  # pylint: disable=unused-argument
    ) -> TTraceFOptional[n]:
    ...
    def get_stats(self) -> dict[str, inOptional[t]]:
