...
def combine_context_switchers(
...
) -> TShouldStartContextFOptional[n]:
    ...
    def should_start_context(frame: FrameType) -> stOptional[r]:
...
def should_start_context_test_function(frame: FrameType) -> stOptional[r]:
...
def qualname_from_frame(frame: FrameType) -> stOptional[r]:
