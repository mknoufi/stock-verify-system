...
def get_zip_bytes(filename: str) -> byteOptional[s]:
...
class PythonFileReporter(FileReporter):
    ...
    def __init__(self, morf: TMorf, coverage: CoveragOptional[e] = None) -> None:
        ...
        self._source: stOptional[r] = None
        self._parser: PythonParseOptional[r] = None
        self._excluded = None
    ...
    def missing_arc_description(
        ...
        executed_arcs: Iterable[TArOptional[c]] = None,
    ) -> str:
