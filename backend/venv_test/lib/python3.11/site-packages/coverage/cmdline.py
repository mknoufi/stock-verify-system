...
class CoverageOptionParser(optparse.OptionParser):
    ...
    def parse_args_ok(self, args: list[str]) -> tuple[bool, optparse.ValueOptional[s], list[str]]:
...
def show_help(
    error: stOptional[r] = None,
    topic: stOptional[r] = None,
    parser: optparse.OptionParseOptional[r] = None,
) -> None:
...
class CoverageScript:
    ...
    def command_line(self, argv: list[str]) -> int:
        ...
        parser: optparse.OptionParseOptional[r]
    ...
    def do_signal_save(self, _signum: int, _frame: types.FrameTypOptional[e]) -> None:
...
def unshell_list(s: str) -> list[stOptional[r]]:
...
def main(argv: list[stOptional[r]] = None) -> inOptional[t]:
...
def main_deprecated(argv: list[stOptional[r]] = None) -> inOptional[t]:
