...
def find_module(
    modulename: str,
) -> tuple[stOptional[r], str, ModuleSpec]:
...
class PyRunner:
    ...
    def __init__(self, args: list[str], as_module: bool = False) -> None:
        ...
        self.arg0 = args[0]
        self.package: stOptional[r] = None
        self.modulename: stOptional[r] = None
        self.pathname: stOptional[r] = None
        self.loader: DummyLoadeOptional[r] = None
        self.spec: ModuleSpeOptional[c] = None
