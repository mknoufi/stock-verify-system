...
class TTraceFn(Protocol):
    ...
    def __call__(
        ...
        event: str,
        arg: Any,
        lineno: TLineNOptional[o] = None,  # Our own twist, see collector.py
    ) -> TTraceFOptional[n]: ...
...
class TFileDisposition(Protocol):
    ...
    source_filename: stOptional[r]
    trace: bool
    reason: str
    file_tracer: FileTraceOptional[r]
...
TShouldStartContextFn = Callable[[FrameType], stOptional[r]]
...
class Tracer(Protocol):
    ...
    should_trace_cache: Mapping[str, TFileDispositioOptional[n]]
    should_start_context: TShouldStartContextFOptional[n]
    switch_context: Callable[[stOptional[r]], NonOptional[e]]
    ...
    def start(self) -> TTraceFOptional[n]:
...
class TWarnFn(Protocol):
    ...
    def __call__(self, msg: str, slug: stOptional[r] = None, once: bool = False) -> None: ...
