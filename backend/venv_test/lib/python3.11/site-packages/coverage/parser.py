...
class PythonParser:
    ...
    def __init__(
        ...
        self._ast_root: ast.ASOptional[T] = None
        ...
        self._all_arcs: set[TArOptional[c]] = None
        self._missing_arc_fragments: TArcFragmentOptional[s] = None
    ...
    def _finish_action_msg(self, action_msg: stOptional[r], end: TLineNo) -> str:
...
class TAddArcFn(Protocol):
    ...
    def __call__(
        ...
        missing_cause_msg: stOptional[r] = None,
        action_msg: stOptional[r] = None,
    ) -> None:
        """
...
class TryBlock(Block):
    ...
    def __init__(self, handler_start: TLineNOptional[o], final_start: TLineNOptional[o]) -> None:
...
class AstArcAnalyzer:
    ...
    def process_body(
        ...
        from_start: ArcStarOptional[t] = None,
        prev_starts: set[ArcStarOptional[t]] = None,
    ) -> set[ArcStart]:
    ...
    def _handle_decorated(self, node: ast.FunctionDef) -> set[ArcStart]:
        ...
        last: TLineNOptional[o] = node.lineno
