...
def combinable_files(data_file: str, data_paths: Iterable[stOptional[r]] = None) -> list[str]:
...
def combine_parallel_data(
    data: CoverageData,
    aliases: PathAliaseOptional[s] = None,
    data_paths: Iterable[stOptional[r]] = None,
    strict: bool = False,
    keep: bool = False,
    message: Callable[[str], NonOptional[e]] = None,
) -> None:
