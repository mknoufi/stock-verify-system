...
class DebugControl:
    ...
    def __init__(
        ...
        output: IO[stOptional[r]],
        file_name: stOptional[r] = None,
    ) -> None:
    ...
    def write(self, msg: str, *, exc: BaseExceptioOptional[n] = None) -> None:
...
def short_filename(filename: stOptional[r]) -> stOptional[r]:
...
class PytestTracker:
    ...
    def __init__(self) -> None:
        self.test_name: stOptional[r] = None
...
class DebugOutputFile:
    ...
    @classmethod
    def _get_singleton_data(cls) -> tuple[DebugOutputFilOptional[e], bool]:
