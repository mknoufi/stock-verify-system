...
class Plugins:
    ...
    def __init__(self, debug: TDebugCtOptional[l] = None) -> None:
        ...
        self.current_module: stOptional[r] = None
        self.debug = debug
    ...
    def _add_plugin(
        ...
        specialized: list[CoveragePlugiOptional[n]],
    ) -> None:
        """Add a plugin object.
...
class DebugPluginWrapper(CoveragePlugin):
    ...
    def file_tracer(self, filename: str) -> FileTraceOptional[r]:
    ...
    def dynamic_context(self, frame: FrameType) -> stOptional[r]:
...
class DebugFileTracerWrapper(FileTracer):
    ...
    def dynamic_source_filename(self, filename: str, frame: FrameType) -> stOptional[r]:
