...
class TableElement(MarkdownElement):
    ...
    def __init__(self) -> None:
        self.header: TableHeaderElemenOptional[t] = None
        self.body: TableBodyElemenOptional[t] = None
...
class TableHeaderElement(MarkdownElement):
    ...
    def __init__(self) -> None:
        self.row: TableRowElemenOptional[t] = None
...
class ListElement(MarkdownElement):
    ...
    def __init__(self, list_type: str, list_start: inOptional[t]) -> None:
...
class MarkdownContext:
    ...
    def __init__(
        ...
        style: Style,
        inline_code_lexer: stOptional[r] = None,
        ...
        self._syntax: SyntaOptional[x] = None
...
class Markdown(JupyterMixin):
    ...
    def __init__(
        ...
        justify: JustifyMethoOptional[d] = None,
        style: str | Style = "none",
        hyperlinks: bool = True,
        inline_code_lexer: stOptional[r] = None,
        inline_code_theme: stOptional[r] = None,
    ) -> None:
        parser = MarkdownIt().enable("strikethrough").enable("table")
        self.markup = markup
        self.parsed = parser.parse(markup)
        self.code_theme = code_theme
        self.justify: JustifyMethoOptional[d] = justify
        self.style = style
        self.hyperlinks = hyperlinks
