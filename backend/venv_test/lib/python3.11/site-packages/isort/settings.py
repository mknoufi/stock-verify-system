...
class _Config:
    ...
    formatter: str = ""
    formatting_function: Callable[[str, str, object], stOptional[r]] = None
...
class Config(_Config):
    def __init__(
        ...
        settings_file: str = "",
        settings_path: str = "",
        config: _ConfiOptional[g] = None,
        **config_overrides: Any,
    ):
        self._known_patterns: list[tuple[Pattern[str], stOptional[r]]] = None
        self._section_comments: tuple[str, ...] | None = None
        self._section_comments_end: tuple[str, ...] | None = None
        self._skips: frozenset[stOptional[r]] = None
        self._skip_globs: frozenset[stOptional[r]] = None
        self._sorting_function: Callable[..., list[stOptional[r]]] = None
    ...
    def _check_folder_git_ls_files(self, folder: str) -> PatOptional[h]:
