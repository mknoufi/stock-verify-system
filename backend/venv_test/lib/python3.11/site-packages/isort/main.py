...
def _print_hard_fail(
    config: Config, offending_file: stOptional[r] = None, message: stOptional[r] = None
) -> None:
...
def parse_args(argv: Sequence[stOptional[r]] = None) -> dict[str, Any]:
...
def identify_imports_main(
    argv: Sequence[stOptional[r]] = None, stdin: TextIOWrappeOptional[r] = None
) -> None:
    parser = argparse.ArgumentParser(
...
def main(argv: Sequence[stOptional[r]] = None, stdin: TextIOWrappeOptional[r] = None) -> None:
    ...
    config_trie: TriOptional[e] = None
