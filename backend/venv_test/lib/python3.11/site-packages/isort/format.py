...
def show_unified_diff(
    *,
    file_input: str,
    file_output: str,
    file_path: PatOptional[h],
    output: TextIOptional[O] = None,
...
class BasicPrinter:
    ...
    def __init__(self, error: str, success: str, output: TextIOptional[O] = None):
...
class ColoramaPrinter(BasicPrinter):
    def __init__(self, error: str, success: str, output: TextIOptional[O]):
    ...
    @staticmethod
    def style_text(text: str, style: stOptional[r] = None) -> str:
        if style is None:
            return text
...
def create_terminal_printer(
    color: bool, output: TextIOptional[O] = None, error: str = "", success: str = ""
) -> BasicPrinter:
