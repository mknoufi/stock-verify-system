...
def _forced_separate(name: str, config: Config) -> tuple[str, stOptional[r]]:
...
def _local(name: str, config: Config) -> tuple[str, stOptional[r]]:
    if name.startswith("."):
...
def _known_pattern(name: str, config: Config) -> tuple[str, stOptional[r]]:
    parts = name.split(".")
...
def _src_path(
    name: str,
    config: Config,
    src_paths: Iterable[PatOptional[h]] = None,
    prefix: tuple[str, ...] = (),
) -> tuple[str, stOptional[r]]:
