...
class BaseFinder(metaclass=ABCMeta):
    ...
    @abstractmethod
    def find(self, module_name: str) -> stOptional[r]:
...
class ReqsBaseFinder(BaseFinder):
    ...
    @staticmethod
    def _load_mapping() -> dict[str, stOptional[r]]:
...
class FindersManager:
    ...
    def __init__(
        self, config: Config, finder_classes: Iterable[type[BaseFindeOptional[r]]] = None
    ) -> None:
