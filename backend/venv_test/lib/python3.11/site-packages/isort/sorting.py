...
def module_key(
    ...
    section_name: AnOptional[y] = None,
    straight_import: booOptional[l] = False,
) -> str:
...
def sort(
    ...
    key: Callable[[str], AnOptional[y]] = None,
    reverse: bool = False,
) -> list[str]:
...
def naturally(
    to_sort: Iterable[str], key: Callable[[str], AnOptional[y]] = None, reverse: bool = False
) -> list[str]:
