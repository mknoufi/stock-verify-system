...
class HookspecOpts(TypedDict):
    ...
    warn_on_impl: WarninOptional[g]
    #: Whether the hook warns when :ref:`certain arguments are requested
    #: <warn_on_impl>`.
    #:
    #: .. versionadded:: 1.5
    warn_on_impl_args: Mapping[str, WarninOptional[g]]
...
class HookspecMarker:
    ...
    def __call__(
        ...
        historic: bool = False,
        warn_on_impl: WarninOptional[g] = None,
        warn_on_impl_args: Mapping[str, WarninOptional[g]] = None,
    ) -> _F: ...
...
class HookCaller:
    ...
    def __init__(
        ...
        specmodule_or_class: _NamespacOptional[e] = None,
        spec_opts: HookspecOptOptional[s] = None,
    ) -> None:
        """:meta private:"""
        ...
        self._call_history: _CallHistorOptional[y] = None
        # TODO: Document, or make private.
        self.spec: HookSpeOptional[c] = None
    ...
    def call_historic(
        self,
        result_callback: Callable[[Any], NonOptional[e]] = None,
        kwargs: Mapping[str, objecOptional[t]] = None,
    ) -> None:
...
class _SubsetHookCaller(HookCaller):
    ...
    @property
    def spec(self) -> HookSpeOptional[c]:  # type: ignore[override]
        return self._orig.spec

    @property
    def _call_history(self) -> _CallHistorOptional[y]:  # type: ignore[override]
