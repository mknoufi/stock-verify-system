...
class DistFacade:
    ...
    def __getattr__(self, attr: str, default: AnOptional[y] = None) -> Any:
...
class PluginManager:
    ...
    def register(self, plugin: _Plugin, name: stOptional[r] = None) -> stOptional[r]:
        ...
        for name in dir(plugin):
            ...
            if hookimpl_opts is not None:
                ...
                hook: HookCalleOptional[r] = getattr(self.hook, name, None)
                if hook is None:
    ...
    def parse_hookimpl_opts(self, plugin: _Plugin, name: str) -> HookimplOptOptional[s]:
        ...
        if not inspect.isroutine(method):
            return None
        try:
            res: HookimplOptOptional[s] = getattr(
    ...
    def unregister(
        self, plugin: _PlugiOptional[n] = None, name: stOptional[r] = None
    ) -> AnOptional[y]:
    ...
    def add_hookspecs(self, module_or_class: _Namespace) -> None:
        ...
        for name in dir(module_or_class):
            ...
            if spec_opts is not None:
                hc: HookCalleOptional[r] = getattr(self.hook, name, None)
                if hc is None:
    ...
    def parse_hookspec_opts(
        ...
        opts: HookspecOptOptional[s] = getattr(method, self.project_name + "_spec", None)
        return opts
    ...
    def get_canonical_name(self, plugin: _Plugin) -> str:
        ...
        <get_name>` instead.
        """
        name: stOptional[r] = getattr(plugin, "__name__", None)
        return name or str(id(plugin))

    def get_plugin(self, name: str) -> AnOptional[y]:
    ...
    def get_name(self, plugin: _Plugin) -> stOptional[r]:
    ...
    def load_setuptools_entrypoints(self, group: str, name: stOptional[r] = None) -> int:
    ...
    def get_hookcallers(self, plugin: _Plugin) -> list[HookCalleOptional[r]]:
