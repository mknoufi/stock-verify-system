...
def asdict(
    ...
    Args:
        ...
        value_serializer (typing.CallablOptional[e]):
...
def resolve_types(cls, globalns=None, localns=None, attribs=None, include_extras=True):
    ...
    *type* field. In other words, you don't need to resolve your types if you
    ...
    Args:
        ...
        globalns (dicOptional[t]): Dictionary containing global variables.

        localns (dicOptional[t]): Dictionary containing local variables.

        attribs (lisOptional[t]):
