...
def define(
    ...
    *,
    ...
    Args:
        ...
        on_setattr (~typing.Callable | list[~typing.CallablOptional[e]] | ~typing.Literal[attrs.setters.NO_OP]):
        ...
        field_transformer (~typing.CallablOptional[e]):
        ...
        getstate_setstate (booOptional[l]):
            .. note::
