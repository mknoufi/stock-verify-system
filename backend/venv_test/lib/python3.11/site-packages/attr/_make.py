...
def _compile_and_eval(
    script: str,
    globs: dict[str, AnOptional[y]],
    locs: Mapping[str, objecOptional[t]] = None,
    filename: str = "",
) -> None:
    """
...
def _linecache_and_compile(
    ...
    filename: str,
    globs: dict[str, AnOptional[y]],
    locals: Mapping[str, objecOptional[t]] = None,
) -> dict[str, Any]:
    """
...
class ClassProps:
    ...
    Attributes:
        ...
        on_setattr_hook (Callable[[Any, Attribute[Any], Any], AnOptional[y]]):
            The class's ``__setattr__`` hook.

        field_transformer (Callable[[Attribute[Any]], Attribute[AnOptional[y]]]):
