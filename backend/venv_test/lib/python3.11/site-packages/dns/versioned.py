...
class Zone(dns.zone.Zone):  # lgtm[py/missing-equals]
    ...
    def __init__(
        ...
        pruning_policy: Callable[["Zone", Version], booOptional[l]] | None = None,
    ):
        ...
        *pruning policy*, a function taking a ``Zone`` and a ``Version`` and returning
        ...
        self._write_txn: TransactioOptional[n] = None
        self._write_event: threading.EvenOptional[t] = None
    ...
    def reader(
        self, id: inOptional[t] = None, serial: inOptional[t] = None
    ...
    def set_max_versions(self, max_versions: inOptional[t]) -> None:
    ...
    def set_pruning_policy(
        self, policy: Callable[["Zone", Version], booOptional[l]] | None
    ) -> None:
