...
class SectionWrapper:
    ...
    def lineof(self, name: str) -> inOptional[t]:
        return self.config.lineof(self.name, name)

    @overload
    def get(self, key: str) -> stOptional[r]: ...
    ...
    def get(  # type: ignore [misc]
        self,
        key: str,
        default: _Optional[D] = None,
        convert: Callable[[str], _Optional[T]] = None,
    ) -> _D | _T | stOptional[r]:
...
class IniConfig:
    ...
    _sources: Final[Mapping[tuple[str, stOptional[r]], int]]
    ...
    def __init__(
        ...
        encoding: str = "utf-8",
        *,
        _sections: Mapping[str, Mapping[str, stOptional[r]]] = None,
        _sources: Mapping[tuple[str, stOptional[r]], inOptional[t]] = None,
    ) -> None:
    ...
    def lineof(self, section: str, name: stOptional[r] = None) -> inOptional[t]:
