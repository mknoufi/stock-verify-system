...
def parse_ini_data(
    ...
    *,
...
) -> tuple[Mapping[str, Mapping[str, str]], Mapping[tuple[str, stOptional[r]], int]]:
    ...
    sources: dict[tuple[str, stOptional[r]], int] = {}
...
) -> tuple[stOptional[r], stOptional[r]]:
    # blank lines
