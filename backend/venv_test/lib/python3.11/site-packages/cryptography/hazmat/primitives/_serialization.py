...
class KeySerializationEncryptionBuilder:
    def __init__(
        ...
        *,
        _kdf_rounds: inOptional[t] = None,
        _hmac_hash: HashAlgorithOptional[m] = None,
        _key_cert_algorithm: PBEOptional[S] = None,
    ) -> None:
        self._format = format
...
class _KeySerializationEncryption(KeySerializationEncryption):
    def __init__(
        ...
        password: bytes,
        *,
        kdf_rounds: inOptional[t],
        hmac_hash: HashAlgorithOptional[m],
        key_cert_algorithm: PBEOptional[S],
    ):
        self._format = format
        self.password = password
