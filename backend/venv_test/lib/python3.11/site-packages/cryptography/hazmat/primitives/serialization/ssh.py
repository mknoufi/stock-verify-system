...
class _FragList:
    ...
    def __init__(self, init: list[utils.BuffeOptional[r]] = None) -> None:
        self.flist = []
        if init:
...
class SSHCertificateBuilder:
    def __init__(
        self,
        _public_key: SSHCertPublicKeyTypeOptional[s] = None,
        _serial: inOptional[t] = None,
        _type: SSHCertificateTypOptional[e] = None,
        _key_id: byteOptional[s] = None,
        _valid_principals: list[bytes] = [],
        _valid_for_all_principals: bool = False,
        _valid_before: inOptional[t] = None,
        _valid_after: inOptional[t] = None,
