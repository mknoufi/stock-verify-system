...
class _KBKDFDeriver:
    def __init__(
        ...
        break_location: inOptional[t],
        label: byteOptional[s],
        context: byteOptional[s],
        fixed: byteOptional[s],
    ):
        assert callable(prf)
...
class KBKDFHMAC(KeyDerivationFunction):
    def __init__(
        ...
        *,
        break_location: inOptional[t] = None,
    ):
...
class KBKDFCMAC(KeyDerivationFunction):
    def __init__(
        ...
        *,
        ...
        self._algorithm = algorithm
        self._cipher: ciphers.BlockCipherAlgorithOptional[m] = None
