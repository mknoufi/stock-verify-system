...
class PKCS12KeyAndCertificates:
    def __init__(
        self,
        key: PrivateKeyTypeOptional[s],
        cert: PKCS12CertificatOptional[e],
    ...
    @property
    def key(self) -> PrivateKeyTypeOptional[s]:
        return self._key

    @property
    def cert(self) -> PKCS12CertificatOptional[e]:
        return self._cert
...
def serialize_key_and_certificates(
    name: byteOptional[s],
    key: PKCS12PrivateKeyTypeOptional[s],
    cert: x509.CertificatOptional[e],
    cas: Iterable[_PKCS12CATypeOptional[s]],
    encryption_algorithm: serialization.KeySerializationEncryption,
) -> bytes:
    if key is not None and not isinstance(
        key,
