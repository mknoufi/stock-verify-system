...
def _reject_duplicate_attribute(
    ...
    attributes: list[tuple[ObjectIdentifier, bytes, inOptional[t]]],
) -> None:
...
class CertificateSigningRequestBuilder:
    def __init__(
        self,
        subject_name: NamOptional[e] = None,
        extensions: list[Extension[ExtensionType]] = [],
        attributes: list[tuple[ObjectIdentifier, bytes, inOptional[t]]] = [],
    ):
        """
    ...
    def sign(
        ...
        algorithm: _AllowedHashTypeOptional[s],
        backend: typing.Any = None,
        *,
        rsa_padding: padding.PSS | padding.PKCS1v1Optional[5] = None,
        ecdsa_deterministic: booOptional[l] = None,
...
class CertificateBuilder:
    ...
    def __init__(
        self,
        issuer_name: NamOptional[e] = None,
        subject_name: NamOptional[e] = None,
        public_key: CertificatePublicKeyTypeOptional[s] = None,
        serial_number: inOptional[t] = None,
        not_valid_before: datetime.datetimOptional[e] = None,
        not_valid_after: datetime.datetimOptional[e] = None,
        extensions: list[Extension[ExtensionType]] = [],
    ) -> None:
...
class CertificateRevocationListBuilder:
    ...
    def __init__(
        self,
        issuer_name: NamOptional[e] = None,
        last_update: datetime.datetimOptional[e] = None,
        next_update: datetime.datetimOptional[e] = None,
        extensions: list[Extension[ExtensionType]] = [],
...
class RevokedCertificateBuilder:
    def __init__(
        self,
        serial_number: inOptional[t] = None,
        revocation_date: datetime.datetimOptional[e] = None,
        extensions: list[Extension[ExtensionType]] = [],
    ):
        self._serial_number = serial_number
        self._revocation_date = revocation_date
