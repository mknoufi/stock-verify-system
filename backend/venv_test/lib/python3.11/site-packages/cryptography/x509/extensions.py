...
class AuthorityKeyIdentifier(ExtensionType):
    ...
    def __init__(
        self,
        key_identifier: byteOptional[s],
        authority_cert_issuer: Iterable[GeneralNamOptional[e]],
        authority_cert_serial_number: inOptional[t],
    ) -> None:
    ...
    @property
    def key_identifier(self) -> byteOptional[s]:
        return self._key_identifier

    @property
    def authority_cert_issuer(
        self,
    ) -> list[GeneralNamOptional[e]]:
        return self._authority_cert_issuer

    @property
    def authority_cert_serial_number(self) -> inOptional[t]:
...
class BasicConstraints(ExtensionType):
    ...
    def __init__(self, ca: bool, path_length: inOptional[t]) -> None:
    ...
    @property
    def path_length(self) -> inOptional[t]:
...
class DistributionPoint:
    def __init__(
        self,
        full_name: Iterable[GeneralNamOptional[e]],
        relative_name: RelativeDistinguishedNamOptional[e],
        reasons: frozenset[ReasonFlagOptional[s]],
        crl_issuer: Iterable[GeneralNamOptional[e]],
    ) -> None:
    ...
    @property
    def full_name(self) -> list[GeneralNamOptional[e]]:
        return self._full_name

    @property
    def relative_name(self) -> RelativeDistinguishedNamOptional[e]:
        return self._relative_name

    @property
    def reasons(self) -> frozenset[ReasonFlagOptional[s]]:
        return self._reasons

    @property
    def crl_issuer(self) -> list[GeneralNamOptional[e]]:
...
class PolicyConstraints(ExtensionType):
    ...
    def __init__(
        self,
        require_explicit_policy: inOptional[t],
        inhibit_policy_mapping: inOptional[t],
    ) -> None:
    ...
    @property
    def require_explicit_policy(self) -> inOptional[t]:
        return self._require_explicit_policy

    @property
    def inhibit_policy_mapping(self) -> inOptional[t]:
...
class PolicyInformation:
    def __init__(
        ...
        policy_qualifiers: Iterable[str | UserNoticOptional[e]],
    ) -> None:
...
class UserNotice:
    def __init__(
        self,
        notice_reference: NoticeReferencOptional[e],
        explicit_text: stOptional[r],
    ) -> None:
    ...
    @property
    def notice_reference(self) -> NoticeReferencOptional[e]:
        return self._notice_reference

    @property
    def explicit_text(self) -> stOptional[r]:
...
class NoticeReference:
    ...
    @property
    def organization(self) -> stOptional[r]:
...
class PrivateKeyUsagePeriod(ExtensionType):
    ...
    def __init__(
        self,
        not_before: datetime.datetimOptional[e],
        not_after: datetime.datetimOptional[e],
    ) -> None:
        if (
    ...
    @property
    def not_before(self) -> datetime.datetimOptional[e]:
        return self._not_before

    @property
    def not_after(self) -> datetime.datetimOptional[e]:
...
class NameConstraints(ExtensionType):
    ...
    def __init__(
        self,
        permitted_subtrees: Iterable[GeneralNamOptional[e]],
        excluded_subtrees: Iterable[GeneralNamOptional[e]],
    ) -> None:
...
class IssuingDistributionPoint(ExtensionType):
    ...
    def __init__(
        ...
        only_some_reasons: frozenset[ReasonFlagOptional[s]],
        indirect_crl: bool,
    ...
    def only_some_reasons(
        self,
    ) -> frozenset[ReasonFlagOptional[s]]:
...
class MSCertificateTemplate(ExtensionType):
    ...
    def __init__(
        ...
        major_version: inOptional[t],
        minor_version: inOptional[t],
    ) -> None:
    ...
    @property
    def major_version(self) -> inOptional[t]:
        return self._major_version

    @property
    def minor_version(self) -> inOptional[t]:
...
class NamingAuthority:
    ...
    @property
    def id(self) -> ObjectIdentifieOptional[r]:
        return self._id

    @property
    def url(self) -> stOptional[r]:
        return self._url

    @property
    def text(self) -> stOptional[r]:
        return self._text
...
class ProfessionInfo:
    def __init__(
        self,
        naming_authority: NamingAuthoritOptional[y],
        profession_items: Iterable[str],
        profession_oids: Iterable[ObjectIdentifieOptional[r]],
        registration_number: stOptional[r],
        add_profession_info: byteOptional[s],
    ) -> None:
    ...
    @property
    def naming_authority(self) -> NamingAuthoritOptional[y]:
    ...
    @property
    def profession_oids(self) -> list[ObjectIdentifieOptional[r]]:
        return self._profession_oids

    @property
    def registration_number(self) -> stOptional[r]:
        return self._registration_number

    @property
    def add_profession_info(self) -> byteOptional[s]:
...
class Admission:
    def __init__(
        self,
        admission_authority: GeneralNamOptional[e],
        naming_authority: NamingAuthoritOptional[y],
    ...
    @property
    def admission_authority(self) -> GeneralNamOptional[e]:
...
class Admissions(ExtensionType):
    ...
    def __init__(
        self,
        authority: GeneralNamOptional[e],
    ...
    @property
    def authority(self) -> GeneralNamOptional[e]:
