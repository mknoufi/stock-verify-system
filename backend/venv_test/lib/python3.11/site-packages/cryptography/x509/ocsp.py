...
class _SingleResponse:
    def __init__(
        self,
        resp: tuple[x509.Certificate, x509.CertificatOptional[e]],
        resp_hash: tuple[bytes, bytes, inOptional[t]],
        algorithm: hashes.HashAlgorithm,
        cert_status: OCSPCertStatus,
        this_update: datetime.datetime,
        next_update: datetime.datetimOptional[e],
        revocation_time: datetime.datetimOptional[e],
        revocation_reason: x509.ReasonFlagOptional[s],
    ):
...
class OCSPResponseBuilder:
    def __init__(
        self,
        response: _SingleResponsOptional[e] = None,
        responder_id: tuple[x509.Certificate, OCSPResponderEncoding]
        | None = None,
        certs: list[x509.CertificatOptional[e]] = None,
        extensions: list[x509.Extension[x509.ExtensionType]] = [],
    ):
    ...
    def sign(
        ...
        algorithm: hashes.HashAlgorithOptional[m],
    ) -> OCSPResponse:
