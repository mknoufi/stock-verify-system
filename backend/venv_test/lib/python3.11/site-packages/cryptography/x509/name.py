...
class NameAttribute(typing.Generic[NameAttributeValueType]):
    ...
    def rfc4514_string(
        self, attr_name_overrides: _OidNameMaOptional[p] = None
    ) -> str:
        """
...
class Name:
    ...
    def from_rfc4514_string(
        cls,
        data: str,
        attr_name_overrides: _NameOidMaOptional[p] = None,
    ) -> Name:
