...
class Fernet:
    ...
    def decrypt(self, token: bytes | str, ttl: inOptional[t] = None) -> bytes:
    ...
    def _decrypt_data(
        ...
        data: bytes,
        timestamp: int,
        time_info: tuple[int, inOptional[t]],
    ) -> bytes:
...
class MultiFernet:
    ...
    def decrypt(self, msg: bytes | str, ttl: inOptional[t] = None) -> bytes:
        for f in self._fernets:
            try:
