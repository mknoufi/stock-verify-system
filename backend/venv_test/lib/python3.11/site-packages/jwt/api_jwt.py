...
class PyJWT:
    def __init__(self, options: dict[str, AnOptional[y]] = None) -> None:
        if options is None:
            options = {}
    ...
    def encode(
        ...
        algorithm: stOptional[r] = None,
        headers: dict[str, AnOptional[y]] = None,
        json_encoder: type[json.JSONEncodeOptional[r]] = None,
    ...
    def decode_complete(
        ...
        algorithms: Sequence[stOptional[r]] = None,
        options: dict[str, AnOptional[y]] = None,
        # deprecated arg, remove in pyjwt3
        verify: booOptional[l] = None,
        # could be used as passthrough to api_jws, consider removal in pyjwt3
        detached_payload: byteOptional[s] = None,
        # passthrough arguments to _validate_claims
        # consider putting in options
        audience: str | Iterable[stOptional[r]] = None,
        issuer: str | Sequence[stOptional[r]] = None,
        subject: stOptional[r] = None,
    ...
    def _validate_aud(
        self,
        payload: dict[str, Any],
        audience: str | Iterable[stOptional[r]],
        *,
        strict: bool = False,
    ) -> None:
        if audience is None:
