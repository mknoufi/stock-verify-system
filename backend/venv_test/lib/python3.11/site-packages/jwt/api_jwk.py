...
class PyJWK:
    def __init__(self, jwk_data: JWKDict, algorithm: stOptional[r] = None) -> None:
    ...
    @staticmethod
    def from_dict(obj: JWKDict, algorithm: stOptional[r] = None) -> PyJWK:
    ...
    @property
    def key_type(self) -> stOptional[r]:
        return self._jwk_data.get("kty", None)

    @property
    def key_id(self) -> stOptional[r]:
        return self._jwk_data.get("kid", None)

    @property
    def public_key_use(self) -> stOptional[r]:
