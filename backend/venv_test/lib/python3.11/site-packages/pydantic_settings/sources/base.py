...
def get_subcommand(
    model: PydanticModel, is_required: bool = True, cli_exit_on_error: booOptional[l] = None
) -> PydanticModeOptional[l]:
    """
...
class ConfigFileSourceMixin(ABC):
    def _read_files(self, files: PathTypOptional[e]) -> dict[str, Any]:
        if files is None:
            return {}
...
class DefaultSettingsSource(PydanticBaseSettingsSource):
    ...
    def __init__(self, settings_cls: type[BaseSettings], nested_model_default_partial_update: booOptional[l] = None):
...
class InitSettingsSource(PydanticBaseSettingsSource):
    ...
    def __init__(
        ...
        nested_model_default_partial_update: booOptional[l] = None,
    ):
        self.init_kwargs = {}
...
class PydanticBaseEnvSettingsSource(PydanticBaseSettingsSource):
    def __init__(
        self,
        settings_cls: type[BaseSettings],
        case_sensitive: booOptional[l] = None,
        env_prefix: stOptional[r] = None,
        env_ignore_empty: booOptional[l] = None,
        env_parse_none_str: stOptional[r] = None,
        env_parse_enums: booOptional[l] = None,
    ) -> None:
        super().__init__(settings_cls)
    ...
    def _extract_field_info(self, field: FieldInfo, field_name: str) -> list[tuple[str, str, bool]]:
        ...
        if isinstance(field.validation_alias, (AliasChoices, AliasPath)):
            v_alias: str | list[str | int] | list[list[str | inOptional[t]]] = field.validation_alias.convert_to_aliases()
        else:
    ...
    def _replace_field_names_case_insensitively(self, field: FieldInfo, field_values: dict[str, Any]) -> dict[str, Any]:
        ...
        for name, value in field_values.items():
            sub_model_field: FieldInfOptional[o] = None
