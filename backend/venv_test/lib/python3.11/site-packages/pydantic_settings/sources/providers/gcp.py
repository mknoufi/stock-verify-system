...
class GoogleSecretManagerMapping(Mapping[str, stOptional[r]]):
    _loaded_secrets: dict[str, stOptional[r]]
    ...
    def __getitem__(self, key: str) -> stOptional[r]:
        if not self._case_sensitive:
            key = key.lower()
...
class GoogleSecretManagerSettingsSource(EnvSettingsSource):
    ...
    def __init__(
        ...
        credentials: CredentialOptional[s] = None,
        ...
        secret_client: SecretManagerServiceClienOptional[t] = None,
