...
class EnvSettingsSource(PydanticBaseEnvSettingsSource):
    ...
    def next_field(
        self, field: FieldInfo | AnOptional[y], key: str, case_sensitive: booOptional[l] = None
    ) -> FieldInfOptional[o]:
        """
    ...
    def explode_env_vars(self, field_name: str, field: FieldInfo, env_vars: Mapping[str, stOptional[r]]) -> dict[str, Any]:
        """
        ...
        for env_name, env_val in env_vars.items():
            ...
            *keys, last_key = env_name_without_prefix.split(self.env_nested_delimiter, self.maxsplit)
            env_var = result
            target_field: FieldInfOptional[o] = field
            for key in keys:
    ...
    def _coerce_env_val_strict(self, field: FieldInfOptional[o], value: Any) -> Any:
        """
