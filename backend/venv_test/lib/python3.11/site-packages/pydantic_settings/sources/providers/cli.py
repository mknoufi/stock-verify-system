...
class _CliArg(BaseModel):
    ...
    enable_decoding: booOptional[l]
    env_prefix_len: int
    args: list[str] = []
    kwargs: dict[str, Any] = {}

    _alias_names: tuple[str, ...] = PrivateAttr(())
    _alias_paths: dict[str, inOptional[t]] = PrivateAttr({})
    ...
    def __init__(
        ...
        parser_map: defaultdict[str | FieldInfo, dict[inOptional[t] | str, _CliArg]],
        **values: Any,
    ) -> None:
    ...
    @cached_property
    def subcommand_dest(self) -> stOptional[r]:
    ...
    @cached_property
    def alias_paths(self) -> dict[str, inOptional[t]]:
...
T = TypeVar('T')
CliSubCommand = Annotated[Optional[T], _CliSubCommand]
...
class CliSettingsSource(EnvSettingsSource, Generic[T]):
    ...
    def __init__(
        ...
        cli_prog_name: stOptional[r] = None,
        cli_parse_args: bool | list[str] | tuple[str, ...] | None = None,
        cli_parse_none_str: stOptional[r] = None,
        cli_hide_none_type: booOptional[l] = None,
        cli_avoid_json: booOptional[l] = None,
        cli_enforce_required: booOptional[l] = None,
        cli_use_class_docs_for_groups: booOptional[l] = None,
        cli_exit_on_error: booOptional[l] = None,
        cli_prefix: stOptional[r] = None,
        cli_flag_prefix_char: stOptional[r] = None,
        cli_implicit_flags: booOptional[l] = None,
        cli_ignore_unknown_args: booOptional[l] = None,
        cli_kebab_case: bool | Literal['all', 'no_enums'] | None = None,
        cli_shortcuts: Mapping[str, str | list[stOptional[r]]] = None,
        case_sensitive: booOptional[l] = True,
        root_parser: Any = None,
        parse_args_method: Callable[..., AnOptional[y]] = None,
        add_argument_method: Callable[..., AnOptional[y]] = ArgumentParser.add_argument,
        add_argument_group_method: Callable[..., AnOptional[y]] = ArgumentParser.add_argument_group,
        add_parser_method: Callable[..., AnOptional[y]] = _SubParsersAction.add_parser,
        add_subparsers_method: Callable[..., AnOptional[y]] = ArgumentParser.add_subparsers,
    ...
    def __call__(
        self,
        *,
        args: list[str] | tuple[str, ...] | booOptional[l] = None,
        parsed_args: Namespace | SimpleNamespace | dict[str, list[str] | stOptional[r]] = None,
    ...
    @overload
    def _load_env_vars(self) -> Mapping[str, stOptional[r]]: ...
    ...
    def _load_env_vars(
        self, *, parsed_args: Namespace | SimpleNamespace | dict[str, list[str] | stOptional[r]] = None
    ) -> Mapping[str, stOptional[r]] | CliSettingsSource[T]:
    ...
    def _get_merge_parsed_list_types(self, parsed_list: list[str], field_name: str) -> tuple[typOptional[e], typOptional[e]]:
    ...
    def _merged_list_to_str(self, merged_list: list[str], field_name: str) -> str:
        ...
        is_use_decode: booOptional[l] = None
    ...
    def _consume_string_or_number(self, item: str, merged_list: list[str], merge_type: type[AnOptional[y]]) -> str:
    ...
    def _connect_parser_method(
        self, parser_method: Callable[..., AnOptional[y]], method_name: str, *args: Any, **kwargs: Any
    ) -> Callable[..., Any]:
        if (
            ...
            def parse_args_insensitive_method(
                ...
                namespace: NamespacOptional[e] = None,
            ) -> Any:
                insensitive_args = []
    ...
    def _connect_group_method(self, add_argument_group_method: Callable[..., AnOptional[y]]) -> Callable[..., Any]:
    ...
    def _connect_root_parser(
        self,
        root_parser: T,
        parse_args_method: Callable[..., AnOptional[y]],
        add_argument_method: Callable[..., AnOptional[y]] = ArgumentParser.add_argument,
        add_argument_group_method: Callable[..., AnOptional[y]] = ArgumentParser.add_argument_group,
        add_parser_method: Callable[..., AnOptional[y]] = _SubParsersAction.add_parser,
        add_subparsers_method: Callable[..., AnOptional[y]] = ArgumentParser.add_subparsers,
        ...
        self._cli_dict_args: dict[str, type[AnOptional[y]]] = {}
        self._parser_map: defaultdict[str | FieldInfo, dict[inOptional[t] | str, _CliArg]] = defaultdict(dict)
    ...
    def _add_parser_args(
        ...
        subparsers: Any = None
        alias_path_args: dict[str, inOptional[t]] = {}
    ...
    def _metavar_format_choices(self, args: list[str], obj_qualname: stOptional[r] = None) -> str:
        if 'JSON' in args:
