...
class NestedSecretsSettingsSource(EnvSettingsSource):
    def __init__(
        ...
        secrets_dir_max_size: inOptional[t] = None,
        secrets_case_sensitive: booOptional[l] = None,
        secrets_prefix: stOptional[r] = None,
        secrets_nested_delimiter: stOptional[r] = None,
        secrets_nested_subdir: booOptional[l] = None,
        ...
        self.secrets_dir: PathTypOptional[e] = first_not_none(
        ...
        # nested options
        self.secrets_nested_delimiter: stOptional[r] = first_not_none(
