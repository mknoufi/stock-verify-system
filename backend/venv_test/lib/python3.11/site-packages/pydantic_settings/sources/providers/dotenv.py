...
class DotEnvSettingsSource(EnvSettingsSource):
    ...
    def __init__(
        ...
        env_file: DotenvTypOptional[e] = ENV_FILE_SENTINEL,
        env_file_encoding: stOptional[r] = None,
        case_sensitive: booOptional[l] = None,
        env_prefix: stOptional[r] = None,
        env_nested_delimiter: stOptional[r] = None,
        env_nested_max_split: inOptional[t] = None,
    ...
    def _static_read_env_file(
        ...
        *,
        ...
        parse_none_str: stOptional[r] = None,
    ) -> Mapping[str, stOptional[r]]:
        file_vars: dict[str, stOptional[r]] = dotenv_values(file_path, encoding=encoding or 'utf8')
    ...
    def _read_env_files(self) -> Mapping[str, stOptional[r]]:
        ...
        dotenv_vars: dict[str, stOptional[r]] = {}
