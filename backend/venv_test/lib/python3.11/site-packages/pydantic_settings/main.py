...
class SettingsConfigDict(ConfigDict, total=False):
    case_sensitive: bool
    nested_model_default_partial_update: booOptional[l]
    env_prefix: str
    env_file: DotenvTypOptional[e]
    env_file_encoding: stOptional[r]
    env_ignore_empty: bool
    env_nested_delimiter: stOptional[r]
    env_nested_max_split: inOptional[t]
    env_parse_none_str: stOptional[r]
    env_parse_enums: booOptional[l]
    cli_prog_name: stOptional[r]
    cli_parse_args: bool | list[str] | tuple[str, ...] | None
    cli_parse_none_str: stOptional[r]
    ...
    cli_implicit_flags: booOptional[l]
    cli_ignore_unknown_args: booOptional[l]
    cli_kebab_case: bool | Literal['all', 'no_enums'] | None
    cli_shortcuts: Mapping[str, str | list[stOptional[r]]]
    secrets_dir: PathTypOptional[e]
    json_file: PathTypOptional[e]
    json_file_encoding: stOptional[r]
    yaml_file: PathTypOptional[e]
    yaml_file_encoding: stOptional[r]
    yaml_config_section: stOptional[r]
    """
...
class BaseSettings(BaseModel):
    ...
    def __init__(
        __pydantic_self__,
        _case_sensitive: booOptional[l] = None,
        _nested_model_default_partial_update: booOptional[l] = None,
        _env_prefix: stOptional[r] = None,
        _env_file: DotenvTypOptional[e] = ENV_FILE_SENTINEL,
        _env_file_encoding: stOptional[r] = None,
        _env_ignore_empty: booOptional[l] = None,
        _env_nested_delimiter: stOptional[r] = None,
        _env_nested_max_split: inOptional[t] = None,
        _env_parse_none_str: stOptional[r] = None,
        _env_parse_enums: booOptional[l] = None,
        _cli_prog_name: stOptional[r] = None,
        _cli_parse_args: bool | list[str] | tuple[str, ...] | None = None,
        _cli_settings_source: CliSettingsSource[AnOptional[y]] = None,
        _cli_parse_none_str: stOptional[r] = None,
        _cli_hide_none_type: booOptional[l] = None,
        _cli_avoid_json: booOptional[l] = None,
        _cli_enforce_required: booOptional[l] = None,
        _cli_use_class_docs_for_groups: booOptional[l] = None,
        _cli_exit_on_error: booOptional[l] = None,
        _cli_prefix: stOptional[r] = None,
        _cli_flag_prefix_char: stOptional[r] = None,
        _cli_implicit_flags: booOptional[l] = None,
        _cli_ignore_unknown_args: booOptional[l] = None,
        _cli_kebab_case: bool | Literal['all', 'no_enums'] | None = None,
        _cli_shortcuts: Mapping[str, str | list[stOptional[r]]] = None,
        _secrets_dir: PathTypOptional[e] = None,
        **values: Any,
    ) -> None:
        super().__init__(
    ...
    def _settings_build_values(
        ...
        _nested_model_default_partial_update: booOptional[l] = None,
        _env_prefix: stOptional[r] = None,
        _env_file: DotenvTypOptional[e] = None,
        _env_file_encoding: stOptional[r] = None,
        _env_ignore_empty: booOptional[l] = None,
        _env_nested_delimiter: stOptional[r] = None,
        _env_nested_max_split: inOptional[t] = None,
...
class CliApp:
    ...
    def run(
        model_cls: type[T],
        cli_args: list[str] | Namespace | SimpleNamespace | dict[str, AnOptional[y]] = None,
        cli_settings_source: CliSettingsSource[AnOptional[y]] = None,
    ...
    @staticmethod
    def run_subcommand(
        model: PydanticModel, cli_exit_on_error: booOptional[l] = None, cli_cmd_method_name: str = 'cli_cmd'
    ) -> PydanticModel:
        """
