...
def _explicitly_chosen(
    *,
    option: list[stOptional[r]],
    extend: list[stOptional[r]],
) -> tuple[str, ...]:
...
class StyleGuideManager:
    ...
    def __init__(
        ...
        decider: DecisionEnginOptional[e] = None,
    ) -> None:
    ...
    def handle_error(
        ...
        column_number: int,
        text: str,
        physical_line: stOptional[r] = None,
    ) -> int:
...
class StyleGuide:
    ...
    def copy(
        self,
        filename: stOptional[r] = None,
        extend_ignore_with: Sequence[stOptional[r]] = None,
    ) -> StyleGuide:
