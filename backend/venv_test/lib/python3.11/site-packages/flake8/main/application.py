...
class Application:
    ...
    def __init__(self) -> None:
        ...
        self.end_time: floaOptional[t] = None

        self.plugins: finder.PluginOptional[s] = None
        #: The user-selected formatter from :attr:`formatting_plugins`
        self.formatter: BaseFormatteOptional[r] = None
        #: The :class:`flake8.style_guide.StyleGuideManager` built from the
        #: user's options
        self.guide: style_guide.StyleGuideManageOptional[r] = None
        #: The :class:`flake8.checker.Manager` that will handle running all of
        #: the checks selected by the user.
        self.file_checker_manager: checker.ManageOptional[r] = None

        #: The user-supplied options parsed into an instance of
        #: :class:`argparse.Namespace`
        self.options: argparse.NamespacOptional[e] = None
