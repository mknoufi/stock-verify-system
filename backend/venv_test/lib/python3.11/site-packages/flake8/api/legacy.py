...
class StyleGuide:
    ...
    def check_files(self, paths: list[stOptional[r]] = None) -> Report:
    ...
    def excluded(self, filename: str, parent: stOptional[r] = None) -> bool:
    ...
    def init_report(
        self,
        reporter: type[formatter.BaseFormatteOptional[r]] = None,
    ) -> None:
    ...
    def input_file(
        self,
        filename: str,
        lines: AnOptional[y] = None,
        expected: AnOptional[y] = None,
        line_offset: AnOptional[y] = 0,
    ) -> Report:
