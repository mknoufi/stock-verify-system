...
class Option:
    ...
    def __init__(
        ...
        self.config_name: stOptional[r] = None
...
class OptionManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._current_group: argparse._ArgumentGrouOptional[p] = None
    ...
    def parse_args(
        self,
        args: Sequence[stOptional[r]] = None,
        values: argparse.NamespacOptional[e] = None,
    ) -> argparse.Namespace:
