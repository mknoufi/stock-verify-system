...
class BaseFormatter:
    ...
    def __init__(self, options: argparse.Namespace) -> None:
        ...
        self.output_fd: IO[stOptional[r]] = None
        self.newline = "\n"
    ...
    def format(self, error: Violation) -> stOptional[r]:
    ...
    def show_source(self, error: Violation) -> stOptional[r]:
    ...
    def write(self, line: stOptional[r], source: stOptional[r]) -> None:
