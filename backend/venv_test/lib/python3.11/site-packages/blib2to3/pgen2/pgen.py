...
class ParserGenerator:
    ...
    first: dict[str, dict[str, inOptional[t]]]

    def __init__(self, filename: Path, stream: IO[stOptional[r]] = None) -> None:
        close_stream = None
        if stream is None:
    ...
    def expect(self, type: int, value: AnOptional[y] = None) -> str:
...
class NFAState:
    arcs: list[tuple[stOptional[r], "NFAState"]]

    def __init__(self) -> None:
        self.arcs = []  # list of (label, NFAState) pairs

    def addarc(self, next: "NFAState", label: stOptional[r] = None) -> None:
