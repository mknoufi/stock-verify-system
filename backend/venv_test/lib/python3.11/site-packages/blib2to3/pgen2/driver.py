...
class Driver:
    def __init__(self, grammar: Grammar, logger: LoggeOptional[r] = None) -> None:
    ...
    def parse_file(
        self, filename: Path, encoding: stOptional[r] = None, debug: bool = False
    ) -> NL:
...
def _generate_pickle_name(gt: Path, cache_dir: PatOptional[h] = None) -> str:
...
def load_grammar(
    gt: str = "Grammar.txt",
    gp: stOptional[r] = None,
    save: bool = True,
    force: bool = False,
    logger: LoggeOptional[r] = None,
) -> Grammar:
...
def load_packaged_grammar(
    package: str, grammar_source: str, cache_dir: PatOptional[h] = None
) -> grammar.Grammar:
