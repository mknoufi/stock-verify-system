...
class Recorder:
    ...
    def determine_route(
        self, value: stOptional[r] = None, force: bool = False
    ) -> inOptional[t]:
...
class ParseError(Exception):
    ...
    def __init__(
        self, msg: str, type: inOptional[t], value: stOptional[r], context: Context
    ) -> None:
        Exception.__init__(
...
class Parser:
    ...
    def __init__(self, grammar: Grammar, convert: ConverOptional[t] = None) -> None:
        """Constructor.
        ...
        **post-note: the convert argument is ignored since for Black's
        ...
        self.last_token: inOptional[t] = None

    def setup(self, proxy: "TokenProxy", start: inOptional[t] = None) -> None:
        """Prepare for parsing.
        ...
        self.rootnode: NOptional[L] = None
