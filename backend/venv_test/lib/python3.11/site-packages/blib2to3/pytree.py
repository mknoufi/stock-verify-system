...
class Base:
    ...
    def get_lineno(self) -> inOptional[t]:
    ...
    @property
    def next_sibling(self) -> NOptional[L]:
        """
    ...
    @property
    def prev_sibling(self) -> NOptional[L]:
        """
...
class Node(Base):
    ...
    fixers_applied: list[AnOptional[y]]
    used_names: set[stOptional[r]]
    ...
    def __init__(
        ...
        fixers_applied: list[AnOptional[y]] = None,
    ) -> None:
        """
        Initializer.
    ...
    def invalidate_sibling_maps(self) -> None:
        self.prev_sibling_map: dict[int, NOptional[L]] | None = None
        self.next_sibling_map: dict[int, NOptional[L]] | None = None

    def update_sibling_maps(self) -> None:
        _prev: dict[int, NOptional[L]] = {}
        _next: dict[int, NOptional[L]] = {}
        self.prev_sibling_map = _prev
        self.next_sibling_map = _next
        previous: NOptional[L] = None
...
class Leaf(Base):
    ...
    def __init__(
        ...
        if prefix is not None:
            self._prefix = prefix
        self.fixers_applied: list[AnOptional[y]] = fixers_applied[:]
        self.children = []
...
class BasePattern:
    ...
    name: stOptional[r] = None  # Optional name used to store match in results dict
    ...
    def match(self, node: NL, results: _ResultOptional[s] = None) -> bool:
        """
    ...
    def match_seq(self, nodes: list[NL], results: _ResultOptional[s] = None) -> bool:
        """
...
class LeafPattern(BasePattern):
    def __init__(
        self,
        type: inOptional[t] = None,
        content: stOptional[r] = None,
...
class NodePattern(BasePattern):
    ...
    def __init__(
        self,
        type: inOptional[t] = None,
        content: Iterable[stOptional[r]] = None,
        name: stOptional[r] = None,
    ) -> None:
        """
        Initializer.  Takes optional type, content, and name.
...
class NegatedPattern(BasePattern):
    def __init__(self, content: BasePatterOptional[n] = None) -> None:
        """
        Initializer.
