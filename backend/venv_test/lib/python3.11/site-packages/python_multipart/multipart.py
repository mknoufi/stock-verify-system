...
if TYPE_CHECKING:  # pragma: no cover
    ...
    class FieldProtocol(_FormProtocol, Protocol):
        def __init__(self, name: byteOptional[s]) -> None: ...

        def set_none(self) -> None: ...

    class FileProtocol(_FormProtocol, Protocol):
        def __init__(self, file_name: byteOptional[s], field_name: byteOptional[s], config: FileConfig) -> None: ...
...
def parse_options_header(value: str | byteOptional[s]) -> tuple[bytes, dict[bytes, bytes]]:
...
class Field:
    ...
    @classmethod
    def from_value(cls, name: bytes, value: byteOptional[s]) -> Field:
    ...
    @property
    def field_name(self) -> byteOptional[s]:
        """This property returns the name of the field."""
        return self._name

    @property
    def value(self) -> byteOptional[s]:
...
class File:
    ...
    def __init__(self, file_name: byteOptional[s], field_name: byteOptional[s] = None, config: FileConfig = {}) -> None:
        ...
        self._actual_file_name: byteOptional[s] = None
    ...
    @property
    def file_name(self) -> byteOptional[s]:
        """The file name given in the upload request."""
        return self._file_name

    @property
    def actual_file_name(self) -> byteOptional[s]:
...
class BaseParser:
    ...
    def callback(
        self, name: CallbackName, data: byteOptional[s] = None, start: inOptional[t] = None, end: inOptional[t] = None
    ) -> None:
    ...
    def set_callback(self, name: CallbackName, new_func: Callable[..., AnOptional[y]]) -> None:
...
class QuerystringParser(BaseParser):
    ...
    | Callback Name  | Parameters      | Description                                         |
    |----------------|-----------------|-----------------------------------------------------|
    | on_field_starOptional[t]            | Called when a new field is encountered.             |
...
class FormParser:
    ...
    def __init__(
        self,
        content_type: str,
        on_field: OnFieldCallbacOptional[k],
        on_file: OnFileCallbacOptional[k],
        on_end: Callable[[], NonOptional[e]] = None,
        boundary: bytes | stOptional[r] = None,
        file_name: byteOptional[s] = None,
        ...
        parser: OctetStreamParser | MultipartParser | QuerystringParseOptional[r] = None
        ...
        if content_type == "application/octet-stream":
            ...
            f_multi: FileProtocol | FieldProtocoOptional[l] = None
            writer = None
            is_file = False
...
def create_form_parser(
    ...
    """
    content_type: str | byteOptional[s] = headers.get("Content-Type")
...
def parse_form(
    ...
    content_length: int | float | byteOptional[s] = headers.get("Content-Length")
