...
def _out(message: stOptional[r] = None, nl: bool = True, **styles: Any) -> None:
...
@mypyc_attr(patchable=True)
def _err(message: stOptional[r] = None, nl: bool = True, **styles: Any) -> None:
    if message is not None:
        if "fg" not in styles:
            styles["fg"] = "red"
        message = style(message, **styles)
...
@mypyc_attr(patchable=True)
def out(message: stOptional[r] = None, nl: bool = True, **styles: Any) -> None:
    _out(message, nl=nl, **styles)


def err(message: stOptional[r] = None, nl: bool = True, **styles: Any) -> None:
