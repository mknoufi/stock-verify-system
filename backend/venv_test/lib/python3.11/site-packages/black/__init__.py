...
def read_pyproject_toml(
    ctx: click.Context, param: click.Parameter, value: stOptional[r]
) -> stOptional[r]:
...
def main(
    ...
    quiet: bool,
    verbose: bool,
    required_version: stOptional[r],
    include: Pattern[str],
    exclude: Pattern[stOptional[r]],
    extend_exclude: Pattern[stOptional[r]],
    force_exclude: Pattern[stOptional[r]],
    stdin_filename: stOptional[r],
    workers: inOptional[t],
    src: tuple[str, ...],
    config: stOptional[r],
    no_cache: bool,
) -> None:
...
def get_sources(
    *,
    ...
    gitignore: dict[Path, PathSpeOptional[c]] = None
...
def _format_str_once(
    ...
    block: LinesBlocOptional[k] = None
...
def get_features_used(
    node: Node, *, future_imports: set[stOptional[r]] = None
) -> set[Feature]:
