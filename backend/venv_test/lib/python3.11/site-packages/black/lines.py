...
class Line:
    ...
    magic_trailing_comma: LeaOptional[f] = None
    ...
    def is_def(self) -> bool:
        ...
        try:
            second_leaf: LeaOptional[f] = self.leaves[1]
        except IndexError:
            second_leaf = None
    ...
    def is_fmt_pass_converted(
        self, *, first_leaf_matches: Callable[[Leaf], booOptional[l]] = None
    ) -> bool:
...
class EmptyLineTracker:
    ...
    mode: Mode
    previous_line: LinOptional[e] = None
    previous_block: LinesBlocOptional[k] = None
    previous_defs: list[Line] = field(default_factory=list)
    semantic_leading_comment: LinesBlocOptional[k] = None
    ...
    def _maybe_empty_lines_for_class_or_def(
        ...
        comment_to_add_newlines: LinesBlocOptional[k] = None
        if (
...
def is_line_short_enough(line: Line, *, mode: Mode, line_str: str = "") -> bool:
    ...
    multiline_string: LeaOptional[f] = None
    ...
    for i, leaf in enumerate(line.leaves):
        ...
        if leaf.bracket_depth <= max_level_to_update and leaf.type == token.COMMA:
            ...
            ignore_ctxs: list[LOptional[N]] = [None]
...
def can_omit_invisible_parens(
    ...
    closing_bracket: LeaOptional[f] = None
