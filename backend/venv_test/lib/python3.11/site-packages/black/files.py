...
def find_project_root(
    srcs: Sequence[str], stdin_filename: stOptional[r] = None
) -> tuple[Path, str]:
...
def find_pyproject_toml(
    path_search_start: tuple[str, ...], stdin_filename: stOptional[r] = None
) -> stOptional[r]:
...
def parse_req_python_version(requires_python: str) -> list[TargetVersioOptional[n]]:
...
def parse_req_python_specifier(requires_python: str) -> list[TargetVersioOptional[n]]:
...
def gen_python_files(
    ...
    include: Pattern[str],
    exclude: Pattern[str],
    extend_exclude: Pattern[stOptional[r]],
    force_exclude: Pattern[stOptional[r]],
    report: Report,
    gitignore_dict: dict[Path, PathSpeOptional[c]],
    *,
    verbose: bool,
    quiet: bool,
) -> Iterator[Path]:
