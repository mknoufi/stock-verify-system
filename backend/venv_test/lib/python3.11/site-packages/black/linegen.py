...
def left_hand_split(
    ...
    for leaf_type in [token.LPAR, token.LSQB]:
        ...
        matching_bracket: LeaOptional[f] = None
        depth = 0
...
def _first_right_hand_split(
    ...
    opening_bracket: LeaOptional[f] = None
...
def _get_last_non_comment_leaf(line: Line) -> inOptional[t]:
