...
class BaseStringSplitter(StringTransformer):
    ...
    @staticmethod
    def _prefer_paren_wrap_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
...
class StringSplitter(BaseStringSplitter, CustomSplitMapMixin):
    ...
    def _get_break_idx(self, string: str, max_break_idx: int) -> inOptional[t]:
        """
...
class StringParenWrapper(BaseStringSplitter, CustomSplitMapMixin):
    ...
    @staticmethod
    def _return_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
            string_idx such that @LL[string_idx] is equal to our target (i.e.
    ...
    @staticmethod
    def _else_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
            string_idx such that @LL[string_idx] is equal to our target (i.e.
    ...
    @staticmethod
    def _assert_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
            string_idx such that @LL[string_idx] is equal to our target (i.e.
    ...
    @staticmethod
    def _assign_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
            string_idx such that @LL[string_idx] is equal to our target (i.e.
    ...
    @staticmethod
    def _dict_or_lambda_match(LL: list[Leaf]) -> inOptional[t]:
        """
        Returns:
            string_idx such that @LL[string_idx] is equal to our target (i.e.
