...
class AsyncMongoClient(common.BaseObject, Generic[_DocumentType]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._timeout: floaOptional[t] = None
        self._topology_settings: TopologySettings = None  # type: ignore[assignment]
        self._event_listeners: _EventListenerOptional[s] = None
    ...
    def _normalize_and_validate_options(
        self, opts: common._CaseInsensitiveDictionary, seeds: set[tuple[str, inOptional[t]]]
