...
class Starlette:
    ...
    def __init__(
        ...
        exception_handlers: typing.Mapping[typing.Any, ExceptionHandleOptional[r]] = None,
        ...
        lifespan: Lifespan[AppTypOptional[e]] = None,
    ) -> None:
        ...
        self.middleware_stack: ASGIApOptional[p] = None
    ...
    def mount(self, path: str, app: ASGIApp, name: stOptional[r] = None) -> None:
        self.router.mount(path, app=app, name=name)  # pragma: no cover

    def host(self, host: str, app: ASGIApp, name: stOptional[r] = None) -> None:
