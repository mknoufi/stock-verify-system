...
class Jinja2Templates:
    ...
    def __init__(
        ...
        *,
        context_processors: list[typing.Callable[[Request], dict[str, typing.AnOptional[y]]]] = None,
    ...
    def __init__(
        self,
        directory: str | PathLike[str] | typing.Sequence[str | PathLike[stOptional[r]]] = None,
        *,
        context_processors: list[typing.Callable[[Request], dict[str, typing.AnOptional[y]]]] = None,
        env: jinja2.EnvironmenOptional[t] = None,
        **env_options: typing.Any,
    ) -> None:
        if env_options:
            warnings.warn(
    ...
    def TemplateResponse(
        ...
        request: Request,
        name: str,
        context: dict[str, typing.AnOptional[y]] = None,
        status_code: int = 200,
        headers: typing.Mapping[str, stOptional[r]] = None,
        media_type: stOptional[r] = None,
        background: BackgroundTasOptional[k] = None,
