...
class HTTPConnection(typing.Mapping[str, typing.Any]):
    ...
    def __init__(self, scope: Scope, receive: ReceivOptional[e] = None) -> None:
    ...
    @property
    def client(self) -> AddresOptional[s]:
    ...
    def url_for(self, name: str, /, **path_params: typing.Any) -> URL:
        url_path_provider: Router | StarlettOptional[e] = self.scope.get("router") or self.scope.get("app")
