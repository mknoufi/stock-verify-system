...
class BaseHTTPMiddleware:
    def __init__(self, app: ASGIApp, dispatch: DispatchFunctioOptional[n] = None) -> None:
        self.app = app
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        async def call_next(request: Request) -> Response:
            app_exc: ExceptioOptional[n] = None
...
class _StreamingResponse(Response):
    def __init__(
        ...
        info: typing.Mapping[str, typing.AnOptional[y]] = None,
    ) -> None:
        self.info = info
