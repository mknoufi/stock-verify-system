...
class WebSocketTestSession:
    ...
    def __exit__(self, *args: typing.Any) -> booOptional[l]:
    ...
    def close(self, code: int = 1000, reason: stOptional[r] = None) -> None:
...
class TestClient(httpx.Client):
    __test__ = False
    task: Future[None]
    portal: anyio.abc.BlockingPortaOptional[l] = None
    ...
    def __init__(
        ...
        backend_options: dict[str, typing.AnOptional[y]] = None,
        cookies: httpx._types.CookieTypeOptional[s] = None,
        headers: dict[str, stOptional[r]] = None,
    ...
    def request(  # type: ignore[override]
        ...
        *,
        content: httpx._types.RequestContenOptional[t] = None,
        data: _RequestDatOptional[a] = None,
        files: httpx._types.RequestFileOptional[s] = None,
        json: typing.Any = None,
        params: httpx._types.QueryParamTypeOptional[s] = None,
        headers: httpx._types.HeaderTypeOptional[s] = None,
        cookies: httpx._types.CookieTypeOptional[s] = None,
        auth: httpx._types.AuthTypes | httpx._client.UseClientDefault = httpx._client.USE_CLIENT_DEFAULT,
        follow_redirects: bool | httpx._client.UseClientDefault = httpx._client.USE_CLIENT_DEFAULT,
        timeout: httpx._types.TimeoutTypes | httpx._client.UseClientDefault = httpx._client.USE_CLIENT_DEFAULT,
        extensions: dict[str, typing.AnOptional[y]] = None,
    ) -> httpx.Response:
    ...
    def websocket_connect(
        self,
        url: str,
        subprotocols: typing.Sequence[stOptional[r]] = None,
        **kwargs: typing.Any,
    ...
    def __enter__(self) -> TestClient:
        with contextlib.ExitStack() as stack:
            ...
            send: anyio.create_memory_object_stream[typing.MutableMapping[str, typing.AnOptional[y]]] = (
