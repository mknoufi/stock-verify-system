...
class Route(BaseRoute):
    def __init__(
        ...
        *,
        methods: list[stOptional[r]] = None,
        name: stOptional[r] = None,
        include_in_schema: bool = True,
        middleware: typing.Sequence[MiddlewarOptional[e]] = None,
    ) -> None:
...
class Mount(BaseRoute):
    def __init__(
        self,
        path: str,
        app: ASGIApOptional[p] = None,
        routes: typing.Sequence[BaseRoutOptional[e]] = None,
        name: stOptional[r] = None,
        *,
        middleware: typing.Sequence[MiddlewarOptional[e]] = None,
    ) -> None:
...
class Host(BaseRoute):
    def __init__(self, host: str, app: ASGIApp, name: stOptional[r] = None) -> None:
...
class _AsyncLiftContextManager(typing.AsyncContextManager[_T]):
    ...
    async def __aexit__(
        ...
        traceback: types.TracebackTypOptional[e],
    ) -> booOptional[l]:
...
class Router:
    def __init__(
        ...
        default: ASGIApOptional[p] = None,
        on_startup: typing.Sequence[typing.Callable[[], typing.AnOptional[y]]] = None,
        on_shutdown: typing.Sequence[typing.Callable[[], typing.AnOptional[y]]] = None,
        # the generic to Lifespan[AppType] is the type of the top level application
        # which the router cannot know statically, so we use typing.Any
        lifespan: Lifespan[typing.AnOptional[y]] = None,
        *,
        middleware: typing.Sequence[MiddlewarOptional[e]] = None,
    ) -> None:
    ...
    def mount(self, path: str, app: ASGIApp, name: stOptional[r] = None) -> None:  # pragma: no cover
        route = Mount(path, app=app, name=name)
        self.routes.append(route)

    def host(self, host: str, app: ASGIApp, name: stOptional[r] = None) -> None:  # pragma: no cover
    ...
    def websocket_route(self, path: str, name: stOptional[r] = None) -> typing.Callable:  # type: ignore[type-arg]
        """
        We no longer document this decorator style API, and its usage is discouraged.
        Instead you should use the following approach:
