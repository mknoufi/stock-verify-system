...
class WebSocketDisconnect(Exception):
    def __init__(self, code: int = 1000, reason: stOptional[r] = None) -> None:
        self.code = code
...
class WebSocket(HTTPConnection):
    ...
    async def accept(
        self,
        subprotocol: stOptional[r] = None,
        headers: typing.Iterable[tuple[bytes, byteOptional[s]]] = None,
    ) -> None:
        headers = headers or []
    ...
    async def close(self, code: int = 1000, reason: stOptional[r] = None) -> None:
