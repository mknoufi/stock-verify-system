...
class UploadFile:
    ...
    def __init__(
        ...
        *,
        size: inOptional[t] = None,
        filename: stOptional[r] = None,
        headers: HeaderOptional[s] = None,
    ) -> None:
    ...
    @property
    def content_type(self) -> stOptional[r]:
...
class Headers(typing.Mapping[str, str]):
    ...
    def __init__(
        ...
        raw: list[tuple[bytes, byteOptional[s]]] = None,
        scope: typing.MutableMapping[str, typing.AnOptional[y]] = None,
    ) -> None:
...
class State:
    ...
    def __init__(self, state: dict[str, typing.AnOptional[y]] = None):
        if state is None:
            state = {}
