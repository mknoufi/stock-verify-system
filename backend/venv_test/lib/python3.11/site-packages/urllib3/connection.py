...
class HTTPConnection(_HTTPConnection):
    ...
    proxy_is_verified: booOptional[l] = None

    blocksize: int
    source_address: tuple[str, inOptional[t]]
    socket_options: connection._TYPE_SOCKET_OPTIONOptional[S]

    _has_connected_to_proxy: bool
    _response_options: _ResponseOptionOptional[s]
    _tunnel_host: stOptional[r]
    _tunnel_port: inOptional[t]
    _tunnel_scheme: stOptional[r]
    ...
    def __init__(
        ...
        *,
        ...
        source_address: tuple[str, inOptional[t]] = None,
        blocksize: int = 16384,
        socket_options: None | (
        ...
        self._tunnel_host: stOptional[r] = None
        self._tunnel_port: inOptional[t] = None
        self._tunnel_scheme: stOptional[r] = None
...
class HTTPSConnection(HTTPConnection):
    ...
    cert_reqs: int | stOptional[r] = None
    ca_certs: stOptional[r] = None
    ca_cert_dir: stOptional[r] = None
    ca_cert_data: None | str | bytes = None
    ssl_version: int | stOptional[r] = None
    ssl_minimum_version: inOptional[t] = None
    ssl_maximum_version: inOptional[t] = None
    assert_fingerprint: stOptional[r] = None
    _connect_callback: typing.Callable[..., NonOptional[e]] = None
    ...
    def __init__(
        ...
        *,
        ...
        assert_fingerprint: stOptional[r] = None,
        server_hostname: stOptional[r] = None,
        ssl_context: ssl.SSLContexOptional[t] = None,
        ca_certs: stOptional[r] = None,
        ca_cert_dir: stOptional[r] = None,
        ca_cert_data: None | str | bytes = None,
        ssl_minimum_version: inOptional[t] = None,
        ssl_maximum_version: inOptional[t] = None,
        ssl_version: int | stOptional[r] = None,  # Deprecated
        cert_file: stOptional[r] = None,
        key_file: stOptional[r] = None,
        key_password: stOptional[r] = None,
    ) -> None:
        super().__init__(
            host,
            port=port,
    ...
    def connect(self) -> None:
        ...
        target_supports_http2: booOptional[l]
...
def _ssl_wrap_socket_and_match_hostname(
    ...
    *,
    ...
    ssl_minimum_version: inOptional[t],
    ssl_maximum_version: inOptional[t],
    cert_file: stOptional[r],
    key_file: stOptional[r],
    key_password: stOptional[r],
    ca_certs: stOptional[r],
    ca_cert_dir: stOptional[r],
    ca_cert_data: None | str | bytes,
    assert_hostname: None | str | typing.Literal[False],
    assert_fingerprint: stOptional[r],
    server_hostname: stOptional[r],
    ssl_context: ssl.SSLContexOptional[t],
...
def _match_hostname(
    cert: _TYPE_PEER_CERT_RET_DICOptional[T],
...
def _wrap_proxy_error(err: Exception, proxy_scheme: stOptional[r]) -> ProxyError:
...
def _url_from_connection(
    conn: HTTPConnection | HTTPSConnection, path: stOptional[r] = None
) -> str:
