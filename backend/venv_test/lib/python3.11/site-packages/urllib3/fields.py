...
def guess_content_type(
    filename: stOptional[r], default: str = "application/octet-stream"
) -> str:
    """
...
class RequestField:
    ...
    def __init__(
        ...
        header_formatter: typing.Callable[[str, _TYPE_FIELD_VALUE], stOptional[r]] = None,
    ):
        self._name = name
        self._filename = filename
        self.data = data
        self.headers: dict[str, stOptional[r]] = {}
        if headers:
    ...
    def from_tuples(
        ...
        """
        filename: stOptional[r]
        content_type: stOptional[r]
        data: _TYPE_FIELD_VALUE
    ...
    def _render_parts(
        self,
        header_parts: (
            dict[str, _TYPE_FIELD_VALUOptional[E]]
            | typing.Sequence[tuple[str, _TYPE_FIELD_VALUOptional[E]]]
        ),
    ) -> str:
        """
        ...
        :param header_parts:
            ...
            as `k1="v1"; k2="v2"; ...`.
        """
        iterable: typing.Iterable[tuple[str, _TYPE_FIELD_VALUOptional[E]]]
    ...
    def make_multipart(
        self,
        content_disposition: stOptional[r] = None,
        content_type: stOptional[r] = None,
        content_location: stOptional[r] = None,
    ) -> None:
        """
