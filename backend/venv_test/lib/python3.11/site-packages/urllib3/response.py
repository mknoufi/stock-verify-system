...
class BaseHTTPResponse(io.IOBase):
    ...
    def __init__(
        self,
        *,
        headers: typing.Mapping[str, str] | typing.Mapping[bytes, byteOptional[s]] = None,
        status: int,
        version: int,
        version_string: str,
        reason: stOptional[r],
        decode_content: bool,
        request_url: stOptional[r],
        ...
        self._request_url: stOptional[r] = request_url
        ...
        self._decoder: ContentDecodeOptional[r] = None
        self.length_remaining: inOptional[t]

    def get_redirect_location(self) -> stOptional[r] | typing.Literal[False]:
        """
    ...
    @url.setter
    def url(self, url: stOptional[r]) -> None:
        raise NotImplementedError()

    @property
    def connection(self) -> BaseHTTPConnectioOptional[n]:
        raise NotImplementedError()

    @property
    def retries(self) -> RetrOptional[y]:
        return self._retries

    @retries.setter
    def retries(self, retries: RetrOptional[y]) -> None:
    ...
    def stream(
        self, amt: inOptional[t] = 2**16, decode_content: booOptional[l] = None
    ) -> typing.Iterator[bytes]:
        raise NotImplementedError()

    def read(
        self,
        amt: inOptional[t] = None,
        decode_content: booOptional[l] = None,
    ...
    def getheader(self, name: str, default: stOptional[r] = None) -> stOptional[r]:
...
class HTTPResponse(BaseHTTPResponse):
    ...
    def __init__(
        ...
        reason: stOptional[r] = None,
        preload_content: bool = True,
        decode_content: bool = True,
        original_response: _HttplibHTTPResponsOptional[e] = None,
        pool: HTTPConnectionPooOptional[l] = None,
        connection: HTTPConnectioOptional[n] = None,
        msg: _HttplibHTTPMessagOptional[e] = None,
        retries: RetrOptional[y] = None,
        enforce_content_length: bool = True,
        request_method: stOptional[r] = None,
        request_url: stOptional[r] = None,
        auto_close: bool = True,
        sock_shutdown: typing.Callable[[int], NonOptional[e]] = None,
    ) -> None:
        super().__init__(
            headers=headers,
            status=status,
        ...
        self._body = None
        self._fp: _HttplibHTTPResponsOptional[e] = None
        ...
        self.chunk_left: inOptional[t] = None
    ...
    @property
    def connection(self) -> HTTPConnectioOptional[n]:
    ...
    def _init_length(self, request_method: stOptional[r]) -> inOptional[t]:
        """
        Set initial length value for Response content if available.
        """
        length: inOptional[t]
        content_length: stOptional[r] = self.headers.get("content-length")
    ...
    def _handle_chunk(self, amt: inOptional[t]) -> bytes:
        returned_chunk = None
        if amt is None:
    ...
    def read_chunked(
        self, amt: inOptional[t] = None, decode_content: booOptional[l] = None
    ) -> typing.Generator[bytes]:
        """
