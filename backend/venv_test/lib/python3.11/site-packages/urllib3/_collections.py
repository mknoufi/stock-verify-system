...
def ensure_can_construct_http_header_dict(
    potential: object,
) -> ValidHTTPHeaderSourcOptional[e]:
...
class RecentlyUsedContainer(typing.Generic[_KT, _VT], typing.MutableMapping[_KT, _VT]):
    ...
    _maxsize: int
    dispose_func: typing.Callable[[_VT], NonOptional[e]]
    lock: RLock

    def __init__(
        self,
        maxsize: int = 10,
        dispose_func: typing.Callable[[_VT], NonOptional[e]] = None,
    ) -> None:
        super().__init__()
...
class HTTPHeaderDict(typing.MutableMapping[str, str]):
    ...
    def __init__(self, headers: ValidHTTPHeaderSourcOptional[e] = None, **kwargs: str):
        super().__init__()
