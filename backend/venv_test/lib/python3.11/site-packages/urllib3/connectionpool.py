...
class ConnectionPool:
    ...
    scheme: stOptional[r] = None
    QueueCls = queue.LifoQueue

    def __init__(self, host: str, port: inOptional[t] = None) -> None:
        if not host:
...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def __init__(
        ...
        timeout: _TYPE_TIMEOUOptional[T] = _DEFAULT_TIMEOUT,
        maxsize: int = 1,
        block: bool = False,
        headers: typing.Mapping[str, stOptional[r]] = None,
        retries: Retry | bool | inOptional[t] = None,
        _proxy: UrOptional[l] = None,
        _proxy_headers: typing.Mapping[str, stOptional[r]] = None,
        _proxy_config: ProxyConfiOptional[g] = None,
        **conn_kw: typing.Any,
    ):
        ...
        self.pool: queue.LifoQueue[typing.AnOptional[y]] = self.QueueCls(maxsize)
        self.block = block
    ...
    def _get_conn(self, timeout: floaOptional[t] = None) -> BaseHTTPConnection:
        """
    ...
    def _put_conn(self, conn: BaseHTTPConnectioOptional[n]) -> None:
        """
    ...
    def _raise_timeout(
        ...
        url: str,
        timeout_value: _TYPE_TIMEOUOptional[T],
    ) -> None:
    ...
    def _make_request(
        ...
        headers: typing.Mapping[str, stOptional[r]] = None,
        retries: RetrOptional[y] = None,
        timeout: _TYPE_TIMEOUT = _DEFAULT_TIMEOUT,
        chunked: bool = False,
        response_conn: BaseHTTPConnectioOptional[n] = None,
    ...
    def urlopen(  # type: ignore[override]
        ...
        timeout: _TYPE_TIMEOUT = _DEFAULT_TIMEOUT,
        pool_timeout: inOptional[t] = None,
        release_conn: booOptional[l] = None,
        chunked: bool = False,
        body_pos: _TYPE_BODY_POSITIOOptional[N] = None,
        preload_content: bool = True,
        decode_content: bool = True,
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def __init__(
        ...
        ssl_minimum_version: ssl.TLSVersioOptional[n] = None,
        ssl_maximum_version: ssl.TLSVersioOptional[n] = None,
        assert_hostname: str | typing.Literal[FalsOptional[e]] = None,
...
@typing.overload
def _normalize_host(host: None, scheme: stOptional[r]) -> None: ...


@typing.overload
def _normalize_host(host: str, scheme: stOptional[r]) -> str: ...


def _normalize_host(host: stOptional[r], scheme: stOptional[r]) -> stOptional[r]:
    """
...
def _url_from_pool(
    pool: HTTPConnectionPool | HTTPSConnectionPool, path: stOptional[r] = None
) -> str:
