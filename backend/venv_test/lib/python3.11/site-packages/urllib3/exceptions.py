...
class RequestError(PoolError):
    ...
    def __init__(self, pool: ConnectionPool, url: stOptional[r], message: str) -> None:
        self.url = url
...
class MaxRetryError(RequestError):
    ...
    def __init__(
        self, pool: ConnectionPool, url: stOptional[r], reason: ExceptioOptional[n] = None
    ) -> None:
        self.reason = reason
...
class InvalidChunkLength(HTTPError, httplib_IncompleteRead):
    ...
    def __init__(self, response: HTTPResponse, length: bytes) -> None:
        ...
        self.expected: inOptional[t] = response.length_remaining
...
class ProxySchemeUnknown(AssertionError, URLSchemeUnknown):
    ...
    def __init__(self, scheme: stOptional[r]) -> None:
...
class HeaderParsingError(HTTPError):
    ...
    def __init__(
        self, defects: list[MessageDefect], unparsed_data: bytes | stOptional[r]
    ) -> None:
