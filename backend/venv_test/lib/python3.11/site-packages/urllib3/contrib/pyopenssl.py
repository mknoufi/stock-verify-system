...
def _dnsname_to_stdlib(name: str) -> stOptional[r]:
    """
    ...
    def idna_encode(name: str) -> byteOptional[s]:
        """
...
class WrappedSocket:
    ...
    ) -> dict[str, list[typing.AnOptional[y]]]:
...
class PyOpenSSLContext:
    ...
    def load_verify_locations(
        self,
        cafile: stOptional[r] = None,
        capath: stOptional[r] = None,
        cadata: byteOptional[s] = None,
    ) -> None:
    ...
    def wrap_socket(
        ...
        suppress_ragged_eofs: bool = True,
        server_hostname: bytes | stOptional[r] = None,
    ) -> WrappedSocket:
