...
class _RequestError(Exception):
    def __init__(
        ...
        *,
        request: EmscriptenRequesOptional[t] = None,
        response: EmscriptenResponsOptional[e] = None,
    ):
...
class _ReadStream(io.RawIOBase):
    def __init__(
        ...
        self.request: EmscriptenRequesOptional[t] = request
...
class _JSPIReadStream(io.RawIOBase):
    ...
    def __init__(
        ...
        self._is_done = False
        self.request: EmscriptenRequesOptional[t] = request
        self.response: EmscriptenResponsOptional[e] = response
...
_fetcher: _StreamingFetcheOptional[r] = None
...
def send_streaming_request(request: EmscriptenRequest) -> EmscriptenResponsOptional[e]:
    if has_jspi():
...
def _run_sync_with_timeout(
    ...
    request: EmscriptenRequesOptional[t],
    response: EmscriptenResponsOptional[e],
) -> Any:
    """
...
def streaming_ready() -> booOptional[l]:
    if _fetcher:
