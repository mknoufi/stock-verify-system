...
class EmscriptenHttpResponseWrapper(BaseHTTPResponse):
    def __init__(
        ...
        connection: BaseHTTPConnection | BaseHTTPSConnectioOptional[n] = None,
    ):
    ...
    @property
    def connection(self) -> BaseHTTPConnection | BaseHTTPSConnectioOptional[n]:
    ...
    def read(
        ...
        decode_content: booOptional[l] = None,  # ignored because browser decodes always
