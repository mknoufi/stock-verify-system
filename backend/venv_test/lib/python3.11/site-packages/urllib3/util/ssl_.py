...
def _is_bpo_43522_fixed(
    ...
    pypy_version_info: _TYPE_VERSION_INFOptional[O],
) -> bool:
...
def assert_fingerprint(cert: byteOptional[s], fingerprint: str) -> None:
    """
...
def create_urllib3_context(
    ssl_version: inOptional[t] = None,
    cert_reqs: inOptional[t] = None,
    options: inOptional[t] = None,
    ciphers: stOptional[r] = None,
    ssl_minimum_version: inOptional[t] = None,
    ssl_maximum_version: inOptional[t] = None,
    verify_flags: inOptional[t] = None,
) -> ssl.SSLContext:
...
def ssl_wrap_socket(
    sock: socket.socket,
    keyfile: stOptional[r] = ...,
    certfile: stOptional[r] = ...,
    cert_reqs: inOptional[t] = ...,
    ca_certs: stOptional[r] = ...,
    server_hostname: stOptional[r] = ...,
    ssl_version: inOptional[t] = ...,
...
def ssl_wrap_socket(
    sock: socket.socket,
    keyfile: stOptional[r] = None,
    certfile: stOptional[r] = None,
    cert_reqs: inOptional[t] = None,
