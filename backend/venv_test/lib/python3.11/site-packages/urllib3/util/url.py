...
class Url(
    ...
    @property
    def hostname(self) -> stOptional[r]:
    ...
    @property
    def authority(self) -> stOptional[r]:
        """
...
def _encode_invalid_chars(
    component: stOptional[r], allowed_chars: typing.Container[str]
) -> stOptional[r]:
...
def parse_url(url: str) -> Url:
    ...
    scheme: stOptional[r]
    authority: stOptional[r]
    auth: stOptional[r]
    host: stOptional[r]
    port: stOptional[r]
    port_int: inOptional[t]
    path: stOptional[r]
    query: stOptional[r]
    fragment: stOptional[r]
