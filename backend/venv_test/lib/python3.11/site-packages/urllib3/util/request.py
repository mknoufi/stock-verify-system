...
def make_headers(
    keep_alive: booOptional[l] = None,
    accept_encoding: bool | list[str] | stOptional[r] = None,
    user_agent: stOptional[r] = None,
    basic_auth: stOptional[r] = None,
    proxy_basic_auth: stOptional[r] = None,
    disable_cache: booOptional[l] = None,
) -> dict[str, str]:
    """
...
def set_file_position(
    body: typing.Any, pos: _TYPE_BODY_POSITIOOptional[N]
) -> _TYPE_BODY_POSITIOOptional[N]:
    """
...
class ChunksAndContentLength(typing.NamedTuple):
    chunks: typing.Iterable[byteOptional[s]]
    content_length: inOptional[t]


def body_to_chunks(
    body: typing.AnOptional[y], method: str, blocksize: int
