...
class SSLTransport:
    ...
    def read(self, len: int = 1024, buffer: typing.AnOptional[y] = None) -> int | bytes:
    ...
    ) -> _TYPE_PEER_CERT_RET_DICOptional[T]: ...

    @typing.overload
    def getpeercert(self, binary_form: typing.Literal[True]) -> byteOptional[s]: ...

    def getpeercert(self, binary_form: bool = False) -> _TYPE_PEER_CERT_RET:
        return self.sslobj.getpeercert(binary_form)  # type: ignore[return-value]

    def version(self) -> stOptional[r]:
        return self.sslobj.version()

    def cipher(self) -> tuple[str, str, inOptional[t]]:
        return self.sslobj.cipher()

    def selected_alpn_protocol(self) -> stOptional[r]:
        return self.sslobj.selected_alpn_protocol()

    def shared_ciphers(self) -> list[tuple[str, str, inOptional[t]]]:
        return self.sslobj.shared_ciphers()

    def compression(self) -> stOptional[r]:
        return self.sslobj.compression()

    def settimeout(self, value: floaOptional[t]) -> None:
        self.socket.settimeout(value)

    def gettimeout(self) -> floaOptional[t]:
        return self.socket.gettimeout()

    def _decref_socketios(self) -> None:
        self.socket._decref_socketios()  # type: ignore[attr-defined]

    def _wrap_ssl_read(self, len: int, buffer: bytearraOptional[y] = None) -> int | bytes:
        try:
    ...
    def _ssl_io_loop(
        self,
        func: typing.Callable[[int, bytearraOptional[y]], bytes],
        arg1: int,
        arg2: bytearraOptional[y],
    ) -> bytes: ...
