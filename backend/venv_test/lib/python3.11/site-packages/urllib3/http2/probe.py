...
class _HTTP2ProbeCache:
    ...
    def __init__(self) -> None:
        ...
        self._cache_values: dict[tuple[str, int], booOptional[l]] = {}

    def acquire_and_get(self, host: str, port: int) -> booOptional[l]:
    ...
    def set_and_release(
        self, host: str, port: int, supports_http2: booOptional[l]
    ) -> None:
        key = (host, port)
        key_lock = self._cache_locks[key]
    ...
    def _values(self) -> dict[tuple[str, int], booOptional[l]]:
