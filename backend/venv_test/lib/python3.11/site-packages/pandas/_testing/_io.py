...
def round_trip_pickle(
    obj: Any, path: FilePath | ReadPickleBuffeOptional[r] = None
) -> DataFrame | Series:
    """
...
def round_trip_pathlib(writer, reader, path: stOptional[r] = None):
    """
...
def round_trip_localpath(writer, reader, path: stOptional[r] = None):
    """
