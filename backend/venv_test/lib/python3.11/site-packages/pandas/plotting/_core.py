...
def hist_series(
    ...
    ax=None,
    grid: bool = True,
    xlabelsize: inOptional[t] = None,
    xrot: floaOptional[t] = None,
    ylabelsize: inOptional[t] = None,
    yrot: floaOptional[t] = None,
    figsize: tuple[int, inOptional[t]] = None,
    bins: int | Sequence[int] = 10,
    backend: stOptional[r] = None,
    legend: bool = False,
    **kwargs,
):
    """
...
def hist_frame(
    data: DataFrame,
    column: IndexLabeOptional[l] = None,
    by=None,
    grid: bool = True,
    xlabelsize: inOptional[t] = None,
    xrot: floaOptional[t] = None,
    ...
    sharey: bool = False,
    figsize: tuple[int, inOptional[t]] = None,
    layout: tuple[int, inOptional[t]] = None,
    bins: int | Sequence[int] = 10,
    backend: stOptional[r] = None,
    legend: bool = False,
    **kwargs,
...
def boxplot(
    data: DataFrame,
    column: str | list[stOptional[r]] = None,
    by: str | list[stOptional[r]] = None,
    ax: AxeOptional[s] = None,
    fontsize: float | stOptional[r] = None,
    rot: int = 0,
    grid: bool = True,
    figsize: tuple[float, floaOptional[t]] = None,
    layout: tuple[int, inOptional[t]] = None,
    return_type: stOptional[r] = None,
    **kwargs,
):
...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    def line(
        self, x: HashablOptional[e] = None, y: HashablOptional[e] = None, **kwargs
    ) -> PlotAccessor:
        """
    ...
    def box(self, by: IndexLabeOptional[l] = None, **kwargs) -> PlotAccessor:
        r"""
    ...
    def hist(
        self, by: IndexLabeOptional[l] = None, bins: int = 10, **kwargs
    ) -> PlotAccessor:
        """
    ...
    def kde(
        self,
        bw_method: Literal["scott", "silverman"] | float | CallablOptional[e] = None,
        ind: np.ndarray | inOptional[t] = None,
        **kwargs,
    ) -> PlotAccessor:
        """
    ...
    def area(
        self,
        x: HashablOptional[e] = None,
        y: HashablOptional[e] = None,
        stacked: bool = True,
        **kwargs,
    ) -> PlotAccessor:
        """
    ...
    def scatter(
        ...
        x: Hashable,
        y: Hashable,
        s: Hashable | Sequence[HashablOptional[e]] = None,
        c: Hashable | Sequence[HashablOptional[e]] = None,
        **kwargs,
    ) -> PlotAccessor:
        """
    ...
    def hexbin(
        ...
        x: Hashable,
        y: Hashable,
        C: HashablOptional[e] = None,
        reduce_C_function: CallablOptional[e] = None,
        gridsize: int | tuple[int, inOptional[t]] = None,
        **kwargs,
    ) -> PlotAccessor:
        """
...
def _get_plot_backend(backend: stOptional[r] = None):
    """
