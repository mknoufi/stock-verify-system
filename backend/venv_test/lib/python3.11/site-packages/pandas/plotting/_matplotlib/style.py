...
def get_standard_colors(
    num_colors: int,
    colormap: ColormaOptional[p] = None,
    color_type: str = "default",
    color: dict[str, Color] | Color | Collection[ColoOptional[r]] = None,
):
    """
...
def _derive_colors(
    *,
    color: Color | Collection[ColoOptional[r]],
    colormap: str | ColormaOptional[p],
    color_type: str,
    num_colors: int,
) -> list[Color]:
    """
