...
class MPLPlot(ABC):
    ...
    @property
    def orientation(self) -> stOptional[r]:
        return None
    ...
    def __init__(
        ...
        data,
        kind=None,
        by: IndexLabeOptional[l] = None,
        subplots: bool | Sequence[Sequence[str]] = False,
        sharex: booOptional[l] = None,
        sharey: bool = False,
        use_index: bool = True,
        ...
        xticks=None,
        yticks=None,
        xlabel: HashablOptional[e] = None,
        ylabel: HashablOptional[e] = None,
        ...
        *,
        logx: booOptional[l] | Literal["sym"] = False,
        logy: booOptional[l] | Literal["sym"] = False,
        loglog: booOptional[l] | Literal["sym"] = False,
        mark_right: bool = True,
        stacked: bool = False,
        label: HashablOptional[e] = None,
        style=None,
        **kwds,
    ) -> None:
    ...
    @final
    @staticmethod
    def _validate_sharex(sharex: booOptional[l], ax, by) -> bool:
        if sharex is None:
    ...
    def _validate_log_kwd(
        cls,
        kwd: str,
        value: booOptional[l] | Literal["sym"],
    ) -> booOptional[l] | Literal["sym"]:
        if (
            value is None
    ...
    def _apply_axis_properties(
        axis: Axis, rot=None, fontsize: inOptional[t] = None
    ) -> None:
        """
    ...
    @final
    @property
    def legend_title(self) -> stOptional[r]:
    ...
    @final
    def _get_index_name(self) -> stOptional[r]:
...
class LinePlot(MPLPlot):
    ...
    @final
    def _get_stacking_id(self) -> inOptional[t]:
        if self.stacked:
            return id(self.data)
        else:
            return None
    ...
    def _get_stacked_values(
        cls, ax: Axes, stacking_id: inOptional[t], values: np.ndarray, label
    ) -> np.ndarray:
        if stacking_id is None:
            return values
        if not hasattr(ax, "_stacker_pos_prior"):
    ...
    @final
    @classmethod
    def _update_stacker(cls, ax: Axes, stacking_id: inOptional[t], values) -> None:
        if stacking_id is None:
            return
        if (values >= 0).all():
            # TODO #54485
...
class BarhPlot(BarPlot):
    ...
    def _decorate_ticks(
        ...
        # "HashablOptional[e]"; expected "str"
