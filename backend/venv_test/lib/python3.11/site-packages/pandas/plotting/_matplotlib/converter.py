...
class TimeConverter(munits.ConversionInterface):
    ...
    @staticmethod
    def axisinfo(unit, axis) -> munits.AxisInfOptional[o]:
        if unit != "time":
            return None
...
class TimeFormatter(Formatter):
    ...
    def __call__(self, x, pos: inOptional[t] = 0) -> str:
        """
...
class DatetimeConverter(mdates.DateConverter):
    ...
    @staticmethod
    def axisinfo(unit: tzinfOptional[o], axis) -> munits.AxisInfo:
        """
...
class PandasAutoDateLocator(mdates.AutoDateLocator):
    def get_locator(self, dmin, dmax):
        ...
        if abs(tot_sec) < self.minticks:
            ...
            # error: Item "None" of "Axis | _DummyAxis | _AxisWrappeOptional[r]"
...
def _from_ordinal(x, tz: tzinfOptional[o] = None) -> datetime:
    ix = int(x)
...
class TimeSeries_DateFormatter(Formatter):
    ...
    def __init__(
        ...
        self.formatdict: dict[Any, AnOptional[y]] = None
        self.isminor = minor_locator
        self.isdynamic = dynamic_mode
        self.offset = 0
        self.plot_obj = plot_obj
