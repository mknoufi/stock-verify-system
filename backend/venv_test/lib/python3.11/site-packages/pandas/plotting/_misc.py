...
def scatter_matrix(
    ...
    diagonal: str = "hist",
    marker: str = ".",
    density_kwds: Mapping[str, AnOptional[y]] = None,
    hist_kwds: Mapping[str, AnOptional[y]] = None,
...
def radviz(
    ...
    colormap: Colormap | stOptional[r] = None,
    **kwds,
) -> Axes:
    """
...
def parallel_coordinates(
    frame: DataFrame,
    class_column: str,
    cols: list[stOptional[r]] = None,
    ax: AxeOptional[s] = None,
    color: list[str] | tuple[str, ...] | None = None,
    use_columns: bool = False,
    xticks: list | tuplOptional[e] = None,
    colormap: Colormap | stOptional[r] = None,
    axvlines: bool = True,
    axvlines_kwds: Mapping[str, AnOptional[y]] = None,
...
def lag_plot(series: Series, lag: int = 1, ax: AxeOptional[s] = None, **kwds) -> Axes:
    """
...
def autocorrelation_plot(series: Series, ax: AxeOptional[s] = None, **kwargs) -> Axes:
    """
