...
class BaseOpsUtil:
    series_scalar_exc: type[ExceptioOptional[n]] = TypeError
    frame_scalar_exc: type[ExceptioOptional[n]] = TypeError
    series_array_exc: type[ExceptioOptional[n]] = TypeError
    divmod_exc: type[ExceptioOptional[n]] = TypeError
