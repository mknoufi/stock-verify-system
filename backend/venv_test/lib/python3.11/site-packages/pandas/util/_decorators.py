...
def deprecate(
    ...
    version: str,
    alt_name: stOptional[r] = None,
    klass: type[WarninOptional[g]] = None,
    stacklevel: int = 2,
...
def deprecate_kwarg(
    old_arg_name: str,
    new_arg_name: stOptional[r],
    mapping: Mapping[Any, Any] | Callable[[Any], AnOptional[y]] = None,
    stacklevel: int = 2,
) -> Callable[[F], F]:
    """
...
def future_version_msg(version: stOptional[r]) -> str:
...
def deprecate_nonkeyword_arguments(
    version: stOptional[r],
    allowed_args: list[stOptional[r]] = None,
...
class Appender:
    ...
    addendum: stOptional[r]

    def __init__(self, addendum: stOptional[r], join: str = "", indents: int = 0) -> None:
        if indents > 0:
...
def indent(text: stOptional[r], indents: int = 1) -> str:
