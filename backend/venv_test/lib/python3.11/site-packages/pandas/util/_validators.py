...
def validate_endpoints(closed: stOptional[r]) -> tuple[bool, bool]:
    """
...
def validate_inclusive(inclusive: stOptional[r]) -> tuple[bool, bool]:
    """
    ...
    ValueError : if argument is not among valid values
    """
    left_right_inclusive: tuple[bool, booOptional[l]] = None
