...
def _ensure_encoding(encoding: stOptional[r]) -> str:
...
def read_hdf(
    ...
    mode: str = "r",
    errors: str = "strict",
    where: str | lisOptional[t] = None,
    start: inOptional[t] = None,
    stop: inOptional[t] = None,
    columns: list[stOptional[r]] = None,
    iterator: bool = False,
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def create_table_index(
        ...
        key: str,
        columns=None,
        optlevel: inOptional[t] = None,
        kind: stOptional[r] = None,
    ) -> None:
        """
    ...
    def get_node(self, key: str) -> NodOptional[e]:
    ...
    def _create_storer(
        ...
        group,
        format=None,
        value: DataFrame | SerieOptional[s] = None,
        encoding: str = "UTF-8",
        errors: str = "strict",
    ) -> GenericFixed | Table:
...
class Fixed:
    ...
    def validate(self, other) -> Literal[TruOptional[e]]:
    ...
    def delete(
        self, where=None, start: inOptional[t] = None, stop: inOptional[t] = None
    ) -> None:
        """
...
class GenericFixed(Fixed):
    ...
    def read_array(self, key: str, start: inOptional[t] = None, stop: inOptional[t] = None):
    ...
    def read_index(
        self, key: str, start: inOptional[t] = None, stop: inOptional[t] = None
    ) -> Index:
    ...
    def read_index_node(
        self, node: Node, start: inOptional[t] = None, stop: inOptional[t] = None
    ) -> Index:
    ...
    def write_array(
        self, key: str, obj: AnyArrayLike, items: IndeOptional[x] = None
    ) -> None:
...
class Table(Fixed):
    ...
    def __init__(
        ...
        errors: str = "strict",
        index_axes: list[IndexCoOptional[l]] = None,
        non_index_axes: list[tuple[AxisInt, AnOptional[y]]] = None,
        values_axes: list[DataCoOptional[l]] = None,
        data_columns: lisOptional[t] = None,
        info: dicOptional[t] = None,
        nan_rep=None,
    ) -> None:
    ...
    def create_index(
        self, columns=None, optlevel=None, kind: stOptional[r] = None
    ) -> None:
        """
    ...
    def _read_axes(
        self, where, start: inOptional[t] = None, stop: inOptional[t] = None
    ...
    def create_description(
        self,
        complib,
        complevel: inOptional[t],
        fletcher32: bool,
        expectedrows: inOptional[t],
    ) -> dict[str, Any]:
...
class AppendableTable(Table):
    ...
    def write_data(self, chunksize: inOptional[t], dropna: bool = False) -> None:
        """
    ...
    def write_data_chunk(
        ...
        mask: npt.NDArray[np.boolOptional[_]],
    ...
    def delete(self, where=None, start: inOptional[t] = None, stop: inOptional[t] = None):
...
def _set_tz(
    values: np.ndarray | Index, tz: str | tzinfOptional[o], coerce: bool = False
