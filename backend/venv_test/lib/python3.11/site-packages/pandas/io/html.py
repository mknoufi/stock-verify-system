...
def _get_skiprows(skiprows: int | Sequence[int] | slicOptional[e]) -> int | Sequence[int]:
    """
...
class _HtmlFrameParser:
    ...
    def _href_getter(self, obj) -> stOptional[r]:
        """
...
def _parser_dispatch(flavor: HTMLFlavorOptional[s]) -> type[_HtmlFrameParser]:
    """
...
def read_html(
    ...
    *,
    match: str | Pattern = ".+",
    flavor: HTMLFlavors | Sequence[HTMLFlavorOptional[s]] = None,
    header: int | Sequence[inOptional[t]] = None,
    index_col: int | Sequence[inOptional[t]] = None,
    skiprows: int | Sequence[int] | slicOptional[e] = None,
    attrs: dict[str, stOptional[r]] = None,
    parse_dates: bool = False,
    thousands: stOptional[r] = ",",
    encoding: stOptional[r] = None,
    decimal: str = ".",
    converters: dicOptional[t] = None,
    na_values: Iterable[objecOptional[t]] = None,
