...
def _handle_date_column(
    col, utc: bool = False, format: str | dict[str, AnOptional[y]] = None
):
...
def read_sql_table(
    ...
    con,
    schema=...,
    index_col: str | list[stOptional[r]] = ...,
    coerce_float=...,
    parse_dates: list[str] | dict[str, stOptional[r]] = ...,
    columns: list[stOptional[r]] = ...,
    chunksize: None = ...,
...
def read_sql_table(
    ...
    index_col: str | list[stOptional[r]] = None,
    coerce_float: bool = True,
    parse_dates: list[str] | dict[str, stOptional[r]] = None,
...
def read_sql_query(
    ...
    index_col: str | list[stOptional[r]] = ...,
    coerce_float=...,
    params: list[Any] | Mapping[str, AnOptional[y]] = ...,
    parse_dates: list[str] | dict[str, stOptional[r]] = ...,
    chunksize: None = ...,
...
def read_sql_query(
    ...
    index_col: str | list[stOptional[r]] = None,
    coerce_float: bool = True,
    params: list[Any] | Mapping[str, AnOptional[y]] = None,
    parse_dates: list[str] | dict[str, stOptional[r]] = None,
    chunksize: inOptional[t] = None,
    dtype: DtypeArOptional[g] = None,
    dtype_backend: DtypeBackend | lib.NoDefault = lib.no_default,
...
def to_sql(
    ...
    **engine_kwargs,
    ...
    method : {None, 'multi', callable}, optional
        ...
        - callable with signature ``(pd_table, conn, keys, data_iter) -> inOptional[t]``.
...
def has_table(table_name: str, con, schema: stOptional[r] = None) -> bool:
    """
...
class SQLTable(PandasObject):
    ...
    def __init__(
        ...
        pandas_sql_engine,
        frame=None,
        index: bool | str | list[stOptional[r]] = True,
        if_exists: Literal["fail", "replace", "append"] = "fail",
        prefix: str = "pandas",
        index_label=None,
        schema=None,
...
class PandasSQL(PandasObject, ABC):
    ...
    @abstractmethod
    def has_table(self, name: str, schema: stOptional[r] = None) -> bool:
        pass
...
class SQLDatabase(PandasSQL):
    ...
    def __init__(
        self, con, schema: stOptional[r] = None, need_transaction: bool = False
    ) -> None:
    ...
    def get_table(self, table_name: str, schema: stOptional[r] = None) -> Table:
        from sqlalchemy import (
            Numeric,
            Table,
        )
    ...
    def drop_table(self, table_name: str, schema: stOptional[r] = None) -> None:
        schema = schema or self.meta.schema
...
class SQLiteDatabase(PandasSQL):
    ...
    def get_table(self, table_name: str, schema: stOptional[r] = None) -> None:
        return None  # not supported in fallback mode

    def drop_table(self, name: str, schema: stOptional[r] = None) -> None:
