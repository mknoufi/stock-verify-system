...
class _XMLFrameParser:
    ...
    def __init__(
        ...
        xpath: str,
        namespaces: dict[str, stOptional[r]],
        elems_only: bool,
        attrs_only: bool,
        names: Sequence[stOptional[r]],
        dtype: DtypeArOptional[g],
        converters: ConvertersArOptional[g],
        parse_dates: ParseDatesArOptional[g],
        encoding: stOptional[r],
        stylesheet: FilePath | ReadBuffer[bytes] | ReadBuffer[stOptional[r]],
        iterparse: dict[str, list[stOptional[r]]],
    ...
    def parse_data(self) -> list[dict[str, stOptional[r]]]:
        """
        Parse xml data.
    ...
    def _parse_nodes(self, elems: list[Any]) -> list[dict[str, stOptional[r]]]:
        """
        Parse xml nodes.
        ...
        dicts: list[dict[str, stOptional[r]]]
    ...
    def _iterparse_nodes(self, iterparse: Callable) -> list[dict[str, stOptional[r]]]:
        """
        Iterparse xml nodes.
        ...
        dicts: list[dict[str, stOptional[r]]] = []
        row: dict[str, stOptional[r]] | None = None
...
class _EtreeFrameParser(_XMLFrameParser):
    ...
    def parse_data(self) -> list[dict[str, stOptional[r]]]:
        ...
        xml_dicts: list[dict[str, stOptional[r]]] = (
...
def read_xml(
    ...
    *,
    xpath: str = "./*",
    namespaces: dict[str, stOptional[r]] = None,
    elems_only: bool = False,
    attrs_only: bool = False,
    names: Sequence[stOptional[r]] = None,
    dtype: DtypeArOptional[g] = None,
    converters: ConvertersArOptional[g] = None,
    parse_dates: ParseDatesArOptional[g] = None,
    # encoding can not be None for lxml and StringIO input
    encoding: stOptional[r] = "utf-8",
    parser: XMLParsers = "lxml",
    stylesheet: FilePath | ReadBuffer[bytes] | ReadBuffer[stOptional[r]] = None,
    iterparse: dict[str, list[stOptional[r]]] = None,
