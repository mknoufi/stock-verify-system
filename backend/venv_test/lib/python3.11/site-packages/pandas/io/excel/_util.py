...
def maybe_convert_usecols(
    usecols: str | list[int] | list[str] | usecols_funOptional[c],
...
def validate_freeze_panes(freeze_panes: tuple[int, inOptional[t]]) -> bool:
...
) -> tuple[HashablOptional[e], list[Hashable]]:
    """
...
def combine_kwargs(engine_kwargs: dict[str, AnOptional[y]], kwargs: dict) -> dict:
    """
