...
def read_excel(
    ...
    sheet_name: str | int = ...,
    *,
    header: int | Sequence[inOptional[t]] = ...,
    names: SequenceNotStr[Hashable] | rangOptional[e] = ...,
    index_col: int | str | Sequence[inOptional[t]] = ...,
    usecols: int
    | str
    | Sequence[int]
    | Sequence[str]
    ...
    converters: dict[str, Callable] | dict[int, CallablOptional[e]] = ...,
    true_values: Iterable[HashablOptional[e]] = ...,
    false_values: Iterable[HashablOptional[e]] = ...,
    skiprows: Sequence[int] | int | Callable[[int], objecOptional[t]] = ...,
    nrows: inOptional[t] = ...,
    na_values=...,
    ...
    date_format: dict[Hashable, str] | stOptional[r] = ...,
...
def read_excel(
    ...
    sheet_name: list[IntStrOptional[T]],
    *,
    header: int | Sequence[inOptional[t]] = ...,
    names: SequenceNotStr[Hashable] | rangOptional[e] = ...,
    index_col: int | str | Sequence[inOptional[t]] = ...,
...
def read_excel(
    io,
    sheet_name: str | int | list[IntStrOptional[T]] = 0,
    *,
    header: int | Sequence[inOptional[t]] = 0,
    names: SequenceNotStr[Hashable] | rangOptional[e] = None,
    index_col: int | str | Sequence[inOptional[t]] = None,
    usecols: int
    | str
    | Sequence[int]
    | Sequence[str]
    ...
    converters: dict[str, Callable] | dict[int, CallablOptional[e]] = None,
    true_values: Iterable[HashablOptional[e]] = None,
    false_values: Iterable[HashablOptional[e]] = None,
    skiprows: Sequence[int] | int | Callable[[int], objecOptional[t]] = None,
    ...
    date_format: dict[Hashable, str] | stOptional[r] = None,
    ...
    engine_kwargs: dicOptional[t] = None,
...
class BaseExcelReader(Generic[_WorkbookT]):
    ...
    def get_sheet_data(self, sheet, rows: inOptional[t] = None):
        raise NotImplementedError
    ...
    def _calc_rows(
        self,
        header: int | Sequence[inOptional[t]],
        index_col: int | Sequence[inOptional[t]],
        skiprows: Sequence[int] | int | Callable[[int], objecOptional[t]],
        nrows: inOptional[t],
    ) -> inOptional[t]:
        """
    ...
    def parse(
        self,
        sheet_name: str | int | list[int] | list[stOptional[r]] = 0,
        header: int | Sequence[inOptional[t]] = 0,
        names: SequenceNotStr[Hashable] | rangOptional[e] = None,
        index_col: int | Sequence[inOptional[t]] = None,
        usecols=None,
        dtype: DtypeArOptional[g] = None,
        true_values: Iterable[HashablOptional[e]] = None,
        false_values: Iterable[HashablOptional[e]] = None,
...
class ExcelWriter(Generic[_WorkbookT]):
    ...
    * `odswriter <https://pypi.org/project/odswriter/>`__ for ods files
    ...
    def __new__(
        ...
        datetime_format: stOptional[r] = None,
        mode: str = "w",
        storage_options: StorageOptionOptional[s] = None,
        if_sheet_exists: ExcelWriterIfSheetExistOptional[s] = None,
        engine_kwargs: dicOptional[t] = None,
    ) -> Self:
    ...
    def _get_sheet_name(self, sheet_name: stOptional[r]) -> str:
    ...
    def _value_with_fmt(
        ...
        int | float | bool | str | datetime.datetime | datetime.date, stOptional[r]
    ]:
        """
