...
class PythonParser(ParserBase):
    ...
    def __init__(self, f: ReadCsvBuffer[str] | list, **kwds) -> None:
        ...
        self.data: Iterator[stOptional[r]] = None
        self.buf: list = []
        self.pos = 0
        self.line_pos = 0
        ...
        self._col_indices: list[inOptional[t]] = None
        columns: list[list[ScalaOptional[r]]]
        (
            columns,
    ...
    def read(
        self, rows: inOptional[t] = None
    ) -> tuple[
        IndeOptional[x], Sequence[Hashable] | MultiIndex, Mapping[Hashable, ArrayLike]
    ]:
        try:
    ...
    def _infer_columns(
        self,
    ) -> tuple[list[list[ScalaOptional[r]]], int, set[ScalaOptional[r]]]:
        names = self.names
        num_original_columns = 0
        clear_buffer = True
        unnamed_cols: set[ScalaOptional[r]] = set()
        ...
        if self.header is not None:
            ...
            for level, hr in enumerate(header):
                ...
                this_columns: list[ScalaOptional[r]] = []
                this_unnamed_cols = []
            ...
            first_line: list[ScalaOptional[r]]
    ...
    def _handle_usecols(
        self,
        columns: list[list[ScalaOptional[r]]],
        usecols_key: list[ScalaOptional[r]],
        num_original_columns: int,
    ) -> list[list[ScalaOptional[r]]]:
        """
    ...
    def _next_iter_line(self, row_num: int) -> list[ScalaOptional[r]]:
        """
    ...
    def _get_index_name(
        self,
    ) -> tuple[Sequence[HashablOptional[e]], list[Hashable], list[Hashable]]:
        """
        ...
        next_line: list[ScalaOptional[r]]
        try:
    ...
    def _get_lines(self, rows: inOptional[t] = None) -> list[list[Scalar]]:
        lines = self.buf
        new_rows = None
...
class FixedWidthReader(abc.Iterator):
    ...
    def __init__(
        ...
        delimiter: stOptional[r],
        comment: stOptional[r],
        skiprows: set[inOptional[t]] = None,
        infer_nrows: int = 100,
    ) -> None:
        self.f = f
        self.buffer: IteratoOptional[r] = None
    ...
    def get_rows(self, infer_nrows: int, skiprows: set[inOptional[t]] = None) -> list[str]:
        """
    ...
    def detect_colspecs(
        self, infer_nrows: int = 100, skiprows: set[inOptional[t]] = None
    ) -> list[tuple[int, int]]:
