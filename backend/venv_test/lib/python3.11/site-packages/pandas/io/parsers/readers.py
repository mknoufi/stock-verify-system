...
on_bad_lines : {{'error', 'warn', 'skip'}} or Callable, default 'error'
    ...
    .. versionadded:: 1.4.0
        ...
        - Callable, function with signature
          ``(bad_line: list[str]) -> list[stOptional[r]]`` that will process a single
...
@overload
def validate_integer(name: str, val: inOptional[t], min_val: int = ...) -> inOptional[t]:
    ...


def validate_integer(
    name: str, val: int | floaOptional[t], min_val: int = 0
) -> inOptional[t]:
    """
...
def _validate_names(names: Sequence[HashablOptional[e]]) -> None:
    """
...
def read_csv(
    ...
    *,
    sep: stOptional[r] | lib.NoDefault = ...,
    delimiter: stOptional[r] | lib.NoDefault = ...,
    header: int | Sequence[inOptional[t]] | Literal["infer"] = ...,
    names: Sequence[HashablOptional[e]] | lib.NoDefault = ...,
    index_col: IndexLabel | Literal[FalsOptional[e]] = ...,
    usecols: UsecolsArgType = ...,
    dtype: DtypeArOptional[g] = ...,
    engine: CSVEnginOptional[e] = ...,
    converters: Mapping[Hashable, CallablOptional[e]] = ...,
    true_values: lisOptional[t] = ...,
    false_values: lisOptional[t] = ...,
    skipinitialspace: bool = ...,
    skiprows: list[int] | int | Callable[[Hashable], booOptional[l]] = ...,
    skipfooter: int = ...,
    nrows: inOptional[t] = ...,
    na_values: Hashable
    | Iterable[Hashable]
    ...
    parse_dates: bool | Sequence[HashablOptional[e]] = ...,
    infer_datetime_format: bool | lib.NoDefault = ...,
    keep_date_col: bool | lib.NoDefault = ...,
    date_parser: Callable | lib.NoDefault = ...,
    date_format: str | dict[Hashable, stOptional[r]] = ...,
    dayfirst: bool = ...,
    cache_dates: bool = ...,
    iterator: Literal[True],
    chunksize: inOptional[t] = ...,
    compression: CompressionOptions = ...,
    thousands: stOptional[r] = ...,
    decimal: str = ...,
    ...
    comment: stOptional[r] = ...,
    encoding: stOptional[r] = ...,
    encoding_errors: stOptional[r] = ...,
    dialect: str | csv.DialecOptional[t] = ...,
    on_bad_lines=...,
...
def read_csv(
    filepath_or_buffer: FilePath | ReadCsvBuffer[bytes] | ReadCsvBuffer[str],
    *,
    sep: stOptional[r] | lib.NoDefault = lib.no_default,
    delimiter: stOptional[r] | lib.NoDefault = None,
    # Column and Index Locations and Names
    header: int | Sequence[inOptional[t]] | Literal["infer"] = "infer",
    names: Sequence[HashablOptional[e]] | lib.NoDefault = lib.no_default,
    index_col: IndexLabel | Literal[FalsOptional[e]] = None,
    usecols: UsecolsArgType = None,
    # General Parsing Configuration
    dtype: DtypeArOptional[g] = None,
    engine: CSVEnginOptional[e] = None,
    converters: Mapping[Hashable, CallablOptional[e]] = None,
    true_values: lisOptional[t] = None,
    false_values: lisOptional[t] = None,
    skipinitialspace: bool = False,
    skiprows: list[int] | int | Callable[[Hashable], booOptional[l]] = None,
    skipfooter: int = 0,
    ...
    # Datetime Handling
    parse_dates: bool | Sequence[HashablOptional[e]] = None,
    infer_datetime_format: bool | lib.NoDefault = lib.no_default,
    keep_date_col: bool | lib.NoDefault = lib.no_default,
    date_parser: Callable | lib.NoDefault = lib.no_default,
    date_format: str | dict[Hashable, stOptional[r]] = None,
    dayfirst: bool = False,
    ...
    comment: stOptional[r] = None,
    encoding: stOptional[r] = None,
    encoding_errors: stOptional[r] = "strict",
    dialect: str | csv.DialecOptional[t] = None,
    # Error Handling
    ...
    if lib.is_list_like(parse_dates):
        # GH#55569
        depr = False
        # error: Item "bool" of "bool | Sequence[HashablOptional[e]]" has no
...
def read_table(
    ...
    *,
    ...
    skipfooter: int = ...,
    nrows: inOptional[t] = ...,
    na_values: Sequence[str] | Mapping[str, Sequence[stOptional[r]]] = ...,
    keep_default_na: bool = ...,
    na_filter: bool = ...,
    verbose: bool | lib.NoDefault = ...,
    skip_blank_lines: bool = ...,
...
def read_table(
    ...
    *,
    ...
    nrows: inOptional[t] = None,
    # NA and Missing Data Handling
    na_values: Sequence[str] | Mapping[str, Sequence[stOptional[r]]] = None,
    keep_default_na: bool = True,
    na_filter: bool = True,
    verbose: bool | lib.NoDefault = lib.no_default,
    skip_blank_lines: bool = True,
    ...
    low_memory: bool = _c_parser_defaults["low_memory"],
    memory_map: bool = False,
    float_precision: stOptional[r] = None,
    storage_options: StorageOptionOptional[s] = None,
    dtype_backend: DtypeBackend | lib.NoDefault = lib.no_default,
) -> DataFrame | TextFileReader:
    if keep_date_col is not lib.no_default:
...
def read_fwf(
    filepath_or_buffer: FilePath | ReadCsvBuffer[bytes] | ReadCsvBuffer[str],
    *,
    colspecs: Sequence[tuple[int, int]] | stOptional[r] = ...,
    widths: Sequence[inOptional[t]] = ...,
    infer_nrows: int = ...,
    dtype_backend: DtypeBackend | lib.NoDefault = ...,
    iterator: Literal[True],
    chunksize: inOptional[t] = ...,
...
def read_fwf(
    filepath_or_buffer: FilePath | ReadCsvBuffer[bytes] | ReadCsvBuffer[str],
    *,
    colspecs: Sequence[tuple[int, int]] | stOptional[r] = "infer",
    widths: Sequence[inOptional[t]] = None,
    infer_nrows: int = 100,
    dtype_backend: DtypeBackend | lib.NoDefault = lib.no_default,
    iterator: bool = False,
    chunksize: inOptional[t] = None,
...
class TextFileReader(abc.Iterator):
    ...
    def __init__(
        ...
        **kwds,
        ...
        self.handles: IOHandleOptional[s] = None
    ...
    def read(self, nrows: inOptional[t] = None) -> DataFrame:
    ...
    def get_chunk(self, size: inOptional[t] = None) -> DataFrame:
        if size is None:
            size = self.chunksize
    ...
    def __exit__(
        ...
        traceback: TracebackTypOptional[e],
    ) -> None:
        self.close()
...
def _extract_dialect(kwds: dict[str, Any]) -> csv.DialecOptional[t]:
    """
