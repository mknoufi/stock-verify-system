...
class ParserBase:
    ...
    cache_dates: bool
    keep_date_col: bool
    usecols_dtype: stOptional[r]

    def __init__(self, kwds) -> None:
        self._implicit_index = False

        self.names = kwds.get("names")
        self.orig_names: Sequence[HashablOptional[e]] = None

        self.index_col = kwds.get("index_col", None)
        self.unnamed_cols: set = set()
        self.index_names: Sequence[HashablOptional[e]] = None
        self.col_names: Sequence[HashablOptional[e]] = None
    ...
    def _extract_multi_indexer_columns(
        self,
        header,
        index_names: Sequence[HashablOptional[e]],
        passed_names: bool = False,
    ) -> tuple[
        Sequence[Hashable], Sequence[HashablOptional[e]], Sequence[HashablOptional[e]], bool
    ]:
        """
    ...
    def _maybe_make_multi_index_columns(
        ...
        col_names: Sequence[HashablOptional[e]] = None,
    ...
    @final
    def _make_index(
        self, data, alldata, columns, indexnamerow: list[ScalaOptional[r]] = None
    ) -> tuple[IndeOptional[x], Sequence[Hashable] | MultiIndex]:
        index: IndeOptional[x]
    ...
    def _set_noconvert_dtype_columns(
        ...
        """
        usecols: list[int] | list[stOptional[r]]
    ...
    @final
    def _clean_index_names(self, columns, index_col) -> tuple[lisOptional[t], list, list]:
        ...
        index_names: list[str | inOptional[t]] = []
    ...
    @final
    def _get_empty_meta(self, columns, dtype: DtypeArOptional[g] = None):
        columns = list(columns)
...
def _try_convert_dates(
    parser: Callable, colspec, data_dict, columns, target_name: stOptional[r] = None
):
    colset = set(columns)
    colnames = []
