...
def _get_filepath_or_buffer(
    ...
    encoding: str = "utf-8",
    compression: CompressionOptionOptional[s] = None,
    mode: str = "r",
...
def get_compression_method(
...
) -> tuple[stOptional[r], CompressionDict]:
    """
    ...
    """
    compression_method: stOptional[r]
...
def infer_compression(
    filepath_or_buffer: FilePath | BaseBuffer, compression: stOptional[r]
) -> stOptional[r]:
    """
...
class _BytesTarFile(_BufferedWriter):
    def __init__(
        ...
        fileobj: ReadBuffer[bytes] | WriteBuffer[byteOptional[s]] = None,
        archive_name: stOptional[r] = None,
        **kwargs,
    ) -> None:
        super().__init__()
    ...
    def infer_filename(self) -> stOptional[r]:
        """
...
class _BytesIOWrapper:
    ...
    def read(self, n: inOptional[t] = -1) -> bytes:
...
def is_potential_multi_index(
    ...
    index_col: bool | Sequence[inOptional[t]] = None,
) -> bool:
    """
