...
class StataReader(StataParser, abc.Iterator):
    ...
    def __init__(
        ...
        index_col: stOptional[r] = None,
        convert_missing: bool = False,
        preserve_dtypes: bool = True,
        columns: Sequence[stOptional[r]] = None,
        ...
        self._close_file: Callable[[], NonOptional[e]] = None
        self._missing_values = False
        self._can_read_value_labels = False
        self._column_selector_set = False
        self._value_labels_read = False
        self._data_read = False
        self._dtype: np.dtypOptional[e] = None
        self._lines_read = 0
...
the string values returned are correct."""
    ...
    def read(
        ...
        convert_dates: booOptional[l] = None,
        convert_categoricals: booOptional[l] = None,
        index_col: stOptional[r] = None,
        convert_missing: booOptional[l] = None,
        preserve_dtypes: booOptional[l] = None,
        columns: Sequence[stOptional[r]] = None,
        order_categoricals: booOptional[l] = None,
    ) -> DataFrame:
        self._ensure_open()
        ...
        for col, label in zip(data, lbllist):
            if label in value_label_dict:
                ...
                if self._using_iterator and key_matches.all():
                    initial_categories: np.ndarraOptional[y] = keys
...
class StataWriter(StataParser):
    ...
    def __init__(
        ...
        byteorder: stOptional[r] = None,
        time_stamp: datetimOptional[e] = None,
        ...
        *,
        ...
        self._compression = compression
        self._output_file: IO[byteOptional[s]] = None
