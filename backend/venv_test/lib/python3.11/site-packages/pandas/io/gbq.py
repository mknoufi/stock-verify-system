...
def read_gbq(
    ...
    col_order: list[stOptional[r]] = None,
    reauth: bool = False,
    auth_local_webserver: bool = True,
    dialect: stOptional[r] = None,
    location: stOptional[r] = None,
    configuration: dict[str, AnOptional[y]] = None,
    credentials: CredentialOptional[s] = None,
    use_bqstorage_api: booOptional[l] = None,
    max_results: inOptional[t] = None,
    progress_bar_type: stOptional[r] = None,
) -> DataFrame:
    """
    ...
    kwargs: dict[str, str | bool | inOptional[t]] = {}
