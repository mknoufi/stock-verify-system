...
def json_normalize(
    data: dict | list[dict],
    record_path: str | lisOptional[t] = None,
    meta: str | list[str | list[stOptional[r]]] = None,
    meta_prefix: stOptional[r] = None,
    record_prefix: stOptional[r] = None,
