...
def to_json(
    ...
    force_ascii: bool = ...,
    date_unit: str = ...,
    default_handler: Callable[[Any], JSONSerializablOptional[e]] = ...,
    lines: bool = ...,
...
def to_json(
    path_or_buf: FilePath | WriteBuffer[str] | WriteBuffer[byteOptional[s]],
    obj: NDFrame,
    orient: stOptional[r] = None,
...
def read_json(
    ...
    *,
    ...
    convert_axes: booOptional[l] = ...,
    convert_dates: bool | list[str] = ...,
    keep_default_dates: bool = ...,
    precise_float: bool = ...,
    date_unit: stOptional[r] = ...,
...
def read_json(
    ...
    *,
    ...
    convert_axes: booOptional[l] = None,
    convert_dates: bool | list[str] = True,
    keep_default_dates: bool = True,
    precise_float: bool = False,
    date_unit: stOptional[r] = None,
...
class JsonReader(abc.Iterator, Generic[FrameSeriesStrT]):
    ...
    def __init__(
        ...
        self.handles: IOHandles[stOptional[r]] = None
...
class Parser:
    ...
    def __init__(
        ...
        self.date_unit = date_unit
        self.keep_default_dates = keep_default_dates
        self.obj: DataFrame | SerieOptional[s] = None
        self.dtype_backend = dtype_backend
...
class FrameParser(Parser):
    ...
    def _process_converter(
        ...
        filt: Callable[[Hashable], booOptional[l]] = None,
    ) -> None:
        """
