...
class StylerRenderer:
    ...
    def __init__(
        ...
        self.tooltips: TooltipOptional[s] = None
        precision = (
    ...
    def _render_latex(
        self, sparse_index: bool, sparse_columns: bool, clines: stOptional[r], **kwargs
    ) -> str:
        """
    ...
    def _translate_latex(self, d: dict, clines: stOptional[r]) -> None:
        r"""
...
def _get_level_lengths(
    ...
    sparsify: bool,
    max_index: int,
    hidden_elements: Sequence[inOptional[t]] = None,
):
    """
...
def _wrap_decimal_thousands(
    formatter: Callable, decimal: str, thousands: stOptional[r]
) -> Callable:
    """
...
def _maybe_wrap_formatter(
    formatter: BaseFormatteOptional[r] = None,
    na_rep: stOptional[r] = None,
    precision: inOptional[t] = None,
    decimal: str = ".",
    thousands: stOptional[r] = None,
...
def refactor_levels(
    level: Level | list[LeveOptional[l]],
    obj: Index,
) -> list[int]:
    """
...
def _parse_latex_table_wrapping(table_styles: CSSStyles, caption: stOptional[r]) -> bool:
    """
...
def _parse_latex_table_styles(table_styles: CSSStyles, selector: str) -> stOptional[r]:
    """
