...
class HTMLFormatter:
    ...
    def write_th(
        self, s: Any, header: bool = False, indent: int = 0, tags: stOptional[r] = None
    ) -> None:
        """
    ...
    def write_td(self, s: Any, indent: int = 0, tags: stOptional[r] = None) -> None:
        self._write_cell(s, kind="td", indent=indent, tags=tags)

    def _write_cell(
        self, s: Any, kind: str = "td", indent: int = 0, tags: stOptional[r] = None
    ) -> None:
        if tags is not None:
    ...
    def write_tr(
        ...
        indent_delta: int = 0,
        header: bool = False,
        align: stOptional[r] = None,
        tags: dict[int, stOptional[r]] = None,
        nindex_levels: int = 0,
    ) -> None:
        if tags is None:
            tags = {}
