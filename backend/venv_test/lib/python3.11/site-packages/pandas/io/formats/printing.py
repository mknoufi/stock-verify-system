...
def _pprint_seq(
    seq: Sequence, _nest_lvl: int = 0, max_seq_items: inOptional[t] = None, **kwds
) -> str:
    """
...
def _pprint_dict(
    seq: Mapping, _nest_lvl: int = 0, max_seq_items: inOptional[t] = None, **kwds
) -> str:
    """
    internal. pprinter for iterables. you should probably use pprint_thing()
    rather than calling this directly.
...
def pprint_thing(
    thing: Any,
    _nest_lvl: int = 0,
    escape_chars: EscapeCharOptional[s] = None,
    default_escapes: bool = False,
    quote_strings: bool = False,
    max_seq_items: inOptional[t] = None,
) -> str:
    """
    ...
    def as_escaped_string(
        thing: Any, escape_chars: EscapeCharOptional[s] = escape_chars
    ) -> str:
        translate = {"\t": r"\t", "\n": r"\n", "\r": r"\r"}
...
def default_pprint(thing: Any, max_seq_items: inOptional[t] = None) -> str:
    return pprint_thing(
        thing,
        escape_chars=("\t", "\r", "\n"),
        quote_strings=True,
