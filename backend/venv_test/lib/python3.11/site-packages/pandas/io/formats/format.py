...
class DataFrameFormatter:
    ...
    def _initialize_sparsify(self, sparsify: booOptional[l]) -> bool:
        if sparsify is None:
            return get_option("display.multi_sparse")
        return sparsify

    def _initialize_formatters(
        self, formatters: FormattersTypOptional[e]
    ) -> FormattersType:
    ...
    def _initialize_justify(self, justify: stOptional[r]) -> str:
        if justify is None:
            return get_option("display.colheader_justify")
        else:
            return justify

    def _initialize_columns(self, columns: AxeOptional[s]) -> Index:
    ...
    def _initialize_colspace(self, col_space: ColspaceArgTypOptional[e]) -> ColspaceType:
        result: ColspaceType
    ...
    def _calc_max_cols_fitted(self) -> inOptional[t]:
    ...
    def _calc_max_rows_fitted(self) -> inOptional[t]:
    ...
    def _adjust_max_rows(self, max_rows: inOptional[t]) -> inOptional[t]:
    ...
    def _get_formatter(self, i: str | int) -> CallablOptional[e]:
        if isinstance(self.formatters, (list, tuple)):
            if is_integer(i):
                i = cast(int, i)
...
@contextmanager
def _get_buffer(
    buf: FilePath | WriteBuffer[stOptional[r]], encoding: stOptional[r] = None
...
def format_array(
    values: ArrayLike,
    formatter: CallablOptional[e],
    float_format: FloatFormatTypOptional[e] = None,
    na_rep: str = "NaN",
    digits: inOptional[t] = None,
    space: str | inOptional[t] = None,
    justify: str = "right",
    decimal: str = ".",
    leading_space: booOptional[l] = True,
    quoting: inOptional[t] = None,
    fallback_formatter: CallablOptional[e] = None,
) -> list[str]:
    """
...
class _GenericArrayFormatter:
    def __init__(
        ...
        values: ArrayLike,
        digits: int = 7,
        formatter: CallablOptional[e] = None,
        na_rep: str = "NaN",
        space: str | int = 12,
        float_format: FloatFormatTypOptional[e] = None,
        justify: str = "right",
...
def get_format_datetime64(
    is_dates_only: bool, nat_rep: str = "NaT", date_format: stOptional[r] = None
) -> Callable:
...
def _make_fixed_width(
    strings: list[str],
    justify: str = "right",
    minimum: inOptional[t] = None,
    adj: printing._TextAdjustmenOptional[t] = None,
) -> list[str]:
...
class EngFormatter:
    ...
    def __init__(
        self, accuracy: inOptional[t] = None, use_eng_prefix: bool = False
    ) -> None:
