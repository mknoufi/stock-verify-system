...
class CSVFormatter:
    ...
    @property
    def float_format(self) -> FloatFormatTypOptional[e]:
    ...
    def _initialize_index_label(self, index_label: IndexLabeOptional[l]) -> IndexLabel:
    ...
    def _initialize_quotechar(self, quotechar: stOptional[r]) -> stOptional[r]:
    ...
    def _initialize_columns(
        self, cols: Iterable[HashablOptional[e]]
    ...
    def _initialize_chunksize(self, chunksize: inOptional[t]) -> int:
