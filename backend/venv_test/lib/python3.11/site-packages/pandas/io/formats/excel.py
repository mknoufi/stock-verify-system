...
class ExcelCell:
    ...
    def __init__(
        ...
        val,
        style=None,
        mergestart: inOptional[t] = None,
        mergeend: inOptional[t] = None,
    ) -> None:
        self.row = row
        self.col = col
        self.val = val
...
class CssExcelCell(ExcelCell):
    def __init__(
        ...
        val,
        style: dicOptional[t],
        css_styles: dict[tuple[int, int], list[tuple[str, AnOptional[y]]]],
        css_row: int,
        css_col: int,
        css_converter: CallablOptional[e],
        **kwargs,
    ) -> None:
...
class CSSToExcelConverter:
    ...
    inherited: dict[str, stOptional[r]]

    def __init__(self, inherited: stOptional[r] = None) -> None:
    ...
    def build_xlstyle(self, props: Mapping[str, str]) -> dict[str, dict[str, str]]:
        ...
        def remove_none(d: dict[str, stOptional[r]]) -> None:
    ...
    def build_alignment(self, props: Mapping[str, str]) -> dict[str, bool | stOptional[r]]:
    ...
    def _get_vertical_alignment(self, props: Mapping[str, str]) -> stOptional[r]:
        vertical_align = props.get("vertical-align")
        if vertical_align:
            return self.VERTICAL_MAP.get(vertical_align)
        return None

    def _get_is_wrap_text(self, props: Mapping[str, str]) -> booOptional[l]:
    ...
    ) -> dict[str, dict[str, stOptional[r]]]:
        return {
            side: {
    ...
    def _border_style(self, style: stOptional[r], width: stOptional[r], color: stOptional[r]):
    ...
    def _get_width_name(self, width_input: stOptional[r]) -> stOptional[r]:
    ...
    def _width_to_float(self, width: stOptional[r]) -> float:
        if width is None:
            width = "2pt"
    ...
    def build_number_format(self, props: Mapping[str, str]) -> dict[str, stOptional[r]]:
    ...
    def build_font(
        self, props: Mapping[str, str]
    ) -> dict[str, bool | float | stOptional[r]]:
    ...
    def _get_is_bold(self, props: Mapping[str, str]) -> booOptional[l]:
        weight = props.get("font-weight")
        if weight:
            return self.BOLD_MAP.get(weight)
        return None

    def _get_is_italic(self, props: Mapping[str, str]) -> booOptional[l]:
    ...
    def _get_underline(self, decoration: Sequence[str]) -> stOptional[r]:
        if "underline" in decoration:
            return "single"
        return None

    def _get_shadow(self, props: Mapping[str, str]) -> booOptional[l]:
    ...
    def _get_font_size(self, props: Mapping[str, str]) -> floaOptional[t]:
        size = props.get("font-size")
        if size is None:
            return size
        return self._pt_to_float(size)

    def _select_font_family(self, font_names: Sequence[str]) -> inOptional[t]:
        family = None
    ...
    def color_to_excel(self, val: stOptional[r]) -> stOptional[r]:
        if val is None:
            return None
...
class ExcelFormatter:
    ...
    def __init__(
        ...
        cols: Sequence[HashablOptional[e]] = None,
        header: Sequence[Hashable] | bool = True,
        index: bool = True,
        index_label: IndexLabeOptional[l] = None,
        merge_cells: bool = False,
        inf_rep: str = "inf",
        style_converter: CallablOptional[e] = None,
    ) -> None:
        self.rowcounter = 0
        self.na_rep = na_rep
        if not isinstance(df, DataFrame):
            ...
            self.style_converter: CallablOptional[e] = style_converter
        else:
            self.styler = None
