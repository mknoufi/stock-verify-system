...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def __init__(
        ...
        precision: inOptional[t] = None,
        table_styles: CSSStyleOptional[s] = None,
        uuid: stOptional[r] = None,
        caption: str | tuple | lisOptional[t] = None,
        table_attributes: stOptional[r] = None,
        cell_ids: bool = True,
        na_rep: stOptional[r] = None,
        uuid_len: int = 5,
        decimal: stOptional[r] = None,
        thousands: stOptional[r] = None,
        escape: stOptional[r] = None,
        formatter: ExtFormatteOptional[r] = None,
    ) -> None:
        super().__init__(
            data=data,
            uuid=uuid,
    ...
    def _repr_latex_(self) -> stOptional[r]:
    ...
    def set_tooltips(
        self,
        ttips: DataFrame,
        props: CSSPropertieOptional[s] = None,
        css_class: stOptional[r] = None,
    ) -> Styler:
        """
    ...
    def to_latex(
        ...
        *,
        ...
        position_float: stOptional[r] = ...,
        hrules: booOptional[l] = ...,
        clines: stOptional[r] = ...,
        label: stOptional[r] = ...,
        caption: str | tuplOptional[e] = ...,
        sparse_index: booOptional[l] = ...,
        sparse_columns: booOptional[l] = ...,
        multirow_align: stOptional[r] = ...,
        multicol_align: stOptional[r] = ...,
        siunitx: bool = ...,
        environment: stOptional[r] = ...,
    ...
    def to_latex(
        ...
        *,
        ...
        position_float: stOptional[r] = None,
        hrules: booOptional[l] = None,
        clines: stOptional[r] = None,
        label: stOptional[r] = None,
        caption: str | tuplOptional[e] = None,
        sparse_index: booOptional[l] = None,
        sparse_columns: booOptional[l] = None,
        multirow_align: stOptional[r] = None,
        multicol_align: stOptional[r] = None,
        siunitx: bool = False,
        environment: stOptional[r] = None,
        encoding: stOptional[r] = None,
    ...
    def to_html(
        ...
        buf: FilePath | WriteBuffer[str],
        *,
        table_uuid: stOptional[r] = ...,
        table_attributes: stOptional[r] = ...,
        sparse_index: booOptional[l] = ...,
        sparse_columns: booOptional[l] = ...,
        bold_headers: bool = ...,
        caption: stOptional[r] = ...,
        max_rows: inOptional[t] = ...,
        max_columns: inOptional[t] = ...,
        encoding: stOptional[r] = ...,
        doctype_html: bool = ...,
        exclude_styles: bool = ...,
        **kwargs,
    ...
    def to_html(
        ...
        buf: FilePath | WriteBuffer[stOptional[r]] = None,
        *,
        table_uuid: stOptional[r] = None,
        table_attributes: stOptional[r] = None,
        sparse_index: booOptional[l] = None,
        sparse_columns: booOptional[l] = None,
        bold_headers: bool = False,
        caption: stOptional[r] = None,
        max_rows: inOptional[t] = None,
        max_columns: inOptional[t] = None,
        encoding: stOptional[r] = None,
    ...
    def _apply_index(
        ...
        func: Callable,
        axis: Axis = 0,
        level: Level | list[LeveOptional[l]] = None,
        method: str = "apply",
        **kwargs,
    ) -> Styler:
        axis = self.data._get_axis_number(axis)
    ...
    def _map(self, func: Callable, subset: SubseOptional[t] = None, **kwargs) -> Styler:
    ...
    @Substitution(subset=subset_args)
    def map(self, func: Callable, subset: SubseOptional[t] = None, **kwargs) -> Styler:
        """
    ...
    @Substitution(subset=subset_args)
    def applymap(
        self, func: Callable, subset: SubseOptional[t] = None, **kwargs
    ) -> Styler:
        """
        Apply a CSS-styling function elementwise.
    ...
    def set_sticky(
        self,
        axis: Axis = 0,
        pixel_size: inOptional[t] = None,
        levels: Level | list[LeveOptional[l]] = None,
    ) -> Styler:
        """
    ...
    def set_table_styles(
        self,
        table_styles: dict[Any, CSSStyles] | CSSStyleOptional[s] = None,
        axis: AxisInt = 0,
        overwrite: bool = True,
        css_class_names: dict[str, stOptional[r]] = None,
    ) -> Styler:
        """
    ...
    def background_gradient(
        ...
        vmin: floaOptional[t] = None,
        vmax: floaOptional[t] = None,
        gmap: SequencOptional[e] = None,
    ) -> Styler:
        """
    ...
    @Substitution(subset=subset_args)
    def set_properties(self, subset: SubseOptional[t] = None, **kwargs) -> Styler:
        """
    ...
    def bar(  # pylint: disable=disallowed-name
        ...
        axis: AxiOptional[s] = 0,
        *,
        color: str | list | tuplOptional[e] = None,
        cmap: AnOptional[y] = None,
        width: float = 100,
        height: float = 100,
    ...
    def highlight_between(
        ...
        color: str = "yellow",
        axis: AxiOptional[s] = 0,
        left: Scalar | SequencOptional[e] = None,
        right: Scalar | SequencOptional[e] = None,
    ...
    def from_custom_template(
        ...
        html_table: stOptional[r] = None,
        html_style: stOptional[r] = None,
    ) -> type[Styler]:
        """
...
def _background_gradient(
    ...
    vmin: floaOptional[t] = None,
    vmax: floaOptional[t] = None,
    gmap: Sequence | np.ndarray | DataFrame | SerieOptional[s] = None,
...
def _highlight_between(
    data: NDFrame,
    props: str,
    left: Scalar | Sequence | np.ndarray | NDFramOptional[e] = None,
    right: Scalar | Sequence | np.ndarray | NDFramOptional[e] = None,
