...
class RegisteredOption(NamedTuple):
    ...
    defval: object
    doc: str
    validator: Callable[[object], AnOptional[y]]
    cb: Callable[[str], AnOptional[y]]
...
def _describe_option(pat: str = "", _print_desc: bool = True) -> stOptional[r]:
    keys = _select_options(pat)
    if len(keys) == 0:
...
def register_option(
    ...
    defval: object,
    doc: str = "",
    validator: Callable[[object], AnOptional[y]] = None,
    cb: Callable[[str], AnOptional[y]] = None,
) -> None:
    """
...
def deprecate_option(
    ...
    rkey: stOptional[r] = None,
    removal_ver: stOptional[r] = None,
) -> None:
    """
