...
def process_skipna(skipna: bool | ndarraOptional[y], args) -> tuple[bool, Any]:
...
def validate_argmin_with_skipna(skipna: bool | ndarraOptional[y], args, kwargs) -> bool:
    """
...
def validate_argmax_with_skipna(skipna: bool | ndarraOptional[y], args, kwargs) -> bool:
    """
...
ARGSORT_DEFAULTS: dict[str, int | stOptional[r]] = {}
...
ARGSORT_DEFAULTS_KIND: dict[str, inOptional[t]] = {}
...
def validate_argsort_with_ascending(ascending: bool | inOptional[t], args, kwargs) -> bool:
    """
...
ALLANY_DEFAULTS: dict[str, booOptional[l]] = {}
...
SORT_DEFAULTS: dict[str, int | stOptional[r]] = {}
SORT_DEFAULTS["axis"] = -1
SORT_DEFAULTS["kind"] = "quicksort"
SORT_DEFAULTS["order"] = None
validate_sort = CompatValidator(SORT_DEFAULTS, fname="sort", method="kwargs")

STAT_FUNC_DEFAULTS: dict[str, AnOptional[y]] = {}
...
STAT_DDOF_FUNC_DEFAULTS: dict[str, booOptional[l]] = {}
STAT_DDOF_FUNC_DEFAULTS["dtype"] = None
STAT_DDOF_FUNC_DEFAULTS["out"] = None
STAT_DDOF_FUNC_DEFAULTS["keepdims"] = False
validate_stat_ddof_func = CompatValidator(STAT_DDOF_FUNC_DEFAULTS, method="kwargs")

TAKE_DEFAULTS: dict[str, stOptional[r]] = {}
TAKE_DEFAULTS["out"] = None
TAKE_DEFAULTS["mode"] = "raise"
validate_take = CompatValidator(TAKE_DEFAULTS, fname="take", method="kwargs")


def validate_take_with_convert(convert: ndarray | booOptional[l], args, kwargs) -> bool:
    """
    If this function is called via the 'numpy' library, the third parameter in
...
def validate_minmax_axis(axis: AxisInOptional[t], ndim: int = 1) -> None:
    """
