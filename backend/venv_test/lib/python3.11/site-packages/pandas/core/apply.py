...
class Apply(metaclass=abc.ABCMeta):
    ...
    def agg(self) -> DataFrame | SerieOptional[s]:
        """
...
def reconstruct_func(
    func: AggFuncTypOptional[e], **kwargs
) -> tuple[bool, AggFuncType, tuple[str, ...] | None, npt.NDArray[np.intOptional[p]]]:
    """
    ...
    **kwargs: dict, kwargs used in is_multi_agg_with_relabel and
    ...
    order: npt.NDArray[np.intOptional[p]] = None
