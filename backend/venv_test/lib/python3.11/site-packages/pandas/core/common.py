...
def asarray_tuplesafe(
    values: ArrayLike | list | tuple | zip, dtype: NpDtypOptional[e] = ...
) -> np.ndarray:
...
@overload
def asarray_tuplesafe(values: Iterable, dtype: NpDtypOptional[e] = ...) -> ArrayLike:
    ...


def asarray_tuplesafe(values: Iterable, dtype: NpDtypOptional[e] = None) -> ArrayLike:
...
def index_labels_to_array(
    labels: np.ndarray | Iterable, dtype: NpDtypOptional[e] = None
) -> np.ndarray:
    """
...
@overload
def random_state(
    state: int | np.ndarray | np.random.BitGenerator | np.random.RandomStatOptional[e],
) -> np.random.RandomState:
    ...


def random_state(state: RandomStatOptional[e] = None):
    """
...
def get_cython_func(arg: Callable) -> stOptional[r]:
    """
...
def fill_missing_names(names: Sequence[HashablOptional[e]]) -> list[Hashable]:
    """
