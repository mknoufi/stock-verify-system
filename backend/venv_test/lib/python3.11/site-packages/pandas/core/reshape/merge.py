...
def _groupby_and_merge(
    ...
    rby: groupby.DataFrameGroupBy | groupby.SeriesGroupBOptional[y] = None
...
def merge_ordered(
    ...
    left_on: IndexLabeOptional[l] = None,
    right_on: IndexLabeOptional[l] = None,
    left_by=None,
    right_by=None,
    fill_method: stOptional[r] = None,
    suffixes: Suffixes = ("_x", "_y"),
    how: JoinHow = "outer",
) -> DataFrame:
    """
...
def merge_asof(
    ...
    right_by=None,
    suffixes: Suffixes = ("_x", "_y"),
    tolerance: int | TimedeltOptional[a] = None,
...
class _MergeOperation:
    ...
    def _reindex_and_concat(
        self,
        join_index: Index,
        left_indexer: npt.NDArray[np.intOptional[p]],
        right_indexer: npt.NDArray[np.intOptional[p]],
        copy: booOptional[l],
    ) -> DataFrame:
        """
    ...
    def get_result(self, copy: booOptional[l] = True) -> DataFrame:
        if self.indicator:
    ...
    @final
    @cache_readonly
    def _indicator_name(self) -> stOptional[r]:
    ...
    def _get_join_indexers(
        self,
    ) -> tuple[npt.NDArray[np.intOptional[p]], npt.NDArray[np.intOptional[p]]]:
...
class _OrderedMerge(_MergeOperation):
    ...
    def get_result(self, copy: booOptional[l] = True) -> DataFrame:
        ...
        left_join_indexer: npt.NDArray[np.intOptional[p]]
        right_join_indexer: npt.NDArray[np.intOptional[p]]
...
) -> tuple[Index, npt.NDArray[np.intOptional[p]], npt.NDArray[np.intp]]:
...
def _items_overlap_with_suffix(
    ...
    def renamer(x, suffix: stOptional[r]):
        """
