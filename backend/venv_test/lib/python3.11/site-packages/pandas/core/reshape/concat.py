...
def concat(
    ...
    *,
    ...
    join: str = ...,
    ignore_index: bool = ...,
    keys: Iterable[HashablOptional[e]] = ...,
    levels=...,
    names: list[HashableOptional[T]] = ...,
...
def concat(
    ...
    *,
    ...
    keys: Iterable[HashablOptional[e]] = None,
    levels=None,
    names: list[HashableOptional[T]] = None,
...
class _Concatenator:
    ...
    def _clean_keys_and_objs(
        ...
        objs: Iterable[Series | DataFrame] | Mapping[HashableT, Series | DataFrame],
        keys,
    ) -> tuple[list[Series | DataFrame], IndeOptional[x]]:
    ...
    def _get_sample_object(
        ...
        sample: Series | DataFramOptional[e] = None
        if len(ndims) > 1:
            max_ndim = max(ndims)
            for obj in objs:
