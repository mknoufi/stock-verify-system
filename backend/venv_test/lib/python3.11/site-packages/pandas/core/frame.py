...
class DataFrame(NDFrame, OpsMixin):
    ...
    def __init__(
        self,
        data=None,
        index: AxeOptional[s] = None,
        columns: AxeOptional[s] = None,
        dtype: DtypOptional[e] = None,
        copy: booOptional[l] = None,
    ) -> None:
        allow_mgr = False
    ...
    def __dataframe_consortium_standard__(
        self, *, api_version: stOptional[r] = None
    ) -> Any:
        """
    ...
    def _repr_html_(self) -> stOptional[r]:
        """
    ...
    def to_string(
        self,
        buf: None = ...,
        columns: AxeOptional[s] = ...,
        col_space: int | list[int] | dict[Hashable, inOptional[t]] = ...,
        header: bool | SequenceNotStr[str] = ...,
        index: bool = ...,
        na_rep: str = ...,
        formatters: fmt.FormattersTypOptional[e] = ...,
        float_format: fmt.FloatFormatTypOptional[e] = ...,
        sparsify: booOptional[l] = ...,
        index_names: bool = ...,
        justify: stOptional[r] = ...,
        max_rows: inOptional[t] = ...,
        max_cols: inOptional[t] = ...,
        show_dimensions: bool = ...,
        decimal: str = ...,
        line_width: inOptional[t] = ...,
        min_rows: inOptional[t] = ...,
        max_colwidth: inOptional[t] = ...,
    ...
    def to_string(
        ...
        columns: AxeOptional[s] = None,
        col_space: int | list[int] | dict[Hashable, inOptional[t]] = None,
        header: bool | SequenceNotStr[str] = True,
        index: bool = True,
        na_rep: str = "NaN",
        formatters: fmt.FormattersTypOptional[e] = None,
        float_format: fmt.FloatFormatTypOptional[e] = None,
        sparsify: booOptional[l] = None,
        index_names: bool = True,
        justify: stOptional[r] = None,
        max_rows: inOptional[t] = None,
        max_cols: inOptional[t] = None,
        show_dimensions: bool = False,
        decimal: str = ".",
        line_width: inOptional[t] = None,
        min_rows: inOptional[t] = None,
        max_colwidth: inOptional[t] = None,
    ...
    def itertuples(
        self, index: bool = True, name: stOptional[r] = "Pandas"
    ) -> Iterable[tuple[Any, ...]]:
        """
    ...
    def to_numpy(
        self,
        dtype: npt.DTypeLikOptional[e] = None,
        copy: bool = False,
    ...
    def to_gbq(
        ...
        project_id: stOptional[r] = None,
        chunksize: inOptional[t] = None,
        reauth: bool = False,
        if_exists: ToGbqIfexist = "fail",
        auth_local_webserver: bool = True,
        table_schema: list[dict[str, stOptional[r]]] = None,
        location: stOptional[r] = None,
    ...
    def from_records(
        ...
        ) -> tuple[list[ArrayLike], Index, IndeOptional[x]]:
            """
    ...
    def to_stata(
        ...
        *,
        convert_dates: dict[Hashable, stOptional[r]] = None,
        write_index: bool = True,
        byteorder: ToStataByteordeOptional[r] = None,
        time_stamp: datetime.datetimOptional[e] = None,
        data_label: stOptional[r] = None,
        variable_labels: dict[Hashable, stOptional[r]] = None,
        version: inOptional[t] = 114,
        convert_strl: Sequence[HashablOptional[e]] = None,
        compression: CompressionOptions = "infer",
        storage_options: StorageOptionOptional[s] = None,
        value_labels: dict[Hashable, dict[float, stOptional[r]]] = None,
    ) -> None:
        """
    ...
    def to_parquet(
        ...
        compression: stOptional[r] = ...,
        index: booOptional[l] = ...,
        partition_cols: list[stOptional[r]] = ...,
    ...
    def to_parquet(
        self,
        path: FilePath | WriteBuffer[byteOptional[s]] = None,
        engine: Literal["auto", "pyarrow", "fastparquet"] = "auto",
        compression: stOptional[r] = "snappy",
        index: booOptional[l] = None,
        partition_cols: list[stOptional[r]] = None,
        storage_options: StorageOptionOptional[s] = None,
        **kwargs,
    ) -> byteOptional[s]:
        """
    ...
    def to_html(
        ...
        buf: FilePath | WriteBuffer[str],
        columns: AxeOptional[s] = ...,
        col_space: ColspaceArgTypOptional[e] = ...,
        header: bool = ...,
        index: bool = ...,
        na_rep: str = ...,
        ...
        decimal: str = ...,
        bold_rows: bool = ...,
        classes: str | list | tuplOptional[e] = ...,
        escape: bool = ...,
        notebook: bool = ...,
        border: int | booOptional[l] = ...,
        table_id: stOptional[r] = ...,
        render_links: bool = ...,
        encoding: stOptional[r] = ...,
    ) -> None:
        ...
    ...
    def to_html(
        ...
        buf: FilePath | WriteBuffer[stOptional[r]] = None,
        columns: AxeOptional[s] = None,
        col_space: ColspaceArgTypOptional[e] = None,
        header: bool = True,
        index: bool = True,
        na_rep: str = "NaN",
        ...
        decimal: str = ".",
        bold_rows: bool = True,
        classes: str | list | tuplOptional[e] = None,
        escape: bool = True,
        notebook: bool = False,
        border: int | booOptional[l] = None,
        table_id: stOptional[r] = None,
    ...
    def to_xml(
        ...
        *,
        index: bool = ...,
        root_name: stOptional[r] = ...,
        row_name: stOptional[r] = ...,
        na_rep: stOptional[r] = ...,
        attr_cols: list[stOptional[r]] = ...,
        elem_cols: list[stOptional[r]] = ...,
        namespaces: dict[stOptional[r], stOptional[r]] = ...,
        prefix: stOptional[r] = ...,
        encoding: str = ...,
        xml_declaration: booOptional[l] = ...,
        pretty_print: booOptional[l] = ...,
        parser: XMLParserOptional[s] = ...,
        stylesheet: FilePath | ReadBuffer[str] | ReadBuffer[byteOptional[s]] = ...,
        compression: CompressionOptions = ...,
        storage_options: StorageOptionOptional[s] = ...,
    ) -> str:
        ...
    ...
    def to_xml(
        self,
        path_or_buffer: FilePath | WriteBuffer[bytes] | WriteBuffer[stOptional[r]] = None,
        index: bool = True,
        root_name: stOptional[r] = "data",
        row_name: stOptional[r] = "row",
        na_rep: stOptional[r] = None,
        attr_cols: list[stOptional[r]] = None,
        elem_cols: list[stOptional[r]] = None,
        namespaces: dict[stOptional[r], stOptional[r]] = None,
        prefix: stOptional[r] = None,
        encoding: str = "utf-8",
        xml_declaration: booOptional[l] = True,
        pretty_print: booOptional[l] = True,
        parser: XMLParserOptional[s] = "lxml",
        stylesheet: FilePath | ReadBuffer[str] | ReadBuffer[byteOptional[s]] = None,
        compression: CompressionOptions = "infer",
        storage_options: StorageOptionOptional[s] = None,
    ) -> stOptional[r]:
        """
    ...
    def info(
        self,
        verbose: booOptional[l] = None,
        buf: WriteBuffer[stOptional[r]] = None,
        max_cols: inOptional[t] = None,
        memory_usage: bool | stOptional[r] = None,
        show_counts: booOptional[l] = None,
    ) -> None:
        info = DataFrameInfo(
            data=self,
    ...
    def _iset_item_mgr(
        ...
        value,
        inplace: bool = False,
        refs: BlockValuesRefOptional[s] = None,
    ) -> None:
    ...
    def _set_item_mgr(
        self, key, value: ArrayLike, refs: BlockValuesRefOptional[s] = None
    ) -> None:
        try:
    ...
    @overload
    def query(self, expr: str, *, inplace: bool = ..., **kwargs) -> DataFramOptional[e]:
        ...

    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFramOptional[e]:
        """
    ...
    def eval(self, expr: str, *, inplace: bool = False, **kwargs) -> AnOptional[y]:
        """
    ...
    def _sanitize_column(self, value) -> tuple[ArrayLike, BlockValuesRefOptional[s]]:
        """
    ...
    def rename(
        self,
        mapper: RenameOptional[r] = ...,
        *,
        index: RenameOptional[r] = ...,
        columns: RenameOptional[r] = ...,
        axis: AxiOptional[s] = ...,
        copy: booOptional[l] = ...,
        inplace: Literal[True],
        level: Level = ...,
    ...
    def reset_index(
        ...
        *,
        ...
        names: Hashable | Sequence[HashablOptional[e]] = None,
    ) -> DataFrame:
        ...
    ...
    def reset_index(
        ...
        *,
        ...
        if not drop:
            to_insert: Iterable[tuple[Any, AnOptional[y]]]
    ...
    def dropna(
        ...
        *,
        ...
        subset: IndexLabeOptional[l] = None,
        inplace: bool = False,
    ...
    def drop_duplicates(
        self,
        subset: Hashable | Sequence[HashablOptional[e]] = ...,
        *,
        keep: DropKeep = ...,
        inplace: Literal[True],
        ignore_index: bool = ...,
    ...
    def drop_duplicates(
        self,
        subset: Hashable | Sequence[HashablOptional[e]] = None,
        *,
        keep: DropKeep = "first",
        inplace: bool = False,
        ignore_index: bool = False,
    ...
    def _dispatch_frame_op(
        self, right, func: Callable, axis: AxisInOptional[t] = None
    ) -> DataFrame:
        """
    ...
    def _gotitem(
        ...
        key: IndexLabel,
        ndim: int,
        subset: DataFrame | SerieOptional[s] = None,
    ) -> DataFrame | Series:
        """
    ...
    def apply(
        ...
        engine_kwargs: dict[str, booOptional[l]] = None,
        **kwargs,
    ):
        """
    ...
    def map(
        self, func: PythonFuncType, na_action: stOptional[r] = None, **kwargs
    ) -> DataFrame:
        """
    ...
    def applymap(
        self, func: PythonFuncType, na_action: NaActioOptional[n] = None, **kwargs
    ) -> DataFrame:
        """
        Apply a function to a Dataframe elementwise.
    ...
    def join(
        ...
        on: IndexLabeOptional[l] = None,
        how: MergeHow = "left",
        lsuffix: str = "",
        rsuffix: str = "",
        sort: bool = False,
        validate: JoinValidatOptional[e] = None,
    ) -> DataFrame:
        """
    ...
    def merge(
        ...
        how: MergeHow = "inner",
        on: IndexLabel | AnyArrayLikOptional[e] = None,
        left_on: IndexLabel | AnyArrayLikOptional[e] = None,
        right_on: IndexLabel | AnyArrayLikOptional[e] = None,
        ...
        validate: MergeValidatOptional[e] = None,
    ) -> DataFrame:
        from pandas.core.reshape.merge import merge
    ...
    def cummin(self, axis: AxiOptional[s] = None, skipna: bool = True, *args, **kwargs):
        return NDFrame.cummin(self, axis, skipna, *args, **kwargs)

    @doc(make_doc("cummax", ndim=2))
    def cummax(self, axis: AxiOptional[s] = None, skipna: bool = True, *args, **kwargs):
        return NDFrame.cummax(self, axis, skipna, *args, **kwargs)

    @doc(make_doc("cumsum", ndim=2))
    def cumsum(self, axis: AxiOptional[s] = None, skipna: bool = True, *args, **kwargs):
        return NDFrame.cumsum(self, axis, skipna, *args, **kwargs)

    @doc(make_doc("cumprod", 2))
    def cumprod(self, axis: AxiOptional[s] = None, skipna: bool = True, *args, **kwargs):
    ...
    def to_period(
        self, freq: FrequencOptional[y] = None, axis: Axis = 0, copy: booOptional[l] = None
    ) -> DataFrame:
        """
...
) -> tuple[ArrayLike, BlockValuesRefOptional[s]]:
