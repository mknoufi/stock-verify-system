...
def to_pyarrow_type(
    dtype: ArrowDtype | pa.DataType | DtypOptional[e],
) -> pa.DataTypOptional[e]:
    """
...
class ArrowExtensionArray(  # type: ignore[misc]
    ...
    @classmethod
    def _from_sequence(cls, scalars, *, dtype: DtypOptional[e] = None, copy: bool = False):
        """
    ...
    def _from_sequence_of_strings(
        cls, strings, *, dtype: DtypOptional[e] = None, copy: bool = False
    ):
        """
    ...
    @classmethod
    def _box_pa(
        cls, value, pa_type: pa.DataTypOptional[e] = None
    ...
    @classmethod
    def _box_pa_scalar(cls, value, pa_type: pa.DataTypOptional[e] = None) -> pa.Scalar:
        """
    ...
    @classmethod
    def _box_pa_array(
        cls, value, pa_type: pa.DataTypOptional[e] = None, copy: bool = False
    ...
    def __array__(
        self, dtype: NpDtypOptional[e] = None, copy: booOptional[l] = None
    ) -> np.ndarray:
    ...
    def fillna(
        self,
        value: object | ArrayLikOptional[e] = None,
    ...
    def _str_accumulate(
        ...
        tail: pa.arraOptional[y] = None
        na_mask: pa.arraOptional[y] = None
    ...
    def _if_else(
        ...
        def _to_numpy_and_type(value) -> tuple[np.ndarray, pa.DataTypOptional[e]]:
    ...
    def _str_index(self, sub: str, start: int = 0, end: inOptional[t] = None):
        predicate = lambda val: val.index(sub, start, end)
        result = self._apply_elementwise(predicate)
        return type(self)(pa.chunked_array(result))

    def _str_rindex(self, sub: str, start: int = 0, end: inOptional[t] = None):
    ...
    def _str_split(
        self,
        pat: stOptional[r] = None,
        n: inOptional[t] = -1,
        expand: bool = False,
        regex: booOptional[l] = None,
    ):
        if n in {-1, 0}:
            n = None
        if pat is None:
    ...
    def _str_rsplit(self, pat: stOptional[r] = None, n: inOptional[t] = -1):
        if n in {-1, 0}:
            n = None
        if pat is None:
            return type(self)(
    ...
    def _dt_day_name(self, locale: stOptional[r] = None):
        if locale is None:
            locale = "C"
        return type(self)(pc.strftime(self._pa_array, format="%A", locale=locale))

    def _dt_month_name(self, locale: stOptional[r] = None):
        if locale is None:
            locale = "C"
