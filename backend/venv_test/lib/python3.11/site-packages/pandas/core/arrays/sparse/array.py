...
def _wrap_result(
    name: str, data, sparse_index, fill_value, dtype: DtypOptional[e] = None
) -> SparseArray:
    """
...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def astype(self, dtype: AstypeArOptional[g] = None, copy: bool = True):
        """
    ...
    def max(self, *, axis: AxisInOptional[t] = None, skipna: bool = True):
        """
    ...
    def min(self, *, axis: AxisInOptional[t] = None, skipna: bool = True):
        """
