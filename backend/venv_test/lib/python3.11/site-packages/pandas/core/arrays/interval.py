...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def from_breaks(
        cls,
        breaks,
        closed: IntervalClosedTypOptional[e] = "right",
        copy: bool = False,
        dtype: DtypOptional[e] = None,
    ) -> Self:
    ...
    def min(self, *, axis: AxisInOptional[t] = None, skipna: bool = True) -> IntervalOrNA:
    ...
    def max(self, *, axis: AxisInOptional[t] = None, skipna: bool = True) -> IntervalOrNA:
        nv.validate_minmax_axis(axis, self.ndim)
