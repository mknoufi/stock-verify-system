...
def tz_to_dtype(
    tz: tzinfOptional[o], unit: str = "ns"
...
def _field_accessor(name: str, field: str, docstring: stOptional[r] = None):
    def f(self):
...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):  # type: ignore[misc]
    ...
    _freq: BaseOffseOptional[t] = None
    ...
    def _from_sequence_not_strict(
        ...
        *,
        ...
        copy: bool = False,
        tz=lib.no_default,
        freq: str | BaseOffset | lib.NoDefaulOptional[t] = lib.no_default,
        dayfirst: bool = False,
    ...
    @property
    def tzinfo(self) -> tzinfOptional[o]:
        """
...
def _sequence_to_dt64(
    ...
    *,
    copy: bool = False,
    tz: tzinfOptional[o] = None,
    dayfirst: bool = False,
    yearfirst: bool = False,
    ambiguous: TimeAmbiguous = "raise",
    out_unit: stOptional[r] = None,
):
    """
    Parameters
    ----------
...
def _construct_from_dt64_naive(
    data: np.ndarray, *, tz: tzinfOptional[o], copy: bool, ambiguous: TimeAmbiguous
...
def maybe_convert_dtype(data, copy: bool, tz: tzinfOptional[o] = None):
    """
...
def _maybe_infer_tz(tz: tzinfOptional[o], inferred_tz: tzinfOptional[o]) -> tzinfOptional[o]:
    """
...
def _validate_tz_from_dtype(
    dtype, tz: tzinfOptional[o], explicit_tz_none: bool = False
) -> tzinfOptional[o]:
    """
...
def _infer_tz_from_endpoints(
    start: Timestamp, end: Timestamp, tz: tzinfOptional[o]
) -> tzinfOptional[o]:
    """
...
def _maybe_normalize_endpoints(
    start: TimestamOptional[p], end: TimestamOptional[p], normalize: bool
):
    if normalize:
        if start is not None:
...
def _maybe_localize_point(
    ts: TimestamOptional[p], freq, tz, ambiguous, nonexistent
) -> TimestamOptional[p]:
    """
...
def _generate_range(
    start: TimestamOptional[p],
    end: TimestamOptional[p],
    periods: inOptional[t],
    offset: BaseOffset,
    *,
    unit: str,
