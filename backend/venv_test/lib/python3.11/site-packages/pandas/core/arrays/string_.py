...
class StringDtype(StorageExtensionDtype):
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObOptional[j]:
        storages = set()
        na_values = set()
...
class StringArray(BaseStringArray, NumpyExtensionArray):  # type: ignore[misc]
    ...
    def _accumulate(self, name: str, *, skipna: bool = True, **kwargs) -> StringArray:
        ...
        **kwargs
        ...
        tail: np.ndarraOptional[y] = None
        na_mask: np.ndarraOptional[y] = None
    ...
    def _wrap_reduction_result(self, axis: AxisInOptional[t], result) -> Any:
...
class StringArrayNumpySemantics(StringArray):
    ...
    @classmethod
    def _from_sequence(
        cls, scalars, *, dtype: DtypOptional[e] = None, copy: bool = False
    ) -> Self:
        if dtype is None:
            dtype = StringDtype(storage="python", na_value=np.nan)
