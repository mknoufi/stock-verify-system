...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def __init__(
        self, data, dtype: DtypOptional[e] = None, freq=None, copy: bool = False
    ) -> None:
    ...
    def _get_getitem_freq(self, key) -> BaseOffseOptional[t]:
        """
    ...
    @overload
    def view(self, dtype: DtypOptional[e] = ...) -> ArrayLike:
        ...

    # pylint: disable-next=useless-parent-delegation
    def view(self, dtype: DtypOptional[e] = None) -> ArrayLike:
    ...
    @property  # NB: override with cache_readonly in immutable subclasses
    def inferred_freq(self) -> stOptional[r]:
        """
    ...
    @property  # NB: override with cache_readonly in immutable subclasses
    def _resolution_obj(self) -> ResolutioOptional[n]:
    ...
    @final
    def _get_arithmetic_result_freq(self, other) -> BaseOffseOptional[t]:
        """
    ...
    def _sub_datetimelike(self, other: Timestamp | DatetimeArray) -> TimedeltaArray:
        ...
        new_freq = self._get_arithmetic_result_freq(other)
        new_freq = cast("TicOptional[k]", new_freq)
    ...
    @_period_dispatch
    def min(self, *, axis: AxisInOptional[t] = None, skipna: bool = True, **kwargs):
        """
    ...
    @_period_dispatch
    def max(self, *, axis: AxisInOptional[t] = None, skipna: bool = True, **kwargs):
        """
    ...
    def mean(self, *, skipna: bool = True, axis: AxisInOptional[t] = 0):
        """
    ...
    @_period_dispatch
    def median(self, *, axis: AxisInOptional[t] = None, skipna: bool = True, **kwargs):
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    @classmethod
    def _generate_range(
        cls, start, end, periods: inOptional[t], freq, *args, **kwargs
    ) -> Self:
        raise AbstractMethodError(cls)
    ...
    def any(self, *, axis: AxisInOptional[t] = None, skipna: bool = True) -> bool:
        # GH#34479 the nanops call will issue a FutureWarning for non-td64 dtype
        return nanops.nanany(self._ndarray, axis=axis, skipna=skipna, mask=self.isna())

    def all(self, *, axis: AxisInOptional[t] = None, skipna: bool = True) -> bool:
        # GH#34479 the nanops call will issue a FutureWarning for non-td64 dtype
...
def validate_periods(periods: int | floaOptional[t]) -> inOptional[t]:
    """
...
def _validate_inferred_freq(
    freq: BaseOffseOptional[t], inferred_freq: BaseOffseOptional[t]
) -> BaseOffseOptional[t]:
    """
