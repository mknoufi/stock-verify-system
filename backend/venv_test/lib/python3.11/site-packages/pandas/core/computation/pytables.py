...
class PyTablesScope(_scope.Scope):
    ...
    def __init__(
        ...
        global_dict=None,
        local_dict=None,
        queryables: dict[str, AnOptional[y]] = None,
    ) -> None:
...
class FilterBinOp(BinOp):
    filter: tuple[Any, Any, IndeOptional[x]] = None
    ...
    def evaluate(self) -> SelOptional[f]:  # type: ignore[override]
...
class PyTablesExprVisitor(BaseExprVisitor):
    ...
    def visit_UnaryOp(self, node, **kwargs) -> ops.Term | UnaryOOptional[p]:
...
class PyTablesExpr(expr.Expr):
    ...
    _visitor: PyTablesExprVisitoOptional[r]
    env: PyTablesScope
    expr: str
    ...
    def __init__(
        ...
        local_dict: _scope.DeepChainMap[Any, AnOptional[y]] = None
