...
def _guess_datetime_format_for_array(arr, dayfirst: booOptional[l] = False) -> stOptional[r]:
...
def should_cache(
    arg: ArrayConvertible, unique_share: float = 0.7, check_count: inOptional[t] = None
) -> bool:
    """
...
def _box_as_indexlike(
    dt_array: ArrayLike, utc: bool = False, name: HashablOptional[e] = None
) -> Index:
    """
...
def _convert_listlike_datetimes(
    ...
    dayfirst: booOptional[l] = None,
    yearfirst: booOptional[l] = None,
    exact: bool = True,
):
    """
...
def to_datetime(
    ...
    origin: str = "unix",
    cache: bool = True,
) -> DatetimeIndex | Series | DatetimeScalar | NaTTypOptional[e]:
    """
