...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    _metadata: list[str] = []
    _is_copy: weakref.ReferenceType[NDFrame] | stOptional[r] = None
    _mgr: Manager
    ...
    def _init_mgr(
        cls,
        mgr: Manager,
        axes: dict[Literal["index", "columns"], AxeOptional[s]],
        dtype: DtypeObOptional[j] = None,
        copy: bool_t = False,
    ) -> Manager:
    ...
    def set_flags(
        ...
        *,
        copy: bool_t = False,
        allows_duplicate_labels: bool_Optional[t] = None,
    ) -> Self:
        """
    ...
    @final
    @classmethod
    def _validate_dtype(cls, dtype) -> DtypeObOptional[j]:
    ...
    @final
    def _construct_axes_dict(self, axes: Sequence[AxiOptional[s]] = None, **kwargs):
    ...
    def _set_axis_nocheck(
        self, labels, axis: Axis, inplace: bool_t, copy: bool_Optional[t]
    ):
        if inplace:
    ...
    @final
    def swapaxes(self, axis1: Axis, axis2: Axis, copy: bool_Optional[t] = None) -> Self:
        """
    ...
    @final
    def squeeze(self, axis: AxiOptional[s] = None):
        """
    ...
    def _rename(
        self,
        mapper: RenameOptional[r] = None,
        *,
        index: RenameOptional[r] = None,
        columns: RenameOptional[r] = None,
        axis: AxiOptional[s] = None,
        copy: bool_Optional[t] = None,
        inplace: bool_t = False,
        level: LeveOptional[l] = None,
        errors: str = "ignore",
    ) -> SelOptional[f]:
    ...
    @final
    def _set_axis_name(
        self, name, axis: Axis = 0, inplace: bool_t = False, copy: bool_Optional[t] = True
    ):
        """
    ...
    def __array__(
        self, dtype: npt.DTypeLikOptional[e] = None, copy: bool_Optional[t] = None
    ) -> np.ndarray:
    ...
    def to_excel(
        ...
        na_rep: str = "",
        float_format: stOptional[r] = None,
        columns: Sequence[HashablOptional[e]] = None,
        header: Sequence[Hashable] | bool_t = True,
        index: bool_t = True,
        index_label: IndexLabeOptional[l] = None,
        startrow: int = 0,
        startcol: int = 0,
        engine: Literal["openpyxl", "xlsxwriter"] | None = None,
        merge_cells: bool_t = True,
        inf_rep: str = "inf",
        freeze_panes: tuple[int, inOptional[t]] = None,
        storage_options: StorageOptionOptional[s] = None,
        engine_kwargs: dict[str, AnOptional[y]] = None,
    ) -> None:
        """
    ...
    def to_json(
        self,
        path_or_buf: FilePath | WriteBuffer[bytes] | WriteBuffer[stOptional[r]] = None,
        orient: Literal["split", "records", "index", "table", "columns", "values"]
        | None = None,
        date_format: stOptional[r] = None,
        double_precision: int = 10,
        force_ascii: bool_t = True,
        date_unit: TimeUnit = "ms",
        default_handler: Callable[[Any], JSONSerializablOptional[e]] = None,
        lines: bool_t = False,
        compression: CompressionOptions = "infer",
        index: bool_Optional[t] = None,
        indent: inOptional[t] = None,
        storage_options: StorageOptionOptional[s] = None,
        mode: Literal["a", "w"] = "w",
    ) -> stOptional[r]:
        """
    ...
    def to_hdf(
        ...
        complevel: inOptional[t] = None,
        complib: Literal["zlib", "lzo", "bzip2", "blosc"] | None = None,
        append: bool_t = False,
        format: Literal["fixed", "table"] | None = None,
        index: bool_t = True,
        min_itemsize: int | dict[str, inOptional[t]] = None,
        nan_rep=None,
        dropna: bool_Optional[t] = None,
        data_columns: Literal[True] | list[stOptional[r]] = None,
    ...
    def to_sql(
        ...
        name: str,
        con,
        schema: stOptional[r] = None,
        if_exists: Literal["fail", "replace", "append"] = "fail",
        index: bool_t = True,
        index_label: IndexLabeOptional[l] = None,
        chunksize: inOptional[t] = None,
        dtype: DtypeArOptional[g] = None,
        method: Literal["multi"] | CallablOptional[e] = None,
    ) -> inOptional[t]:
        """
    ...
    def to_clipboard(
        self, excel: bool_t = True, sep: stOptional[r] = None, **kwargs
    ) -> None:
        r"""
    ...
    def to_latex(
        self,
        buf: None = ...,
        columns: Sequence[HashablOptional[e]] = ...,
        header: bool_t | SequenceNotStr[str] = ...,
        index: bool_t = ...,
        na_rep: str = ...,
        formatters: FormattersTypOptional[e] = ...,
        float_format: FloatFormatTypOptional[e] = ...,
        sparsify: bool_Optional[t] = ...,
        index_names: bool_t = ...,
        bold_rows: bool_t = ...,
        column_format: stOptional[r] = ...,
        longtable: bool_Optional[t] = ...,
        escape: bool_Optional[t] = ...,
        encoding: stOptional[r] = ...,
        decimal: str = ...,
        multicolumn: bool_Optional[t] = ...,
        multicolumn_format: stOptional[r] = ...,
        multirow: bool_Optional[t] = ...,
        caption: str | tuple[str, stOptional[r]] = ...,
        label: stOptional[r] = ...,
        position: stOptional[r] = ...,
    ) -> str:
        ...
    ...
    def to_latex(
        self,
        buf: FilePath | WriteBuffer[stOptional[r]] = None,
        columns: Sequence[HashablOptional[e]] = None,
        header: bool_t | SequenceNotStr[str] = True,
        index: bool_t = True,
        na_rep: str = "NaN",
        formatters: FormattersTypOptional[e] = None,
        float_format: FloatFormatTypOptional[e] = None,
        sparsify: bool_Optional[t] = None,
        index_names: bool_t = True,
        bold_rows: bool_t = False,
        column_format: stOptional[r] = None,
        longtable: bool_Optional[t] = None,
        escape: bool_Optional[t] = None,
        encoding: stOptional[r] = None,
        decimal: str = ".",
        multicolumn: bool_Optional[t] = None,
        multicolumn_format: stOptional[r] = None,
        multirow: bool_Optional[t] = None,
        caption: str | tuple[str, stOptional[r]] = None,
        label: stOptional[r] = None,
        position: stOptional[r] = None,
    ) -> stOptional[r]:
        r"""
        ...
        if isinstance(float_format, str):
            float_format_: CallablOptional[e] = lambda x: float_format % x
        else:
        ...
        formatters_: list | tuple | dict | CallablOptional[e] = None
    ...
    def _to_latex_via_styler(
        ...
        buf=None,
        *,
        hide: dict | list[dicOptional[t]] = None,
        relabel_index: dict | list[dicOptional[t]] = None,
        format: dict | list[dicOptional[t]] = None,
        format_index: dict | list[dicOptional[t]] = None,
        render_kwargs: dicOptional[t] = None,
    ):
        """
        Render object to a LaTeX tabular, longtable, or nested table.
    ...
    def to_csv(
        ...
        sep: str = ...,
        na_rep: str = ...,
        float_format: str | CallablOptional[e] = ...,
        columns: Sequence[HashablOptional[e]] = ...,
        header: bool_t | list[str] = ...,
        index: bool_t = ...,
        index_label: IndexLabeOptional[l] = ...,
        mode: str = ...,
        encoding: stOptional[r] = ...,
        compression: CompressionOptions = ...,
        quoting: inOptional[t] = ...,
        quotechar: str = ...,
        lineterminator: stOptional[r] = ...,
        chunksize: inOptional[t] = ...,
        date_format: stOptional[r] = ...,
        doublequote: bool_t = ...,
        escapechar: stOptional[r] = ...,
        decimal: str = ...,
    ...
    def to_csv(
        ...
        sep: str = ",",
        na_rep: str = "",
        float_format: str | CallablOptional[e] = None,
        columns: Sequence[HashablOptional[e]] = None,
        ...
        encoding: stOptional[r] = None,
        compression: CompressionOptions = "infer",
        quoting: inOptional[t] = None,
        quotechar: str = '"',
        lineterminator: stOptional[r] = None,
        chunksize: inOptional[t] = None,
        date_format: stOptional[r] = None,
        doublequote: bool_t = True,
        escapechar: stOptional[r] = None,
        decimal: str = ".",
        errors: OpenFileErrors = "strict",
        storage_options: StorageOptionOptional[s] = None,
    ) -> stOptional[r]:
    ...
    def xs(
        ...
        key: IndexLabel,
        axis: Axis = 0,
        level: IndexLabeOptional[l] = None,
    ...
    def drop(
        self,
        labels: IndexLabeOptional[l] = None,
        *,
        axis: Axis = 0,
        index: IndexLabeOptional[l] = None,
        columns: IndexLabeOptional[l] = None,
        level: LeveOptional[l] = None,
        inplace: bool_t = False,
    ...
    @final
    def add_prefix(self, prefix: str, axis: AxiOptional[s] = None) -> Self:
        """
    ...
    @final
    def add_suffix(self, suffix: str, axis: AxiOptional[s] = None) -> Self:
        """
    ...
    def sort_values(
        ...
        *,
        ...
        key: ValueKeyFunOptional[c] = None,
    ) -> SelOptional[f]:
        """
    ...
    def sort_index(
        ...
        *,
        ...
        ignore_index: bool_t = False,
        key: IndexKeyFunOptional[c] = None,
    ) -> SelOptional[f]:
        inplace = validate_bool_kwarg(inplace, "inplace")
        axis = self._get_axis_number(axis)
    ...
    def reindex(
        ...
        *,
        ...
        columns=None,
        axis: AxiOptional[s] = None,
        method: ReindexMethoOptional[d] = None,
        copy: bool_Optional[t] = None,
        level: LeveOptional[l] = None,
        fill_value: ScalaOptional[r] = np.nan,
        limit: inOptional[t] = None,
        tolerance=None,
    ) -> Self:
        """
    ...
    def _needs_reindex_multi(self, axes, method, level: LeveOptional[l]) -> bool_t:
    ...
    def filter(
        self,
        items=None,
        like: stOptional[r] = None,
        regex: stOptional[r] = None,
        axis: AxiOptional[s] = None,
    ) -> Self:
        """
    ...
    def sample(
        self,
        n: inOptional[t] = None,
        frac: floaOptional[t] = None,
        replace: bool_t = False,
        weights=None,
        random_state: RandomStatOptional[e] = None,
        axis: AxiOptional[s] = None,
        ignore_index: bool_t = False,
    ) -> Self:
        """
    ...
    @final
    def __finalize__(self, other, method: stOptional[r] = None, **kwargs) -> Self:
        """
    ...
    @final
    def astype(
        self, dtype, copy: bool_Optional[t] = None, errors: IgnoreRaise = "raise"
    ) -> Self:
        """
    ...
    @final
    def copy(self, deep: bool_Optional[t] = True) -> Self:
        """
    ...
    @final
    def infer_objects(self, copy: bool_Optional[t] = None) -> Self:
        """
    ...
    def fillna(
        ...
        *,
        method: FillnaOptionOptional[s] = ...,
        axis: AxiOptional[s] = ...,
        inplace: Literal[False] = ...,
        limit: inOptional[t] = ...,
        downcast: dicOptional[t] = ...,
    ) -> Self:
        ...
    ...
    def fillna(
        self,
        value: Hashable | Mapping | Series | DataFramOptional[e] = None,
        *,
        method: FillnaOptionOptional[s] = None,
        axis: AxiOptional[s] = None,
        inplace: bool_t = False,
        limit: inOptional[t] = None,
        downcast: dicOptional[t] | lib.NoDefault = lib.no_default,
    ) -> SelOptional[f]:
        """
    ...
    def ffill(
        ...
        *,
        ...
        downcast: dicOptional[t] | lib.NoDefault = ...,
    ) -> Self:
        ...
    ...
    def asfreq(
        ...
        fill_value: HashablOptional[e] = None,
    ) -> Self:
        """
    ...
    @final
    def at_time(self, time, asof: bool_t = False, axis: AxiOptional[s] = None) -> Self:
        """
    ...
    def resample(
        ...
        on: LeveOptional[l] = None,
        level: LeveOptional[l] = None,
        origin: str | TimestampConvertibleTypes = "start_day",
        offset: TimedeltaConvertibleTypeOptional[s] = None,
    ...
    def align(
        ...
        copy: bool_Optional[t] = None,
        fill_value: HashablOptional[e] = None,
        method: FillnaOptionOptional[s] | lib.NoDefault = lib.no_default,
        limit: inOptional[t] | lib.NoDefault = lib.no_default,
        fill_axis: Axis | lib.NoDefault = lib.no_default,
        broadcast_axis: AxiOptional[s] | lib.NoDefault = lib.no_default,
    ) -> tuple[Self, NDFrameT]:
        """
    ...
    def _align_frame(
        ...
        limit: inOptional[t] = None,
        fill_axis: Axis = 0,
    ) -> tuple[Self, DataFrame, IndeOptional[x]]:
        # defaults
    ...
    def _align_series(
        ...
        limit: inOptional[t] = None,
        fill_axis: Axis = 0,
    ) -> tuple[Self, Series, IndeOptional[x]]:
        is_series = isinstance(self, ABCSeries)
        if copy and using_copy_on_write():
            copy = False
    ...
    @doc(klass=_shared_doc_kwargs["klass"])
    def tz_convert(
        self, tz, axis: Axis = 0, level=None, copy: bool_Optional[t] = None
    ) -> Self:
        """
    ...
    def pct_change(
        self,
        periods: int = 1,
        fill_method: FillnaOptionOptional[s] | lib.NoDefault = lib.no_default,
        limit: inOptional[t] | lib.NoDefault = lib.no_default,
        freq=None,
        **kwargs,
    ) -> Self:
    ...
    def cummax(self, axis: AxiOptional[s] = None, skipna: bool_t = True, *args, **kwargs):
        return self._accum_func(
            "cummax", np.maximum.accumulate, axis, skipna, *args, **kwargs
        )

    def cummin(self, axis: AxiOptional[s] = None, skipna: bool_t = True, *args, **kwargs):
        return self._accum_func(
            "cummin", np.minimum.accumulate, axis, skipna, *args, **kwargs
        )

    def cumsum(self, axis: AxiOptional[s] = None, skipna: bool_t = True, *args, **kwargs):
        return self._accum_func("cumsum", np.cumsum, axis, skipna, *args, **kwargs)

    def cumprod(self, axis: AxiOptional[s] = None, skipna: bool_t = True, *args, **kwargs):
    ...
    def _stat_function_ddof(
        ...
        name: str,
        func,
        axis: AxiOptional[s] | lib.NoDefault = lib.no_default,
        skipna: bool_t = True,
        ddof: int = 1,
        numeric_only: bool_t = False,
        **kwargs,
    ...
    def rolling(
        ...
        min_periods: inOptional[t] = None,
        center: bool_t = False,
        win_type: stOptional[r] = None,
        on: stOptional[r] = None,
        axis: Axis | lib.NoDefault = lib.no_default,
        closed: IntervalClosedTypOptional[e] = None,
        step: inOptional[t] = None,
        method: str = "single",
    ) -> Window | Rolling:
        if axis is not lib.no_default:
            axis = self._get_axis_number(axis)
    ...
    def ewm(
        self,
        com: floaOptional[t] = None,
        span: floaOptional[t] = None,
        halflife: float | TimedeltaConvertibleTypeOptional[s] = None,
        alpha: floaOptional[t] = None,
        min_periods: inOptional[t] = 0,
        adjust: bool_t = True,
        ignore_na: bool_t = False,
        axis: Axis | lib.NoDefault = lib.no_default,
        times: np.ndarray | DataFrame | SerieOptional[s] = None,
        method: Literal["single", "table"] = "single",
    ) -> ExponentialMovingWindow:
        if axis is not lib.no_default:
            axis = self._get_axis_number(axis)
    ...
    @final
    def _find_valid_index(self, *, how: str) -> HashablOptional[e]:
        """
    ...
    def first_valid_index(self) -> HashablOptional[e]:
        """
    ...
    def last_valid_index(self) -> HashablOptional[e]:
