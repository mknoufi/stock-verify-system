...
def forbid_nonstring_types(
    forbidden: list[stOptional[r]], name: stOptional[r] = None
) -> Callable[[F], F]:
    """
...
def _map_and_wrap(name: stOptional[r], docstring: stOptional[r]):
...
class StringMethods(NoNewAttributesMixin):
    ...
    def _wrap_result(
        ...
        if isinstance(self._orig, ABCIndex):
            ...
            # This is a mess.
            _dtype: DtypeObj | stOptional[r] = dtype
    ...
    def split(
        self,
        pat: str | re.PatterOptional[n] = None,
        *,
        n=-1,
        expand: bool = False,
    ...
    def decode(
        self, encoding, errors: str = "strict", dtype: str | DtypeObOptional[j] = None
    ):
        """
