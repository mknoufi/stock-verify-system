...
class Block(PandasObject, libinternals.Block):
    ...
    def make_block(
        self,
        values,
        placement: BlockPlacemenOptional[t] = None,
    ...
    def take_nd(
        ...
        axis: AxisInt,
        new_mgr_locs: BlockPlacemenOptional[t] = None,
    ...
    def get_values(self, dtype: DtypeObOptional[j] = None) -> np.ndarray:
        """
...
def new_block_2d(
    values: ArrayLike, placement: BlockPlacement, refs: BlockValuesRefOptional[s] = None
):
...
def extract_pandas_array(
    values: ArrayLike, dtype: DtypeObOptional[j], ndim: int
) -> tuple[ArrayLike, DtypeObOptional[j]]:
    """
