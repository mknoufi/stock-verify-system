...
class BaseBlockManager(DataManager):
    ...
    def apply(
        self,
        f,
        align_keys: list[stOptional[r]] = None,
        **kwargs,
    ) -> Self:
        """
    ...
    def astype(self, dtype, copy: booOptional[l] = False, errors: str = "raise") -> Self:
        if copy is None:
    ...
    def convert(self, copy: booOptional[l]) -> Self:
        if copy is None:
            if using_copy_on_write():
                copy = False
            else:
    ...
    def _combine(self, blocks: list[Block], index: IndeOptional[x] = None) -> Self:
    ...
    def copy(self, deep: booOptional[l] | Literal["all"] = True) -> Self:
        """
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def column_arrays(self) -> list[np.ndarray]:
        ...
        result: list[np.ndarraOptional[y]] = [None] * len(self.items)
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    @classmethod
    def from_array(
        cls, array: ArrayLike, index: Index, refs: BlockValuesRefOptional[s] = None
    ) -> SingleBlockManager:
        """
