...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    def _init_dict(
        self, data: Mapping, index: IndeOptional[x] = None, dtype: DtypeObOptional[j] = None
    ):
        """
    ...
    @property
    def _references(self) -> BlockValuesRefOptional[s]:
    ...
    def view(self, dtype: DtypOptional[e] = None) -> Series:
        """
    ...
    # NDArray Compat
    def __array__(
        self, dtype: npt.DTypeLikOptional[e] = None, copy: booOptional[l] = None
    ) -> np.ndarray:
        """
    ...
    def __column_consortium_standard__(self, *, api_version: stOptional[r] = None) -> Any:
        """
    ...
    def _set_name(
        self, name, inplace: bool = False, deep: booOptional[l] = None
    ) -> Series:
        """
        Set the Series name.
    ...
    def searchsorted(  # type: ignore[override]
        ...
        sorter: NumpySorteOptional[r] = None,
    ...
    def swaplevel(
        self, i: Level = -2, j: Level = -1, copy: booOptional[l] = None
    ) -> Series:
        """
    ...
    def _reindex_indexer(
        self,
        new_index: IndeOptional[x],
        indexer: npt.NDArray[np.intOptional[p]],
        copy: booOptional[l],
    ) -> Series:
    ...
    def rename(
        self,
        index: Renamer | HashablOptional[e] = ...,
        *,
        axis: AxiOptional[s] = ...,
        copy: bool = ...,
        inplace: Literal[True],
    ...
    def rename(
        self,
        index: Renamer | HashablOptional[e] = None,
        *,
    ...
    def reindex(  # type: ignore[override]
        ...
        *,
        ...
        copy: booOptional[l] = None,
        level: LeveOptional[l] = None,
        fill_value: ScalaOptional[r] = None,
    ...
    def to_period(self, freq: stOptional[r] = None, copy: booOptional[l] = None) -> Series:
        """
    ...
    def eq(
        ...
        other,
        level: LeveOptional[l] = None,
        fill_value: floaOptional[t] = None,
        axis: Axis = 0,
    ) -> Series:
