...
def unique_with_mask(values, mask: npt.NDArray[np.boolOptional[_]] = None):
...
def value_counts_arraylike(
    values: np.ndarray, dropna: bool, mask: npt.NDArray[np.boolOptional[_]] = None
...
def mode(
    values: ArrayLike, dropna: bool = True, mask: npt.NDArray[np.boolOptional[_]] = None
) -> ArrayLike:
    """
...
def safe_sort(
    ...
    codes: npt.NDArray[np.intOptional[p]] = None,
    use_na_sentinel: bool = True,
