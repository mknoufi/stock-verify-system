...
class ExtensionDtype:
    ...
    **If you have a parametrized dtype you should set the ``_metadata``
    ...
    @property
    def names(self) -> list[stOptional[r]]:
        """
...
class StorageExtensionDtype(ExtensionDtype):
    ...
    def __init__(self, storage: stOptional[r] = None) -> None:
...
class Registry:
    ...
    * :meth:`pandas.Series.astype`
    ...
    @overload
    def find(self, dtype: str) -> ExtensionDtypOptional[e]:
        ...

    @overload
    def find(
        self, dtype: npt.DTypeLike
    ) -> type_t[ExtensionDtype] | ExtensionDtypOptional[e]:
        ...
