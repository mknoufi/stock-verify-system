...
def maybe_box_datetimelike(value: Scalar, dtype: DtypOptional[e] = None) -> Scalar:
    """
...
def maybe_box_native(value: ScalaOptional[r] | NAType) -> ScalaOptional[r] | NAType:
    """
...
def _maybe_cast_to_extension_array(
    cls: type[ExtensionArray], obj: ArrayLike, dtype: ExtensionDtypOptional[e] = None
) -> ArrayLike:
    """
...
def construct_1d_arraylike_from_scalar(
    value: Scalar, length: int, dtype: DtypeObOptional[j]
) -> ArrayLike:
    """
