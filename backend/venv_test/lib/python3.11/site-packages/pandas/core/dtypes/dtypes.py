...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    @classmethod
    def _from_fastpath(
        cls, categories=None, ordered: booOptional[l] = None
    ) -> CategoricalDtype:
    ...
    def _from_categorical_dtype(
        cls, dtype: CategoricalDtype, categories=None, ordered: OrdereOptional[d] = None
    ) -> CategoricalDtype:
...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    _closed: IntervalClosedTypOptional[e]

    def __init__(self, subtype=None, closed: IntervalClosedTypOptional[e] = None) -> None:
...
class NumpyEADtype(ExtensionDtype):
    ...
    def __init__(self, dtype: npt.DTypeLike | NumpyEADtypOptional[e]) -> None:
