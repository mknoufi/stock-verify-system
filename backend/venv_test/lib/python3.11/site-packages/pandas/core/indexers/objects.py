...
class BaseIndexer:
    ...
    def __init__(
        self, index_array: np.ndarraOptional[y] = None, window_size: int = 0, **kwargs
    ) -> None:
...
class VariableOffsetWindowIndexer(BaseIndexer):
    ...
    def __init__(
        self,
        index_array: np.ndarraOptional[y] = None,
        window_size: int = 0,
        index: DatetimeIndeOptional[x] = None,
        offset: BaseOffseOptional[t] = None,
        **kwargs,
    ) -> None:
...
class GroupbyIndexer(BaseIndexer):
    ...
    def __init__(
        ...
        groupby_indices: dicOptional[t] = None,
        window_indexer: type[BaseIndexer] = BaseIndexer,
        indexer_kwargs: dicOptional[t] = None,
        **kwargs,
    ) -> None:
        """
        Parameters
    ...
    def get_window_bounds(
        ...
        for key, indices in self.groupby_indices.items():
            index_array: np.ndarraOptional[y]
