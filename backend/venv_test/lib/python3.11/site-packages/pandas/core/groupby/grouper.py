...
class Grouper:
    ...
    sort: bool
    dropna: bool
    _gpr_index: IndeOptional[x]
    _grouper: IndeOptional[x]
    ...
    def __init__(
        ...
        self._indexer_deprecated: npt.NDArray[np.intOptional[p]] = None
        self._obj_deprecated = None
        self._gpr_index = None
        self.binner = None
        self._grouper = None
        self._indexer: npt.NDArray[np.intOptional[p]] = None
    ...
    def _set_grouper(
        ...
        # possibly sort
        indexer: npt.NDArray[np.intOptional[p]] = None
...
class Grouping:
    ...
    _codes: npt.NDArray[np.signedintegeOptional[r]] = None
    _all_grouper: CategoricaOptional[l]
    _orig_cats: IndeOptional[x]
    _index: Index
    ...
    def __init__(
        ...
        index: Index,
        grouper=None,
        obj: NDFramOptional[e] = None,
        level=None,
        sort: bool = True,
        observed: bool = False,
        in_axis: bool = False,
        dropna: bool = True,
        uniques: ArrayLikOptional[e] = None,
    ) -> None:
        self.level = level
