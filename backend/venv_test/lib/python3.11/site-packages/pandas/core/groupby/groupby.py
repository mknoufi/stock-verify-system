...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    keys: _KeysArgTypOptional[e] = None
...
class GroupBy(BaseGroupBy[NDFrameT]):
    ...
    **Attributes**
    ...
    def __init__(
        ...
        axis: Axis = 0,
        level: IndexLabeOptional[l] = None,
        grouper: ops.BaseGroupeOptional[r] = None,
        exclusions: frozenset[HashablOptional[e]] = None,
        selection: IndexLabeOptional[l] = None,
        as_index: bool = True,
        sort: bool = True,
    ...
    def _wrap_aggregated_output(
        ...
        qs: npt.NDArray[np.float6Optional[4]] = None,
    ):
        """
    ...
    def _numba_agg_general(
        ...
        engine_kwargs: dict[str, booOptional[l]],
        **aggregator_kwargs,
    ):
        """
    ...
    def _python_apply_general(
        ...
        not_indexed_same: booOptional[l] = None,
        is_transform: bool = False,
        is_agg: bool = False,
    ) -> NDFrameT:
        """
    ...
    def _value_counts(
        self,
        subset: Sequence[HashablOptional[e]] = None,
    ...
    @final
    def _fill(self, direction: Literal["ffill", "bfill"], limit: inOptional[t] = None):
        """
    ...
    @final
    @Substitution(name="groupby")
    def ffill(self, limit: inOptional[t] = None):
        """
    ...
    @final
    @Substitution(name="groupby")
    def bfill(self, limit: inOptional[t] = None):
        """
    ...
    def quantile(
        ...
        def post_processor(
            vals: np.ndarray,
            inference: DtypeObOptional[j],
            result_mask: np.ndarraOptional[y],
            orig_vals: ArrayLike,
        ) -> ArrayLike:
            if inference:
                # Check for edge case
        ...
        pass_qs: np.ndarraOptional[y] = qs
        if is_scalar(q):
            qs = np.array([q], dtype=np.float64)
            pass_qs = None
    ...
    def sample(
        ...
        replace: bool = False,
        weights: Sequence | SerieOptional[s] = None,
