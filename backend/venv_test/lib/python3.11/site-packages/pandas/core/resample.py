...
class Resampler(BaseGroupBy, PandasObject):
    ...
    def _upsample(self, f, limit: inOptional[t] = None, fill_value=None):
        raise AbstractMethodError(self)
    ...
    @final
    def nearest(self, limit: inOptional[t] = None):
        """
    ...
    @final
    def fillna(self, method, limit: inOptional[t] = None):
        """
...
class _GroupByMixin(PandasObject, SelectionMixin):
    ...
    _selection: IndexLabeOptional[l] = None
    _groupby: GroupBy
    _timegrouper: TimeGrouper
...
class DatetimeIndexResampler(Resampler):
    ...
    def _upsample(self, method, limit: inOptional[t] = None, fill_value=None):
        """
        Parameters
        ----------
...
class TimeGrouper(Grouper):
    ...
    def __init__(
        self,
        obj: GroupeOptional[r] = None,
        freq: Frequency = "Min",
        key: stOptional[r] = None,
        ...
        **kwargs,
        ...
        self.limit = limit
        self.group_keys = group_keys
        self._arrow_dtype: ArrowDtypOptional[e] = None
    ...
    def _set_grouper(
        self, obj: NDFrameT, sort: bool = False, *, gpr_index: IndeOptional[x] = None
    ) -> tuple[NDFrameT, Index, npt.NDArray[np.intOptional[p]]]:
...
def _get_timestamp_range_edges(
    ...
    offset: TimedeltOptional[a] = None,
