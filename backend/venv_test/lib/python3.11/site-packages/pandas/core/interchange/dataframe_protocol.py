...
class ColumnBuffers(TypedDict):
    ...
    validity: tuple[Buffer, AnOptional[y]]

    # first element is a buffer containing the offset values for
    # variable-size binary data (e.g., variable-length strings);
    # second element is the offsets buffer's associated dtype.
    # None if the data buffer does not have an associated offsets buffer
    offsets: tuple[Buffer, AnOptional[y]]
...
class Buffer(ABC):
    ...
    @abstractmethod
    def __dlpack_device__(self) -> tuple[DlpackDeviceType, inOptional[t]]:
        """
...
class Column(ABC):
    ...
    @property
    @abstractmethod
    def null_count(self) -> inOptional[t]:
        """
    ...
    @abstractmethod
    def get_chunks(self, n_chunks: inOptional[t] = None) -> Iterable[Column]:
        """
...
class DataFrame(ABC):
    ...
    @abstractmethod
    def num_rows(self) -> inOptional[t]:
    ...
    @abstractmethod
    def get_chunks(self, n_chunks: inOptional[t] = None) -> Iterable[DataFrame]:
        """
        Return an iterator yielding the chunks.
