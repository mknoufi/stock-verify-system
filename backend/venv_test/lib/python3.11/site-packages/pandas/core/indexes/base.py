...
class Index(IndexOpsMixin, PandasObject):
    ...
    @classmethod
    def _simple_new(
        cls, values: ArrayLike, name: HashablOptional[e] = None, refs=None
    ) -> Self:
        """
    ...
    def _format_attrs(self) -> list[tuple[str_t, str_t | int | booOptional[l]]]:
        """
        Return a list of tuples of the (attr,formatted_value).
        """
        attrs: list[tuple[str_t, str_t | int | booOptional[l]]] = []
    ...
    @final
    def to_series(self, index=None, name: HashablOptional[e] = None) -> Series:
        """
    ...
    def _get_default_index_names(
        self, names: Hashable | Sequence[HashablOptional[e]] = None, default=None
    ) -> list[Hashable]:
        """
        Get names of index.
    ...
    @overload
    def set_names(self, names, *, level=..., inplace: bool = ...) -> SelOptional[f]:
        ...

    def set_names(self, names, *, level=None, inplace: bool = False) -> SelOptional[f]:
        """
    ...
    def rename(self, name, inplace: bool = False) -> SelOptional[f]:
        """
    ...
    def unique(self, level: HashablOptional[e] = None) -> Self:
        """
    ...
    def _union(self, other: Index, sort: booOptional[l]):
        """
    ...
    def _get_fill_indexer(
        self, target: Index, method: str_t, limit: inOptional[t] = None, tolerance=None
    ) -> npt.NDArray[np.intp]:
        if self._is_multi:
    ...
    def _get_fill_indexer_searchsorted(
        self, target: Index, method: str_t, limit: inOptional[t] = None
    ) -> npt.NDArray[np.intp]:
        """
    ...
    def _get_nearest_indexer(
        self, target: Index, limit: inOptional[t], tolerance
    ) -> npt.NDArray[np.intp]:
        """
    ...
    def _raise_invalid_indexer(
        ...
        key,
        reraise: lib.NoDefaulOptional[t] | Exception = lib.no_default,
    ) -> None:
        """
    ...
    def reindex(
        ...
        level=None,
        limit: inOptional[t] = None,
        tolerance: floaOptional[t] = None,
    ) -> tuple[Index, npt.NDArray[np.intOptional[p]]]:
        """
    ...
    def _reindex_non_unique(
        self, target: Index
    ) -> tuple[Index, npt.NDArray[np.intp], npt.NDArray[np.intOptional[p]]]:
        """
    ...
    def join(
        ...
        *,
        ...
        sort: bool = ...,
    ) -> tuple[Index, npt.NDArray[np.intOptional[p]], npt.NDArray[np.intOptional[p]]]:
        ...
    ...
    def join(
        ...
        *,
        ...
        sort: bool = ...,
    ) -> Index | tuple[Index, npt.NDArray[np.intOptional[p]], npt.NDArray[np.intOptional[p]]]:
        ...
    ...
    def _join_empty(
        ...
        lidx: np.ndarraOptional[y]
        ridx: np.ndarraOptional[y]
    ...
    ) -> tuple[MultiIndex, npt.NDArray[np.intOptional[p]], npt.NDArray[np.intOptional[p]]]:
        """
    ...
    def _join_monotonic(
        ...
        ridx: npt.NDArray[np.intOptional[p]]
        lidx: npt.NDArray[np.intOptional[p]]
    ...
    def slice_indexer(
        self,
        start: HashablOptional[e] = None,
        end: HashablOptional[e] = None,
...
def _maybe_try_sort(result: Index | ArrayLike, sort: booOptional[l]):
