...
class RangeIndex(Index):
    ...
    @classmethod
    def from_range(cls, data: range, name=None, dtype: DtypOptional[e] = None) -> Self:
        """
    ...
    def _simple_new(  # type: ignore[override]
        cls, values: range, name: HashablOptional[e] = None
    ) -> Self:
    ...
    @classmethod
    def _validate_dtype(cls, dtype: DtypOptional[e]) -> None:
        if dtype is None:
            return
    ...
    @doc(Index.copy)
    def copy(self, name: HashablOptional[e] = None, deep: bool = False) -> Self:
    ...
    def symmetric_difference(
        self, other, result_name: HashablOptional[e] = None, sort=None
    ):
