...
class DatetimeIndexOpsMixin(NDArrayBackedExtensionIndex, ABC):
    ...
    def mean(self, *, skipna: bool = True, axis: inOptional[t] = 0):
        return self._data.mean(skipna=skipna, axis=axis)

    @property
    def freq(self) -> BaseOffseOptional[t]:
    ...
    def _format_with_header(
        self, *, header: list[str], na_rep: str, date_format: stOptional[r] = None
    ) -> list[str]:
