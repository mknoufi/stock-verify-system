...
class MultiIndex(Index):
    ...
    _typ = "multiindex"
    _names: list[HashablOptional[e]] = []
    _levels = FrozenList()
    _codes = FrozenList()
    _comparables = ["names"]

    sortorder: inOptional[t]
    ...
    def _verify_integrity(
        self,
        codes: lisOptional[t] = None,
        levels: lisOptional[t] = None,
        levels_to_verify: list[int] | rangOptional[e] = None,
    ):
        """
        Parameters
        ----------
    ...
    def from_tuples(
        ...
        sortorder: inOptional[t] = None,
        names: Sequence[Hashable] | HashablOptional[e] = None,
    ) -> MultiIndex:
        """
    ...
    def _format_multi(
        ...
        *,
        include_names: bool,
        sparsify: booOptional[l] | lib.NoDefault,
        formatter: CallablOptional[e] = None,
    ) -> list:
        if len(self) == 0:
            return []
    ...
    def drop(  # type: ignore[override]
        self,
        codes,
        level: Index | np.ndarray | Iterable[HashablOptional[e]] = None,
    ...
    def _get_level_indexer(
        self, key, level: int = 0, indexer: npt.NDArray[np.boolOptional[_]] = None
    ):
    ...
    def get_locs(self, seq) -> npt.NDArray[np.intp]:
        ...
        indexer: npt.NDArray[np.boolOptional[_]] = None

        for i, k in enumerate(seq):
            lvl_indexer: npt.NDArray[np.bool_] | slicOptional[e] = None
