...
def get_center_of_mass(
    comass: floaOptional[t],
    span: floaOptional[t],
    halflife: floaOptional[t],
    alpha: floaOptional[t],
) -> float:
...
def _calculate_deltas(
    ...
    halflife: float | TimedeltaConvertibleTypeOptional[s],
...
class ExponentialMovingWindow(BaseWindow):
    ...
    **times**
    ...
    def __init__(
        ...
        axis: Axis = 0,
        times: np.ndarray | NDFramOptional[e] = None,
        method: str = "single",
        *,
        selection=None,
    ) -> None:
