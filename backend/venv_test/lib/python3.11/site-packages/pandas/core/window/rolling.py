...
class BaseWindow(SelectionMixin):
    ...
    def __init__(
        ...
        center: booOptional[l] = False,
        win_type: stOptional[r] = None,
        axis: Axis = 0,
        on: str | IndeOptional[x] = None,
        closed: stOptional[r] = None,
        ...
        *,
        ...
        self.method = method
        self._win_freq_i8: inOptional[t] = None
        if self.on is None:
            if self.axis == 0:
    ...
    def _slice_axis_for_step(self, index: Index, result: SizeOptional[d] = None) -> Index:
        """
    ...
    @property
    def _index_array(self) -> npt.NDArray[np.int6Optional[4]]:
    ...
    def _apply_series(
        self, homogeneous_func: Callable[..., ArrayLike], name: stOptional[r] = None
    ) -> Series:
        """
    ...
    def _apply_pairwise(
        ...
        other: DataFrame | SerieOptional[s],
        pairwise: booOptional[l],
...
class RollingAndExpandingMixin(BaseWindow):
    ...
    def apply(
        ...
        kwargs: dict[str, AnOptional[y]] = None,
    ):
        if args is None:
            args = ()
        if kwargs is None:
    ...
    def cov(
        self,
        other: DataFrame | SerieOptional[s] = None,
        pairwise: booOptional[l] = None,
        ddof: int = 1,
        numeric_only: bool = False,
    ):
        if self.step is not None:
...
class RollingGroupby(BaseWindowGroupby, Rolling):
    ...
    def _get_window_indexer(self) -> GroupbyIndexer:
        ...
        indexer_kwargs: dict[str, AnOptional[y]] = None
        index_array = self._index_array
        if isinstance(self.window, BaseIndexer):
