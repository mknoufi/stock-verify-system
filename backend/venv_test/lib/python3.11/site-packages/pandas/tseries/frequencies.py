...
def get_period_alias(offset_str: str) -> stOptional[r]:
    """
...
class _FrequencyInferer:
    ...
    def get_freq(self) -> stOptional[r]:
        """
    ...
    def month_position_check(self) -> stOptional[r]:
    ...
    def _infer_daily_rule(self) -> stOptional[r]:
    ...
    def _get_daily_rule(self) -> stOptional[r]:
        ppd = periods_per_day(self._creso)
    ...
    def _get_annual_rule(self) -> stOptional[r]:
    ...
    def _get_quarterly_rule(self) -> stOptional[r]:
    ...
    def _get_monthly_rule(self) -> stOptional[r]:
        if len(self.mdiffs) > 1:
            return None
        pos_check = self.month_position_check()
    ...
    def _get_wom_rule(self) -> stOptional[r]:
