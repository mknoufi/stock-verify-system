...
class QueryParams(typing.Mapping[str, str]):
    ...
    def __init__(self, *args: QueryParamTypeOptional[s], **kwargs: typing.Any) -> None:
    ...
    def merge(self, params: QueryParamTypeOptional[s] = None) -> QueryParams:
        """
    ...
    def update(self, params: QueryParamTypeOptional[s] = None) -> None:
        raise RuntimeError(
