...
class Timeout:
    ...
    **Usage**:
    ...
    def as_dict(self) -> dict[str, floaOptional[t]]:
        return {
...
class Limits:
    ...
    * **keepalive_expiry** - Time limit on idle keep-alive connections in seconds.
    ...
    def __init__(
        self,
        *,
        max_connections: inOptional[t] = None,
        max_keepalive_connections: inOptional[t] = None,
        keepalive_expiry: floaOptional[t] = 5.0,
    ) -> None:
...
class Proxy:
    def __init__(
        ...
        *,
        ...
        auth: tuple[str, stOptional[r]] = None,
    ...
    @property
    def raw_auth(self) -> tuple[bytes, byteOptional[s]]:
