...
class ParseResult(typing.NamedTuple):
    ...
    def copy_with(self, **kwargs: stOptional[r]) -> ParseResult:
        if not kwargs:
            return self
...
def urlparse(url: str = "", **kwargs: stOptional[r]) -> ParseResult:
    ...
    parsed_port: inOptional[t] = normalize_port(port, scheme)
    ...
    parsed_query: stOptional[r] = None if query is None else quote(query, safe=QUERY_SAFE)
    parsed_frag: stOptional[r] = None if frag is None else quote(frag, safe=FRAG_SAFE)
...
def normalize_port(port: str | inOptional[t], scheme: str) -> inOptional[t]:
