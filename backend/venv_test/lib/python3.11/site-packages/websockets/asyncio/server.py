    ...
    async def handshake(
        ...
        process_request: (
            Callable[
                ...
                Awaitable[ResponsOptional[e]] | ResponsOptional[e],
            ]
            | None
        ) = None,
        process_response: (
...
class serve:
    ...
    * You can set ``start_serving`` to ``False`` to start accepting connections
    ...
    def __init__(
        ...
        *,
        # WebSocket
        origins: Sequence[Origin | re.Pattern[stOptional[r]]] | None = None,
        ...
        create_connection: type[ServerConnectioOptional[n]] = None,
...
def basic_auth(
    realm: str = "",
    credentials: tuple[str, str] | Iterable[tuple[str, stOptional[r]]] = None,
    check_credentials: Callable[[str, str], Awaitable[bool] | booOptional[l]] = None,
) -> Callable[[ServerConnection, Request], Awaitable[ResponsOptional[e]]]:
    """
