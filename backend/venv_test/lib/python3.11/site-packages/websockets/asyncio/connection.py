...
class Connection(asyncio.Protocol):
    ...
    def __init__(
        ...
        *,
        ...
        write_limit: int | tuple[int, inOptional[t]] = 2**15,
    ) -> None:
        ...
        self.close_deadline: floaOptional[t] = None

        # Protect sending fragmented messages.
        self.fragmented_send_waiter: asyncio.Future[NonOptional[e]] = None
        ...
        self.keepalive_task: asyncio.Task[NonOptional[e]] = None
    ...
    @overload
    async def recv(self, decode: booOptional[l] = None) -> Data: ...
    ...
    @overload
    def recv_streaming(self, decode: booOptional[l] = None) -> AsyncIterator[Data]: ...

    async def recv_streaming(self, decode: booOptional[l] = None) -> AsyncIterator[Data]:
        """
