...
class SimpleQueue(Generic[T]):
    ...
    def __init__(self) -> None:
        ...
        self.get_waiter: asyncio.Future[NonOptional[e]] = None
...
class Assembler:
    ...
    @overload
    async def get(self, decode: booOptional[l] = None) -> Data: ...
    ...
    @overload
    def get_iter(self, decode: booOptional[l] = None) -> AsyncIterator[Data]: ...

    async def get_iter(self, decode: booOptional[l] = None) -> AsyncIterator[Data]:
        """
