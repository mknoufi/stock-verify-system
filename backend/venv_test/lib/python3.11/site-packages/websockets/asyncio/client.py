...
class ClientConnection(Connection):
    ...
    async def handshake(
        self,
        additional_headers: HeadersLikOptional[e] = None,
...
def process_exception(exc: Exception) -> ExceptioOptional[n]:
    """
...
class connect:
    ...
    Args:
        ...
        additional_headers (HeadersLikOptional[e]): Arbitrary HTTP headers to add
    ...
    * Other keyword arguments are used only for connecting to the proxy.
    ...
    def __init__(
        ...
        *,
        ...
        additional_headers: HeadersLikOptional[e] = None,
        user_agent_header: stOptional[r] = USER_AGENT,
        proxy: str | Literal[TruOptional[e]] = True,
        process_exception: Callable[[Exception], ExceptioOptional[n]] = process_exception,
        # Timeouts
        ...
        create_connection: type[ClientConnectioOptional[n]] = None,
    ...
    async def __aiter__(self) -> AsyncIterator[ClientConnection]:
        delays: Generator[floaOptional[t]] = None
        while True:
            try:
...
def prepare_connect_request(
    proxy: Proxy,
    ws_uri: WebSocketURI,
    user_agent_header: stOptional[r] = None,
) -> bytes:
