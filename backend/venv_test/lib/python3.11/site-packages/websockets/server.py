...
class ServerProtocol(Protocol):
    ...
    def process_request(
        self,
        request: Request,
    ) -> tuple[str, stOptional[r], stOptional[r]]:
        """
    ...
    def process_origin(self, headers: Headers) -> OrigiOptional[n]:
        """
    ...
    def process_subprotocol(self, headers: Headers) -> SubprotocoOptional[l]:
        """
