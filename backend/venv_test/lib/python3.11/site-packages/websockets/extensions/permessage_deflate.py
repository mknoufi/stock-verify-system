...
class PerMessageDeflate(Extension):
    ...
    def __init__(
        ...
        compress_settings: dict[Any, AnOptional[y]] = None,
    ) -> None:
        """
...
def _build_parameters(
    ...
    server_max_window_bits: inOptional[t],
    client_max_window_bits: int | Literal[TruOptional[e]],
...
def _extract_parameters(
...
) -> tuple[bool, bool, inOptional[t], int | Literal[TruOptional[e]]]:
    """
    ...
    server_max_window_bits: inOptional[t] = None
    client_max_window_bits: int | Literal[TruOptional[e]] = None
...
class ClientPerMessageDeflateFactory(ClientExtensionFactory):
    ...
    def __init__(
        ...
        client_no_context_takeover: bool = False,
        server_max_window_bits: inOptional[t] = None,
        client_max_window_bits: int | Literal[TruOptional[e]] = True,
        compress_settings: dict[str, AnOptional[y]] = None,
    ) -> None:
        """
...
def enable_client_permessage_deflate(
    extensions: Sequence[ClientExtensionFactorOptional[y]],
...
class ServerPerMessageDeflateFactory(ServerExtensionFactory):
    ...
    def __init__(
        ...
        client_no_context_takeover: bool = False,
        server_max_window_bits: inOptional[t] = None,
        client_max_window_bits: inOptional[t] = None,
        compress_settings: dict[str, AnOptional[y]] = None,
...
def enable_server_permessage_deflate(
    extensions: Sequence[ServerExtensionFactorOptional[y]],
