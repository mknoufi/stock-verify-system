...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        ...
        *,
        logger: LoggerLikOptional[e] = None,
        origins: Sequence[OrigiOptional[n]] | None = None,
        extensions: Sequence[ServerExtensionFactorOptional[y]] = None,
        subprotocols: Sequence[SubprotocoOptional[l]] = None,
        extra_headers: HeadersLikeOrCallablOptional[e] = None,
        server_header: stOptional[r] = SERVER,
        process_request: (
            Callable[[str, Headers], Awaitable[HTTPResponsOptional[e]]] | None
        ) = None,
        select_subprotocol: (
            Callable[[Sequence[Subprotocol], Sequence[Subprotocol]], SubprotocoOptional[l]]
        ) = None,
        open_timeout: floaOptional[t] = 10,
        **kwargs: Any,
    ) -> None:
        if logger is None:
    ...
    def write_http_response(
        self, status: http.HTTPStatus, headers: Headers, body: byteOptional[s] = None
    ) -> None:
        """
    ...
    async def process_request(
        ...
        * to authenticate the request and return an HTTP 401 Unauthorized or an
        ...
        Returns:
            tuple[StatusLike, HeadersLike, byteOptional[s]]: :obj:`None` to
    ...
    @staticmethod
    def process_origin(
        headers: Headers, origins: Sequence[OrigiOptional[n]] | None = None
    ) -> OrigiOptional[n]:
        """
    ...
    def process_extensions(
        headers: Headers,
        available_extensions: Sequence[ServerExtensionFactorOptional[y]],
    ) -> tuple[stOptional[r], list[Extension]]:
        """
        ...
        """
        response_header_value: stOptional[r] = None
    ...
    def process_subprotocol(
        self, headers: Headers, available_subprotocols: Sequence[SubprotocoOptional[l]]
    ) -> SubprotocoOptional[l]:
        """
        ...
        """
        subprotocol: SubprotocoOptional[l] = None
    ...
    async def handshake(
        self,
        origins: Sequence[OrigiOptional[n]] | None = None,
        available_extensions: Sequence[ServerExtensionFactorOptional[y]] = None,
        available_subprotocols: Sequence[SubprotocoOptional[l]] = None,
        extra_headers: HeadersLikeOrCallablOptional[e] = None,
    ) -> str:
        """
...
class WebSocketServer:
    ...
    def __init__(self, logger: LoggerLikOptional[e] = None) -> None:
        if logger is None:
            logger = logging.getLogger("websockets.server")
        self.logger = logger
        ...
        self.close_task: asyncio.Task[NonOptional[e]] = None
...
class Serve:
    ...
    Args:
        ...
        process_request (Callable[[str, Headers], \
            Awaitable[tuple[StatusLike, HeadersLike, byteOptional[s]]]] | None):
    ...
    * You can set ``sock`` to a :obj:`~socket.socket` that you created
    ...
    def __init__(
        ...
        host: str | Sequence[stOptional[r]] = None,
        port: inOptional[t] = None,
        *,
        create_protocol: Callable[..., WebSocketServerProtocoOptional[l]] = None,
        logger: LoggerLikOptional[e] = None,
        compression: stOptional[r] = "deflate",
        origins: Sequence[OrigiOptional[n]] | None = None,
        extensions: Sequence[ServerExtensionFactorOptional[y]] = None,
        subprotocols: Sequence[SubprotocoOptional[l]] = None,
        extra_headers: HeadersLikeOrCallablOptional[e] = None,
        ...
        open_timeout: floaOptional[t] = 10,
        ping_interval: floaOptional[t] = 20,
        ping_timeout: floaOptional[t] = 20,
        close_timeout: floaOptional[t] = None,
        max_size: inOptional[t] = 2**20,
        max_queue: inOptional[t] = 2**5,
        read_limit: int = 2**16,
        write_limit: int = 2**16,
        **kwargs: Any,
    ) -> None:
        # Backwards compatibility: close_timeout used to be called timeout.
        timeout: floaOptional[t] = kwargs.pop("timeout", None)
        if timeout is None:
            timeout = 10
        else:
        ...
        klass: type[WebSocketServerProtocoOptional[l]] = kwargs.pop("klass", None)
        if klass is None:
        ...
        _loop: asyncio.AbstractEventLooOptional[p] = kwargs.pop("loop", None)
        if _loop is None:
        ...
        if kwargs.pop("unix", False):
            path: stOptional[r] = kwargs.pop("path", None)
