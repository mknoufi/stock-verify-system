...
class WebSocketClientProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        origin: OrigiOptional[n] = None,
        extensions: Sequence[ClientExtensionFactorOptional[y]] = None,
        subprotocols: Sequence[SubprotocoOptional[l]] = None,
        extra_headers: HeadersLikOptional[e] = None,
        user_agent_header: stOptional[r] = USER_AGENT,
        **kwargs: Any,
    ) -> None:
        if logger is None:
    ...
    def process_extensions(
        headers: Headers,
        available_extensions: Sequence[ClientExtensionFactorOptional[y]],
    ) -> list[Extension]:
        """
    ...
    def process_subprotocol(
        headers: Headers, available_subprotocols: Sequence[SubprotocoOptional[l]]
    ...
    async def handshake(
        ...
        wsuri: WebSocketURI,
        origin: OrigiOptional[n] = None,
        available_extensions: Sequence[ClientExtensionFactorOptional[y]] = None,
...
class Connect:
    ...
    * You can set ``host`` and ``port`` to connect to a different host and
    ...
    def __init__(
        ...
        uri: str,
        *,
        create_protocol: Callable[..., WebSocketClientProtocoOptional[l]] = None,
        logger: LoggerLikOptional[e] = None,
        ...
        **kwargs: Any,
        ...
        klass: type[WebSocketClientProtocoOptional[l]] = kwargs.pop("klass", None)
        if klass is None:
