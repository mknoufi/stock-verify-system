    ...
    * on the server side, when the connection handler terminates.
    ...
    def __init__(
        ...
        *,
        ...
        host: stOptional[r] = None,
        port: inOptional[t] = None,
        secure: booOptional[l] = None,
        legacy_recv: bool = False,
        loop: asyncio.AbstractEventLooOptional[p] = None,
        timeout: floaOptional[t] = None,
    ) -> None:
        ...
        self._paused = False
        self._drain_waiter: asyncio.Future[NonOptional[e]] = None
        ...
        self.subprotocol: SubprotocoOptional[l] = None
        """Subprotocol, if one was negotiated."""

        # Close code and reason, set when a close frame is sent or received.
        self.close_rcvd: ClosOptional[e] = None
        self.close_sent: ClosOptional[e] = None
        self.close_rcvd_then_sent: booOptional[l] = None
        ...
        self._pop_message_waiter: asyncio.Future[NonOptional[e]] = None
        self._put_message_waiter: asyncio.Future[NonOptional[e]] = None

        # Protect sending fragmented messages.
        self._fragmented_message_waiter: asyncio.Future[NonOptional[e]] = None
        ...
        self.transfer_data_exc: BaseExceptioOptional[n] = None
    ...
    @property
    def close_code(self) -> inOptional[t]:
        """
    ...
    @property
    def close_reason(self) -> stOptional[r]:
        """
    ...
    async def ping(self, data: DatOptional[a] = None) -> Awaitable[float]:
        """
        Send a Ping_.
    ...
    async def read_message(self) -> DatOptional[a]:
        """
    ...
    async def read_data_frame(self, max_size: inOptional[t]) -> FramOptional[e]:
        """
    ...
    async def read_frame(self, max_size: inOptional[t]) -> Frame:
        """
    ...
    async def write_close_frame(self, close: Close, data: byteOptional[s] = None) -> None:
        """
