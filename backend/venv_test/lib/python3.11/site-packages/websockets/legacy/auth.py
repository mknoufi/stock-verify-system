...
class BasicAuthWebSocketServerProtocol(WebSocketServerProtocol):
    ...
    def __init__(
        self,
        *args: Any,
        realm: stOptional[r] = None,
        check_credentials: Callable[[str, str], Awaitable[booOptional[l]]] = None,
        **kwargs: Any,
    ) -> None:
...
def basic_auth_protocol_factory(
    realm: stOptional[r] = None,
    credentials: Credentials | Iterable[CredentialOptional[s]] = None,
    check_credentials: Callable[[str, str], Awaitable[booOptional[l]]] = None,
    create_protocol: Callable[..., BasicAuthWebSocketServerProtocoOptional[l]] = None,
