...
class Assembler:
    ...
    def __init__(
        self,
        high: inOptional[t] = None,
        low: inOptional[t] = None,
        ...
        self.frames: queue.SimpleQueue[FramOptional[e]] = queue.SimpleQueue()
    ...
    def get_next_frame(self, timeout: floaOptional[t] = None) -> Frame:
    ...
    @overload
    def get(self, timeout: floaOptional[t], decode: Literal[True]) -> str: ...

    @overload
    def get(self, timeout: floaOptional[t], decode: Literal[False]) -> bytes: ...

    @overload
    def get(self, timeout: floaOptional[t] = None, *, decode: Literal[True]) -> str: ...

    @overload
    def get(self, timeout: floaOptional[t] = None, *, decode: Literal[False]) -> bytes: ...

    @overload
    def get(self, timeout: floaOptional[t] = None, decode: booOptional[l] = None) -> Data: ...
    ...
    @overload
    def get_iter(self, decode: booOptional[l] = None) -> Iterator[Data]: ...
