...
def serve(
    ...
    *,
    # TCP/TLS
    sock: socket.sockeOptional[t] = None,
    ssl: ssl_module.SSLContexOptional[t] = None,
    # WebSocket
...
def basic_auth(
    ...
    check_credentials: Callable[[str, str], booOptional[l]] = None,
) -> Callable[[ServerConnection, Request], ResponsOptional[e]]:
    """
