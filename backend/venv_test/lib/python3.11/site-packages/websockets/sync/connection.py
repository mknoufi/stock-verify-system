...
class Connection:
    ...
    def __init__(
        ...
        *,
        ...
        close_timeout: floaOptional[t] = 10,
        max_queue: inOptional[t] | tuple[inOptional[t], inOptional[t]] = 16,
    ) -> None:
        self.socket = socket
        ...
        self.request: RequesOptional[t] = None
        """Opening handshake request."""
        self.response: ResponsOptional[e] = None
        ...
        self.close_deadline: DeadlinOptional[e] = None
        ...
        self.keepalive_thread: threading.ThreaOptional[d] = None
        ...
        self.recv_exc: BaseExceptioOptional[n] = None
    ...
    @property
    def subprotocol(self) -> SubprotocoOptional[l]:
        """
    ...
    @overload
    def recv(self, timeout: floaOptional[t], decode: Literal[True]) -> str: ...

    @overload
    def recv(self, timeout: floaOptional[t], decode: Literal[False]) -> bytes: ...

    @overload
    def recv(self, timeout: floaOptional[t] = None, *, decode: Literal[True]) -> str: ...

    @overload
    def recv(
        self, timeout: floaOptional[t] = None, *, decode: Literal[False]
    ) -> bytes: ...

    @overload
    def recv(
        self, timeout: floaOptional[t] = None, decode: booOptional[l] = None
    ) -> Data: ...

    def recv(self, timeout: floaOptional[t] = None, decode: booOptional[l] = None) -> Data:
        """
    ...
    @overload
    def recv_streaming(self, decode: booOptional[l] = None) -> Iterator[Data]: ...
    ...
    def send_context(
        ...
        *,
        ...
        original_exc: BaseExceptioOptional[n] = None
    ...
    def set_recv_exc(self, exc: BaseExceptioOptional[n]) -> None:
        """
