...
class ConnectionClosed(WebSocketException):
    ...
    def __init__(
        self,
        rcvd: frames.ClosOptional[e],
        sent: frames.ClosOptional[e],
        rcvd_then_sent: booOptional[l] = None,
    ) -> None:
        self.rcvd = rcvd
        self.sent = sent
...
class InvalidHeader(InvalidHandshake):
    ...
    def __init__(self, name: str, value: stOptional[r] = None) -> None:
        self.name = name
        self.value = value
...
class InvalidOrigin(InvalidHeader):
    ...
    def __init__(self, origin: stOptional[r]) -> None:
...
class InvalidParameterValue(NegotiationError):
    ...
    def __init__(self, name: str, value: stOptional[r]) -> None:
        self.name = name
        self.value = value
...
class PayloadTooBig(WebSocketException):
    ...
    def __init__(
        self,
        size_or_message: inOptional[t] | str,
        max_size: inOptional[t] = None,
        cur_size: inOptional[t] = None,
    ) -> None:
        if isinstance(size_or_message, str):
            ...
            self.message: stOptional[r] = size_or_message
        else:
            self.message = None
            self.size: inOptional[t] = size_or_message
    ...
    def set_current_size(self, cur_size: inOptional[t]) -> None:
