...
) -> list[ConversionSpecifieOptional[r]]:
...
class StringFormatterChecker:
    ...
    def check_specs_in_format_call(
        ...
        for spec, repl in zip(specs, replacements):
            ...
            if not spec.conv_type:
                expected_type: TypOptional[e] = AnyType(TypeOfAny.special_form)
            else:
    ...
    def get_expr_by_position(self, pos: int, call: CallExpr) -> ExpressioOptional[n]:
    ...
    def get_expr_by_name(self, key: str, call: CallExpr) -> ExpressioOptional[n]:
    ...
    def accept(self, expr: Expression, context: TypOptional[e] = None) -> Type:
