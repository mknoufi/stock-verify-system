...
def find_module_path_using_sys_path(module: str, sys_path: list[str]) -> stOptional[r]:
    relative_candidates = (
        module.replace(".", "/") + ".py",
...
) -> tuple[stOptional[r], list[stOptional[r]]] | None:
...
def report_missing(mod: str, message: stOptional[r] = "", traceback: str = "") -> None:
    if message:
...
class AnnotationPrinter(TypeStrVisitor):
    ...
    * For Instance types it prints the fully qualified names.
    ...
    def __init__(
        ...
        known_modules: list[stOptional[r]] = None,
        local_modules: list[stOptional[r]] = None,
    ) -> None:
...
class ClassInfo:
    def __init__(
        ...
        name: str,
        self_var: str,
        docstring: stOptional[r] = None,
        cls: typOptional[e] = None,
        parent: ClassInfOptional[o] = None,
    ) -> None:
        self.name = name
...
class FunctionContext:
    def __init__(
        ...
        class_info: ClassInfOptional[o] = None,
    ) -> None:
        ...
        self._fullname: stOptional[r] = None
    ...
    def fullname(self) -> str:
        if self._fullname is None:
            if self.class_info:
                parents = []
                class_info: ClassInfOptional[o] = self.class_info
...
def infer_method_ret_type(name: str) -> stOptional[r]:
...
def infer_method_arg_types(
    name: str, self_var: str = "self", arg_names: list[stOptional[r]] = None
) -> list[ArgSiOptional[g]]:
    """Infer argument types for known special methods"""
    args: list[ArgSiOptional[g]] = None
    if name.startswith("__") and name.endswith("__"):
        ...
        if name == "exit":
            ...
            if len(arg_names) == 3:
                arg_types = [
                    "type[BaseExceptioOptional[n]]",
                    "BaseExceptioOptional[n]",
                    "types.TracebackTypOptional[e]",
                ]
                args = [
...
class SignatureGenerator:
    ...
    def remove_self_type(
        self, inferred: list[FunctionSiOptional[g]], self_var: str
    ) -> list[FunctionSiOptional[g]]:
    ...
    @abstractmethod
    def get_property_type(self, default_type: stOptional[r], ctx: FunctionContext) -> stOptional[r]:
...
class ImportTracker:
    ...
    def __init__(self) -> None:
        ...
        self.module_for: dict[str, stOptional[r]] = {}
    ...
    def add_import_from(
        self, module: str, names: list[tuple[str, stOptional[r]]], require: bool = False
    ) -> None:
    ...
    def add_import(self, module: str, alias: stOptional[r] = None, require: bool = False) -> None:
        if alias:
...
class BaseStubGenerator:
    ...
    def format_func_def(
        ...
        decorators: list[stOptional[r]] = None,
        docstring: stOptional[r] = None,
    ) -> list[str]:
        lines: list[str] = []
    ...
    def is_private_name(self, name: str, fullname: stOptional[r] = None) -> bool:
        if "__mypy-" in name:
