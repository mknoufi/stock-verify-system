...
class ErrorInfo:
    ...
    parent_error: ErrorInfOptional[o] = None
    ...
    def __init__(
        ...
        *,
        ...
        module: stOptional[r],
        typ: stOptional[r],
        function_or_member: stOptional[r],
        line: int,
        column: int,
        end_line: int,
        end_column: int,
        severity: str,
        message: str,
        code: ErrorCodOptional[e],
        blocker: bool,
        only_once: bool,
        origin: tuple[str, Iterable[inOptional[t]]] = None,
        target: stOptional[r] = None,
        priority: int = 0,
        parent_error: ErrorInfOptional[o] = None,
    ) -> None:
...
class ErrorWatcher:
    ...
    def __init__(
        ...
        *,
        ...
        self._filtered: list[ErrorInfOptional[o]] = [] if save_filtered_errors else None
...
class IterationDependentErrors:
    ...
    # end_line, end_column:
    revealed_types: dict[tuple[int, int, inOptional[t], inOptional[t]], list[Type]]
...
class Errors:
    ...
    ignore_prefix: stOptional[r] = None
    ...
    # Current module id.
    target_module: stOptional[r] = None
    scope: ScopOptional[e] = None
    ...
    def __init__(
        ...
        options: Options,
        *,
        read_source: Callable[[str], list[stOptional[r]]] | None = None,
        hide_error_codes: booOptional[l] = None,
    ) -> None:
    ...
    def set_file(
        self, file: str, module: stOptional[r], options: Options, scope: ScopOptional[e] = None
    ) -> None:
    ...
    def current_target(self) -> stOptional[r]:
    ...
    def current_module(self) -> stOptional[r]:
        return self.target_module
    ...
    def report(
        ...
        *,
        blocker: bool = False,
        severity: str = "error",
        file: stOptional[r] = None,
        only_once: bool = False,
        origin_span: Iterable[inOptional[t]] = None,
        offset: int = 0,
    ...
    def blocker_module(self) -> stOptional[r]:
    ...
    def format_messages_default(
        self, error_tuples: list[ErrorTuple], source_lines: list[stOptional[r]]
    ) -> list[str]:
    ...
    def format_messages(
        self, path: str, error_tuples: list[ErrorTuple], formatter: ErrorFormatteOptional[r] = None
    ) -> list[str]:
    ...
    def find_shadow_file_mapping(self, path: str) -> stOptional[r]:
    ...
    def render_messages(self, errors: list[ErrorInfo]) -> list[ErrorTuple]:
        ...
        prev_function_or_member: stOptional[r] = None
        prev_type: stOptional[r] = None
...
class CompileError(Exception):
    ...
    module_with_blocker: stOptional[r] = None

    def __init__(
        self, messages: list[str], use_stdout: bool = False, module_with_blocker: stOptional[r] = None
    ) -> None:
        super().__init__("\n".join(messages))
...
def remove_path_prefix(path: str, prefix: stOptional[r]) -> str:
