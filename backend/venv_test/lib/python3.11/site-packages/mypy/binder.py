...
class ConditionalTypeBinder:
    ...
    type_assignments: AssignOptional[s] = None
    ...
    def __init__(self, options: Options) -> None:
        ...
        self.declarations: dict[Key, TypOptional[e]] = {}
    ...
    def _add_dependencies(self, key: Key, value: KeOptional[y] = None) -> None:
        if value is None:
            value = key
        else:
    ...
    def _get(self, key: Key, index: int = -1) -> CurrentTypOptional[e]:
        if index < 0:
    ...
    def get(self, expr: Expression) -> TypOptional[e]:
        key = literal_hash(expr)
    ...
    def assign_type(self, expr: Expression, type: Type, declared_type: TypOptional[e]) -> None:
...
def get_declaration(expr: BindableExpression) -> TypOptional[e]:
