...
def get_explicit_package_bases(options: Options) -> list[stOptional[r]]:
...
class SourceFinder:
    ...
    def _crawl_up_helper(self, dir: str) -> tuple[str, stOptional[r]]:
    ...
    def get_init_file(self, dir: str) -> stOptional[r]:
...
def strip_py(arg: str) -> stOptional[r]:
