...
class Context:
    ...
    def __init__(self, line: int = -1, column: int = -1) -> None:
        self.line = line
        self.column = column
        self.end_line: inOptional[t] = None
        self.end_column: inOptional[t] = None

    def set_line(
        self,
        target: Context | int,
        column: inOptional[t] = None,
        end_line: inOptional[t] = None,
        end_column: inOptional[t] = None,
    ) -> None:
...
class MypyFile(SymbolNode):
    ...
    _is_typeshed_file: booOptional[l]
    ...
    def __init__(
        ...
        imports: list[ImportBase],
        is_bom: bool = False,
        ignored_lines: dict[int, list[stOptional[r]]] = None,
    ) -> None:
        super().__init__()
        self.defs = defs
...
class Import(ImportBase):
    ...
    ids: list[tuple[str, stOptional[r]]]  # (module id, as id)

    def __init__(self, ids: list[tuple[str, stOptional[r]]]) -> None:
        super().__init__()
        self.ids = ids
...
class ImportFrom(ImportBase):
    ...
    id: str
    relative: int
    names: list[tuple[str, stOptional[r]]]  # Tuples (name, as name)

    def __init__(self, id: str, relative: int, names: list[tuple[str, stOptional[r]]]) -> None:
        super().__init__()
        self.id = id
        self.names = names
...
class FuncBase(Node):
    ...
    def __init__(self) -> None:
        ...
        self.type: mypy.types.ProperTypOptional[e] = None
        # Original, not semantically analyzed type (used for reprocessing)
        self.unanalyzed_type: mypy.types.ProperTypOptional[e] = None
...
class OverloadedFuncDef(FuncBase, SymbolNode, Statement):
    ...
    impl: OverloadParOptional[t]
    deprecated: stOptional[r]
    setter_index: inOptional[t]
    ...
    def __init__(self, items: list[OverloadPart]) -> None:
        ...
        self._is_trivial_self: booOptional[l] = None
        if items:
...
class Argument(Node):
    ...
    def __init__(
        self,
        variable: Var,
        type_annotation: mypy.types.TypOptional[e],
        initializer: ExpressioOptional[n],
        kind: ArgKind,
        pos_only: bool = False,
    ) -> None:
        super().__init__()
...
class TypeParam:
    ...
    def __init__(
        ...
        name: str,
        kind: int,
        upper_bound: mypy.types.TypOptional[e],
        values: list[mypy.types.Type],
        default: mypy.types.TypOptional[e],
    ) -> None:
        self.name = name
        self.kind = kind
...
class FuncItem(FuncBase):
    ...
    def __init__(
        self,
        arguments: list[ArgumenOptional[t]] = None,
        body: BlocOptional[k] = None,
        typ: mypy.types.FunctionLikOptional[e] = None,
        type_args: list[TypeParaOptional[m]] = None,
    ) -> None:
        super().__init__()
        ...
        self.type_args: list[TypeParaOptional[m]] = type_args
...
class FuncDef(FuncItem, SymbolNode, Statement):
    ...
    def __init__(
        ...
        self.is_mypy_only = False
        self.dataclass_transform_spec: DataclassTransformSpeOptional[c] = None
        self.docstring: stOptional[r] = None
        self.deprecated: stOptional[r] = None
        ...
        if arguments:
            self.original_first_arg: stOptional[r] = arguments[0].variable.name
        else:
...
class Decorator(SymbolNode, Statement):
    ...
    @property
    def type(self) -> mypy.types.TypOptional[e]:
...
class Var(SymbolNode):
    ...
    def __init__(self, name: str, type: mypy.types.TypOptional[e] = None) -> None:
        super().__init__()
        ...
        self.type: mypy.types.TypOptional[e] = type  # Declared or inferred type, or None
        # The setter type for settable properties.
        self.setter_type: mypy.types.CallableTypOptional[e] = None
        ...
        # tools like mypyc.
        self.final_value: int | float | complex | bool | stOptional[r] = None
    ...
    def read(cls, data: ReadBuffer) -> Var:
        ...
        typ = mypy.types.read_type_opt(data)
        v = Var(name, typ)
        setter_type: mypy.types.CallableTypOptional[e] = None
        tag = read_tag(data)
        if tag != LITERAL_NONE:
...
class ClassDef(Statement):
    ...
    type_args: list[TypeParaOptional[m]]
    ...
    metaclass: ExpressioOptional[n]
    decorators: list[Expression]
    keywords: dict[str, Expression]
    analyzed: ExpressioOptional[n]
    ...
    def __init__(
        ...
        name: str,
        defs: Block,
        type_vars: list[mypy.types.TypeVarLikeTypOptional[e]] = None,
        base_type_exprs: list[ExpressioOptional[n]] = None,
        metaclass: ExpressioOptional[n] = None,
        keywords: list[tuple[str, ExpressioOptional[n]]] = None,
        type_args: list[TypeParaOptional[m]] = None,
    ) -> None:
        super().__init__()
        self.name = name
...
class AssignmentStmt(Statement):
    ...
    def __init__(
        ...
        lvalues: list[Lvalue],
        rvalue: Expression,
        type: mypy.types.TypOptional[e] = None,
...
class WhileStmt(Statement):
    ...
    expr: Expression
    body: Block
    else_body: BlocOptional[k]

    def __init__(self, expr: Expression, body: Block, else_body: BlocOptional[k]) -> None:
        super().__init__()
        self.expr = expr
        self.body = body
...
class ForStmt(Statement):
    ...
    index_type: mypy.types.TypOptional[e]
    # Original, not semantically analyzed type in annotation (used for reprocessing)
    unanalyzed_index_type: mypy.types.TypOptional[e]
    # Inferred iterable item type
    inferred_item_type: mypy.types.TypOptional[e]
    # Inferred iterator type
    inferred_iterator_type: mypy.types.TypOptional[e]
    ...
    def __init__(
        ...
        body: Block,
        else_body: BlocOptional[k],
        index_type: mypy.types.TypOptional[e] = None,
    ) -> None:
        super().__init__()
        self.index = index
...
class ReturnStmt(Statement):
    ...
    expr: ExpressioOptional[n]

    def __init__(self, expr: ExpressioOptional[n]) -> None:
        super().__init__()
        self.expr = expr
...
class AssertStmt(Statement):
    ...
    expr: Expression
    msg: ExpressioOptional[n]

    def __init__(self, expr: Expression, msg: ExpressioOptional[n] = None) -> None:
        super().__init__()
        self.expr = expr
        self.msg = msg
...
class IfStmt(Statement):
    ...
    def __init__(self, expr: list[Expression], body: list[Block], else_body: BlocOptional[k]) -> None:
        super().__init__()
        self.expr = expr
        self.body = body
        self.else_body = else_body
...
class RaiseStmt(Statement):
    ...
    expr: ExpressioOptional[n]
    from_expr: ExpressioOptional[n]

    def __init__(self, expr: ExpressioOptional[n], from_expr: ExpressioOptional[n]) -> None:
        super().__init__()
        self.expr = expr
...
class TryStmt(Statement):
    ...
    types: list[ExpressioOptional[n]]  # Except type expressions
    vars: list[NameExpOptional[r]]  # Except variable names
    handlers: list[Block]  # Except bodies
    else_body: BlocOptional[k]
    finally_body: BlocOptional[k]
    ...
    def __init__(
        self,
        body: Block,
        vars: list[NameExpOptional[r]],
        types: list[ExpressioOptional[n]],
        handlers: list[Block],
        else_body: BlocOptional[k],
        finally_body: BlocOptional[k],
    ) -> None:
...
class WithStmt(Statement):
    ...
    def __init__(
        ...
        target: list[LvaluOptional[e]],
        body: Block,
        target_type: mypy.types.TypOptional[e] = None,
    ) -> None:
        super().__init__()
        self.expr = expr
        self.target = target
...
class MatchStmt(Statement):
    ...
    subject: Expression
    subject_dummy: NameExpOptional[r]
    patterns: list[Pattern]
    guards: list[ExpressioOptional[n]]
    bodies: list[Block]
...
class StrExpr(Expression):
    ...
    as_type: NotParsed | mypy.types.TypOptional[e]
...
class RefExpr(Expression):
    ...
    def __init__(self) -> None:
        ...
        self.kind: inOptional[t] = None
        # Var, FuncDef or TypeInfo that describes this
        self.node: SymbolNodOptional[e] = None
        ...
        self.type_guard: mypy.types.TypOptional[e] = None
        # And same for TypeIs
        self.type_is: mypy.types.TypOptional[e] = None
...
class MemberExpr(RefExpr):
    ...
    def __init__(self, expr: Expression, name: str) -> None:
        ...
        self.def_var: VaOptional[r] = None
...
class CallExpr(Expression):
    ...
    def __init__(
        ...
        arg_names: list[stOptional[r]],
        analyzed: ExpressioOptional[n] = None,
    ) -> None:
        super().__init__()
        if not arg_names:
        ...
        self.arg_names: list[stOptional[r]] = arg_names
...
class OpExpr(Expression):
    ...
    analyzed: TypeAliasExpOptional[r]
    # If this value expression can also be parsed as a valid type expression,
    # represents the type denoted by the type expression.
    # None means "is not a type expression".
    as_type: NotParsed | mypy.types.TypOptional[e]
    ...
    def __init__(
        self, op: str, left: Expression, right: Expression, analyzed: TypeAliasExpOptional[r] = None
    ) -> None:
        super().__init__()
        self.op = op
        self.left = left
...
class ComparisonExpr(Expression):
    ...
    method_types: list[mypy.types.TypOptional[e]]
...
class SliceExpr(Expression):
    ...
    begin_index: ExpressioOptional[n]
    end_index: ExpressioOptional[n]
    stride: ExpressioOptional[n]
...
class RevealExpr(Expression):
    ...
    expr: ExpressioOptional[n]
    kind: int
    local_nodes: list[VaOptional[r]]

    def __init__(
        self,
        kind: int,
        expr: ExpressioOptional[n] = None,
        local_nodes: list[VaOptional[r]] = None,
...
class SuperExpr(Expression):
    ...
    name: str
    info: TypeInfOptional[o]  # Type that contains this super expression
...
class DictExpr(Expression):
    ...
    items: list[tuple[ExpressioOptional[n], Expression]]

    def __init__(self, items: list[tuple[ExpressioOptional[n], Expression]]) -> None:
        super().__init__()
        self.items = items
...
class EnumCallExpr(Expression):
    ...
    items: list[str]
    values: list[ExpressioOptional[n]]

    def __init__(self, info: TypeInfo, items: list[str], values: list[ExpressioOptional[n]]) -> None:
        super().__init__()
        self.info = info
        self.items = items
        self.values = values
...
class NewTypeExpr(Expression):
    ...
    old_type: mypy.types.TypOptional[e]
    # The synthesized class representing the new type (inherits old_type)
    info: TypeInfOptional[o]

    def __init__(
        self, name: str, old_type: mypy.types.TypOptional[e], line: int, column: int
    ) -> None:
...
class TempNode(Expression):
    ...
    def __init__(
        self, typ: mypy.types.Type, no_rhs: bool = False, *, context: ContexOptional[t] = None
    ) -> None:
...
class TypeInfo(SymbolNode):
    ...
    _mro_refs: list[stOptional[r]]
    bad_mro: bool  # Could not construct full MRO
    is_final: bool
    is_disjoint_base: bool

    declared_metaclass: mypy.types.InstancOptional[e]
    metaclass_type: mypy.types.InstancOptional[e]
    ...
    alt_promote: mypy.types.InstancOptional[e]
    ...
    # tuple type.
    tuple_type: mypy.types.TupleTypOptional[e]
    ...
    typeddict_type: mypy.types.TypedDictTypOptional[e]
    ...
    type_object_type: mypy.types.FunctionLikOptional[e]
    ...
    def __init__(self, names: SymbolTable, defn: ClassDef, module_name: str) -> None:
        ...
        self.type_var_tuple_prefix: inOptional[t] = None
        self.type_var_tuple_suffix: inOptional[t] = None
        self.add_type_vars()
        self.is_final = False
    ...
    def get(self, name: str) -> SymbolTableNodOptional[e]:
        for cls in self.mro:
    ...
    def get_containing_type_info(self, name: str) -> TypeInfOptional[o]:
        for cls in self.mro:
    ...
    def get_method(self, name: str) -> FuncBase | DecoratoOptional[r]:
        for cls in self.mro:
            if name in cls.names:
    ...
    def calculate_metaclass_type(self) -> mypy.types.InstancOptional[e]:
    ...
    def explain_metaclass_conflict(self) -> stOptional[r]:
...
class TypeAlias(SymbolNode):
    ...
    def __init__(
        ...
        column: int,
        *,
        alias_tvars: list[mypy.types.TypeVarLikeTypOptional[e]] = None,
        no_args: bool = False,
        ...
        self._is_recursive: booOptional[l] = None
        self.eager = eager
...
class DataclassTransformSpec:
    ...
    def __init__(
        self,
        *,
        eq_default: booOptional[l] = None,
        order_default: booOptional[l] = None,
        kw_only_default: booOptional[l] = None,
        ...
        frozen_default: booOptional[l] = None,
    ) -> None:
...
def get_member_expr_fullname(expr: MemberExpr) -> stOptional[r]:
    """Return the qualified name representation of a member expression.

    Return a string of form foo.bar, foo.bar.baz, or similar, or None if the
    argument cannot be represented in this form.
    """
    initial: stOptional[r] = None
...
def is_final_node(node: SymbolNodOptional[e]) -> bool:
...
def get_func_def(typ: mypy.types.CallableType) -> SymbolNodOptional[e]:
...
def local_definitions(
    names: SymbolTable, name_prefix: str, info: TypeInfOptional[o] = None
) -> Iterator[Definition]:
...
def read_overload_part(data: ReadBuffer, tag: TaOptional[g] = None) -> OverloadPart:
    if tag is None:
        tag = read_tag(data)
    if tag == DECORATOR:
        return Decorator.read(data)
