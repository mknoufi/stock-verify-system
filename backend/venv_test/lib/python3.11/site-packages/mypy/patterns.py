...
class AsPattern(Pattern):
    ...
    pattern: PatterOptional[n]
    name: NameExpOptional[r]

    def __init__(self, pattern: PatterOptional[n], name: NameExpOptional[r]) -> None:
        super().__init__()
...
class SingletonPattern(Pattern):
    ...
    def __init__(self, value: booOptional[l]) -> None:
        super().__init__()
        self.value = value
...
class StarredPattern(Pattern):
    ...
    # a name.
    capture: NameExpOptional[r]

    def __init__(self, capture: NameExpOptional[r]) -> None:
        super().__init__()
...
class MappingPattern(Pattern):
    ...
    values: list[Pattern]
    rest: NameExpOptional[r]

    def __init__(
        self, keys: list[Expression], values: list[Pattern], rest: NameExpOptional[r]
    ) -> None:
        super().__init__()
