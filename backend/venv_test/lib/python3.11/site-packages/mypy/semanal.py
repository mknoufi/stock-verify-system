...
class SemanticAnalyzer(
    ...
    statement: StatemenOptional[t] = None  # Statement/definition being analyzed
    ...
    def __init__(
        ...
        self.current_overload_item: inOptional[t] = None
        ...
        self._str_type: InstancOptional[e] = None
        self._function_type: InstancOptional[e] = None
        self._object_type: InstancOptional[e] = None
    ...
    def refresh_partial(
        ...
        file_node: MypyFile,
        options: Options,
        active_type: TypeInfOptional[o] = None,
    ) -> None:
    ...
    def add_implicit_module_attrs(self, file_node: MypyFile) -> None:
        ...
        str_type: TypOptional[e] = self.named_type_or_none("builtins.str")
        if str_type is None:
    ...
    @contextmanager
    def file_context(
        self, file_node: MypyFile, options: Options, active_type: TypeInfOptional[o] = None
    ) -> Iterator[None]:
    ...
    def set_original_def(self, previous: NodOptional[e], new: FuncDef | Decorator) -> bool:
    ...
    @contextmanager
    def overload_item_set(self, item: inOptional[t]) -> Iterator[None]:
    ...
    @staticmethod
    def get_deprecated(expression: Expression) -> stOptional[r]:
        if (
    ...
    def analyze_overload_sigs_and_impl(
    ...
    ) -> tuple[list[CallableType], OverloadParOptional[t], list[int]]:
        ...
        impl: OverloadParOptional[t] = None
    ...
    def push_type_args(
        self, type_args: list[TypeParaOptional[m]], context: Context
    ) -> list[tuple[str, TypeVarLikeExpOptional[r]]]:
        if not type_args:
            return []
    ...
    def pop_type_args(self, type_args: list[TypeParaOptional[m]]) -> None:
        if not type_args:
            return
        self.locals.pop()
    ...
    def analyze_namedtuple_classdef(
        ...
        if (
            ...
            is_named_tuple = True
            info: TypeInfOptional[o] = defn.info
        else:
    ...
    def get_fullname_for_hook(self, expr: Expression) -> stOptional[r]:
    ...
    def analyze_class_typevar_declaration(self, base: Type) -> tuple[TypeVarLikeList, booOptional[l]]:
    ...
    def analyze_unbound_tvar(self, t: Type) -> tuple[str, TypeVarLikeExpOptional[r]]:
    ...
    ) -> tuple[str, TypeVarLikeExpOptional[r]]:
    ...
    def tvar_defs_from_tvars(
        ...
        last_tvar_name_with_default: stOptional[r] = None
    ...
    def prepare_class_def(
        self, defn: ClassDef, info: TypeInfOptional[o] = None, custom_names: bool = False
    ) -> None:
    ...
    def get_name_repr_of_expr(self, expr: Expression) -> stOptional[r]:
    ...
    ) -> tuple[list[tuple[ProperType, Expression]], booOptional[l]]:
    ...
    def calculate_class_mro(
        self, defn: ClassDef, obj_type: Callable[[], InstancOptional[e]] = None
    ) -> None:
    ...
    def infer_metaclass_and_bases_from_compat_helpers(self, defn: ClassDef) -> None:
        ...
        * past.utils.with_metaclass(M, B1, B2, ...)
        ...
        with_meta_expr: ExpressioOptional[n] = None
        ...
        add_meta_expr: ExpressioOptional[n] = None
    ...
    def get_declared_metaclass(
        self, name: str, metaclass_expr: ExpressioOptional[n]
    ) -> tuple[InstancOptional[e], bool, bool]:
        ...
        if metaclass_expr:
            ...
            metaclass_info: NodOptional[e] = sym.node
            if (
    ...
    def recalculate_metaclass(self, defn: ClassDef, declared_metaclass: InstancOptional[e]) -> None:
    ...
    def analyze_simple_literal_type(self, rvalue: Expression, is_final: bool) -> TypOptional[e]:
    ...
    def analyze_alias(
        ...
        declared_type_vars: TypeVarLikeLisOptional[t] = None,
        all_declared_type_params_names: list[stOptional[r]] = None,
        python_3_12_type_alias: bool = False,
    ) -> tuple[TypOptional[e], list[TypeVarLikeType], set[str], bool]:
    ...
    def check_and_set_up_type_alias(self, s: AssignmentStmt) -> bool:
        ...
        type_params: TypeVarLikeLisOptional[t]
        all_type_params_names: list[stOptional[r]]
    ...
    def check_lvalue_validity(self, node: Expression | SymbolNodOptional[e], ctx: Context) -> None:
    ...
    def process_typevar_parameters(
        ...
        names: list[stOptional[r]],
        kinds: list[ArgKind],
        num_values: int,
        context: Context,
    ) -> tuple[int, Type, TypOptional[e]]:
    ...
    def extract_typevarlike_name(self, s: AssignmentStmt, call: CallExpr) -> stOptional[r]:
        if not call:
            return None
    ...
    def is_final_type(self, typ: TypOptional[e]) -> bool:
        if not isinstance(typ, UnboundType):
            return False
        sym = self.lookup_qualified(typ.name, typ)
        if not sym or not sym.node:
    ...
    def visit_block_maybe(self, b: BlocOptional[k]) -> None:
        if b:
            self.visit_block(b)
    ...
    def translate_dict_call(self, call: CallExpr) -> DictExpOptional[r]:
    ...
    def analyze_type_application_args(self, expr: IndexExpr) -> list[TypOptional[e]]:
    ...
    def is_active_symbol_in_class_body(self, node: SymbolNodOptional[e]) -> bool:
    ...
    def is_type_like(self, node: SymbolNodOptional[e]) -> bool:
    ...
    def is_textually_before_class(self, node: SymbolNodOptional[e]) -> bool:
    ...
    def is_defined_in_current_module(self, fullname: stOptional[r]) -> bool:
        if not fullname:
            return False
    ...
    def lookup_type_node(self, expr: Expression) -> SymbolTableNodOptional[e]:
        try:
    ...
    def get_module_symbol(self, node: MypyFile, name: str) -> SymbolTableNodOptional[e]:
    ...
    def named_type(self, fullname: str, args: list[TypOptional[e]] = None) -> Instance:
    ...
    def named_type_or_none(self, fullname: str, args: list[TypOptional[e]] = None) -> InstancOptional[e]:
    ...
    def lookup_current_scope(self, name: str) -> SymbolTableNodOptional[e]:
    ...
    def _get_node_for_class_scoped_import(
        self, name: str, symbol_node: SymbolNodOptional[e], context: Context
    ) -> SymbolNodOptional[e]:
        ...
        if isinstance(f(symbol_node), (Decorator, FuncBase, Var)):
            ...
            if isinstance(f(symbol_node), (FuncBase, Decorator)):
                ...
                typ: TypOptional[e] = AnyType(TypeOfAny.from_error)
    ...
    def add_imported_symbol(
        ...
        symbol_node: SymbolNodOptional[e] = node.node
    ...
    def process_placeholder(
        self, name: stOptional[r], kind: str, ctx: Context, force_progress: bool = False
    ) -> None:
    ...
    def cannot_resolve_name(self, name: stOptional[r], kind: str, ctx: Context) -> None:
    ...
    def name_not_defined(self, name: str, ctx: Context, namespace: stOptional[r] = None) -> None:
    ...
    def already_defined(
        self, name: str, ctx: Context, original_ctx: SymbolTableNode | SymbolNodOptional[e], noun: str
    ) -> None:
        if isinstance(original_ctx, SymbolTableNode):
            node: SymbolNodOptional[e] = original_ctx.node
    ...
    def name_already_defined(
        self, name: str, ctx: Context, original_ctx: SymbolTableNode | SymbolNodOptional[e] = None
    ) -> None:
    ...
    def type_analyzer(
        self,
        *,
        tvar_scope: TypeVarLikeScopOptional[e] = None,
        ...
        allow_unpack: bool = False,
        report_invalid_types: bool = True,
        prohibit_self_type: stOptional[r] = None,
        prohibit_special_class_field_types: stOptional[r] = None,
        allow_type_any: bool = False,
    ) -> TypeAnalyser:
    ...
    def add_plugin_dependency(self, trigger: str, target: stOptional[r] = None) -> None:
    ...
    def add_type_alias_deps(
        self, aliases_used: Collection[str], target: stOptional[r] = None
    ) -> None:
    ...
    def parse_bool(self, expr: Expression) -> booOptional[l]:
        # This wrapper is preserved for plugins.
        return parse_bool(expr)

    def parse_str_literal(self, expr: Expression) -> stOptional[r]:
...
def is_same_var_from_getattr(n1: SymbolNodOptional[e], n2: SymbolNodOptional[e]) -> bool:
...
def is_same_symbol(a: SymbolNodOptional[e], b: SymbolNodOptional[e]) -> bool:
    return (
        a == b
