...
class ExternalSignatureGenerator(SignatureGenerator):
    def __init__(
        self, func_sigs: dict[str, stOptional[r]] = None, class_sigs: dict[str, stOptional[r]] = None
    ) -> None:
        """
...
class InspectionStubGenerator(BaseStubGenerator):
    ...
    def __init__(
        ...
        export_less: bool = False,
        include_docstrings: bool = False,
        module: ModuleTypOptional[e] = None,
    ) -> None:
    ...
    def get_default_function_sig(self, func: object, ctx: FunctionContext) -> FunctionSig:
        ...
        def get_annotation(key: str) -> stOptional[r]:
    ...
    def get_obj_module(self, obj: object) -> stOptional[r]:
    ...
    def is_staticmethod(self, class_info: ClassInfOptional[o], name: str, obj: object) -> bool:
    ...
    def generate_function_stub(
        self, name: str, obj: object, *, output: list[str], class_info: ClassInfOptional[o] = None
    ) -> None:
    ...
    def generate_property_stub(
        ...
        if static:
            ret_type: stOptional[r] = self.strip_or_import(self.get_type_annotation(obj))
        else:
    ...
    def generate_class_stub(
        self, class_name: str, cls: type, output: list[str], parent_class: ClassInfOptional[o] = None
    ) -> None:
...
def infer_c_method_args(
    ...
    if name.startswith("__") and name.endswith("__"):
        ...
        if name in (
            ...
            args = [
                ArgSig(name="type", type="type[BaseExceptioOptional[n]]"),
                ArgSig(name="value", type="BaseExceptioOptional[n]"),
                ArgSig(name="traceback", type="types.TracebackTypOptional[e]"),
            ]
    if args is None:
