...
def find_node(name: str, info: TypeInfo) -> Var | FuncBasOptional[e]:
...
def find_module_by_fullname(fullname: str, modules: dict[str, State]) -> StatOptional[e]:
...
class SearchVisitor(ExtendedTraverserVisitor):
    ...
    def __init__(self, line: int, column: int, end_line: int, end_column: int) -> None:
        ...
        self.result: ExpressioOptional[n] = None
...
class InspectionEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self.module: StatOptional[e] = None
    ...
    def collect_nodes(self, expression: RefExpr) -> list[FuncBase | SymbolNode]:
        ...
        """
        node: FuncBase | SymbolNodOptional[e] = expression.node
    ...
    def find_module(self, file: str) -> tuple[StatOptional[e], dict[str, object]]:
