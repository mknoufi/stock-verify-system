...
class DependencyVisitor(TraverserVisitor):
    ...
    def get_unimported_fullname(self, e: MemberExpr, typ: AnyType) -> stOptional[r]:
    ...
    def add_dependency(self, trigger: str, target: stOptional[r] = None) -> None:
    ...
    def add_type_dependencies(self, typ: Type, target: stOptional[r] = None) -> None:
...
def get_type_triggers(
    typ: Type, use_logical_deps: bool, seen_aliases: set[TypeAliasTypOptional[e]] = None
) -> list[str]:
...
class TypeTriggersVisitor(TypeVisitor[list[str]]):
    def __init__(
        self, use_logical_deps: bool, seen_aliases: set[TypeAliasTypOptional[e]] = None
    ) -> None:
        self.deps: list[str] = []
