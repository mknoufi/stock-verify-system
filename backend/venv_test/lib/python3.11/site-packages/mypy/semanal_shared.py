...
class _NamedTypeCallback(Protocol):
    def __call__(self, fullname: str, args: list[TypOptional[e]] = None) -> Instance: ...
...
def find_dataclass_transform_spec(node: NodOptional[e]) -> DataclassTransformSpeOptional[c]:
    """
...
def parse_bool(expr: Expression) -> booOptional[l]:
