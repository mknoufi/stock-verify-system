...
class SuggestionEngine:
    ...
    def __init__(
        ...
        *,
        ...
        no_any: bool = False,
        flex_any: floaOptional[t] = None,
        use_fixme: stOptional[r] = None,
        max_guesses: inOptional[t] = None,
    ) -> None:
    ...
    def get_default_arg_types(self, fdef: FuncDef) -> list[TypOptional[e]]:
        return [
    ...
    def find_node_by_module_and_name(self, modname: str, tail: str) -> SymbolNodOptional[e]:
        ...
        for i, component in enumerate(components[:-1]):
            ...
            node: SymbolNodOptional[e] = names[component].node
    ...
    def find_node_by_file_and_line(self, file: str, line: int) -> tuple[str, SymbolNode]:
        ...
        node: SymbolNodOptional[e] = None
        closest_line: inOptional[t] = None
    ...
    def extract_from_decorator(self, node: Decorator) -> FuncDeOptional[f]:
    ...
    def pyannotate_signature(
        self, cur_module: stOptional[r], is_method: bool, typ: CallableType
    ) -> PyAnnotateSignature:
    ...
    def format_type(self, cur_module: stOptional[r], typ: Type) -> str:
...
class TypeFormatter(TypeStrVisitor):
    ...
    # TODO: Probably a lot
    def __init__(self, module: stOptional[r], graph: Graph, options: Options) -> None:
