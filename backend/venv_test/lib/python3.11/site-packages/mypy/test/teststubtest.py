...
class _TypedDict(Mapping[str, object]):
    ...
    __closed__: ClassVar[booOptional[l]]
...
def run_stubtest_with_stderr(
    ...
    runtime: str,
    options: list[str],
    config_file: stOptional[r] = None,
    output: io.StringIOptional[O] = None,
    outerr: io.StringIOptional[O] = None,
) -> tuple[str, str]:
...
def run_stubtest(
    stub: str, runtime: str, options: list[str], config_file: stOptional[r] = None
) -> str:
    return run_stubtest_with_stderr(stub, runtime, options, config_file)[0]


class Case:
    def __init__(self, stub: str, runtime: str, error: stOptional[r]) -> None:
        self.stub = stub
    ...
    def test_enum(self) -> Iterator[Case]:
        ...
        yield Case(
            ...
            class Flags2(enum.Flag):
                a = ...
                b = 2
            def bar(x: FlagsOptional[2] = None) -> None: ...
            """,
            runtime="""
            class Flags2(enum.Flag):
                a = 1
        ...
        yield Case(
            ...
            class Flags3(enum.Flag):
                a = ...
                b = 2
            def baz(x: FlagsOptional[3] = ...) -> None: ...
            """,
            runtime="""
            class Flags3(enum.Flag):
                a = 1
        ...
        yield Case(
            ...
            class Flags4(enum.Flag):
                a = 1
                b = 2
            def spam(x: FlagsOptional[4] = None) -> None: ...
            """,
            runtime="""
            class Flags4(enum.Flag):
                a = 1
