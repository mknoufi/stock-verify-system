...
class TypeFixture:
    ...
    def make_type_info(
        self,
        name: str,
        module_name: stOptional[r] = None,
        is_abstract: bool = False,
        mro: list[TypeInfOptional[o]] = None,
        bases: list[InstancOptional[e]] = None,
        typevars: list[stOptional[r]] = None,
        typevar_tuple_index: inOptional[t] = None,
        variances: list[inOptional[t]] = None,
    ) -> TypeInfo:
    ...
    def non_rec_alias(
        self,
        target: Type,
        alias_tvars: list[TypeVarLikeTypOptional[e]] = None,
        args: list[TypOptional[e]] = None,
    ) -> TypeAliasType:
