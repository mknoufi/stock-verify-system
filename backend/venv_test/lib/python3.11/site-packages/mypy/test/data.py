...
class DataDrivenTestCase(pytest.Item):
    ...
    def __init__(
        ...
        *,
        ...
        self.data = data
        self.line = line
        self.old_cwd: stOptional[r] = None
        self.tmpdir: stOptional[r] = None
    ...
    def runtest(self) -> None:
        ...
        try:
            ...
            save_dir: stOptional[r] = self.config.getoption("--save-failures-to", None)
            if save_dir:
    ...
    def repr_failure(
        self, excinfo: pytest.ExceptionInfo[BaseException], style: AnOptional[y] = None
    ) -> str:
        excrepr: object
...
def parse_test_data(raw_data: str, name: str) -> list[TestItem]:
    ...
    id: stOptional[r] = None
    arg: stOptional[r] = None
...
def pytest_pycollect_makeitem(collector: Any, name: str, obj: object) -> AnOptional[y]:
