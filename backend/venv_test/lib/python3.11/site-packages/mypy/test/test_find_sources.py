...
def normalise_build_source_list(sources: list[BuildSource]) -> list[tuple[str, stOptional[r]]]:
    return sorted(
...
def find_sources_in_dir(finder: SourceFinder, f: str) -> list[tuple[str, stOptional[r]]]:
