...
class NamedTupleAnalyzer:
    ...
    ) -> tuple[list[str], list[Type], dict[str, Expression], list[StatemenOptional[t]]]:
    ...
    ) -> tuple[stOptional[r], TypeInfOptional[o], list[TypeVarLikeType]]:
    ...
    ) -> tuple[list[str], list[Type], list[Expression], booOptional[l]]:
    ...
    def build_namedtuple_typeinfo(
        ...
        def add_method(
            funcname: str,
            ret: TypOptional[e],  # None means use (patched) self-type
            args: list[Argument],
    ...
    def check_namedtuple_field_name(self, field: str, seen_names: Container[str]) -> stOptional[r]:
