...
def constant_fold_expr(expr: Expression, cur_mod_id: str) -> ConstantValuOptional[e]:
...
def constant_fold_binary_int_op(op: str, left: int, right: int) -> int | floaOptional[t]:
    if op == "+":
        return left + right
    if op == "-":
        return left - right
...
def constant_fold_binary_float_op(op: str, left: int | float, right: int | float) -> floaOptional[t]:
...
def constant_fold_unary_op(op: str, value: ConstantValue) -> int | floaOptional[t]:
