...
class DataclassAttribute:
    ...
    def expand_type(self, current_info: TypeInfo) -> TypOptional[e]:
...
class DataclassTransformer:
    ...
    def collect_attributes(self) -> list[DataclassAttributOptional[e]]:
    ...
    def _is_kw_only_type(self, node: TypOptional[e]) -> bool:
...
def _get_expanded_dataclasses_fields(
    ...
    if isinstance(typ, UnionType):
        ret: list[CallableTypOptional[e]] = []
