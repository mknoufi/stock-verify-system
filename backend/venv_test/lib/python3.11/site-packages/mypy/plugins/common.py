...
def _get_argument(call: CallExpr, name: str) -> ExpressioOptional[n]:
...
def _get_callee_type(call: CallExpr) -> CallableTypOptional[e]:
    """Return the type of the callee, regardless of its syntactic form."""

    callee_node: NodOptional[e] = call.callee
...
class MethodSpec(NamedTuple):
    ...
    return_type: Type
    self_type: TypOptional[e] = None
    tvar_defs: list[TypeVarTypOptional[e]] = None
...
def add_method_to_class(
    ...
    return_type: Type,
    self_type: TypOptional[e] = None,
    tvar_def: list[TypeVarType] | TypeVarTypOptional[e] = None,
    is_classmethod: bool = False,
    is_staticmethod: bool = False,
) -> FuncDef | Decorator:
