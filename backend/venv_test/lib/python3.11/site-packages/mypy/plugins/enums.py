...
def _first(it: Iterable[_T]) -> _Optional[T]:
...
def _infer_value_type_with_auto_fallback(
    ctx: mypy.plugin.AttributeContext, proper_type: ProperTypOptional[e]
) -> TypOptional[e]:
...
def _extract_underlying_field_name(typ: Type) -> stOptional[r]:
