...
class Converter:
    ...
    def __init__(self, init_type: TypOptional[e] = None, ret_type: TypOptional[e] = None) -> None:
...
class Attribute:
    ...
    def __init__(
        ...
        init: bool,
        kw_only: bool,
        converter: ConverteOptional[r],
        context: Context,
        init_type: TypOptional[e],
    ) -> None:
        self.name = name
        self.alias = alias
        self.info = info
...
def _get_decorator_optional_bool_argument(
    ctx: mypy.plugin.ClassDefContext, name: str, default: booOptional[l] = None
) -> booOptional[l]:
...
def attr_class_maker_callback(
    ...
    auto_attribs_default: booOptional[l] = False,
...
def attr_class_maker_callback_impl(
    ctx: mypy.plugin.ClassDefContext,
    auto_attribs_default: booOptional[l],
    frozen_default: bool,
    slots_default: bool,
) -> bool:
    info = ctx.cls.info
    ...
    if frozen:
        ...
        hashable: booOptional[l] = _get_decorator_bool_argument(
            ctx, "hash", True
...
def _analyze_class(
    ctx: mypy.plugin.ClassDefContext, auto_attribs: booOptional[l], kw_only: bool
) -> list[Attribute]:
...
def _parse_converter(
    ctx: mypy.plugin.ClassDefContext, converter_expr: ExpressioOptional[n]
) -> ConverteOptional[r]:
    ...
    converter_type: TypOptional[e] = None
...
def _add_attrs_magic_attribute(
    ctx: mypy.plugin.ClassDefContext, attrs: list[tuple[str, TypOptional[e]]]
) -> None:
...
def _get_attrs_init_type(typ: Instance) -> CallableTypOptional[e]:
    """
...
def _get_expanded_attr_types(
...
) -> list[Mapping[str, TypOptional[e]]]:
    """
    ...
    if isinstance(typ, AnyType):
        ...
        ret: list[Mapping[str, TypOptional[e]]] = []
