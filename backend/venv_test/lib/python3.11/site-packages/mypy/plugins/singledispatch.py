...
def get_singledispatch_info(typ: Instance) -> SingledispatchTypeVarOptional[s]:
    if len(typ.args) == 2:
...
def fail(ctx: PluginContext, msg: str, context: ContexOptional[t]) -> None:
...
def register_function(
    ...
    func: Type,
    options: Options,
    register_arg: TypOptional[e] = None,
) -> None:
    """Register a function"""
...
def get_dispatch_type(func: CallableType, register_arg: TypOptional[e]) -> TypOptional[e]:
