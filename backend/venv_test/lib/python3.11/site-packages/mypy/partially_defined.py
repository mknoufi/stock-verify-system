...
class BranchState:
    ...
    def __init__(
        self,
        must_be_defined: set[stOptional[r]] = None,
        may_be_defined: set[stOptional[r]] = None,
        skipped: bool = False,
    ) -> None:
...
class BranchStatement:
    def __init__(self, initial_state: BranchStatOptional[e] = None) -> None:
...
class PossiblyUndefinedVariableVisitor(ExtendedTraverserVisitor):
    ...
    def process_lvalue(self, lvalue: LvaluOptional[e]) -> None:
