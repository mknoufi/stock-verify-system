...
def check_output(
    response: dict[str, Any], verbose: bool, junit_xml: stOptional[r], perf_stats_file: stOptional[r]
) -> None:
...
def request(
    status_file: str, command: str, *, timeout: inOptional[t] = None, **kwds: object
) -> dict[str, Any]:
