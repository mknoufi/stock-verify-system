...
def _parse_individual_file(
    config_file: str, stderr: TextIOptional[O] = None
) -> tuple[MutableMapping[str, Any], dict[str, _INI_PARSER_CALLABLE], stOptional[r]]:
...
def convert_to_boolean(value: AnOptional[y]) -> bool:
...
def get_config_module_names(filename: stOptional[r], modules: list[str]) -> str:
