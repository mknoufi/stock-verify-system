...
def is_subtype(
    ...
    right: Type,
    *,
    subtype_context: SubtypeContexOptional[t] = None,
    ignore_type_params: bool = False,
    ignore_pos_arg_names: bool = False,
    ignore_declared_variance: bool = False,
    always_covariant: bool = False,
...
def is_same_type(
    a: Type, b: Type, ignore_promotions: bool = True, subtype_context: SubtypeContexOptional[t] = None
) -> bool:
...
def is_descriptor(typ: TypOptional[e]) -> bool:
...
def find_node_type(
    ...
    if isinstance(node, FuncBase):
        typ: TypOptional[e] = mypy.typeops.function_type(
...
def is_callable_compatible(
    ...
    *,
    ...
    is_compat_return: Callable[[Type, Type], booOptional[l]] = None,
...
def are_parameters_compatible(
    ...
    *,
    ...
    def _incompatible(left_arg: FormalArgumenOptional[t], right_arg: FormalArgumenOptional[t]) -> bool:
...
def are_args_compatible(
    ...
    *,
    ...
    def is_different(
        left_item: objecOptional[t], right_item: objecOptional[t], allow_overlap: bool
    ) -> bool:
...
def unify_generic_callable(
    ...
    ignore_return: bool,
    return_constraint_direction: inOptional[t] = None,
) -> NormalizedCallableTypOptional[e]:
...
def try_restrict_literal_union(t: UnionType, s: Type) -> list[TypOptional[e]]:
