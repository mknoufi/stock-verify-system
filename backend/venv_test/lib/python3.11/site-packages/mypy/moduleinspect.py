...
class ModuleProperties:
    ...
    def __init__(
        ...
        path: list[stOptional[r]] = None,
        all: list[stOptional[r]] = None,
        is_c_module: bool = False,
        subpackages: list[stOptional[r]] = None,
    ) -> None:
...
def is_pyc_only(file: stOptional[r]) -> bool:
...
def get_package_properties(package_id: str) -> ModuleProperties:
    ...
    path: list[stOptional[r]] = getattr(package, "__path__", None)
...
class ModuleInspect:
    ...
    def _get_from_queue(self) -> ModuleProperties | stOptional[r]:
