...
def infer_constraints_for_callable(
    callee: CallableType,
    arg_types: Sequence[TypOptional[e]],
...
def select_trivial(options: Sequence[list[ConstrainOptional[t]]]) -> list[list[Constraint]]:
...
def any_constraints(options: list[list[ConstrainOptional[t]]], *, eager: bool) -> list[Constraint]:
...
def filter_satisfiable(option: list[ConstrainOptional[t]]) -> list[ConstrainOptional[t]]:
...
def exclude_non_meta_vars(option: list[ConstrainOptional[t]]) -> list[ConstrainOptional[t]]:
    ...
    def visit_callable_type(self, template: CallableType) -> list[Constraint]:
        ...
        if isinstance(self.actual, CallableType):
            ...
            if param_spec is None:
                ...
                param_spec_target: TypOptional[e] = None
                if not cactual_ps:
