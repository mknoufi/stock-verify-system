...
def _extract_argument_name(expr: Expression) -> stOptional[r]:
...
def expr_to_unanalyzed_type(
    ...
    _parent: ExpressioOptional[n] = None,
    allow_unpack: bool = False,
    lookup_qualified: Callable[[str, Context], SymbolTableNodOptional[e]] | None = None,
) -> ProperType:
