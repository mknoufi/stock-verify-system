...
class TypeVarLikeScope:
    ...
    def __init__(
        self,
        parent: TypeVarLikeScopOptional[e] = None,
        is_class_scope: bool = False,
        prohibited: TypeVarLikeScopOptional[e] = None,
        namespace: str = "",
    ) -> None:
    ...
    def get_function_scope(self) -> TypeVarLikeScopOptional[e]:
        """Get the nearest parent that's a function scope, not a class scope"""
        it: TypeVarLikeScopOptional[e] = self
    ...
    def get_binding(self, item: str | SymbolTableNode) -> TypeVarLikeTypOptional[e]:
