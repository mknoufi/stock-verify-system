...
Solutions: _TypeAlias = "dict[TypeVarId, TypOptional[e]]"
...
) -> tuple[list[TypOptional[e]], list[TypeVarLikeType]]:
...
def solve_with_dependent(
    ...
    solutions: dict[TypeVarId, TypOptional[e]] = {}
...
def solve_one(lowers: Iterable[Type], uppers: Iterable[Type]) -> TypOptional[e]:
    """Solve constraints by finding by using meets of upper bounds, and joins of lower bounds."""

    candidate: TypOptional[e] = None
    ...
    bottom: TypOptional[e] = None
    top: TypOptional[e] = None
...
def find_linear(c: Constraint) -> tuple[bool, TypeVarIOptional[d]]:
...
def pre_validate_solutions(
    ...
    """
    new_solutions: list[TypOptional[e]] = []
