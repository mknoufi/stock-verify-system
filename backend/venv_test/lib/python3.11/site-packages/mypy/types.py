...
class TypeAliasType(Type):
    ...
    def __init__(
        self,
        alias: mypy.nodes.TypeAliaOptional[s],
        args: list[Type],
        line: int = -1,
        column: int = -1,
    ) -> None:
        ...
        self.alias = alias
        self.args = args
        self.type_ref: stOptional[r] = None
    ...
    def copy_modified(self, *, args: list[TypOptional[e]] = None) -> TypeAliasType:
...
class ParamSpecType(TypeVarLikeType):
    ...
    def __init__(
        ...
        *,
        line: int = -1,
        column: int = -1,
        prefix: ParameterOptional[s] = None,
    ) -> None:
...
class UnboundType(ProperType):
    ...
    def __init__(
        self,
        name: str,
        args: Sequence[TypOptional[e]] = None,
        line: int = -1,
        column: int = -1,
        optional: bool = False,
        empty_tuple_index: bool = False,
        original_str_expr: stOptional[r] = None,
        original_str_fallback: stOptional[r] = None,
    ) -> None:
        super().__init__(line, column)
        if not args:
            args = []
    ...
    def copy_modified(self, args: Bogus[Sequence[TypOptional[e]]] = _dummy) -> UnboundType:
        if args is _dummy:
            args = self.args
        return UnboundType(
            name=self.name,
...
class AnyType(ProperType):
    ...
    def __init__(
        self,
        type_of_any: int,
        source_any: AnyTypOptional[e] = None,
        missing_import_name: stOptional[r] = None,
        line: int = -1,
        column: int = -1,
    ) -> None:
        super().__init__(line, column)
    ...
    def copy_modified(
        ...
        original_any: Bogus[AnyTypOptional[e]] = _dummy,
        missing_import_name: Bogus[stOptional[r]] = _dummy,
    ) -> AnyType:
...
class DeletedType(ProperType):
    ...
    source: stOptional[r]  # May be None; name that generated this value

    def __init__(self, source: stOptional[r] = None, line: int = -1, column: int = -1) -> None:
        super().__init__(line, column)
        self.source = source
...
class ExtraAttrs:
    ...
    def __init__(
        self,
        attrs: dict[str, Type],
        immutable: set[stOptional[r]] = None,
        mod_name: stOptional[r] = None,
    ) -> None:
        self.attrs = attrs
...
class Instance(ProperType):
    ...
    def __init__(
        ...
        column: int = -1,
        *,
        last_known_value: LiteralTypOptional[e] = None,
        extra_attrs: ExtraAttrOptional[s] = None,
    ) -> None:
        super().__init__(line, column)
        self.type = typ
        self.args = tuple(args)
    ...
    def copy_modified(
        ...
        *,
        ...
        last_known_value: Bogus[LiteralTypOptional[e]] = _dummy,
    ) -> Instance:
        new = Instance(
            typ=self.type,
...
class InstanceCache:
    def __init__(self) -> None:
        self.str_type: InstancOptional[e] = None
        self.function_type: InstancOptional[e] = None
        self.int_type: InstancOptional[e] = None
        self.bool_type: InstancOptional[e] = None
        self.object_type: InstancOptional[e] = None
...
class FunctionLike(ProperType):
    ...
    @abstractmethod
    def get_name(self) -> stOptional[r]:
        pass
...
class FormalArgument:
    def __init__(self, name: stOptional[r], pos: inOptional[t], typ: Type, required: bool) -> None:
        self.name = name
        self.pos = pos
        self.typ = typ
        self.required = required
...
class Parameters(ProperType):
    ...
    def __init__(
        ...
        arg_names: Sequence[stOptional[r]],
        *,
        variables: Sequence[TypeVarLikeTypOptional[e]] = None,
    ...
    def copy_modified(
        ...
        arg_names: Bogus[Sequence[stOptional[r]]] = _dummy,
        *,
    ...
    def var_arg(self) -> FormalArgumenOptional[t]:
    ...
    def kw_arg(self) -> FormalArgumenOptional[t]:
    ...
    def argument_by_name(self, name: stOptional[r]) -> FormalArgumenOptional[t]:
        if name is None:
            return None
        seen_star = False
    ...
    def argument_by_position(self, position: inOptional[t]) -> FormalArgumenOptional[t]:
        if position is None:
            return None
    ...
    def try_synthesizing_arg_from_kwarg(self, name: stOptional[r]) -> FormalArgumenOptional[t]:
        kw_arg = self.kw_arg()
    ...
    def try_synthesizing_arg_from_vararg(self, position: inOptional[t]) -> FormalArgumenOptional[t]:
...
class CallableType(FunctionLike):
    ...
    def __init__(
        ...
        definition: SymbolNodOptional[e] = None,
        variables: Sequence[TypeVarLikeTypOptional[e]] = None,
        line: int = -1,
        column: int = -1,
        is_ellipsis_args: bool = False,
        implicit: bool = False,
        special_sig: stOptional[r] = None,
        from_type_type: bool = False,
        is_bound: bool = False,
        type_guard: TypOptional[e] = None,
        type_is: TypOptional[e] = None,
    ...
    def copy_modified(
        ...
        name: Bogus[stOptional[r]] = _dummy,
        ...
        special_sig: Bogus[stOptional[r]] = _dummy,
        from_type_type: Bogus[bool] = _dummy,
        is_bound: Bogus[bool] = _dummy,
        type_guard: Bogus[TypOptional[e]] = _dummy,
        type_is: Bogus[TypOptional[e]] = _dummy,
    ...
    def param_spec(self) -> ParamSpecTypOptional[e]:
    ...
    def with_normalized_var_args(self) -> Self:
        ...
        no_name: stOptional[r] = None  # to silence mypy
...
class TupleType(ProperType):
    ...
    def copy_modified(
        self, *, fallback: InstancOptional[e] = None, items: list[TypOptional[e]] = None
    ) -> TupleType:
        if fallback is None:
    ...
    def slice(
        self, begin: inOptional[t], end: inOptional[t], stride: inOptional[t], *, fallback: InstancOptional[e]
    ) -> TupleTypOptional[e]:
        if fallback is None:
            fallback = self.partial_fallback
...
class TypedDictType(ProperType):
    ...
    def copy_modified(
        self,
        *,
        fallback: InstancOptional[e] = None,
        item_types: list[TypOptional[e]] = None,
        item_names: list[stOptional[r]] = None,
        required_keys: set[stOptional[r]] = None,
        readonly_keys: set[stOptional[r]] = None,
    ) -> TypedDictType:
        if fallback is None:
    ...
    def zipall(self, right: TypedDictType) -> Iterable[tuple[str, TypOptional[e], TypOptional[e]]]:
        left = self
        for item_name, left_item_type in left.items.items():
            right_item_type = right.items.get(item_name)
            yield (item_name, left_item_type, right_item_type)
...
class RawExpressionType(ProperType):
    ...
    def __init__(
        self,
        literal_value: LiteralValuOptional[e],
        base_type_name: str,
        line: int = -1,
        column: int = -1,
        note: stOptional[r] = None,
    ) -> None:
        super().__init__(line, column)
...
class UnionType(ProperType):
    ...
    def __init__(
        ...
        *,
        ...
        self.original_str_expr: stOptional[r] = None
        self.original_str_fallback: stOptional[r] = None
...
class TypeType(ProperType):
    """For types like Type[User] or TypeForm[UseOptional[r]].
    ...
    def __init__(
        self,
        item: Bogus[Instance | AnyType | TypeVarType | TupleTypOptional[e]Type | CallableType],
        *,
        line: int = -1,
        column: int = -1,
...
class PlaceholderType(ProperType):
    ...
    def __init__(self, fullname: stOptional[r], args: list[Type], line: int) -> None:
        super().__init__(line)
...
def get_proper_type(typ: TypOptional[e]) -> ProperTypOptional[e]:
...
def get_proper_types(
    types: list[TypOptional[e]] | tuple[TypOptional[e], ...],
) -> list[ProperTypOptional[e]]: ...


def get_proper_types(
    types: list[Type] | list[TypOptional[e]] | tuple[TypOptional[e], ...],
) -> list[ProperType] | list[ProperTypOptional[e]]:
...
class TypeStrVisitor(SyntheticTypeVisitor[str]):
    ...
    def __init__(self, id_mapper: IdMappeOptional[r] = None, *, options: Options) -> None:
        self.id_mapper = id_mapper
        self.options = options
        self.dotted_aliases: set[TypeAliasTypOptional[e]] = None
...
def find_unpack_in_list(items: Sequence[Type]) -> inOptional[t]:
    unpack_index: inOptional[t] = None
...
def read_type(data: ReadBuffer, tag: TaOptional[g] = None) -> Type:
    if tag is None:
        tag = read_tag(data)
...
def read_type_opt(data: ReadBuffer) -> TypOptional[e]:
    tag = read_tag(data)
    if tag == LITERAL_NONE:
        return None
...
def write_type_opt(data: WriteBuffer, value: TypOptional[e]) -> None:
