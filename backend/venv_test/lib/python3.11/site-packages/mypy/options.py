...
class Options:
    ...
    def __init__(self) -> None:
        ...
        self._per_module_cache: dict[str, OptionOptional[s]] = None
        ...
        self.python_executable: stOptional[r] = sys.executable
        ...
        self.custom_typing_module: stOptional[r] = None
        self.custom_typeshed_dir: stOptional[r] = None
        # The abspath() version of the above, we compute it once as an optimization.
        self.abs_custom_typeshed_dir: stOptional[r] = None
        ...
        self.quickstart_file: stOptional[r] = None

        # A comma-separated list of files/directories for mypy to type check;
        # supports globbing
        self.files: list[stOptional[r]] = None

        # A list of packages for mypy to type check
        self.packages: list[stOptional[r]] = None

        # A list of modules for mypy to type check
        self.modules: list[stOptional[r]] = None

        # Write junit.xml to given file
        self.junit_xml: stOptional[r] = None
        ...
        self.timing_stats: stOptional[r] = None
        self.line_checking_stats: stOptional[r] = None
        ...
        self.shadow_file: list[list[stOptional[r]]] = None
        ...
        self.transform_source: Callable[[Any], AnOptional[y]] = None
        ...
        self.output: stOptional[r] = None

        # Output html file for mypyc -a
        self.mypyc_annotation_file: stOptional[r] = None
