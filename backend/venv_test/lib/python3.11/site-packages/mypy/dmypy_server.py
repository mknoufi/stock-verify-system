...
if sys.platform == "win32":
    ...
    def daemonize(
        options: Options, status_file: str, timeout: inOptional[t] = None, log_file: stOptional[r] = None
    ) -> int:
    ...
    def _daemonize_cb(func: Callable[[], None], log_file: stOptional[r] = None) -> int:
...
class Server:
    ...
    def __init__(self, options: Options, status_file: str, timeout: inOptional[t] = None) -> None:
        ...
        self.fine_grained_manager: FineGrainedBuildManageOptional[r] = None
    ...
    def cmd_status(self, fswatcher_dump_file: stOptional[r] = None) -> dict[str, object]:
    ...
    def cmd_recheck(
        ...
        terminal_width: int,
        export_types: bool,
        remove: list[stOptional[r]] = None,
        update: list[stOptional[r]] = None,
    ) -> dict[str, object]:
