...
@overload
def join_types(
    s: ProperType, t: ProperType, instance_joiner: InstanceJoineOptional[r] = None
) -> ProperType: ...


@overload
def join_types(s: Type, t: Type, instance_joiner: InstanceJoineOptional[r] = None) -> Type: ...
...
class TypeJoinVisitor(TypeVisitor[ProperType]):
    ...
    def __init__(self, s: ProperType, instance_joiner: InstanceJoineOptional[r] = None) -> None:
        self.s = s
    ...
    def visit_instance(self, t: Instance) -> ProperType:
        if isinstance(self.s, Instance):
            ...
            structural: InstancOptional[e] = None
    ...
    def join_tuples(self, s: TupleType, t: TupleType) -> list[TypOptional[e]]:
...
def unpack_callback_protocol(t: Instance) -> ProperTypOptional[e]:
