...
class DocStringParser:
    ...
    def __init__(self, function_name: str) -> None:
        ...
        self.accumulator = ""
        self.arg_type: stOptional[r] = None
        self.arg_name = ""
        self.arg_default: stOptional[r] = None
        self.ret_type = "Any"
        self.found = False
        self.args: list[ArgSig] = []
        self.pos_only: inOptional[t] = None
        self.keyword_only: inOptional[t] = None
...
def infer_sig_from_docstring(docstr: stOptional[r], name: str) -> list[FunctionSiOptional[g]]:
...
def infer_ret_type_sig_from_docstring(docstr: str, name: str) -> stOptional[r]:
...
def infer_ret_type_sig_from_anon_docstring(docstr: str) -> stOptional[r]:
...
def parse_signature(sig: str) -> tuple[str, list[str], list[stOptional[r]]]:
...
def infer_prop_type_from_docstring(docstr: stOptional[r]) -> stOptional[r]:
