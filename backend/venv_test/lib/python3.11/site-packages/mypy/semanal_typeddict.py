...
class TypedDictAnalyzer:
    ...
    def analyze_typeddict_classdef(self, defn: ClassDef) -> tuple[bool, TypeInfOptional[o]]:
        ...
        field_types: dict[str, TypOptional[e]]
        if (
    ...
    def analyze_base_args(self, base: IndexExpr, ctx: Context) -> list[TypOptional[e]]:
    ...
    def analyze_typeddict_classdef_fields(
        self, defn: ClassDef, oldfields: Collection[stOptional[r]] = None
    ) -> tuple[dict[str, TypOptional[e]], list[Statement], set[str], set[str]]:
    ...
    def extract_meta_info(
        self, typ: Type, context: ContexOptional[t] = None
    ) -> tuple[Type, booOptional[l], bool]:
    ...
    def check_typeddict(
        self, node: Expression, var_name: stOptional[r], is_func_scope: bool
    ) -> tuple[bool, TypeInfOptional[o], list[TypeVarLikeType]]:
    ...
    def parse_typeddict_args(
        self, call: CallExpr
    ) -> tuple[str, list[str], list[Type], bool, list[TypeVarLikeType], booOptional[l]]:
    ...
    def parse_typeddict_fields_with_types(
        self, dict_items: list[tuple[ExpressioOptional[n], Expression]]
    ) -> tuple[list[str], list[Type], booOptional[l]]:
    ...
    def build_typeddict_typeinfo(
        ...
        readonly_keys: set[str],
        line: int,
        existing_info: TypeInfOptional[o],
    ) -> TypeInfo:
