...
class StubSource:
    ...
    def __init__(
        self, module: str, path: stOptional[r] = None, runtime_all: list[stOptional[r]] = None
    ) -> None:
        self.source = BuildSource(path, module, None)
        self.runtime_all = runtime_all
        self.ast: MypyFilOptional[e] = None
...
class ASTStubGenerator(BaseStubGenerator, mypy.traverser.TraverserVisitor):
    ...
    @property
    def _current_class(self) -> ClassDeOptional[f]:
    ...
    def _get_func_return(self, o: FuncDef, ctx: FunctionContext) -> stOptional[r]:
        ...
        if has_yield_expression(o) or has_yield_from_expression(o):
            ...
            yield_name = "None"
            send_name: stOptional[r] = None
            return_name: stOptional[r] = None
    ...
    def _get_func_docstring(self, node: FuncDef) -> stOptional[r]:
        ...
        for lvalue in o.lvalues:
            ...
            if isinstance(lvalue, (TupleExpr, ListExpr)):
                ...
                if isinstance(o.unanalyzed_type, TupleType):  # type: ignore[misc]
                    annotations: Iterable[TypOptional[e]] = o.unanalyzed_type.items
                else:
    ...
    def _get_namedtuple_fields(self, call: CallExpr) -> list[tuple[str, stOptional[r]]]:
    ...
    def process_typeddict(self, lvalue: NameExpr, rvalue: CallExpr) -> None:
        ...
        total: ExpressioOptional[n] = None
    ...
    def get_init(
        self, lvalue: str, rvalue: Expression, annotation: TypOptional[e] = None
    ) -> stOptional[r]:
...
class SelfTraverser(mypy.traverser.TraverserVisitor):
    def __init__(self) -> None:
        self.results: list[tuple[str, Expression, TypOptional[e]]] = []
...
def find_self_initializers(fdef: FuncBase) -> list[tuple[str, Expression, TypOptional[e]]]:
...
def main(args: list[stOptional[r]] = None) -> None:
