...
class DeferredNode(NamedTuple):
    ...
    active_typeinfo: TypeInfOptional[o]
...
class TypeChecker(NodeVisitor[None], TypeCheckerSharedApi):
    ...
    # for consistency.
    inferred_attribute_types: dict[Var, TypOptional[e]] = None
    ...
    _variance_dummy_type: InstancOptional[e]
    ...
    @property
    def type_context(self) -> list[TypOptional[e]]:
    ...
    def check_second_pass(
        self,
        todo: Sequence[DeferredNode | FineGrainedDeferredNodOptional[e]] = None,
        *,
    ...
    def defer_node(self, node: DeferredNodeType, enclosing_class: TypeInfOptional[o]) -> None:
    ...
    def accept_loop(
        self,
        body: Statement,
        else_body: StatemenOptional[t] = None,
        *,
        exit_condition: ExpressioOptional[n] = None,
        on_enter_body: Callable[[], NonOptional[e]] = None,
    ) -> None:
    ...
    def extract_callable_type(self, inner_type: TypOptional[e], ctx: Context) -> CallableTypOptional[e]:
        """Get type as seen by an overload item caller."""
        inner_type = get_proper_type(inner_type)
        outer_type: FunctionLikOptional[e] = None
    ...
    def check_overlapping_overloads(self, defn: OverloadedFuncDef) -> None:
        ...
        impl_type: CallableTypOptional[e] = None
        if defn.impl:
            if isinstance(defn.impl, FuncDef):
                inner_type: TypOptional[e] = defn.impl.type
        ...
        for i, item in enumerate(defn.items):
            ...
            if impl_type is not None:
                ...
                if impl_type.variables:
                    impl: CallableTypOptional[e] = unify_generic_callable(
    ...
    def check_func_item(
        self,
        defn: FuncItem,
        type_override: CallableTypOptional[e] = None,
        name: stOptional[r] = None,
    ...
    def check_func_def(
        self, defn: FuncItem, typ: CallableType, name: stOptional[r], allow_empty: bool = False
    ) -> None:
        """Type check a function definition."""
        ...
        for item, typ in expanded:
            ...
            with self.binder.top_frame_context():
                ...
                with self.scope.push_function(defn):
                    ...
                    ref_type: TypOptional[e] = self.scope.active_self_type()
    ...
    def check_explicit_override_decorator(
        ...
        found_method_base_classes: list[TypeInfOptional[o]],
        context: ContexOptional[t] = None,
    ) -> None:
    ...
    def get_op_other_domain(self, tp: FunctionLike) -> TypOptional[e]:
    ...
    def check_init_subclass(self, defn: ClassDef) -> None:
        ...
        for base in defn.info.mro[1:]:
            ...
            arg_names: list[stOptional[r]] = list(defn.keywords.keys())
    ...
    def check_enum_bases(self, defn: ClassDef) -> None:
        ...
        """
        enum_base: InstancOptional[e] = None
    ...
    def get_variable_type_context(self, inferred: Var, rvalue: Expression) -> TypOptional[e]:
        type_contexts = []
        if inferred.info:
    ...
    def node_type_from_base(
        ...
        *,
        ...
        is_class: bool = False,
        current_class: TypeInfOptional[o] = None,
    ) -> tuple[TypOptional[e], SymbolNodOptional[e]]:
    ...
    def check_compatibility_classvar_super(
        self, node: Var, base: TypeInfo, base_node: NodOptional[e]
    ) -> bool:
    ...
    def check_if_final_var_override_writable(
        self, name: str, base_node: NodOptional[e], ctx: Context
    ) -> None:
    ...
    def is_assignable_slot(self, lvalue: Lvalue, typ: TypOptional[e]) -> bool:
    ...
    def check_assignment_to_multiple_lvalues(
        ...
        if isinstance(rvalue, (TupleExpr, ListExpr)):
            ...
            iterable_type: TypOptional[e] = None
            last_idx: inOptional[t] = None
            for idx_rval, rval in enumerate(self.flatten_rvalues(rvalue.items)):
                if isinstance(rval, StarExpr):
                    ...
                    rvalues.append(rval)
            iterable_start: inOptional[t] = None
            iterable_end: inOptional[t] = None
    ...
    def check_rvalue_count_in_assignment(
        ...
        rvalue_count: int,
        context: Context,
        rvalue_unpack: inOptional[t] = None,
    ) -> bool:
    ...
    def check_lvalue(
        self, lvalue: Lvalue, rvalue: ExpressioOptional[n] = None
    ) -> tuple[TypOptional[e], IndexExpOptional[r], VaOptional[r]]:
        lvalue_type = None
        index_lvalue = None
        inferred = None
    ...
    def check_simple_assignment(
        ...
        *,
        notes: list[stOptional[r]] = None,
        lvalue: ExpressioOptional[n] = None,
        inferred: VaOptional[r] = None,
    ) -> tuple[Type, TypOptional[e]]:
    ...
    def type_requires_usage(self, typ: Type) -> tuple[str, ErrorCodOptional[e]]:
    ...
    def analyze_range_native_int_type(self, expr: Expression) -> TypOptional[e]:
    ...
    def analyze_container_item_type(self, typ: Type) -> TypOptional[e]:
    ...
    def visit_decorator_inner(
        ...
        for d in reversed(e.decorators[1:] if skip_first_item else e.decorators):
            ...
            object_type: TypOptional[e] = None
    ...
    def check_async_with_item(
        self, expr: Expression, target: ExpressioOptional[n], infer_lvalue_type: bool
    ) -> Type:
        echk = self.expr_checker
    ...
    def conditional_callable_type_map(
        self, expr: Expression, current_type: TypOptional[e]
    ...
    ) -> tuple[TypOptional[e], TypOptional[e]]:
        """
    ...
    def find_type_equals_check(
        ...
        type_being_compared: list[TypeRangOptional[e]] = None
    ...
    def find_isinstance_check_helper(
        ...
        if isinstance(node, CallExpr) and len(node.args) != 0:
            ...
            if_map: dict[Expression, TypOptional[e]]
            else_map: dict[Expression, TypOptional[e]]
            if_map = {}
            else_map = {}
    ...
    def refine_parent_types(self, expr: Expression, expr_type: Type) -> Mapping[Expression, Type]:
        ...
        while True:
            ...
            if isinstance(expr, MemberExpr):
                ...
                def replay_lookup(new_parent_type: ProperType) -> TypOptional[e]:
    ...
    def literal_int_expr(self, expr: Expression) -> inOptional[t]:
    ...
    def narrow_with_len(self, typ: Type, op: str, size: int) -> tuple[TypOptional[e], TypOptional[e]]:
    ...
    def refine_instance_type_with_len(
        ...
        if op in ("==", "is"):
            ...
            if allow_precise:
                ...
                no_type: TypOptional[e] = TupleType(items=[arg] * size + [unpack], fallback=typ)
            else:
                no_type = typ
            if allow_precise:
                items = []
                ...
                yes_type: TypOptional[e] = UnionType.make_union(items, typ.line, typ.column)
            else:
                yes_type = typ
            return yes_type, no_type
        else:
    ...
    def check_subtype(
        ...
        context: Context,
        msg: str,
        subtype_label: stOptional[r] = None,
        supertype_label: stOptional[r] = None,
        *,
        notes: list[stOptional[r]] = None,
        code: ErrorCodOptional[e] = None,
        outer_context: ContexOptional[t] = None,
    ) -> bool: ...
    ...
    def get_precise_awaitable_type(self, typ: Type, local_errors: ErrorWatcher) -> TypOptional[e]:
    ...
    def check_possible_missing_await(
        self, subtype: Type, supertype: Type, context: Context, code: ErrorCodOptional[e]
    ) -> None:
    ...
    def lookup_type_or_none(self, node: Expression) -> TypOptional[e]:
    ...
    def find_partial_types(self, var: Var) -> dict[Var, ContexOptional[t]]:
    ...
    def find_partial_types_in_all_scopes(
        self, var: Var
    ) -> tuple[bool, bool, dict[Var, ContexOptional[t]]]:
    ...
    def temp_node(self, t: Type, context: ContexOptional[t] = None) -> TempNode:
        """Create a temporary node with the given, fixed type."""
        return TempNode(t, context=context)

    def fail(
        self, msg: str | ErrorMessage, context: Context, *, code: ErrorCodOptional[e] = None
    ) -> ErrorInfo:
    ...
    def conditional_types_with_intersection(
        self,
        expr_type: Type,
        type_ranges: list[TypeRangOptional[e]],
        ctx: Context,
        default: None = None,
        *,
    ...
    def conditional_types_with_intersection(
        ...
        *,
        ...
        yes_type: TypOptional[e] = initial_types[0]
        no_type: TypOptional[e] = initial_types[1]
    ...
    def get_isinstance_type(self, expr: Expression) -> list[TypeRangOptional[e]]:
    ...
    def get_expression_type(self, node: Expression, type_context: TypOptional[e] = None) -> Type:
        return self.expr_checker.accept(node, type_context=type_context)

    def is_defined_in_stub(self, typ: Instance, /) -> bool:
        return self.modules[typ.type.module_name].is_stub

    def check_deprecated(self, node: NodOptional[e], context: Context) -> None:
    ...
    def warn_deprecated(self, node: NodOptional[e], context: Context) -> None:
        """Warn if deprecated."""
        if isinstance(node, Decorator):
            node = node.func
        if (
...
class TypeCheckerAsSemanticAnalyzer(SemanticAnalyzerCoreInterface):
    ...
    def lookup_fully_qualified_or_none(self, fullname: str, /) -> SymbolTableNodOptional[e]:
        try:
    ...
    def note(self, msg: str, ctx: Context, *, code: ErrorCodOptional[e] = None) -> None:
        pass
    ...
    def defer(self, debug_context: ContexOptional[t] = None, force_progress: bool = False) -> None:
        pass
    ...
    @property
    def type(self) -> TypeInfOptional[o]:
...
def conditional_types(
    current_type: Type,
    proposed_type_ranges: list[TypeRangOptional[e]],
    default: None = None,
    *,
    consider_runtime_isinstance: bool = True,
) -> tuple[TypOptional[e], TypOptional[e]]: ...
...
def conditional_types(
    ...
    *,
    ...
    if isinstance(proper_type, UnionType):
        result: list[tuple[TypOptional[e], TypOptional[e]]] = [
            conditional_types(
                union_item,
...
def conditional_types_to_typemaps(
    expr: Expression, yes_type: TypOptional[e], no_type: TypOptional[e]
) -> tuple[TypeMap, TypeMap]:
...
def is_literal_not_implemented(n: ExpressioOptional[n]) -> bool:
...
def builtin_item_type(tp: Type) -> TypOptional[e]:
...
def _find_inplace_method(inst: Instance, method: str, operator: str) -> stOptional[r]:
...
def is_classmethod_node(node: SymbolNodOptional[e]) -> booOptional[l]:
...
def is_node_static(node: SymbolNodOptional[e]) -> booOptional[l]:
...
def group_comparison_operands(
    ...
    last_operator: stOptional[r] = None
...
def is_typed_callable(c: TypOptional[e]) -> bool:
    c = get_proper_type(c)
...
def is_untyped_decorator(typ: TypOptional[e]) -> bool:
    typ = get_proper_type(typ)
    if not typ:
        return True
...
def is_settable_property(defn: SymbolNodOptional[e]) -> TypeGuard[OverloadedFuncDef]:
    if isinstance(defn, OverloadedFuncDef):
        if defn.items and isinstance(defn.items[0], Decorator):
            return defn.items[0].func.is_property
    return False
...
def is_custom_settable_property(defn: SymbolNodOptional[e]) -> bool:
...
def is_typeddict_type_context(lvalue_type: TypOptional[e]) -> bool:
    if lvalue_type is None:
        return False
...
def is_method(node: SymbolNodOptional[e]) -> bool:
