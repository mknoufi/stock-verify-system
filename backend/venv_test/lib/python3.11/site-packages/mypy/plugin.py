...
class TypeAnalyzerPluginInterface:
    ...
    @abstractmethod
    def fail(self, msg: str, ctx: Context, *, code: ErrorCodOptional[e] = None) -> None:
    ...
    ) -> tuple[list[Type], list[ArgKind], list[stOptional[r]]] | None:
...
class CommonPluginApi:
    ...
    @abstractmethod
    def lookup_fully_qualified(self, fullname: str) -> SymbolTableNodOptional[e]:
...
class CheckerPluginInterface:
    ...
    @abstractmethod
    def fail(
        self, msg: str | ErrorMessage, ctx: Context, /, *, code: ErrorCodOptional[e] = None
    ) -> ErrorInfOptional[o]:
        """Emit an error message at given location."""
        raise NotImplementedError
...
class FunctionContext(NamedTuple):
    ...
    callee_arg_names: list[stOptional[r]]
    ...
    arg_names: list[list[stOptional[r]]]
...
class Plugin(CommonPluginApi):
    ...
    def __init__(self, options: Options) -> None:
        ...
        self._modules: dict[str, MypyFilOptional[e]] = None
    ...
    def get_type_analyze_hook(self, fullname: str) -> Callable[[AnalyzeTypeContext], TypOptional[e]]:
    ...
    def get_function_signature_hook(
        self, fullname: str
    ) -> Callable[[FunctionSigContext], FunctionLikOptional[e]]:
    ...
    def get_function_hook(self, fullname: str) -> Callable[[FunctionContext], TypOptional[e]]:
    ...
    def get_method_signature_hook(
        self, fullname: str
    ) -> Callable[[MethodSigContext], FunctionLikOptional[e]]:
    ...
    def get_method_hook(self, fullname: str) -> Callable[[MethodContext], TypOptional[e]]:
    ...
    def get_attribute_hook(self, fullname: str) -> Callable[[AttributeContext], TypOptional[e]]:
    ...
    def get_class_attribute_hook(self, fullname: str) -> Callable[[AttributeContext], TypOptional[e]]:
        """
    ...
    def get_class_decorator_hook(self, fullname: str) -> Callable[[ClassDefContext], NonOptional[e]]:
    ...
    def get_class_decorator_hook_2(
        self, fullname: str
    ) -> Callable[[ClassDefContext], booOptional[l]]:
        """Update class definition for given class decorators.
    ...
    def get_metaclass_hook(self, fullname: str) -> Callable[[ClassDefContext], NonOptional[e]]:
    ...
    def get_base_class_hook(self, fullname: str) -> Callable[[ClassDefContext], NonOptional[e]]:
    ...
    def get_customize_class_mro_hook(
        self, fullname: str
    ) -> Callable[[ClassDefContext], NonOptional[e]]:
    ...
    def get_dynamic_class_hook(
        self, fullname: str
    ) -> Callable[[DynamicClassDefContext], NonOptional[e]]:
