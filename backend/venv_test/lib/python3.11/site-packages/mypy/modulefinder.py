...
class FindModuleCache:
    ...
    def __init__(
        ...
        options: OptionOptional[s],
        stdlib_py_versions: StdlibVersionOptional[s] = None,
        source_set: BuildSourceSeOptional[t] = None,
    ) -> None:
    ...
    def find_module_via_source_set(self, id: str) -> ModuleSearchResulOptional[t]:
...
def default_lib_path(
    data_dir: str, pyversion: tuple[int, int], custom_typeshed_dir: stOptional[r]
) -> list[str]:
...
@functools.cache
def get_search_dirs(python_executable: stOptional[r]) -> tuple[list[str], list[str]]:
...
def compute_search_paths(
    sources: list[BuildSource], options: Options, data_dir: str, alt_lib_path: stOptional[r] = None
) -> SearchPaths:
...
def load_stdlib_py_versions(custom_typeshed_dir: stOptional[r]) -> StdlibVersions:
