...
class MemberContext:
    ...
    def __init__(
        ...
        *,
        ...
        is_self: bool = False,
        rvalue: ExpressioOptional[n] = None,
...
def analyze_member_access(
    ...
    *,
    ...
    original_type: Type,
    chk: TypeCheckerSharedApi,
    override_info: TypeInfOptional[o] = None,
...
def _analyze_member_access(
    name: str, typ: Type, mx: MemberContext, override_info: TypeInfOptional[o] = None
) -> Type:
...
def analyze_instance_member_access(
    name: str, typ: Instance, mx: MemberContext, override_info: TypeInfOptional[o]
) -> Type:
    info = typ.type
    if override_info:
        info = override_info
...
def analyze_type_type_member_access(
    name: str, typ: TypeType, mx: MemberContext, override_info: TypeInfOptional[o]
) -> Type:
...
def analyze_var(
    ...
    *,
    ...
    if var.is_settable_property and mx.is_lvalue:
        typ: TypOptional[e] = var.setter_type
    ...
    if typ:
        ...
        call_type: ProperTypOptional[e] = None
...
def analyze_class_attribute_access(
    ...
    *,
    ...
    override_info: TypeInfOptional[o] = None,
    original_vars: Sequence[TypeVarLikeTypOptional[e]] = None,
) -> TypOptional[e]:
    ...
    if t:
        ...
        if isinstance(node.node, Decorator):
            super_info: TypeInfOptional[o] = node.node.var.info
...
def apply_class_attr_hook(
    mx: MemberContext, hook: Callable[[AttributeContext], TypOptional[e]], result: Type
) -> TypOptional[e]:
    if hook:
        result = hook(
            AttributeContext(
...
def analyze_typeddict_access(
    name: str, typ: TypedDictType, mx: MemberContext, override_info: TypeInfOptional[o]
) -> Type:
    if name == "__setitem__":
...
def bind_self_fast(method: F, original_type: TypOptional[e] = None) -> F:
