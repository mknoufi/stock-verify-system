...
class ExpressionChecker(ExpressionVisitor[Type], ExpressionCheckerSharedApi):
    ...
    type_context: list[TypOptional[e]]
    ...
    _arg_infer_context_cache: ArgumentInferContexOptional[t]
    ...
    def __init__(
        ...
        self.expr_cache: dict[
            tuple[Expression, TypOptional[e]],
            tuple[int, Type, list[ErrorInfo], dict[Expression, Type]],
        ] = {}
        self.in_lambda_expr = False

        self._literal_true: InstancOptional[e] = None
        self._literal_false: InstancOptional[e] = None
    ...
    def method_fullname(self, object_type: Type, method_name: str) -> stOptional[r]:
    ...
    def defn_returns_none(self, defn: SymbolNodOptional[e]) -> bool:
    ...
    def validate_typeddict_kwargs(
        self, kwargs: Iterable[tuple[ExpressioOptional[n], Expression]], callee: TypedDictType
    ) -> tuple[dict[str, list[Expression]], set[stOptional[r]]]:
    ...
    def match_typeddict_call_with_dict(
        self,
        callee: TypedDictType,
        kwargs: list[tuple[ExpressioOptional[n], Expression]],
        context: Context,
    ) -> bool:
        result = self.validate_typeddict_kwargs(kwargs=kwargs, callee=callee)
        if result is not None:
    ...
    def typeddict_callable_from_context(
        self, callee: TypedDictType, variables: Sequence[TypeVarLikeTypOptional[e]] = None
    ) -> CallableType:
        return CallableType(
    ...
    def get_partial_self_var(self, expr: MemberExpr) -> VaOptional[r]:
    ...
    def get_partial_var(self, ref: RefExpr) -> tuple[Var, dict[Var, ContexOptional[t]]]:
        var = ref.node
    ...
    def apply_function_plugin(
        ...
        arg_kinds: list[ArgKind],
        arg_types: list[Type],
        arg_names: Sequence[stOptional[r]] | None,
        formal_to_actual: list[list[int]],
        args: list[Expression],
        fullname: str,
        object_type: TypOptional[e],
        context: Context,
    ) -> Type:
        ...
        formal_arg_names: list[list[stOptional[r]]] = [[] for _ in range(num_formals)]
    ...
    def transform_callee_type(
        self,
        callable_name: stOptional[r],
        callee: Type,
        args: list[Expression],
        arg_kinds: list[ArgKind],
        context: Context,
        arg_names: Sequence[stOptional[r]] | None = None,
    ...
    def check_call(
        ...
        context: Context,
        arg_names: Sequence[stOptional[r]] | None = None,
        callable_node: ExpressioOptional[n] = None,
        callable_name: stOptional[r] = None,
        object_type: TypOptional[e] = None,
        original_type: TypOptional[e] = None,
    ) -> tuple[Type, Type]:
        """Type check a call.
    ...
    def check_callable_call(
        ...
        context: Context,
        arg_names: Sequence[stOptional[r]] | None,
        callable_node: ExpressioOptional[n],
        callable_name: stOptional[r],
        object_type: TypOptional[e],
    ) -> tuple[Type, Type]:
    ...
    def infer_arg_types_in_context(
        ...
        """
        res: list[TypOptional[e]] = [None] * len(args)
    ...
    def infer_function_type_arguments_pass2(
        ...
        arg_names: Sequence[stOptional[r]] | None,
        formal_to_actual: list[list[int]],
        old_inferred_args: Sequence[TypOptional[e]],
        need_refresh: bool,
        context: Context,
    ) -> tuple[CallableType, list[TypOptional[e]]]:
    ...
    def apply_inferred_arguments(
        self, callee_type: CallableType, inferred_args: Sequence[TypOptional[e]], context: Context
    ) -> CallableType:
    ...
    def check_argument_count(
        ...
        actual_names: Sequence[stOptional[r]] | None,
        formal_to_actual: list[list[int]],
        context: ContexOptional[t],
        object_type: TypOptional[e] = None,
        callable_name: stOptional[r] = None,
    ) -> bool:
    ...
    def check_argument_types(
        ...
        formal_to_actual: list[list[int]],
        context: Context,
        check_arg: ArgCheckeOptional[r] = None,
        object_type: TypOptional[e] = None,
    ) -> None:
    ...
    def check_overload_call(
        ...
        erased_targets: list[CallableTypOptional[e]] = None
        inferred_types: list[TypOptional[e]] = None
        unioned_result: tuple[Type, TypOptional[e]] = None
    ...
    def possible_none_type_var_overlap(
        ...
        This is needed to avoid greedy type variable match in situations like this:
            ...
            x: inOptional[t]
            foo(x)
        we want this call to infer list[inOptional[t]], not list[inOptional[t]].
        """
    ...
    def analyze_ordinary_member_access(
        self, e: MemberExpr, is_lvalue: bool, rvalue: ExpressioOptional[n] = None
    ) -> Type:
    ...
    def find_partial_type_ref_fast_path(self, expr: Expression) -> TypOptional[e]:
    ...
    def dangerous_comparison(
        ...
        right: Type,
        *,
        original_container: TypOptional[e] = None,
        seen_types: set[tuple[Type, TypOptional[e]]] = None,
    ...
    def check_op_reversible(
        ...
        def lookup_operator(op_name: str, base_type: Type) -> TypOptional[e]:
        ...
        def lookup_definer(typ: Instance, attr_name: str) -> stOptional[r]:
    ...
    def visit_index_with_type(
        ...
        left_type: Type,
        e: IndexExpr,
        original_type: ProperTypOptional[e] = None,
        self_type: TypOptional[e] = None,
    ) -> Type:
    ...
    def visit_tuple_index_helper(self, left: TupleType, n: int) -> TypOptional[e]:
        unpack_index = find_unpack_in_list(left.items)
        if unpack_index is None:
            if n < 0:
                n += len(left.items)
    ...
    def visit_tuple_slice_helper(self, left_type: TupleType, slic: SliceExpr) -> Type:
        begin: Sequence[inOptional[t]] = [None]
        end: Sequence[inOptional[t]] = [None]
        stride: Sequence[inOptional[t]] = [None]
    ...
    def try_getting_int_literals(self, index: Expression) -> list[inOptional[t]]:
    ...
    def _first_or_join_fast_item(self, items: list[Type]) -> TypOptional[e]:
    ...
    def fast_dict_type(self, e: DictExpr) -> TypOptional[e]:
        """
        ...
        values_set: set[Type] = set()
        stargs: tuple[Type, TypOptional[e]] = None
    ...
    def find_typeddict_context(
        self, context: TypOptional[e], dict_expr: DictExpr
    ...
    def infer_lambda_type_using_context(
        self, e: LambdaExpr
    ) -> tuple[CallableTypOptional[e], CallableTypOptional[e]]:
    ...
    def check_generator_or_comprehension(
        ...
        type_name: str,
        id_for_messages: str,
        additional_args: list[TypOptional[e]] = None,
    ) -> Type:
    ...
    def analyze_cond_branch(
        self,
        map: dict[Expression, TypOptional[e]],
        node: Expression,
        context: TypOptional[e],
    ...
    def _combined_context(self, ty: TypOptional[e]) -> TypOptional[e]:
        ctx_items = []
        if ty is not None:
            if has_any_type(ty):
    ...
    def accept(
        self,
        node: Expression,
        type_context: TypOptional[e] = None,
        allow_none_return: bool = False,
    ...
    def accept_maybe_cache(self, node: Expression, type_context: TypOptional[e] = None) -> Type:
    ...
    def try_parse_as_type_expression(self, maybe_type_expr: Expression) -> TypOptional[e]:
...
def has_erased_component(t: TypOptional[e]) -> bool:
...
def has_uninhabited_component(t: TypOptional[e]) -> bool:
...
def type_info_from_type(typ: Type) -> TypeInfOptional[o]:
...
def is_operator_method(fullname: stOptional[r]) -> bool:
    if not fullname:
        return False
...
def get_partial_instance_type(t: TypOptional[e]) -> PartialTypOptional[e]:
    if t is None or not isinstance(t, PartialType) or t.type is None:
        return None
    return t


def is_type_type_context(context: TypOptional[e]) -> bool:
    context = get_proper_type(context)
