...
def erase_typevars(t: Type, ids_to_erase: Container[TypeVarIOptional[d]] = None) -> Type:
...
class TypeVarEraser(TypeTranslator):
    ...
    def __init__(self, erase_id: Callable[[TypeVarId], booOptional[l]], replacement: Type) -> None:
        super().__init__()
