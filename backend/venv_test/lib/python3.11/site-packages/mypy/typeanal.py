...
def analyze_type_alias(
    ...
    allowed_alias_tvars: list[TypeVarLikeTypOptional[e]] = None,
    alias_type_params_names: list[stOptional[r]] = None,
...
class TypeAnalyser(SyntheticTypeVisitor[Type], TypeAnalyzerPluginInterface):
    ...
    def apply_concatenate_operator(self, t: UnboundType) -> Type:
        ...
        names: list[stOptional[r]] = [None] * len(args)
    ...
    def try_analyze_special_unbound_type(self, t: UnboundType, fullname: str) -> TypOptional[e]:
    ...
    def get_omitted_any(self, typ: Type, fullname: stOptional[r] = None) -> AnyType:
    ...
    def anal_type_guard(self, t: Type) -> TypOptional[e]:
    ...
    def anal_type_guard_arg(self, t: UnboundType, fullname: str) -> TypOptional[e]:
    ...
    def anal_type_is(self, t: Type) -> TypOptional[e]:
        if isinstance(t, UnboundType):
            sym = self.lookup_qualified(t.name, t)
            if sym is not None and sym.node is not None:
    ...
    def anal_type_is_arg(self, t: UnboundType, fullname: str) -> TypOptional[e]:
    ...
    def anal_star_arg_type(self, t: Type, kind: ArgKind, nested: bool) -> tuple[stOptional[r], Type]:
    ...
    def analyze_literal_param(self, idx: int, arg: Type, ctx: Context) -> list[TypOptional[e]]:
    ...
    def named_type(
        self, fullname: str, args: list[TypOptional[e]] = None, line: int = -1, column: int = -1
    ) -> Instance:
...
class MsgCallback(Protocol):
    def __call__(
        self, __msg: str, __ctx: Context, *, code: ErrorCodOptional[e] = None
    ) -> ErrorInfOptional[o]: ...
...
def get_omitted_any(
    ...
    orig_type: Type,
    options: Options,
    fullname: stOptional[r] = None,
    unexpanded_type: TypOptional[e] = None,
) -> AnyType:
    if disallow_any:
...
def fix_instance(
    ...
    any_type: AnyTypOptional[e] = None
...
def set_any_tvars(
    ...
    *,
    ...
    fail: MsgCallbacOptional[k] = None,
    unexpanded_type: TypOptional[e] = None,
) -> TypeAliasType:
...
class DivergingAliasDetector(TrivialSyntheticTypeTranslator):
    ...
    def __init__(
        ...
        lookup: Callable[[str, Context], SymbolTableNodOptional[e]],
...
def find_self_type(typ: Type, lookup: Callable[[str], SymbolTableNodOptional[e]]) -> bool:
    return typ.accept(HasSelfType(lookup))


class HasSelfType(BoolTypeQuery):
    def __init__(self, lookup: Callable[[str], SymbolTableNodOptional[e]]) -> None:
        self.lookup = lookup
        super().__init__(ANY_STRATEGY)
