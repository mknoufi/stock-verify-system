...
class MessageBuilder:
    ...
    def report(
        ...
        *,
        ...
        origin: ContexOptional[t] = None,
        offset: int = 0,
        secondary_context: ContexOptional[t] = None,
        ...
        origin_span: Iterable[inOptional[t]]
    ...
    def has_no_attr(
        ...
        member: str,
        context: Context,
        module_symbol_table: SymbolTablOptional[e] = None,
    ) -> ErrorCodOptional[e]:
    ...
    def too_few_arguments(
        self, callee: CallableType, context: Context, argument_names: Sequence[stOptional[r]] | None
    ) -> None:
        if self.prefer_simple_messages():
    ...
    def unexpected_keyword_argument_for_function(
        self, for_func: str, name: str, context: Context, *, matches: list[stOptional[r]] = None
    ) -> None:
    ...
    def does_not_return_value(self, callee_type: TypOptional[e], context: Context) -> None:
    ...
    def possible_missing_await(self, context: Context, code: ErrorCodOptional[e]) -> None:
    ...
    def reveal_locals(self, type_map: dict[str, TypOptional[e]], context: Context) -> None:
    ...
    def need_annotation_for_var(
        self, node: SymbolNode, context: Context, options: OptionOptional[s] = None
    ) -> None:
        hint = ""
    ...
    def note_call(
        self, subtype: Type, call: Type, context: Context, *, code: ErrorCodOptional[e]
    ) -> None:
        self.note(
...
def should_format_arg_as_type(arg_kind: ArgKind, arg_name: stOptional[r], verbosity: int) -> bool:
    """
...
def pretty_class_or_static_decorator(tp: CallableType) -> stOptional[r]:
...
def get_first_arg(tp: CallableType) -> stOptional[r]:
    definition = get_func_def(tp)
...
def get_conflict_protocol_types(
    left: Instance, right: Instance, class_obj: bool = False, options: OptionOptional[s] = None
...
def callable_name(type: FunctionLike) -> stOptional[r]:
    name = type.get_name()
...
def find_defining_module(modules: dict[str, MypyFile], typ: CallableType) -> MypyFilOptional[e]:
