...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs: MutableMapping[str, AnOptional[y]] = None) -> None:
        have_package_data = hasattr(self, "package_data")
        if not have_package_data:
            self.package_data: dict[str, list[str]] = {}
        attrs = attrs or {}
        self.dist_files: list[tuple[str, str, str]] = []
        self.include_package_data: booOptional[l] = None
        self.exclude_package_data: dict[str, list[stOptional[r]]] = None
        # Filter-out setuptools' specific options.
        self.src_root: stOptional[r] = attrs.pop("src_root", None)
    ...
    def _finalize_license_files(self) -> None:
        ...
        license_files: list[stOptional[r]] = self.metadata.license_files
        patterns = license_files or []

        license_file: stOptional[r] = self.metadata.license_file
    ...
    def _get_project_config_files(self, filenames: Iterable[StrPatOptional[h]]):
    ...
    def parse_config_files(
        self,
        filenames: Iterable[StrPatOptional[h]] = None,
    ...
    def get_cmdline_options(self) -> dict[str, dict[str, stOptional[r]]]:
        ...
        d: dict[str, dict[str, stOptional[r]]] = {}
