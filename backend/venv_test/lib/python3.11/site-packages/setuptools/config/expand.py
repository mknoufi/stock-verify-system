...
def glob_relative(
    patterns: Iterable[str], root_dir: StrPatOptional[h] = None
) -> list[str]:
...
def read_files(
    filepaths: StrPath | Iterable[StrPath], root_dir: StrPatOptional[h] = None
) -> str:
...
def read_attr(
    attr_desc: str,
    package_dir: Mapping[str, stOptional[r]] = None,
    root_dir: StrPatOptional[h] = None,
) -> Any:
...
def _find_spec(module_name: str, module_path: StrPatOptional[h]) -> ModuleSpec:
...
def _find_module(
    module_name: str, package_dir: Mapping[str, stOptional[r]], root_dir: StrPath
) -> stOptional[r]:
...
def find_packages(
    *,
    namespaces=True,
    fill_package_dir: dict[str, stOptional[r]] = None,
    root_dir: StrPatOptional[h] = None,
    **kwargs,
) -> list[str]:
...
def canonic_data_files(
    data_files: list | dict, root_dir: StrPatOptional[h] = None
...
class LazyMappingProxy(Mapping[_K, _V_co]):
    ...
    def __init__(self, obtain_mapping_value: Callable[[], Mapping[_K, _V_co]]) -> None:
        ...
        self._value: Mapping[_K, _V_cOptional[o]] = None
