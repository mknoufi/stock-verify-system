...
class ConfigHandler(Generic[Target]):
    ...
    def _parse_file(self, value, root_dir: StrPatOptional[h]):
    ...
    def parse(self) -> None:
        ...
        for section_name, section_options in self.sections.items():
            ...
            section_parser_method: CallablOptional[e] = getattr(
                self,
...
class ConfigMetadataHandler(ConfigHandler["DistributionMetadata"]):
    ...
    def __init__(
        ...
        ensure_discovered: expand.EnsurePackagesDiscovered,
        package_dir: dicOptional[t] = None,
        root_dir: StrPatOptional[h] = os.curdir,
    ) -> None:
