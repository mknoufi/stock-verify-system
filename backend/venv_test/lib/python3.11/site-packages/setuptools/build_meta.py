...
- build will accumulate values associated with repeated keys in a list.
  ...
  This means that an option passed by build can be ``str | list[stOptional[r]]``.
...
class _BuildMetaBackend(_ConfigSettingsTranslator):
    ...
    def build_wheel(
        ...
        metadata_directory: StrPatOptional[h] = None,
    ):
    ...
    def _get_dist_info_dir(self, metadata_directory: StrPatOptional[h]) -> stOptional[r]:
