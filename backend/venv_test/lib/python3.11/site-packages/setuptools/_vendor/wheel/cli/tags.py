...
def _compute_tags(original_tags: Iterable[str], new_tags: stOptional[r]) -> set[str]:
...
def tags(
    wheel: str,
    python_tags: stOptional[r] = None,
    abi_tags: stOptional[r] = None,
    platform_tags: stOptional[r] = None,
    build_tag: stOptional[r] = None,
    remove: bool = False,
) -> str:
