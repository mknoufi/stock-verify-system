...
@dataclass
class TransformMemo:
    node: Module | ClassDef | FunctionDef | AsyncFunctionDeOptional[f]
    parent: TransformMemOptional[o]
    path: tuple[str, ...]
    joined_path: Constant = field(init=False)
    return_annotation: expOptional[r] = None
    yield_annotation: expOptional[r] = None
    send_annotation: expOptional[r] = None
    is_async: bool = False
    ...
    memo_var_name: NamOptional[e] = field(init=False, default=None)
    ...
    def get_unused_name(self, name: str) -> str:
        memo: TransformMemOptional[o] = self
    ...
    def is_ignored_name(self, expression: expr | ExpOptional[r]) -> bool:
        top_expression = (
    ...
    def name_matches(self, expression: expr | ExpOptional[r], *names: str) -> bool:
...
class TypeguardTransformer(NodeTransformer):
    def __init__(
        self, target_path: Sequence[stOptional[r]] = None, target_lineno: inOptional[t] = None
    ) -> None:
        ...
        self.target_node: FunctionDef | AsyncFunctionDeOptional[f] = None
    ...
    def _convert_annotation(self, annotation: expOptional[r]) -> expOptional[r]:
    ...
    def visit_ClassDef(self, node: ClassDef) -> ClassDeOptional[f]:
    ...
    ) -> FunctionDef | AsyncFunctionDeOptional[f]:
        """
    ...
    def visit_Assign(self, node: Assign) -> Any:
        ...
        if isinstance(self._memo.node, (FunctionDef, AsyncFunctionDef)):
            targets: list[dict[Constant, expOptional[r]]] = []
            ...
            for target in node.targets:
                ...
                annotations_: dict[Constant, expOptional[r]] = {}
                for exp in elts:
                    prefix = ""
