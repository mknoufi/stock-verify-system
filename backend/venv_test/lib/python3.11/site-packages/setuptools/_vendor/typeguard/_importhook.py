...
def optimized_cache_from_source(path: str, debug_override: booOptional[l] = None) -> str:
...
class TypeguardFinder(MetaPathFinder):
    ...
    def __init__(self, packages: list[stOptional[r]], original_pathfinder: MetaPathFinder):
...
def install_import_hook(
    packages: Iterable[stOptional[r]] = None,
    *,
    ...
    """
    if packages is None:
        target_packages: list[stOptional[r]] = None
