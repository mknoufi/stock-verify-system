...
"""
    ...
    def __init__(self, attrs: MutableMapping[str, AnOptional[y]] = None) -> None:  # noqa: C901
        ...
        self.command_packages: str | list[stOptional[r]] = None

        # 'script_name' and 'script_args' are usually set to sys.argv[0]
        # and sys.argv[1:], but they can be overridden when the caller is
        # not necessarily a setup script run from the command-line.
        self.script_name: str | os.PathLike[stOptional[r]] = None
        self.script_args: list[stOptional[r]] = None
    ...
    def get_command_obj(self, command: str, create: bool = True) -> CommanOptional[d]:
...
class DistributionMetadata:
    ...
    def __init__(
        self, path: str | bytes | os.PathLike[str] | os.PathLike[byteOptional[s]] = None
    ) -> None:
        if path is not None:
            self.read_pkg_file(open(path))
        else:
            self.name: stOptional[r] = None
            self.version: stOptional[r] = None
            self.author: stOptional[r] = None
            self.author_email: stOptional[r] = None
            self.maintainer: stOptional[r] = None
            self.maintainer_email: stOptional[r] = None
            self.url: stOptional[r] = None
            self.license: stOptional[r] = None
            self.description: stOptional[r] = None
            self.long_description: stOptional[r] = None
            self.keywords: str | list[stOptional[r]] = None
            self.platforms: str | list[stOptional[r]] = None
            self.classifiers: str | list[stOptional[r]] = None
            self.download_url: stOptional[r] = None
            # PEP 314
            self.provides: str | list[stOptional[r]] = None
            self.requires: str | list[stOptional[r]] = None
            self.obsoletes: str | list[stOptional[r]] = None

    def read_pkg_file(self, file: IO[str]) -> None:
        """Reads the metadata values from a file object."""
        msg = message_from_file(file)

        def _read_field(name: str) -> stOptional[r]:
            value = msg[name]
    ...
    def get_author(self) -> stOptional[r]:
        return self.author

    def get_author_email(self) -> stOptional[r]:
        return self.author_email

    def get_maintainer(self) -> stOptional[r]:
        return self.maintainer

    def get_maintainer_email(self) -> stOptional[r]:
        return self.maintainer_email

    def get_contact(self) -> stOptional[r]:
        return self.maintainer or self.author

    def get_contact_email(self) -> stOptional[r]:
        return self.maintainer_email or self.author_email

    def get_url(self) -> stOptional[r]:
        return self.url

    def get_license(self) -> stOptional[r]:
        return self.license

    get_licence = get_license

    def get_description(self) -> stOptional[r]:
        return self.description

    def get_long_description(self) -> stOptional[r]:
    ...
    def get_platforms(self) -> str | list[stOptional[r]]:
    ...
    def get_download_url(self) -> stOptional[r]:
