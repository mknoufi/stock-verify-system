...
class Compiler:
    ...
    src_extensions: ClassVar[list[stOptional[r]]] = None
    obj_extension: ClassVar[stOptional[r]] = None
    static_lib_extension: ClassVar[stOptional[r]] = None
    shared_lib_extension: ClassVar[stOptional[r]] = None
    static_lib_format: ClassVar[stOptional[r]] = None  # format string
    shared_lib_format: ClassVar[stOptional[r]] = None  # prob. same as static_lib_format
    exe_extension: ClassVar[stOptional[r]] = None
    ...
    def __init__(
        ...
        self.output_dir: stOptional[r] = None
    ...
    def _is_valid_macro(name, value=None):
        """
        A valid macro is a ``name : str`` and a ``value : stOptional[r]``.
    ...
    def define_macro(self, name: str, value: stOptional[r] = None) -> None:
    ...
    def _fix_object_args(
        self, objects: list[str] | tuple[str, ...], output_dir: stOptional[r]
    ) -> tuple[list[str], str]:
    ...
    def detect_language(self, sources: str | list[str]) -> stOptional[r]:
    ...
    def preprocess(
        ...
        output_file: str | os.PathLike[stOptional[r]] = None,
        macros: list[_MacrOptional[o]] = None,
        include_dirs: list[str] | tuple[str, ...] | None = None,
        extra_preargs: list[stOptional[r]] = None,
        extra_postargs: Iterable[stOptional[r]] = None,
    ):
    ...
    def compile(
        ...
        output_dir: stOptional[r] = None,
        macros: list[_MacrOptional[o]] = None,
        include_dirs: list[str] | tuple[str, ...] | None = None,
        debug: bool = False,
        extra_preargs: list[stOptional[r]] = None,
        extra_postargs: list[stOptional[r]] = None,
    ...
    def link(
        ...
        export_symbols: Iterable[stOptional[r]] = None,
        debug: bool = False,
        extra_preargs: list[stOptional[r]] = None,
        extra_postargs: list[stOptional[r]] = None,
        build_temp: str | os.PathLike[stOptional[r]] = None,
        target_lang: stOptional[r] = None,
    ):
    ...
    def has_function(  # noqa: C901
        self,
        funcname: str,
        includes: Iterable[stOptional[r]] = None,
        include_dirs: list[str] | tuple[str, ...] | None = None,
        libraries: list[stOptional[r]] = None,
        library_dirs: list[str] | tuple[str, ...] | None = None,
    ) -> bool:
...
"""
    ...
    def object_filenames(
        ...
        output_dir: str | os.PathLike[stOptional[r]] = '',
    ) -> list[str]:
        if output_dir is None:
            output_dir = ''
        return list(
...
def get_default_compiler(osname: stOptional[r] = None, platform: stOptional[r] = None) -> str:
...
def new_compiler(
    plat: stOptional[r] = None,
    compiler: stOptional[r] = None,
    verbose: bool = False,
    dry_run: bool = False,
    force: bool = False,
) -> Compiler:
