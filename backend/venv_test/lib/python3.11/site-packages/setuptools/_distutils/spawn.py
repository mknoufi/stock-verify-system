...
def _inject_macos_ver(env: _MappingOptional[T]) -> _MappingT | dict[str, str | inOptional[t]]:
...
def _resolve(env: _MappingOptional[T]) -> _MappingT | os._Environ[str]:
...
def find_executable(executable: str, path: stOptional[r] = None) -> stOptional[r]:
