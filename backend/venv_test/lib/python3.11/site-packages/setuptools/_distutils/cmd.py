...
class Command:
    ...
    #    (command_name : string, predicate : unbound_method | strinOptional[g])
    ...
    sub_commands: ClassVar[  # Any to work around variance issues
        list[tuple[str, Callable[[Any], booOptional[l]]]]
    ] = []

    user_options: ClassVar[
        # Specifying both because list is invariant. Avoids mypy override assignment issues
        list[tuple[str, str, str]] | list[tuple[str, stOptional[r], str]]
    ] = []
    ...
    def ensure_string(self, option: str, default: stOptional[r] = None) -> None:
    ...
    def make_archive(
        ...
        base_name: str,
        format: str,
        root_dir: str | os.PathLike[str] | bytes | os.PathLike[byteOptional[s]] = None,
        base_dir: stOptional[r] = None,
        owner: stOptional[r] = None,
        group: stOptional[r] = None,
    ) -> str: ...
    @overload
    def make_archive(
        self,
