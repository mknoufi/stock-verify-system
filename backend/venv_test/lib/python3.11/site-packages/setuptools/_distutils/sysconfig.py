...
def get_python_inc(plat_specific: bool = False, prefix: stOptional[r] = None) -> str:
...
def get_python_lib(
    plat_specific: bool = False, standard_lib: bool = False, prefix: stOptional[r] = None
) -> str:
...
def get_config_var(name: Literal["SO"]) -> int | stOptional[r]: ...
@overload
def get_config_var(name: str) -> int | stOptional[r]: ...
def get_config_var(name: str) -> int | stOptional[r]:
