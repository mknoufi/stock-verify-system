...
class Extension:
    ...
    def __init__(
        ...
        include_dirs: list[stOptional[r]] = None,
        define_macros: list[tuple[str, stOptional[r]]] | None = None,
        undef_macros: list[stOptional[r]] = None,
        library_dirs: list[stOptional[r]] = None,
        libraries: list[stOptional[r]] = None,
        runtime_library_dirs: list[stOptional[r]] = None,
        extra_objects: list[stOptional[r]] = None,
        extra_compile_args: list[stOptional[r]] = None,
        extra_link_args: list[stOptional[r]] = None,
        export_symbols: list[stOptional[r]] = None,
        swig_opts: list[stOptional[r]] = None,
        depends: list[stOptional[r]] = None,
        language: stOptional[r] = None,
        optional: booOptional[l] = None,
