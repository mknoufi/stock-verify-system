...
class install(Command):
    ...
    def initialize_options(self) -> None:
        ...
        # and scheme.
        self.prefix: stOptional[r] = None
        self.exec_prefix: stOptional[r] = None
        self.home: stOptional[r] = None
        self.user = False
        ...
        self.install_lib: stOptional[r] = None  # set to either purelib or platlib
