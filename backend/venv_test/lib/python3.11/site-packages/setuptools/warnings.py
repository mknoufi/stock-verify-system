...
class SetuptoolsWarning(UserWarning):
    ...
    def emit(
        ...
        details: stOptional[r] = None,
        due_date: _DueDatOptional[e] = None,
        see_docs: stOptional[r] = None,
        see_url: stOptional[r] = None,
        stacklevel: int = 2,
        **kwargs,
    ) -> None:
    ...
    def _format(
        ...
        summary: str,
        details: str,
        due_date: datOptional[e] = None,
        see_url: stOptional[r] = None,
        format_args: dicOptional[t] = None,
    ) -> str:
        """Private: reserved for ``setuptools`` internal use only"""
        today = date.today()
