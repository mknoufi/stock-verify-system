...
class SystemInfo:
    ...
    @property
    def WindowsSdkDir(self) -> stOptional[r]:  # noqa: C901  # is too complex (12)  # FIXME
        """
...
class _EnvironmentDict(TypedDict):
    ...
    libpath: str
    path: str
    py_vcruntime_redist: NotRequired[stOptional[r]]
...
class EnvironmentInfo:
    ...
    @property
    def VCRuntimeRedist(self) -> stOptional[r]:
        """
