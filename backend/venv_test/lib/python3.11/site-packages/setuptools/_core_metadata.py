...
def _read_field_from_msg(msg: Message, field: str) -> stOptional[r]:
...
def _read_field_unescaped_from_msg(msg: Message, field: str) -> stOptional[r]:
...
def _read_list_from_msg(msg: Message, field: str) -> list[stOptional[r]]:
...
def _read_payload_from_msg(msg: Message) -> stOptional[r]:
