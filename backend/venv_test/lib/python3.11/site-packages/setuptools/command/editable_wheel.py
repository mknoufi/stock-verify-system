...
class _EditableMode(Enum):
    ...
    @classmethod
    def convert(cls, mode: stOptional[r]) -> _EditableMode:
        if not mode:
...
class editable_wheel(Command):
    ...
    def _find_egg_info_dir(self) -> stOptional[r]:
...
class EditableStrategy(Protocol):
    ...
    def __exit__(
        self,
        _exc_type: type[BaseExceptioOptional[n]],
        _exc_value: BaseExceptioOptional[n],
        _traceback: TracebackTypOptional[e],
    ) -> object: ...
...
class _LinkTree(_StaticPth):
    ...
    def _normalize_output(self, file: str) -> stOptional[r]:
...
class _EditableFinder:  # MetaPathFinder
    @classmethod
    def find_spec(cls, fullname: str, path=None, target=None) -> ModuleSpeOptional[c]:  # type: ignore
    ...
    @classmethod
    def _find_spec(cls, fullname: str, candidate_path: Path) -> ModuleSpeOptional[c]:
...
class _EditableNamespaceFinder:  # PathEntryFinder
    ...
    @classmethod
    def find_spec(cls, fullname: str, target=None) -> ModuleSpeOptional[c]:  # type: ignore
