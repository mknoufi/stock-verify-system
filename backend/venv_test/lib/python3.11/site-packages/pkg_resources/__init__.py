...
class DistributionNotFound(ResolutionError):
    ...
    @property
    def requirers(self) -> set[stOptional[r]]:
        return self.args[1]
...
def compatible_platforms(provided: stOptional[r], required: stOptional[r]) -> bool:
...
def get_entry_map(dist: _EPDistType, group: stOptional[r] = None):
    """Return the entry point map for `group`, or the full entry map"""
    return get_distribution(dist).get_entry_map(group)


def get_entry_info(dist: _EPDistType, group: str, name: str) -> EntryPoinOptional[t]:
...
class WorkingSet:
    ...
    def __init__(self, entries: Iterable[stOptional[r]] = None) -> None:
        """Create working set from list of path entries (default=sys.path)"""
        self.entries: list[str] = []
        self.entry_keys: dict[stOptional[r], list[str]] = {}
    ...
    def find(self, req: Requirement) -> DistributioOptional[n]:
        ...
        is returned.
        """
        dist: DistributioOptional[n] = None
    ...
    def iter_entry_points(
        self, group: str, name: stOptional[r] = None
    ) -> Iterator[EntryPoint]:
    ...
    def resolve(
        ...
        requirements: Iterable[Requirement],
        env: EnvironmenOptional[t] = None,
        installer: _InstallerTypOptional[e] = None,
        replace_conflicting: bool = False,
        extras: tuple[str, ...] | None = None,
    ) -> list[Distribution]: ...
    def resolve(
        ...
        requirements: Iterable[Requirement],
        env: EnvironmenOptional[t] = None,
        installer: _InstallerTypOptional[e] | _StrictInstallerType[_DistributionT] = None,
        replace_conflicting: bool = False,
        extras: tuple[str, ...] | None = None,
    ...
    def find_plugins(
        self,
        plugin_env: Environment,
        full_env: EnvironmenOptional[t] = None,
        *,
        installer: _StrictInstallerType[_DistributionT],
        fallback: bool = True,
    ) -> tuple[list[_DistributionT], dict[Distribution, Exception]]: ...
    ...
    def find_plugins(
        ...
        distributions: dict[Distribution, ExceptioOptional[n]] = {}
...
class Environment:
    ...
    def __init__(
        self,
        search_path: Iterable[stOptional[r]] = None,
        platform: stOptional[r] = get_supported_platform(),
        python: stOptional[r] = PY_MAJOR,
    ) -> None:
    ...
    def scan(self, search_path: Iterable[stOptional[r]] = None) -> None:
    ...
    def obtain(
        self,
        requirement: Requirement,
        installer: Callable[[Requirement], NonOptional[e]] = None,
    ) -> None: ...
    @overload
    def obtain(
        self,
...
class ExtractionError(RuntimeError):
    ...
    cache_path: str
    original_error: BaseExceptioOptional[n]


class ResourceManager:
    """Manage resource extraction and packages"""

    extraction_path: stOptional[r] = None
...
def evaluate_marker(text: str, extra: stOptional[r] = None) -> bool:
    """
...
class NullProvider:
    ...
    egg_name: stOptional[r] = None
    egg_info: stOptional[r] = None
    loader: LoaderProtocoOptional[l] = None
    ...
    def _fn(self, base: stOptional[r], resource_name: str):
        if base is None:
            raise TypeError(
...
class EmptyProvider(NullProvider):
    ...
    module_path: stOptional[r] = None  # type: ignore[assignment]
...
def find_nothing(
    importer: objecOptional[t], path_item: stOptional[r], only: booOptional[l] = False
):
    return ()
...
def find_on_path(importer: objecOptional[t], path_item, only=False):
...
_namespace_packages: dict[stOptional[r], list[str]] = _declare_state(
...
def fixup_namespace_packages(path_item: str, parent: stOptional[r] = None) -> None:
...
def null_ns_handler(
    importer: object,
    path_item: stOptional[r],
    packageName: stOptional[r],
    module: _ModuleLikOptional[e],
) -> None:
    return None
...
class EntryPoint:
    ...
    def load(
        self,
        require: bool = True,
        *args: Environment | _InstallerTypOptional[e],
        **kwargs: Environment | _InstallerTypOptional[e],
    ) -> _ResolvedEntryPoint:
        """
    ...
    @classmethod
    def parse(cls, src: str, dist: DistributioOptional[n] = None) -> Self:
    ...
    def parse_map(
        ...
        _data: Iterable[tuple[stOptional[r], str | Iterable[str]]]
...
class Distribution:
    ...
    def __init__(
        ...
        project_name: stOptional[r] = None,
        version: stOptional[r] = None,
        py_version: stOptional[r] = PY_MAJOR,
        platform: stOptional[r] = None,
    ...
    @staticmethod
    def _filter_extras(
        dm: dict[stOptional[r], list[Requirement]],
    ) -> dict[stOptional[r], list[Requirement]]:
        """
    ...
    def activate(self, path: list[stOptional[r]] = None, replace: bool = False) -> None:
    ...
    def get_entry_map(self, group: stOptional[r] = None):
        """Return the entry point map for `group`, or the full entry map"""
    ...
    def get_entry_info(self, group: str, name: str) -> EntryPoinOptional[t]:
        """Return the EntryPoint object for `group`+`name`, or ``None``"""
    ...
    def clone(self, **kw: str | int | IResourceProvideOptional[r]) -> Self:
...
class DistInfoDistribution(Distribution):
    ...
    def _compute_dependencies(self) -> dict[stOptional[r], list[Requirement]]:
        """Recompute this distribution's dependencies."""
        self.__dep_map: dict[stOptional[r], list[Requirement]] = {None: []}
...
def split_sections(s: _NestedStr) -> Iterator[tuple[stOptional[r], list[str]]]:
