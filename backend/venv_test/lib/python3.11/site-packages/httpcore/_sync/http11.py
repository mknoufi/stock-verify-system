...
class HTTP11Connection(ConnectionInterface):
    ...
    def _send_event(self, event: h11.Event, timeout: floaOptional[t] = None) -> None:
...
class HTTP11UpgradeStream(NetworkStream):
    ...
    def read(self, max_bytes: int, timeout: floaOptional[t] = None) -> bytes:
    ...
    def write(self, buffer: bytes, timeout: floaOptional[t] = None) -> None:
