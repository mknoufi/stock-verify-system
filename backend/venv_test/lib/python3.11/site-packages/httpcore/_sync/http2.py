...
class HTTP2Connection(ConnectionInterface):
    ...
    def __init__(
        ...
        self._connection_terminated: h2.events.ConnectionTerminateOptional[d] = None

        self._read_exception: ExceptioOptional[n] = None
        self._write_exception: ExceptioOptional[n] = None
    ...
    def _receive_events(
        self, request: Request, stream_id: inOptional[t] = None
    ) -> None:
        """
