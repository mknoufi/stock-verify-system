...
def enforce_headers(
    value: HeadersAsMapping | HeadersAsSequencOptional[e] = None, *, name: str
...
def enforce_stream(
    value: bytes | typing.Iterable[bytes] | typing.AsyncIterable[byteOptional[s]],
    *,
    name: str,
...
class Request:
    ...
    def __init__(
        ...
        *,
        ...
        | None = None,
        extensions: ExtensionOptional[s] = None,
    ) -> None:
        """
        Parameters:
...
class Proxy:
    def __init__(
        self,
        url: URL | bytes | str,
        auth: tuple[bytes | str, bytes | stOptional[r]] = None,
        headers: HeadersAsMapping | HeadersAsSequencOptional[e] = None,
        ...
        if auth is not None:
            ...
            self.auth: tuple[bytes, byteOptional[s]] = (username, password)
