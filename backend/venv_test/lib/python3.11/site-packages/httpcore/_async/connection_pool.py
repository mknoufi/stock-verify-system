...
class AsyncPoolRequest:
    def __init__(self, request: Request) -> None:
        ...
        self.connection: AsyncConnectionInterfacOptional[e] = None
        self._connection_acquired = AsyncEvent()

    def assign_to_connection(self, connection: AsyncConnectionInterfacOptional[e]) -> None:
    ...
    async def wait_for_connection(
        self, timeout: floaOptional[t] = None
...
class AsyncConnectionPool(AsyncRequestInterface):
    ...
    async def __aexit__(
        ...
        traceback: types.TracebackTypOptional[e] = None,
    ) -> None:
        await self.aclose()
