...
async def _init_socks5_connection(
    ...
    *,
    host: bytes,
    port: int,
    auth: tuple[bytes, byteOptional[s]] = None,
) -> None:
...
class AsyncSOCKSProxy(AsyncConnectionPool):  # pragma: nocover
    ...
    def __init__(
        ...
        if proxy_auth is not None:
            ...
            self._proxy_auth: tuple[bytes, byteOptional[s]] = (
                username_bytes,
                password_bytes,
            )
        else:
...
class AsyncSocks5Connection(AsyncConnectionInterface):
    def __init__(
        ...
        proxy_origin: Origin,
        remote_origin: Origin,
        proxy_auth: tuple[bytes, byteOptional[s]] = None,
        ssl_context: ssl.SSLContexOptional[t] = None,
        keepalive_expiry: floaOptional[t] = None,
        http1: bool = True,
        http2: bool = False,
        ...
        self._connection: AsyncConnectionInterfacOptional[e] = None
