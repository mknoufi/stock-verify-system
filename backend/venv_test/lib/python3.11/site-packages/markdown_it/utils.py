...
class OptionsType(TypedDict):
    ...
    highlight: Callable[[str, str, str], stOptional[r]]
...
class OptionsDict(MutableMappingABC):  # type: ignore
    ...
    @property
    def highlight(self) -> Callable[[str, str, str], stOptional[r]]:
        """Highlighter function: (content, langName, langAttrs) -> escaped HTML."""
        return self._options["highlight"]

    @highlight.setter
    def highlight(self, value: Callable[[str, str, str], stOptional[r]]) -> None:
