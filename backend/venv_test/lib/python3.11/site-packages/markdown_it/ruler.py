...
class Ruler(Generic[RuleFuncTv]):
    def __init__(self) -> None:
        ...
        self.__cache__: dict[str, list[RuleFuncTOptional[v]]] = None
    ...
    def at(
        self, ruleName: str, fn: RuleFuncTv, options: RuleOptionsTypOptional[e] = None
    ) -> None:
    ...
    def before(
        ...
        ruleName: str,
        fn: RuleFuncTv,
        options: RuleOptionsTypOptional[e] = None,
    ) -> None:
