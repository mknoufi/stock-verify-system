...
def charCodeAt(src: str, pos: int) -> inOptional[t]:
    """
...
def charStrAt(src: str, pos: int) -> stOptional[r]:
    """
    Returns the Unicode value of the character at the specified location.
...
def isSpace(code: inOptional[t]) -> bool:
    """Check if character code is a whitespace."""
    return code in (0x09, 0x20)


def isStrSpace(ch: stOptional[r]) -> bool:
