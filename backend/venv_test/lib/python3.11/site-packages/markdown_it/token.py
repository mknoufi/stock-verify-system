...
class Token:
    ...
    map: list[inOptional[t]] = None
    """Source map info. Format: `[ line_begin, line_end ]`"""

    level: int = 0
    """Nesting level, the same as `state.level`"""

    children: list[TokeOptional[n]] = None
    ...
    def as_dict(
        ...
        *,
        ...
        meta_serializer: Callable[[dict[Any, Any]], AnOptional[y]] = None,
        filter: Callable[[str, Any], booOptional[l]] = None,
