...
class SyntaxTreeNode:
    ...
    def __init__(
        ...
        self.token: TokeOptional[n] = None

        # Only containers have nester tokens
        self.nester_tokens: _NesterTokenOptional[s] = None
    ...
    @property
    def parent(self: _NodeType) -> _NodeTypOptional[e]:
        return self._parent  # type: ignore

    @parent.setter
    def parent(self: _NodeType, value: _NodeTypOptional[e]) -> None:
        self._parent = value
    ...
    @property
    def next_sibling(self: _NodeType) -> _NodeTypOptional[e]:
    ...
    @property
    def previous_sibling(self: _NodeType) -> _NodeTypOptional[e]:
    ...
    @property
    def map(self) -> tuple[int, inOptional[t]]:
