...
class MarkdownIt:
    def __init__(
        ...
        options_update: Mapping[str, AnOptional[y]] = None,
        *,
    ...
    def configure(
        self, presets: str | PresetType, options_update: Mapping[str, AnOptional[y]] = None
    ) -> MarkdownIt:
    ...
    def parse(self, src: str, env: EnvTypOptional[e] = None) -> list[Token]:
    ...
    def render(self, src: str, env: EnvTypOptional[e] = None) -> Any:
    ...
    def parseInline(self, src: str, env: EnvTypOptional[e] = None) -> list[Token]:
    ...
    def renderInline(self, src: str, env: EnvTypOptional[e] = None) -> Any:
