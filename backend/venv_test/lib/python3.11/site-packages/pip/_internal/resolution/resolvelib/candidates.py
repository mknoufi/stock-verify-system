...
def as_base_candidate(candidate: Candidate) -> BaseCandidatOptional[e]:
...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __init__(
        ...
        factory: Factory,
        name: NormalizedNamOptional[e] = None,
        version: VersioOptional[n] = None,
    ) -> None:
        self._link = link
    ...
    @property
    def source_link(self) -> LinOptional[k]:
    ...
    def iter_dependencies(self, with_requires: bool) -> Iterable[RequiremenOptional[t]]:
    ...
    def get_install_requirement(self) -> InstallRequiremenOptional[t]:
        return self._ireq
