...
class Factory:
    def __init__(
        ...
        wheel_cache: WheelCachOptional[e],
        use_user_site: bool,
    ...
    def _make_candidate_from_link(
        ...
        extras: frozenset[str],
        template: InstallRequirement,
        name: NormalizedNamOptional[e],
        version: VersioOptional[n],
    ) -> CandidatOptional[e]:
        base: BaseCandidatOptional[e] = self._make_base_candidate_from_link(
    ...
    def _iter_found_candidates(
        ...
        def _get_installed_candidate() -> CandidatOptional[e]:
    ...
    def make_requirements_from_spec(
        self,
        specifier: str,
        comes_from: InstallRequiremenOptional[t],
    ...
    def get_wheel_cache_entry(self, link: Link, name: stOptional[r]) -> CacheEntrOptional[y]:
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> BaseDistributioOptional[n]:
    ...
    def _report_single_requirement_conflict(
        self, req: Requirement, parent: CandidatOptional[e]
    ) -> DistributionNotFound:
        if parent is None:
            req_disp = str(req)
        else:
