...
class Resolver(BaseResolver):
    ...
    def __init__(
        ...
        self._result: ResulOptional[t] = None
...
def get_topological_weights(
    graph: DirectedGraph[stOptional[r]], requirement_keys: set[str]
) -> dict[stOptional[r], int]:
    ...
    requirement_keys.
    """
    path: set[stOptional[r]] = set()
    weights: dict[stOptional[r], list[int]] = {}

    def visit(node: stOptional[r]) -> None:
        if node in path:
