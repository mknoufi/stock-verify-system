...
class LinkEvaluator:
    ...
    def __init__(
        ...
        allow_yanked: bool,
        ignore_requires_python: booOptional[l] = None,
    ) -> None:
        """
...
class BestCandidateResult:
    ...
    best_candidate: InstallationCandidatOptional[e]
...
class CandidateEvaluator:
    ...
    def create(
        cls,
        project_name: str,
        target_python: TargetPythoOptional[n] = None,
        prefer_binary: bool = False,
        allow_all_prereleases: bool = False,
        specifier: specifiers.BaseSpecifieOptional[r] = None,
        hashes: HasheOptional[s] = None,
    ) -> CandidateEvaluator:
    ...
    def sort_best_candidate(
        self,
        candidates: list[InstallationCandidate],
    ) -> InstallationCandidatOptional[e]:
        """
...
class PackageFinder:
    ...
    def __init__(
        ...
        target_python: TargetPython,
        allow_yanked: bool,
        format_control: FormatControOptional[l] = None,
        candidate_prefs: CandidatePreferenceOptional[s] = None,
        ignore_requires_python: booOptional[l] = None,
    ) -> None:
        """
        ...
        self._best_candidates: dict[
            tuple[str, specifiers.BaseSpecifieOptional[r], HasheOptional[s]],
            BestCandidateResult,
        ] = {}
    ...
    @property
    def custom_cert(self) -> stOptional[r]:
    ...
    @property
    def client_cert(self) -> stOptional[r]:
    ...
    def find_requirement(
        ...
        installed_version: _BaseVersioOptional[n] = None
        ...
        def _should_install_candidate(
            candidate: InstallationCandidatOptional[e],
...
def _extract_version_from_fragment(fragment: str, canonical_name: str) -> stOptional[r]:
