...
class DiagnosticPipError(PipError):
    ...
    def __init__(
        ...
        *,
        ...
        reference: stOptional[r] = None,
        message: str | Text,
        context: str | TexOptional[t],
        hint_stmt: str | TexOptional[t],
        note_stmt: str | TexOptional[t] = None,
        link: stOptional[r] = None,
    ) -> None:
...
class NetworkConnectionError(PipError):
    ...
    def __init__(
        self,
        error_msg: str,
        response: ResponsOptional[e] = None,
...
class InstallationSubprocessError(DiagnosticPipError, InstallationError):
    ...
    def __init__(
        ...
        *,
        ...
        exit_code: int,
        output_lines: list[stOptional[r]],
    ) -> None:
...
class HashError(InstallationError):
    ...
    req: InstallRequiremenOptional[t] = None
    head = ""
    order: int = -1
...
class ConfigurationFileCouldNotBeLoaded(ConfigurationError):
    ...
    def __init__(
        ...
        error: configparser.ErroOptional[r] = None,
    ) -> None:
...
class ExternallyManagedEnvironment(DiagnosticPipError):
    ...
    def __init__(self, error: stOptional[r]) -> None:
        if error is None:
