...
def message_about_scripts_not_on_PATH(scripts: Sequence[str]) -> stOptional[r]:
...
"""
    ...
    def make(
        self, specification: str, options: dict[str, AnOptional[y]] = None
    ) -> list[str]:
...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    direct_url: DirectUrOptional[l] = None,
