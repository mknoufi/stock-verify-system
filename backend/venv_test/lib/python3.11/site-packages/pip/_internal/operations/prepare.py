...
def get_http_url(
    link: Link,
    download: Downloader,
    download_dir: stOptional[r] = None,
...
def get_file_url(
    link: Link, download_dir: stOptional[r] = None, hashes: HasheOptional[s] = None
) -> File:
    ...
    def _log_preparing_link(self, req: InstallRequirement) -> None:
        ...
        if req.req and req.comes_from:
            if isinstance(req.comes_from, str):
                comes_from: stOptional[r] = req.comes_from
            else:
