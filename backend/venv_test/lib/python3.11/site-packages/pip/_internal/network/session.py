...
class LocalFSAdapter(BaseAdapter):
    def send(
        ...
        stream: bool = False,
        timeout: float | tuple[float, floaOptional[t]] = None,
        verify: bool | str = True,
        cert: str | tuple[str, stOptional[r]] = None,
        proxies: Mapping[str, stOptional[r]] = None,
    ) -> Response:
...
class _SSLContextAdapterMixin:
    ...
    def __init__(
        self,
        *,
        ssl_context: SSLContexOptional[t] = None,
        **kwargs: Any,
    ) -> None:
...
class InsecureHTTPAdapter(HTTPAdapter):
    def cert_verify(
        ...
        url: str,
        verify: bool | str,
        cert: str | tuple[str, stOptional[r]],
    ) -> None:
...
class PipSession(requests.Session):
    timeout: inOptional[t] = None

    def __init__(
        self,
        *args: Any,
        retries: int = 0,
        cache: stOptional[r] = None,
        ...
        **kwargs: Any,
        ...
        self.pip_trusted_origins: list[tuple[str, inOptional[t]]] = []
        self.pip_proxy = None
    ...
    def add_trusted_host(
        self, host: str, source: stOptional[r] = None, suppress_logging: bool = False
    ) -> None:
        """
