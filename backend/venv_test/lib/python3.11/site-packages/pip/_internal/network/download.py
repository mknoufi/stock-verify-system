...
def _get_http_response_size(resp: Response) -> inOptional[t]:
    try:
...
def _get_http_response_etag_or_last_modified(resp: Response) -> stOptional[r]:
    """
...
def _log_download(
    ...
    total_length: inOptional[t],
    range_start: inOptional[t] = 0,
) -> Iterable[bytes]:
...
def _get_http_response_filename(resp: Response, link: Link) -> str:
    ...
    ext: stOptional[r] = splitext(filename)[1]
    if not ext:
