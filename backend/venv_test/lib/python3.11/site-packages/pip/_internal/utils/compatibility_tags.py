...
def _expand_allowed_platforms(platforms: list[stOptional[r]]) -> list[stOptional[r]]:
    if not platforms:
        return None
...
def _get_custom_interpreter(
    implementation: stOptional[r] = None, version: stOptional[r] = None
) -> str:
...
def get_supported(
    ...
    platforms: list[stOptional[r]] = None,
    impl: stOptional[r] = None,
    abis: list[stOptional[r]] = None,
) -> list[Tag]:
