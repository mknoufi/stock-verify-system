...
class ParsedRequirement:
    ...
    comes_from: str
    constraint: bool
    options: dict[str, AnOptional[y]]
    line_source: stOptional[r]
...
class ParsedLine:
    ...
    @property
    def requirement(self) -> stOptional[r]:
        if self.args:
            return self.args
...
def parse_requirements(
    filename: str,
    session: PipSession,
    finder: PackageFindeOptional[r] = None,
    options: optparse.ValueOptional[s] = None,
...
def handle_option_line(
    ...
    finder: PackageFindeOptional[r] = None,
    options: optparse.ValueOptional[s] = None,
    session: PipSessioOptional[n] = None,
) -> None:
    if opts.hashes:
        logger.warning(
...
class RequirementsFileParser:
    ...
    def _parse_and_recurse(
        ...
        filename: str,
        constraint: bool,
        parsed_files_stack: list[dict[str, stOptional[r]]],
    ) -> Generator[ParsedLine, None, None]:
...
def get_line_parser(finder: PackageFindeOptional[r]) -> LineParser:
