...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: list[str]) -> int:
        ...
        target_temp_dir: TempDirectorOptional[y] = None
        target_temp_dir_path: stOptional[r] = None
        ...
        try:
            ...
            conflicts: ConflictDetailOptional[s] = None
...
def site_packages_writable(root: stOptional[r], isolated: bool) -> bool:
    return all(
        test_writable_dir(d)
...
def decide_user_install(
    use_user_site: booOptional[l],
    prefix_path: stOptional[r] = None,
    target_dir: stOptional[r] = None,
    root_path: stOptional[r] = None,
