...
class PackageVcs:
    ...
    requested_revision: stOptional[r]
    commit_id: str
    subdirectory: stOptional[r]


@dataclass
class PackageDirectory:
    path: str
    editable: booOptional[l]
    subdirectory: stOptional[r]
...
class Package:
    ...
    vcs: PackageVcOptional[s] = None
    directory: PackageDirectorOptional[y] = None
    archive: PackageArchivOptional[e] = None
    # (not supported) index: Optional[str]
    sdist: PackageSdisOptional[t] = None
    wheels: list[PackageWheeOptional[l]] = None
