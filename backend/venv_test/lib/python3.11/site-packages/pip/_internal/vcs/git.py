...
class Git(VersionControl):
    ...
    @classmethod
    def get_current_branch(cls, location: str) -> stOptional[r]:
        """
    ...
    @classmethod
    def get_revision_sha(cls, dest: str, rev: str) -> tuple[stOptional[r], bool]:
        """
    ...
    @classmethod
    def get_revision(cls, location: str, rev: stOptional[r] = None) -> str:
        if rev is None:
            rev = "HEAD"
