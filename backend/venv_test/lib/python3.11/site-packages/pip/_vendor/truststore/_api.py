...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    def wrap_socket(
        ...
        session: ssl.SSLSessioOptional[n] = None,
    ) -> ssl.SSLSocket:
    ...
    def load_verify_locations(
        self,
        cafile: str | bytes | os.PathLike[str] | os.PathLike[byteOptional[s]] = None,
        capath: str | bytes | os.PathLike[str] | os.PathLike[byteOptional[s]] = None,
    ...
    def load_cert_chain(
        ...
        keyfile: _StrOrBytesPatOptional[h] = None,
        password: _PasswordTypOptional[e] = None,
    ) -> None:
...
def _verify_peercerts(
    sock_or_sslobj: ssl.SSLSocket | ssl.SSLObject, server_hostname: stOptional[r]
) -> None:
    """
