...
class CacheController:
    ...
    def __init__(
        self,
        cache: BaseCachOptional[e] = None,
        cache_etags: bool = True,
        serializer: SerializeOptional[r] = None,
        status_codes: Collection[inOptional[t]] = None,
    ):
    ...
    def parse_cache_control(self, headers: Mapping[str, str]) -> dict[str, inOptional[t]]:
        known_directives = {
    ...
    def _load_from_cache(self, request: PreparedRequest) -> HTTPResponsOptional[e]:
        """
    ...
    def _cache_set(
        ...
        body: byteOptional[s] = None,
        expires_time: inOptional[t] = None,
    ) -> None:
        """
