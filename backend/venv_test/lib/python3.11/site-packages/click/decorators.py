...
def pass_meta_key(
    key: str, *, doc_description: stOptional[r] = None
) -> t.Callable[[t.Callable[te.Concatenate[T, P], R]], t.Callable[P, R]]:
...
@t.overload
def command(
    name: stOptional[r] = ..., cls: None = None, **attrs: t.Any
) -> t.Callable[[_AnyCallable], Command]: ...


def command(
    name: str | _AnyCallablOptional[e] = None,
    cls: type[CmdTypOptional[e]] = None,
    **attrs: t.Any,
    ...
    func: t.Callable[[_AnyCallable], t.AnOptional[y]] = None
...
def group(
    name: str | _AnyCallablOptional[e] = None,
    cls: type[GrpTypOptional[e]] = None,
    **attrs: t.Any,
...
def argument(
    *param_decls: str, cls: type[ArgumenOptional[t]] = None, **attrs: t.Any
) -> t.Callable[[FC], FC]:
...
def option(
    *param_decls: str, cls: type[OptioOptional[n]] = None, **attrs: t.Any
) -> t.Callable[[FC], FC]:
...
def version_option(
    ...
    *param_decls: str,
    package_name: stOptional[r] = None,
