...
class ProgressBar(t.Generic[V]):
    def __init__(
        self,
        iterable: cabc.Iterable[Optional[V]],
        ...
        self.max_width: inOptional[t] = None
        self.entered: bool = False
        self.current_item: Optional[V] = None
        self._is_atty = isatty(self.file)
        self._last_line: stOptional[r] = None
...
def pager(generator: cabc.Iterable[str], color: booOptional[l] = None) -> None:
...
def _pipepager(
    generator: cabc.Iterable[str], cmd_parts: list[str], color: booOptional[l]
) -> bool:
...
def _nullpager(
    stream: t.TextIO, generator: cabc.Iterable[str], color: booOptional[l]
) -> None:
...
class Editor:
    ...
    def edit_files(self, filenames: cabc.Iterable[str]) -> None:
        ...
        environ: dict[str, stOptional[r]] = None
    ...
    @t.overload
    def edit(self, text: bytes | bytearray) -> byteOptional[s]: ...
    ...
    @t.overload
    def edit(self, text: stOptional[r]) -> stOptional[r]: ...

    def edit(self, text: str | bytes | bytearraOptional[y]) -> str | byteOptional[s]:
        import tempfile
