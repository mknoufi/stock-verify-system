...
) -> tuple[cabc.Sequence[str | cabc.Sequence[stOptional[r]] | None], list[str]]:
...
def _normalize_opt(opt: str, ctx: ContexOptional[t]) -> str:
...
class _Option:
    def __init__(
        ...
        dest: stOptional[r],
        action: stOptional[r] = None,
        nargs: int = 1,
        const: t.AnOptional[y] = None,
    ):
        self._short_opts = []
        self._long_opts = []
...
class _Argument:
    def __init__(self, obj: CoreArgument, dest: stOptional[r], nargs: int = 1):
        self.dest = dest
        self.nargs = nargs
        self.obj = obj
    ...
    def process(
        self,
        value: str | cabc.Sequence[stOptional[r]] | None | T_UNSET,
        state: _ParsingState,
    ) -> None:
        if self.nargs > 1:
...
class _OptionParser:
    ...
    def __init__(self, ctx: ContexOptional[t] = None) -> None:
    ...
    def add_argument(self, obj: CoreArgument, dest: stOptional[r], nargs: int = 1) -> None:
    ...
    def _match_long_opt(
        self, opt: str, explicit_value: stOptional[r], state: _ParsingState
    ) -> None:
