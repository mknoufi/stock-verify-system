...
class ParamType:
    ...
    #: Windows).
    envvar_list_splitter: t.ClassVar[stOptional[r]] = None
    ...
    def __call__(
        self,
        value: t.Any,
        param: ParameteOptional[r] = None,
        ctx: ContexOptional[t] = None,
    ) -> t.Any:
        if value is not None:
            return self.convert(value, param, ctx)

    def get_metavar(self, param: Parameter, ctx: Context) -> stOptional[r]:
        """Returns the metavar default for this param if it provides one."""

    def get_missing_message(self, param: Parameter, ctx: ContexOptional[t]) -> stOptional[r]:
    ...
    def convert(
        self, value: t.Any, param: ParameteOptional[r], ctx: ContexOptional[t]
    ) -> t.Any:
...
class Choice(ParamType, t.Generic[ParamTypeValue]):
    ...
    def _normalized_mapping(
        self, ctx: ContexOptional[t] = None
    ...
    def normalize_choice(self, choice: ParamTypeValue, ctx: ContexOptional[t]) -> str:
        """
    ...
    def get_missing_message(self, param: Parameter, ctx: ContexOptional[t]) -> str:
        """
    ...
    def get_invalid_choice_message(self, value: t.Any, ctx: ContexOptional[t]) -> str:
...
class DateTime(ParamType):
    ...
    def __init__(self, formats: cabc.Sequence[stOptional[r]] = None):
    ...
    def _try_to_convert_date(self, value: t.Any, format: str) -> datetimOptional[e]:
        try:
...
class _NumberRangeBase(_NumberParamTypeBase):
    def __init__(
        self,
        min: floaOptional[t] = None,
        max: floaOptional[t] = None,
        min_open: bool = False,
        max_open: bool = False,
        clamp: bool = False,
    ) -> None:
...
class BoolParamType(ParamType):
    ...
    @staticmethod
    def str_to_bool(value: str | bool) -> booOptional[l]:
...
class File(ParamType):
    ...
    def convert(
        ...
        param: ParameteOptional[r],
        ctx: ContexOptional[t],
    ) -> t.IO[t.Any]:
...
class Path(ParamType):
    ...
    def __init__(
        ...
        path_type: type[t.AnOptional[y]] = None,
...
def convert_type(ty: t.AnOptional[y], default: t.AnOptional[y] = None) -> ParamType:
