...
def augment_usage_errors(
    ctx: Context, param: ParameteOptional[r] = None
) -> cabc.Iterator[None]:
...
class Context:
    ...
    def __init__(
        self,
        command: Command,
        parent: ContexOptional[t] = None,
        info_name: stOptional[r] = None,
        obj: t.AnOptional[y] = None,
        auto_envvar_prefix: stOptional[r] = None,
        default_map: cabc.MutableMapping[str, t.AnOptional[y]] = None,
        terminal_width: inOptional[t] = None,
        max_content_width: inOptional[t] = None,
        resilient_parsing: bool = False,
        allow_extra_args: booOptional[l] = None,
        allow_interspersed_args: booOptional[l] = None,
        ignore_unknown_options: booOptional[l] = None,
        help_option_names: list[stOptional[r]] = None,
        token_normalize_func: t.Callable[[str], stOptional[r]] = None,
        color: booOptional[l] = None,
        show_default: booOptional[l] = None,
    ) -> None:
        ...
        self.default_map: cabc.MutableMapping[str, t.AnOptional[y]] = default_map
        ...
        self.invoked_subcommand: stOptional[r] = None

        if terminal_width is None and parent is not None:
            terminal_width = parent.terminal_width

        #: The width of the terminal (None is autodetection).
        self.terminal_width: inOptional[t] = terminal_width
        ...
        self.max_content_width: inOptional[t] = max_content_width
        ...
        self.token_normalize_func: t.Callable[[str], stOptional[r]] = token_normalize_func
        ...
        self.auto_envvar_prefix: stOptional[r] = auto_envvar_prefix

        if color is None and parent is not None:
            color = parent.color

        #: Controls if styling output is wanted or not.
        self.color: booOptional[l] = color

        if show_default is None and parent is not None:
            show_default = parent.show_default

        #: Show option default values when formatting help text.
        self.show_default: booOptional[l] = show_default
    ...
    def __exit__(
        self,
        exc_type: type[BaseExceptioOptional[n]],
        exc_value: BaseExceptioOptional[n],
        tb: TracebackTypOptional[e],
    ) -> booOptional[l]:
        self._depth -= 1
        exit_result: booOptional[l] = None
        if self._depth == 0:
    ...
    def find_object(self, object_type: type[V]) -> Optional[V]:
        """Finds the closest object of a given type."""
        node: ContexOptional[t] = self
    ...
    ) -> t.Any | t.Callable[[], t.AnOptional[y]]: ...

    def lookup_default(self, name: str, call: bool = True) -> t.AnOptional[y]:
    ...
    def get_parameter_source(self, name: str) -> ParameterSourcOptional[e]:
...
class Command:
    ...
    def __init__(
        self,
        name: stOptional[r],
        context_settings: cabc.MutableMapping[str, t.AnOptional[y]] = None,
        callback: t.Callable[..., t.AnOptional[y]] = None,
        params: list[ParameteOptional[r]] = None,
        help: stOptional[r] = None,
        epilog: stOptional[r] = None,
        short_help: stOptional[r] = None,
        options_metavar: stOptional[r] = "[OPTIONS]",
    ...
    def get_help_option(self, ctx: Context) -> OptioOptional[n]:
    ...
    def main(
        self,
        args: cabc.Sequence[stOptional[r]] = None,
        prog_name: stOptional[r] = None,
        complete_var: stOptional[r] = None,
...
class Group(Command):
    ...
    #:
    #: .. versionadded:: 8.0
    command_class: type[CommanOptional[d]] = None
    ...
    #:
    #: .. versionadded:: 8.0
    group_class: type[Group] | type[typOptional[e]] = None
    ...
    def __init__(
        ...
        no_args_is_help: booOptional[l] = None,
        subcommand_metavar: stOptional[r] = None,
        chain: bool = False,
        result_callback: t.Callable[..., t.AnOptional[y]] = None,
        **kwargs: t.Any,
    ) -> None:
    ...
    def add_command(self, cmd: Command, name: stOptional[r] = None) -> None:
    ...
    def command(
        ...
        func: t.Callable[..., t.AnOptional[y]] = None
    ...
    def get_command(self, ctx: Context, cmd_name: str) -> CommanOptional[d]:
    ...
    ) -> tuple[stOptional[r], CommanOptional[d], list[str]]:
...
class CommandCollection(Group):
    ...
    def __init__(
        self,
        name: stOptional[r] = None,
        sources: list[GrouOptional[p]] = None,
        **kwargs: t.Any,
    ) -> None:
        super().__init__(name, **kwargs)
...
class Parameter:
    ...
    def __init__(
        self,
        param_decls: cabc.Sequence[stOptional[r]] = None,
        type: types.ParamType | t.AnOptional[y] = None,
        required: bool = False,
        ...
        default: t.Any | t.Callable[[], t.AnOptional[y]] = UNSET,
        callback: t.Callable[[Context, Parameter, t.Any], t.AnOptional[y]] = None,
        nargs: inOptional[t] = None,
        multiple: bool = False,
        metavar: stOptional[r] = None,
        expose_value: bool = True,
        is_eager: bool = False,
        envvar: str | cabc.Sequence[stOptional[r]] = None,
        ...
        self.default: t.Any | t.Callable[[], t.AnOptional[y]] = default
    ...
    ) -> tuple[stOptional[r], list[str], list[str]]:
    ...
    def resolve_envvar_value(self, ctx: Context) -> stOptional[r]:
    ...
    def value_from_envvar(self, ctx: Context) -> str | cabc.Sequence[stOptional[r]]:
    ...
    def get_help_record(self, ctx: Context) -> tuple[str, stOptional[r]]:
        pass
...
class Option(Parameter):
    ...
    def __init__(
        self,
        param_decls: cabc.Sequence[stOptional[r]] = None,
        show_default: bool | stOptional[r] = None,
        prompt: bool | str = False,
        confirmation_prompt: bool | str = False,
        prompt_required: bool = True,
        hide_input: bool = False,
        is_flag: booOptional[l] = None,
        ...
        **attrs: t.Any,
        ...
        if prompt is True:
            ...
            prompt_text: stOptional[r] = self.name.replace("_", " ").capitalize()
