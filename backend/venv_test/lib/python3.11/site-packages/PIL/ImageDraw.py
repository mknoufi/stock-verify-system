...
class ImageDraw:
    font: (
        ...
        | ImageFont.TransposedFonOptional[t]
    ) = None

    def __init__(self, im: Image.Image, mode: stOptional[r] = None) -> None:
        """
    ...
    def _getink(
        self, ink: _InOptional[k], fill: _InOptional[k] = None
    ) -> tuple[inOptional[t], inOptional[t]]:
        result_ink = None
        result_fill = None
    ...
    def bitmap(
        self, xy: Sequence[int], bitmap: Image.Image, fill: _InOptional[k] = None
    ) -> None:
        """Draw a bitmap."""
        bitmap.load()
        ink, fill = self._getink(fill)
    ...
    def point(self, xy: Coords, fill: _InOptional[k] = None) -> None:
    ...
    def rounded_rectangle(
        ...
        width: int = 1,
        *,
        corners: tuple[bool, bool, bool, booOptional[l]] = None,
    ) -> None:
    ...
    def text(
        ...
        anchor: stOptional[r] = None,
        spacing: float = 4,
        align: str = "left",
        direction: stOptional[r] = None,
        features: list[stOptional[r]] = None,
        language: stOptional[r] = None,
        stroke_width: float = 0,
        stroke_fill: _InOptional[k] = None,
        ...
        **kwargs: Any,
        ...
        def getink(fill: _InOptional[k]) -> int:
...
def Draw(im: Image.Image, mode: stOptional[r] = None) -> ImageDraw:
    """
    A simple 2D drawing interface for PIL images.
...
def getdraw(
    im: Image.ImagOptional[e] = None,
) -> tuple[ImageDraw2.DraOptional[w], ModuleType]:
    """
    :param im: The image to draw in.
