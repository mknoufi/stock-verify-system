...
def version_module(feature: str) -> stOptional[r]:
    """
    :param feature: The module to check for.
    :returns:
...
def version_codec(feature: str) -> stOptional[r]:
    """
    :param feature: The codec to check for.
    :returns:
...
features: dict[str, tuple[str, str, stOptional[r]]] = {
...
def check_feature(feature: str) -> booOptional[l]:
    """
...
def version_feature(feature: str) -> stOptional[r]:
    """
    :param feature: The feature to check for.
...
def check(feature: str) -> booOptional[l]:
    """
...
def version(feature: str) -> stOptional[r]:
    """
    :param feature:
...
def pilinfo(out: IO[stOptional[r]] = None, supported_formats: bool = True) -> None:
    """
