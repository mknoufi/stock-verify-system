...
class Text:
    def __init__(
        ...
        self.stroke_fill: _InOptional[k] = None
    ...
    def stroke(self, width: float = 0, fill: _InOptional[k] = None) -> None:
        """
    ...
    def _split(
        self, xy: tuple[float, float], anchor: stOptional[r], align: str
    ...
    def get_bbox(
        ...
        """
        bbox: tuple[float, float, float, floaOptional[t]] = None
        fontmode = self._get_fontmode()
