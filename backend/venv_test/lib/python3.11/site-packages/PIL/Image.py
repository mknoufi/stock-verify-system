...
ElementTree: ModuleTypOptional[e]
try:
...
MAX_IMAGE_PIXELS: inOptional[t] = int(1024 * 1024 * 1024 // 4 // 3)
...
OPEN: dict[
    ...
    tuple[
        ...
        Callable[[bytes], bool | stOptional[r]],
    ],
] = {}
MIME: dict[str, str] = {}
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    format: stOptional[r] = None
    format_description: stOptional[r] = None
    _close_exclusive_fp_after_loading = True

    def __init__(self) -> None:
        # FIXME: take "new" parameters / other image?
        self._im: core.ImagingCore | DeferredErroOptional[r] = None
        self._mode = ""
        self._size = (0, 0)
        self.palette: ImagePalette.ImagePalettOptional[e] = None
        self.info: dict[str | tuple[int, int], Any] = {}
        self.readonly = 0
        self._exif: ExiOptional[f] = None
    ...
    def close(self) -> None:
        ...
        if getattr(self, "map", None):
            if sys.platform == "win32" and hasattr(sys, "pypy_version_info"):
                self.map.close()
            self.map: mmap.mmaOptional[p] = None
    ...
    def _dump(
        self, file: stOptional[r] = None, format: stOptional[r] = None, **options: Any
    ) -> str:
        suffix = ""
        if format:
            suffix = f".{format}"
    ...
    def _repr_image(self, image_format: str, **kwargs: Any) -> byteOptional[s]:
    ...
    def _repr_png_(self) -> byteOptional[s]:
    ...
    def _repr_jpeg_(self) -> byteOptional[s]:
    ...
    def __arrow_c_array__(
        self, requested_schema: objecOptional[t] = None
    ) -> tuple[object, object]:
        self.load()
    ...
    def load(self) -> core.PixelAccesOptional[s]:
        """
    ...
    def convert(
        self,
        mode: stOptional[r] = None,
        matrix: tuple[float, ...] | None = None,
        dither: DitheOptional[r] = None,
    ...
    def quantize(
        self,
        colors: int = 256,
        method: inOptional[t] = None,
        kmeans: int = 0,
        palette: ImagOptional[e] = None,
    ...
    def crop(self, box: tuple[float, float, float, floaOptional[t]] = None) -> Image:
        """
    ...
    def draft(
        self, mode: stOptional[r], size: tuple[int, inOptional[t]]
    ) -> tuple[str, tuple[int, int, float, floaOptional[t]]]:
        """
    ...
    ) -> tuple[int, int, int, inOptional[t]]:
        """
    ...
    ) -> list[tuple[int, tuple[int, ...]]] | list[tuple[int, floaOptional[t]]]:
        """
    ...
    def getdata(self, band: inOptional[t] = None) -> core.ImagingCore:
        """
    ...
    def getxmp(self) -> dict[str, Any]:
        ...
        def get_value(element: Element) -> str | dict[str, AnOptional[y]]:
    ...
    def getpalette(self, rawmode: stOptional[r] = "RGB") -> list[inOptional[t]]:
        """
    ...
    def histogram(
        self,
        mask: ImagOptional[e] = None,
        extrema: tuple[float, floaOptional[t]] = None,
    ) -> list[int]:
        """
    ...
    def paste(
        ...
        box: Image | tuple[int, int, int, int] | tuple[int, inOptional[t]] = None,
        mask: ImagOptional[e] = None,
    ) -> None:
        """
    ...
    def remap_palette(
        self, dest_map: list[int], source_palette: bytes | bytearraOptional[y] = None
    ) -> Image:
        """
    ...
    def resize(
        ...
        resample: inOptional[t] = None,
        box: tuple[float, float, float, floaOptional[t]] = None,
        reducing_gap: floaOptional[t] = None,
    ) -> Image:
        """
    ...
    def reduce(
        ...
        box: tuple[int, int, int, inOptional[t]] = None,
    ) -> Image:
        """
    ...
    def rotate(
        ...
        center: tuple[float, floaOptional[t]] = None,
        translate: tuple[int, inOptional[t]] = None,
        fillcolor: float | tuple[float, ...] | stOptional[r] = None,
    ) -> Image:
        """
    ...
    def show(self, title: stOptional[r] = None) -> None:
        """
    ...
    def thumbnail(
        ...
        reducing_gap: floaOptional[t] = 2.0,
    ) -> None:
        """
        ...
        def preserve_aspect_ratio() -> tuple[int, inOptional[t]]:
    ...
    def transform(
        ...
        data: Sequence[AnOptional[y]] = None,
...
def new(
    ...
    color: float | tuple[float, ...] | stOptional[r] = 0,
) -> Image:
    """
...
def fromarray(obj: SupportsArrayInterface, mode: stOptional[r] = None) -> Image:
    """
...
def register_open(
    ...
    accept: Callable[[bytes], bool | stOptional[r]] = None,
) -> None:
    """
...
def _apply_env_variables(env: dict[str, stOptional[r]] = None) -> None:
...
class Exif(_ExifBase):
    ...
    def __init__(self) -> None:
        ...
        self._info: TiffImagePlugin.ImageFileDirectory_vOptional[2] = None
        self._loaded_exif: byteOptional[s] = None
    ...
    def _get_ifd_dict(
        self, offset: int, group: inOptional[t] = None
    ) -> dict[int, AnOptional[y]]:
        try:
    ...
    def load_from_fp(self, fp: IO[bytes], offset: inOptional[t] = None) -> None:
