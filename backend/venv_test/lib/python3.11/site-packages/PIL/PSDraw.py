...
class PSDraw:
    ...
    def __init__(self, fp: IO[byteOptional[s]] = None) -> None:
        if not fp:
            fp = sys.stdout.buffer
        self.fp = fp

    def begin_document(self, id: stOptional[r] = None) -> None:
    ...
    def image(
        self, box: tuple[int, int, int, int], im: Image.Image, dpi: inOptional[t] = None
    ) -> None:
