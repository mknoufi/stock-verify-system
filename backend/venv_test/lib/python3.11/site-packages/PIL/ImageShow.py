...
def show(image: Image.Image, title: stOptional[r] = None, **options: Any) -> bool:
    r"""
...
class Viewer:
    ...
    def get_format(self, image: Image.Image) -> stOptional[r]:
...
class DisplayViewer(UnixViewer):
    ...
    def get_command_ex(
        self, file: str, title: stOptional[r] = None, **options: Any
    ) -> tuple[str, str]:
