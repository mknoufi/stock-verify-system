...
class Axis(TypedDict):
    minimum: inOptional[t]
    default: inOptional[t]
    maximum: inOptional[t]
    name: byteOptional[s]
...
class ImageFont:
    ...
    def _load_pilfont(self, filename: str) -> None:
        with open(filename, "rb") as fp:
            image: ImageFile.ImageFilOptional[e] = None
...
class FreeTypeFont:
    ...
    def __init__(
        ...
        index: int = 0,
        encoding: str = "",
        layout_engine: LayouOptional[t] = None,
    ) -> None:
    ...
    def getname(self) -> tuple[stOptional[r], stOptional[r]]:
        """
    ...
    def getmask(
        ...
        anchor: stOptional[r] = None,
        ink: int = 0,
        start: tuple[float, floaOptional[t]] = None,
    ) -> Image.core.ImagingCore:
        """
        Create a bitmap for the text.
    ...
    def font_variant(
        self,
        font: StrOrBytesPath | BinaryIOptional[O] = None,
        size: floaOptional[t] = None,
        index: inOptional[t] = None,
...
class TransposedFont:
    ...
    def __init__(
        ...
        orientation: Image.TransposOptional[e] = None,
    ):
        """
...
def load_default(size: floaOptional[t] = None) -> FreeTypeFont | ImageFont:
