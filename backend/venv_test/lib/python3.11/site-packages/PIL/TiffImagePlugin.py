...
class ImageFileDirectory_v2(_IFDv2Base):
    ...
    def reset(self) -> None:
        ...
        self._next = None
        self._offset: inOptional[t] = None
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def __init__(
        ...
        filename: str | byteOptional[s] = None,
    ) -> None:
    ...
    def _load_libtiff(self) -> Image.core.PixelAccesOptional[s]:
...
class AppendingTiffWriter(io.BytesIO):
    ...
    def setup(self) -> None:
        ...
        self.whereToWriteNewIFDOffset: inOptional[t] = None
    ...
    @staticmethod
    def _verify_bytes_written(bytes_written: inOptional[t], expected: int) -> None:
