...
def register_handler(handler: ImageFile.StubHandleOptional[r]) -> None:
    """
...
class WmfStubImageFile(ImageFile.StubImageFile):
    ...
    def _load(self) -> ImageFile.StubHandleOptional[r]:
        return _handler

    def load(
        self, dpi: float | tuple[float, floaOptional[t]] = None
    ) -> Image.core.PixelAccesOptional[s]:
        if dpi is not None:
            self.info["dpi"] = dpi
