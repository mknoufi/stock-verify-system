...
class _Tile(NamedTuple):
    codec_name: str
    extents: tuple[int, int, int, inOptional[t]]
    offset: int = 0
    args: tuple[Any, ...] | stOptional[r] = None
...
class ImageFile(Image.Image):
    ...
    def __init__(
        self, fp: StrOrBytesPath | IO[bytes], filename: str | byteOptional[s] = None
    ) -> None:
        super().__init__()

        self._min_frame = 0

        self.custom_mimetype: stOptional[r] = None
    ...
    def get_format_mimetype(self) -> stOptional[r]:
    ...
    def load(self) -> Image.core.PixelAccesOptional[s]:
...
class StubImageFile(ImageFile, metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def _load(self) -> StubHandleOptional[r]:
...
class Parser:
    ...
    incremental = None
    image: Image.ImagOptional[e] = None
    data: byteOptional[s] = None
    decoder: Image.core.ImagingDecoder | PyDecodeOptional[r] = None
    offset = 0
    finished = 0
...
def _encode_tile(
    ...
    bufsize: int,
    fh: inOptional[t],
    exc: BaseExceptioOptional[n] = None,
) -> None:
...
class PyCodec:
    fd: IO[byteOptional[s]]

    def __init__(self, mode: str, *args: Any) -> None:
        self.im: Image.core.ImagingCorOptional[e] = None
    ...
    def setimage(
        ...
        extents: tuple[int, int, int, inOptional[t]] = None,
    ) -> None:
        """
...
class PyDecoder(PyCodec):
    ...
    def set_as_raw(
        self, data: bytes, rawmode: stOptional[r] = None, extra: tuple[Any, ...] = ()
    ) -> None:
        """
