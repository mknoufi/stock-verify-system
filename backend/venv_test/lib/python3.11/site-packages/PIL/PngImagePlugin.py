...
class ChunkStream:
    def __init__(self, fp: IO[bytes]) -> None:
        self.fp: IO[byteOptional[s]] = fp
        self.queue: list[tuple[bytes, int, inOptional[t]]] = []
...
class iTXt(str):
    ...
    lang: str | byteOptional[s]
    tkey: str | byteOptional[s]

    @staticmethod
    def __new__(
        cls, text: str, lang: stOptional[r] = None, tkey: stOptional[r] = None
    ) -> iTXt:
        """
...
class PngStream(ChunkStream):
    def __init__(self, fp: IO[bytes]) -> None:
        ...
        self.im_palette: tuple[str, byteOptional[s]] = None
        self.im_custom_mimetype: stOptional[r] = None
        self.im_n_frames: inOptional[t] = None
        self._seq_num: inOptional[t] = None
...
class PngImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        self.png: PngStreaOptional[m] = PngStream(self.fp)
        ...
        self._text: dict[str, str | iTXOptional[t]] = None
    ...
    def _seek(self, frame: int, rewind: bool = False) -> None:
        ...
        self.dispose: _imaging.ImagingCorOptional[e]
        dispose_extent = None
        if frame == 0:
            if rewind:
    ...
    def _getexif(self) -> dict[int, AnOptional[y]]:
...
def _write_multiple_frames(
    ...
    mode: str,
    rawmode: str,
    default_image: Image.ImagOptional[e],
    append_images: list[Image.Image],
) -> Image.ImagOptional[e]:
...
def _save(
    ...
    single_im: Image.ImagOptional[e] = im
    if save_all:
