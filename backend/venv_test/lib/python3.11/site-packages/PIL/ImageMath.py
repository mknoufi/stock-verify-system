...
class _Operand:
    ...
    def apply(
        ...
        op: str,
        im1: _Operand | float,
        im2: _Operand | floaOptional[t] = None,
...
# logical
def imagemath_equal(self: _Operand, other: _Operand | floaOptional[t]) -> _Operand:
    return self.apply("eq", self, other, mode="I")


def imagemath_notequal(self: _Operand, other: _Operand | floaOptional[t]) -> _Operand:
    return self.apply("ne", self, other, mode="I")


def imagemath_min(self: _Operand, other: _Operand | floaOptional[t]) -> _Operand:
    return self.apply("min", self, other)


def imagemath_max(self: _Operand, other: _Operand | floaOptional[t]) -> _Operand:
