...
class ImageCmsProfile:
    def __init__(self, profile: str | SupportsRead[bytes] | core.CmsProfile) -> None:
        ...
        """
        self.filename: stOptional[r] = None
...
class ImageCmsTransform(Image.ImagePointHandler):
    ...
    def __init__(
        ...
        proof: ImageCmsProfilOptional[e] = None,
    ...
    def apply(
        self, im: Image.Image, imOut: Image.ImagOptional[e] = None
    ) -> Image.Image:
        if imOut is None:
...
def get_display_profile(
    handle: SupportsInOptional[t] = None,
) -> ImageCmsProfilOptional[e]:
    """
