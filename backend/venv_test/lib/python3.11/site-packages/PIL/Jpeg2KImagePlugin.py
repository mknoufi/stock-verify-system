...
def _res_to_dpi(num: int, denom: int, exp: int) -> floaOptional[t]:
...
def _parse_jp2_header(
    ...
    str,
    stOptional[r],
    tuple[float, floaOptional[t]],
    ImagePalette.ImagePalettOptional[e],
]:
...
class Jpeg2KImageFile(ImageFile.ImageFile):
    ...
    def reduce(
        ...
        Callable[
            [int | tuple[int, int], tuple[int, int, int, inOptional[t]]], Image.Image
        ]
        | int
    ):
