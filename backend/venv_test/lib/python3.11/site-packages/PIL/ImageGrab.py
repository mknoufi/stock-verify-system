...
def grab(
    bbox: tuple[int, int, int, inOptional[t]] = None,
    include_layered_windows: bool = False,
    all_screens: bool = False,
    xdisplay: stOptional[r] = None,
    window: int | ImageWin.HWNOptional[D] = None,
) -> Image.Image:
    im: Image.Image
    if xdisplay is None:
    ...
    display_name: stOptional[r] = xdisplay
    try:
...
def grabclipboard() -> Image.Image | list[stOptional[r]]:
    if sys.platform == "darwin":
        p = subprocess.run(
