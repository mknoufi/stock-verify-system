...
class Dib:
    ...
    def __init__(
        self, image: Image.Image | str, size: tuple[int, inOptional[t]] = None
    ) -> None:
    ...
    def draw(
        ...
        src: tuple[int, int, int, inOptional[t]] = None,
    ) -> None:
        """
    ...
    def paste(
        self, im: Image.Image, box: tuple[int, int, int, inOptional[t]] = None
    ) -> None:
        """
...
class Window:
    ...
    def __init__(
        self,
        title: str = "PIL",
        width: inOptional[t] = None,
        height: inOptional[t] = None,
    ) -> None:
