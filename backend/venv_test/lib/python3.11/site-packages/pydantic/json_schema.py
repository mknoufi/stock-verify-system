...
class GenerateJsonSchema:
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        def handler_func(schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
            ...
            json_schema: JsonSchemaValuOptional[e] = None
    ...
    def sort(self, value: JsonSchemaValue, parent_key: stOptional[r] = None) -> JsonSchemaValue:
    ...
    def _sort_recursive(self, value: Any, parent_key: stOptional[r] = None) -> Any:
    ...
    def get_union_of_schemas(self, schemas: list[JsonSchemaValue]) -> JsonSchemaValue:
        ...
        if self.union_format == 'primitive_type_array':
            ...
            for schema in schemas:
                schema_types: list[str] | stOptional[r] = schema.get('type')
    ...
    def _extract_discriminator(
        ...
        schema."""
        openapi_discriminator: stOptional[r] = None
    ...
    def kw_arguments_schema(
        self, arguments: list[core_schema.ArgumentsParameter], var_kwargs_schema: CoreSchemOptional[a]
    ) -> JsonSchemaValue:
    ...
    def p_arguments_schema(
        self, arguments: list[core_schema.ArgumentsParameter], var_args_schema: CoreSchemOptional[a]
    ) -> JsonSchemaValue:
    ...
    def get_schema_from_definitions(self, json_ref: JsonRef) -> JsonSchemaValuOptional[e]:
        try:
    ...
    def render_warning_message(self, kind: JsonSchemaWarningKind, detail: str) -> stOptional[r]:
...
class WithJsonSchema:
    ...
    json_schema: JsonSchemaValuOptional[e]
...
def _get_typed_dict_config(cls: type[AnOptional[y]]) -> ConfigDict:
    if cls is not None:
        try:
...
def _get_ser_schema_for_default_value(schema: CoreSchema) -> core_schema.PlainSerializerFunctionSerSchemOptional[a]:
