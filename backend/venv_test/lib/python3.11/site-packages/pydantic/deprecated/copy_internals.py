...
if typing.TYPE_CHECKING:
    ...
    # should be `set[int] | set[str] | dict[int, IncEx] | dict[str, IncEOptional[x]]`, but mypy can't cope
    IncEx: typing_extensions.TypeAlias = 'set[int] | set[str] | dict[int, Any] | dict[str, AnOptional[y]]'
...
def _copy_and_set_values(
    ...
    private: dict[str, AnOptional[y]] = None,
    *,
    deep: bool,  # UP006
) -> Model:
    if deep:
...
def _get_value(
    ...
    to_dict: bool,
    by_alias: bool,
    include: AbstractSetIntStr | MappingIntStrAnOptional[y],
    exclude: AbstractSetIntStr | MappingIntStrAnOptional[y],
    exclude_unset: bool,
...
def _calculate_keys(
    self: BaseModel,
    include: MappingIntStrAnOptional[y],
    exclude: MappingIntStrAnOptional[y],
    exclude_unset: bool,
    update: dict[str, AnOptional[y]] = None,  # noqa UP006
) -> typing.AbstractSet[stOptional[r]]:
