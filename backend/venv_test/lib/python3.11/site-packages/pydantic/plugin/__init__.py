...
NewSchemaReturns: TypeAlias = 'tuple[ValidatePythonHandlerProtocoOptional[l], ValidateJsonHandlerProtocoOptional[l], ValidateStringsHandlerProtocoOptional[l]]'
...
class PydanticPluginProtocol(Protocol):
    ...
    def new_schema_validator(
        ...
        config: CoreConfiOptional[g],
        plugin_settings: dict[str, object],
    ) -> tuple[
        ValidatePythonHandlerProtocoOptional[l], ValidateJsonHandlerProtocoOptional[l], ValidateStringsHandlerProtocoOptional[l]
    ]:
...
class ValidatePythonHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(
        ...
        *,
        ...
        self_instance: AnOptional[y] = None,
