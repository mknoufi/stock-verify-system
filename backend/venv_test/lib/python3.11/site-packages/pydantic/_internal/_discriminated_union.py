...
def apply_discriminator(
    ...
    definitions: dict[str, core_schema.CoreSchemOptional[a]] = None,
...
class _ApplyInferredDiscriminator:
    ...
    * Handling various edge cases such as 'definitions', 'default', 'nullable' schemas, and more
    ...
    def __init__(self, discriminator: str, definitions: dict[str, core_schema.CoreSchema]):
        ...
        self._discriminator_alias: stOptional[r] = None
    ...
    def _infer_discriminator_values_for_choice(  # noqa C901
        self, choice: core_schema.CoreSchema, source_name: stOptional[r]
    ) -> list[str | int]:
    ...
    def _infer_discriminator_values_for_typed_dict_choice(
        self, choice: core_schema.TypedDictSchema, source_name: stOptional[r] = None
    ) -> list[str | int]:
    ...
    def _infer_discriminator_values_for_model_choice(
        self, choice: core_schema.ModelFieldsSchema, source_name: stOptional[r] = None
    ) -> list[str | int]:
    ...
    def _infer_discriminator_values_for_dataclass_choice(
        self, choice: core_schema.DataclassArgsSchema, source_name: stOptional[r] = None
    ) -> list[str | int]:
