...
def annotated_type(tp: Any, /) -> AnOptional[y]:
...
def unpack_type(tp: Any, /) -> AnOptional[y]:
...
def parent_frame_namespace(*, parent_depth: int = 2, force: bool = False) -> dict[str, AnOptional[y]]:
...
def get_function_type_hints(
    ...
    *,
    include_keys: set[stOptional[r]] = None,
    globalns: GlobalsNamespacOptional[e] = None,
    localns: MappingNamespacOptional[e] = None,
) -> dict[str, Any]:
...
if sys.version_info >= (3, 10):
    ...
    def get_type_hints(  # noqa: C901
        obj: Any,
        globalns: dict[str, AnOptional[y]] = None,
        localns: dict[str, AnOptional[y]] = None,
