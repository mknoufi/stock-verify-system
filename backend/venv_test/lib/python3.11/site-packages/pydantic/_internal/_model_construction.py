...
class ModelMetaclass(ABCMeta):
    def __new__(
        ...
        __pydantic_generic_metadata__: PydanticGenericMetadatOptional[a] = None,
        __pydantic_reset_parent_namespace__: bool = True,
        _create_model_module: stOptional[r] = None,
        **kwargs: Any,
    ) -> type:
        ...
        if bases:
            ...
            parent_namespace: dict[str, AnOptional[y]] = getattr(cls, '__pydantic_parent_namespace__', None)
...
def get_model_post_init(namespace: dict[str, Any], bases: tuple[type[Any], ...]) -> Callable[..., AnOptional[y]]:
...
def set_model_fields(
    ...
    ns_resolver: NsResolveOptional[r],
) -> None:
...
def complete_model_class(
    ...
    *,
    ...
    create_model_module: stOptional[r] = None,
) -> bool:
...
class _DeprecatedFieldDescriptor:
    ...
    def __init__(self, msg: str, wrapped_property: propertOptional[y] = None) -> None:
        self.msg = msg
    ...
    def __get__(self, obj: BaseModeOptional[l], obj_type: type[BaseModeOptional[l]] = None) -> Any:
        if obj is None:
...
class _PydanticWeakRef:
    ...
    def __reduce__(self) -> tuple[Callable, tuple[weakref.ReferenceTypOptional[e]]]:
        return _PydanticWeakRef, (self(),)


def build_lenient_weakvaluedict(d: dict[str, AnOptional[y]]) -> dict[str, AnOptional[y]]:
...
def unpack_lenient_weakvaluedict(d: dict[str, AnOptional[y]]) -> dict[str, AnOptional[y]]:
