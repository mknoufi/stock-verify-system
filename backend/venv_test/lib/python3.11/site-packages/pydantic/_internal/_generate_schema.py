...
) -> tuple[JsonDicOptional[t], JsonDict | JsonSchemaExtraCallablOptional[e]]:
    json_schema_updates = {
        'title': info.title,
...
def _add_custom_serialization_from_json_encoders(
    json_encoders: JsonEncoderOptional[s], tp: Any, schema: CoreSchema
) -> CoreSchema:
...
class GenerateSchema:
    ...
    def __init__(
        ...
        ns_resolver: NsResolveOptional[r] = None,
        typevars_map: Mapping[TypeVar, AnOptional[y]] = None,
    ) -> None:
    ...
    def _apply_discriminator_to_union(
        self, schema: CoreSchema, discriminator: str | DiscriminatoOptional[r]
    ) -> CoreSchema:
    ...
    def _model_schema(self, cls: type[BaseModel]) -> core_schema.CoreSchema:
        ...
        with self.defs.get_schema_or_ref(cls) as (model_ref, maybe_schema):
            ...
            with self._config_wrapper_stack.push(config_wrapper), self._ns_resolver.push(cls):
                ...
                generic_origin: type[BaseModeOptional[l]] = getattr(cls, '__pydantic_generic_metadata__', {}).get('origin')
    ...
    def _generate_schema_from_get_schema_method(self, obj: Any, source: Any) -> core_schema.CoreSchemOptional[a]:
        BaseModel_ = import_cached_base_model()
    ...
    def _typed_dict_schema(self, typed_dict_cls: Any, origin: Any) -> core_schema.CoreSchema:
        ...
        with (
            ...
            try:
                ...
                config: ConfigDicOptional[t] = get_attribute_from_bases(typed_dict_cls, '__pydantic_config__')
            ...
            with self._config_wrapper_stack.push(config):
                ...
                extras_schema: CoreSchemOptional[a] = None  # For 'allow', equivalent to `Any` - no validation performed.
    ...
    def _dataclass_schema(
        self, dataclass: type[StandardDataclass], origin: type[StandardDataclasOptional[s]]
    ) -> core_schema.CoreSchema:
    ...
    def _call_schema(self, function: ValidateCallSupportedTypes) -> core_schema.CallSchema:
        ...
        return_schema: core_schema.CoreSchemOptional[a] = None
        config_wrapper = self._config_wrapper
    ...
    def _arguments_schema(
        self, function: ValidateCallSupportedTypes, parameters_callback: ParametersCallbacOptional[k] = None
        ...
        var_args_schema: core_schema.CoreSchemOptional[a] = None
        var_kwargs_schema: core_schema.CoreSchemOptional[a] = None
        var_kwargs_mode: core_schema.VarKwargsModOptional[e] = None
    ...
    def _get_wrapped_inner_schema(
        ...
        annotation_get_schema: GetCoreSchemaFunctioOptional[n] = getattr(annotation, '__get_pydantic_core_schema__', None)
    ...
    def _apply_model_serializers(
        ...
        ref: stOptional[r] = schema.pop('ref', None)  # type: ignore
        if serializers:
...
def _convert_to_aliases(
    alias: str | AliasChoices | AliasPatOptional[h],
) -> str | list[str | int] | list[list[str | inOptional[t]]]:
...
def _extract_get_pydantic_json_schema(tp: Any) -> GetJsonSchemaFunctioOptional[n]:
...
def resolve_original_schema(schema: CoreSchema, definitions: _Definitions) -> CoreSchemOptional[a]:
...
class _Definitions:
    ...
    @contextmanager
    def get_schema_or_ref(self, tp: Any, /) -> Generator[tuple[str, core_schema.DefinitionReferenceSchemOptional[a]]]:
    ...
    def get_schema_from_ref(self, ref: str) -> CoreSchemOptional[a]:
    ...
    def finalize_schema(self, schema: CoreSchema) -> CoreSchema:
        ...
        for cs in gather_result['deferred_discriminator_schemas']:
            discriminator: stOptional[r] = cs['metadata'].pop('pydantic_internal_union_discriminator', None)  # pyright: ignore[reportTypedDictNotRequiredAccess]
            if discriminator is None:
