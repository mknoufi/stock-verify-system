...
class MockCoreSchema(Mapping[str, Any]):
    ...
    def __init__(
        ...
        *,
        ...
        attempt_rebuild: Callable[[], CoreSchemOptional[a]] | None = None,
    ) -> None:
        self._error_message = error_message
        self._code: PydanticErrorCodes = code
        self._attempt_rebuild = attempt_rebuild
        self._built_memo: CoreSchemOptional[a] = None
    ...
    def rebuild(self) -> CoreSchemOptional[a]:
...
class MockValSer(Generic[ValSer]):
    ...
    def __init__(
        ...
        *,
        ...
        attempt_rebuild: Callable[[], ValSeOptional[r]] | None = None,
    ) -> None:
        self._error_message = error_message
    ...
    def rebuild(self) -> ValSeOptional[r]:
        if self._attempt_rebuild:
            val_ser = self._attempt_rebuild()
            if val_ser is not None:
                return val_ser
...
def set_type_adapter_mocks(adapter: TypeAdapter) -> None:
    ...
    def attempt_rebuild_fn(attr_fn: Callable[[TypeAdapter], T]) -> Callable[[], Optional[T]]:
