...
class GatherResult(TypedDict):
    ...
    collected_references: dict[str, DefinitionReferenceSchemOptional[a]]
...
class GatherContext:
    ...
    collected_references: dict[str, DefinitionReferenceSchemOptional[a]] = field(init=False, default_factory=dict)
    """The collected definition references.
