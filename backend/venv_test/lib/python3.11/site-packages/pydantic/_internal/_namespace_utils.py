...
def ns_for_function(obj: Callable[..., Any], parent_namespace: MappingNamespacOptional[e] = None) -> NamespacesTuple:
...
class NsResolver:
    ...
    def __init__(
        self,
        namespaces_tuple: NamespacesTuplOptional[e] = None,
        parent_namespace: MappingNamespacOptional[e] = None,
    ) -> None:
