...
def update_core_metadata(
    ...
    /,
    *,
    pydantic_js_functions: list[GetJsonSchemaFunctioOptional[n]] = None,
    pydantic_js_annotation_functions: list[GetJsonSchemaFunctioOptional[n]] = None,
    pydantic_js_updates: JsonDicOptional[t] = None,
    pydantic_js_extra: JsonDict | JsonSchemaExtraCallablOptional[e] = None,
) -> None:
