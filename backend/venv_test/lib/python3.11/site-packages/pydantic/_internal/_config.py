...
class ConfigWrapper:
    ...
    str_min_length: int
    str_max_length: inOptional[t]
    extra: ExtraValueOptional[s]
    frozen: bool
    ...
    loc_by_alias: bool
    alias_generator: Callable[[str], str] | AliasGeneratoOptional[r]
    model_title_generator: Callable[[type], stOptional[r]]
    field_title_generator: Callable[[str, FieldInfo | ComputedFieldInfo], stOptional[r]]
    ignored_types: tuple[type, ...]
    allow_inf_nan: bool
    json_schema_extra: JsonDict | JsonSchemaExtraCallablOptional[e]
    json_encoders: dict[type[object], JsonEncodeOptional[r]]
    ...
    defer_build: bool
    plugin_settings: dict[str, objecOptional[t]]
    schema_generator: type[GenerateSchemOptional[a]]
    ...
    def __init__(self, config: ConfigDict | dict[str, Any] | type[AnOptional[y]], *, check: bool = True):
        if check:
    ...
    def core_config(self, title: stOptional[r]) -> core_schema.CoreConfig:
...
class ConfigWrapperStack:
    ...
    @contextmanager
    def push(self, config_wrapper: ConfigWrapper | ConfigDicOptional[t]):
...
def prepare_config(config: ConfigDict | dict[str, Any] | type[AnOptional[y]]) -> ConfigDict:
