...
class TypeAdapter(Generic[T]):
    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
    ...
    def __init__(
        ...
        type: Any,
        *,
        config: ConfigDicOptional[t] = None,
        _parent_depth: int = 2,
    ...
    def _fetch_parent_frame(self) -> FrameTypOptional[e]:
    ...
    @property
    def _model_config(self) -> ConfigDicOptional[t]:
    ...
    def rebuild(
        ...
        *,
        ...
        _types_namespace: _namespace_utils.MappingNamespacOptional[e] = None,
    ) -> booOptional[l]:
    ...
    def get_default_value(self, *, strict: booOptional[l] = None, context: AnOptional[y] = None) -> Some[Optional[T]]:
