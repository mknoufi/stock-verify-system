...
class AliasGenerator:
    ...
    alias: Callable[[str], stOptional[r]] = None
    validation_alias: Callable[[str], str | AliasPath | AliasChoiceOptional[s]] = None
    serialization_alias: Callable[[str], stOptional[r]] = None
    ...
    def _generate_alias(
        ...
        field_name: str,
    ) -> str | AliasPath | AliasChoiceOptional[s]:
    ...
    def generate_aliases(self, field_name: str) -> tuple[stOptional[r], str | AliasPath | AliasChoiceOptional[s], stOptional[r]]:
