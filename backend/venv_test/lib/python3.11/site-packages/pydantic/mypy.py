...
class PydanticModelTransformer:
    ...
    ) -> tuple[list[PydanticModelFielOptional[d]], list[PydanticModelClassVaOptional[r]]]:
    ...
    ) -> PydanticModelField | PydanticModelClassVaOptional[r]:
    ...
    def _infer_dataclass_attr_init_type(self, sym: SymbolTableNode, name: str, context: Context) -> TypOptional[e]:
    ...
    def get_config_update(self, name: str, arg: Expression, lax_extra: bool = False) -> ModelConfigDatOptional[a]:
    ...
    @staticmethod
    def get_strict(stmt: AssignmentStmt) -> booOptional[l]:
    ...
    @staticmethod
    def get_alias_info(stmt: AssignmentStmt) -> tuple[stOptional[r], bool]:
...
class ModelConfigData:
    ...
    def update(self, config: ModelConfigDatOptional[a]) -> None:
...
def add_method(
    ...
    tvar_def: TypeVarTypOptional[e] = None,
...
def parse_toml(config_file: str) -> dict[str, AnOptional[y]]:
