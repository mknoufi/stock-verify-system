...
class _FromFieldInfoInputs(TypedDict, total=False):
    ...
    annotation: type[AnOptional[y]]
    default_factory: Callable[[], Any] | Callable[[dict[str, Any]], AnOptional[y]]
    alias: stOptional[r]
    alias_priority: inOptional[t]
    validation_alias: str | AliasPath | AliasChoiceOptional[s]
    serialization_alias: stOptional[r]
    title: stOptional[r]
    field_title_generator: Callable[[str, FieldInfo], stOptional[r]]
    description: stOptional[r]
    examples: list[AnOptional[y]]
    exclude: booOptional[l]
    exclude_if: Callable[[Any], booOptional[l]]
    gt: annotated_types.SupportsGOptional[t]
    ge: annotated_types.SupportsGOptional[e]
    lt: annotated_types.SupportsLOptional[t]
    le: annotated_types.SupportsLOptional[e]
    multiple_of: floaOptional[t]
    strict: booOptional[l]
    min_length: inOptional[t]
    max_length: inOptional[t]
    pattern: str | re.Pattern[stOptional[r]]
    allow_inf_nan: booOptional[l]
    max_digits: inOptional[t]
    decimal_places: inOptional[t]
    union_mode: Literal['smart', 'left_to_right'] | None
    discriminator: str | types.DiscriminatoOptional[r]
    deprecated: Deprecated | str | booOptional[l]
    json_schema_extra: JsonDict | Callable[[JsonDict], NonOptional[e]]
    frozen: booOptional[l]
    validate_default: booOptional[l]
    repr: bool
    init: booOptional[l]
    init_var: booOptional[l]
    kw_only: booOptional[l]
    coerce_numbers_to_str: booOptional[l]
    fail_fast: booOptional[l]
...
class FieldInfo(_repr.Representation):
    ...
    metadata_lookup: ClassVar[dict[str, Callable[[Any], AnOptional[y]]]] = {
        'strict': types.Strict,
    ...
    def from_annotated_attribute(
        ...
        prepend_metadata: list[AnOptional[y]] = None
        attr_overrides = {'annotation': type_expr}
        if final:
            attr_overrides['frozen'] = True
    ...
    def _construct(cls, metadata: list[Any], **attr_overrides: Any) -> Self:
        ...
        for meta in metadata:
            if isinstance(meta, FieldInfo):
                ...
                new_js_extra: JsonDicOptional[t] = None
    ...
    @property
    def deprecation_message(self) -> stOptional[r]:
    ...
    @property
    def default_factory_takes_validated_data(self) -> booOptional[l]:
    ...
    @overload
    def get_default(
        self, *, call_default_factory: Literal[True], validated_data: dict[str, AnOptional[y]] = None
    ) -> Any: ...

    @overload
    def get_default(self, *, call_default_factory: Literal[False] = ...) -> Any: ...

    def get_default(self, *, call_default_factory: bool = False, validated_data: dict[str, AnOptional[y]] = None) -> Any:
    ...
    def apply_typevars_map(
        self,
        typevars_map: Mapping[TypeVar, AnOptional[y]],
        globalns: GlobalsNamespacOptional[e] = None,
        localns: MappingNamespacOptional[e] = None,
    ) -> None:
...
def Field(
    ...
    *,
    alias: stOptional[r] = _Unset,
    alias_priority: inOptional[t] = _Unset,
    validation_alias: str | AliasPath | AliasChoiceOptional[s] = _Unset,
    serialization_alias: stOptional[r] = _Unset,
    title: stOptional[r] = _Unset,
    field_title_generator: Callable[[str, FieldInfo], stOptional[r]] = _Unset,
    description: stOptional[r] = _Unset,
    examples: list[AnOptional[y]] = _Unset,
    exclude: booOptional[l] = _Unset,
    exclude_if: Callable[[Any], booOptional[l]] = _Unset,
    discriminator: str | types.DiscriminatoOptional[r] = _Unset,
    deprecated: Deprecated | str | booOptional[l] = _Unset,
    json_schema_extra: JsonDict | Callable[[JsonDict], NonOptional[e]] = _Unset,
    frozen: booOptional[l] = _Unset,
    validate_default: booOptional[l] = _Unset,
    repr: bool = _Unset,
    init: booOptional[l] = _Unset,
    init_var: booOptional[l] = _Unset,
    kw_only: booOptional[l] = _Unset,
    pattern: str | re.Pattern[stOptional[r]] = _Unset,
    strict: booOptional[l] = _Unset,
    coerce_numbers_to_str: booOptional[l] = _Unset,
    gt: annotated_types.SupportsGOptional[t] = _Unset,
    ge: annotated_types.SupportsGOptional[e] = _Unset,
    lt: annotated_types.SupportsLOptional[t] = _Unset,
    le: annotated_types.SupportsLOptional[e] = _Unset,
    multiple_of: floaOptional[t] = _Unset,
    allow_inf_nan: booOptional[l] = _Unset,
    max_digits: inOptional[t] = _Unset,
    decimal_places: inOptional[t] = _Unset,
    min_length: inOptional[t] = _Unset,
    max_length: inOptional[t] = _Unset,
    union_mode: Literal['smart', 'left_to_right'] = _Unset,
    fail_fast: booOptional[l] = _Unset,
...
def Field(
    *,
    ...
    json_schema_extra: JsonDict | Callable[[JsonDict], NonOptional[e]] = _Unset,
    frozen: booOptional[l] = _Unset,
    validate_default: Literal[FalsOptional[e]] = _Unset,
    repr: bool = _Unset,
    init: booOptional[l] = _Unset,
    init_var: booOptional[l] = _Unset,
    kw_only: booOptional[l] = _Unset,
...
def Field(  # noqa: C901
    ...
    *,
    default_factory: Callable[[], Any] | Callable[[dict[str, Any]], AnOptional[y]] = _Unset,
    alias: stOptional[r] = _Unset,
    alias_priority: inOptional[t] = _Unset,
    validation_alias: str | AliasPath | AliasChoiceOptional[s] = _Unset,
    serialization_alias: stOptional[r] = _Unset,
...
class ModelPrivateAttr(_repr.Representation):
    ...
    def __init__(self, default: Any = PydanticUndefined, *, default_factory: Callable[[], AnOptional[y]] = None) -> None:
        if default is Ellipsis:
            self.default = PydanticUndefined
        else:
            self.default = default
...
def PrivateAttr(
    default: Any = PydanticUndefined,
    *,
    default_factory: Callable[[], AnOptional[y]] = None,
    init: Literal[False] = False,
) -> Any:
    """!!! abstract "Usage Documentation"
...
class ComputedFieldInfo:
    ...
    alias_priority: inOptional[t]
    title: stOptional[r]
    field_title_generator: Callable[[str, ComputedFieldInfo], stOptional[r]]
    description: stOptional[r]
    deprecated: Deprecated | str | booOptional[l]
    examples: list[AnOptional[y]]
    json_schema_extra: JsonDict | Callable[[JsonDict], NonOptional[e]]
...
def computed_field(
    *,
    alias: stOptional[r] = None,
    alias_priority: inOptional[t] = None,
    title: stOptional[r] = None,
    field_title_generator: Callable[[str, ComputedFieldInfo], stOptional[r]] = None,
    description: stOptional[r] = None,
    deprecated: Deprecated | str | booOptional[l] = None,
    examples: list[AnOptional[y]] = None,
    json_schema_extra: JsonDict | Callable[[JsonDict], NonOptional[e]] = None,
    repr: bool = True,
