...
class _BaseUrl:
    ...
    @property
    def username(self) -> stOptional[r]:
    ...
    @property
    def password(self) -> stOptional[r]:
    ...
    def unicode_host(self) -> stOptional[r]:
    ...
    @property
    def fragment(self) -> stOptional[r]:
    ...
    def build(
        ...
        *,
        scheme: str,
        username: stOptional[r] = None,
        password: stOptional[r] = None,
        host: str,
        port: inOptional[t] = None,
        path: stOptional[r] = None,
        query: stOptional[r] = None,
        fragment: stOptional[r] = None,
    ) -> Self:
...
class _BaseMultiHostUrl:
    ...
    def build(
        ...
        *,
        scheme: str,
        hosts: list[MultiHostHosOptional[t]] = None,
        username: stOptional[r] = None,
        password: stOptional[r] = None,
