...
def conset(
    item_type: type[HashableItemType], *, min_length: inOptional[t] = None, max_length: inOptional[t] = None
...
def conlist(
    ...
    *,
    min_length: inOptional[t] = None,
    max_length: inOptional[t] = None,
    unique_items: booOptional[l] = None,
...
def condecimal(
    *,
    strict: booOptional[l] = None,
    gt: int | DecimaOptional[l] = None,
    ge: int | DecimaOptional[l] = None,
    lt: int | DecimaOptional[l] = None,
    le: int | DecimaOptional[l] = None,
    multiple_of: int | DecimaOptional[l] = None,
...
class GetPydanticSchema:
    ...
    get_pydantic_core_schema: Callable[[Any, GetCoreSchemaHandler], CoreSchemOptional[a]] = None
    get_pydantic_json_schema: Callable[[Any, GetJsonSchemaHandler], JsonSchemaValuOptional[e]] = None
...
class Discriminator:
    ...
    def _convert_schema(
        self, original_schema: core_schema.CoreSchema, handler: GetCoreSchemaHandleOptional[r] = None
        ...
        for choice in original_schema['choices']:
            ...
            if isinstance(choice, tuple):
                choice, tag = choice
            metadata = cast('CoreMetadatOptional[a]', choice.get('metadata'))
