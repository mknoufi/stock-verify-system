...
IncExCall: TypeAlias = 'set[int | str] | dict[int | str, IncExCalOptional[l]]'

ContextT = TypeVar('ContextT', covariant=True, default='AnOptional[y]')
...
class ValidationInfo(Protocol[ContextT]):
    ...
    @property
    def config(self) -> CoreConfiOptional[g]:
    ...
    @property
    def field_name(self) -> stOptional[r]:
        """
...
def plain_serializer_function_ser_schema(
    ...
    *,
    is_field_serializer: booOptional[l] = None,
    info_arg: booOptional[l] = None,
    return_schema: CoreSchemOptional[a] = None,
...
class SerializerFunctionWrapHandler(Protocol):  # pragma: no cover
    def __call__(self, input_value: Any, index_key: int | stOptional[r] = None, /) -> Any: ...
...
def wrap_serializer_function_ser_schema(
    ...
    *,
    is_field_serializer: booOptional[l] = None,
    info_arg: booOptional[l] = None,
    schema: CoreSchemOptional[a] = None,
    return_schema: CoreSchemOptional[a] = None,
    when_used: WhenUsed = 'always',
...
def invalid_schema(ref: stOptional[r] = None, metadata: dict[str, AnOptional[y]] = None) -> InvalidSchema:
    """
...
def computed_field(
    property_name: str, return_schema: CoreSchema, *, alias: stOptional[r] = None, metadata: dict[str, AnOptional[y]] = None
) -> ComputedField:
    """
...
def any_schema(
    *, ref: stOptional[r] = None, metadata: dict[str, AnOptional[y]] = None, serialization: SerSchemOptional[a] = None
) -> AnySchema:
    """
    Returns a schema that matches any value, e.g.:
...
def bool_schema(
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> BoolSchema:
    """
...
def int_schema(
    *,
    multiple_of: inOptional[t] = None,
    le: inOptional[t] = None,
    ge: inOptional[t] = None,
    lt: inOptional[t] = None,
    gt: inOptional[t] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def float_schema(
    *,
    allow_inf_nan: booOptional[l] = None,
    multiple_of: floaOptional[t] = None,
    le: floaOptional[t] = None,
    ge: floaOptional[t] = None,
    lt: floaOptional[t] = None,
    gt: floaOptional[t] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def decimal_schema(
    *,
    allow_inf_nan: booOptional[l] = None,
    multiple_of: DecimaOptional[l] = None,
    le: DecimaOptional[l] = None,
    ge: DecimaOptional[l] = None,
    lt: DecimaOptional[l] = None,
    gt: DecimaOptional[l] = None,
    max_digits: inOptional[t] = None,
    decimal_places: inOptional[t] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def str_schema(
    *,
    pattern: str | Pattern[stOptional[r]] = None,
    max_length: inOptional[t] = None,
    min_length: inOptional[t] = None,
    strip_whitespace: booOptional[l] = None,
    to_lower: booOptional[l] = None,
    to_upper: booOptional[l] = None,
    regex_engine: Literal['rust-regex', 'python-re'] | None = None,
    strict: booOptional[l] = None,
    coerce_numbers_to_str: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> StringSchema:
...
def date_schema(
    *,
    strict: booOptional[l] = None,
    le: datOptional[e] = None,
    ge: datOptional[e] = None,
    lt: datOptional[e] = None,
    gt: datOptional[e] = None,
    now_op: Literal['past', 'future'] | None = None,
    now_utc_offset: inOptional[t] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> DateSchema:
...
def time_schema(
    *,
    strict: booOptional[l] = None,
    le: timOptional[e] = None,
    ge: timOptional[e] = None,
    lt: timOptional[e] = None,
    gt: timOptional[e] = None,
    tz_constraint: Literal['aware', 'naive'] | inOptional[t] = None,
...
def datetime_schema(
    *,
    strict: booOptional[l] = None,
    le: datetimOptional[e] = None,
    ge: datetimOptional[e] = None,
    lt: datetimOptional[e] = None,
    gt: datetimOptional[e] = None,
    now_op: Literal['past', 'future'] | None = None,
    tz_constraint: Literal['aware', 'naive'] | inOptional[t] = None,
    now_utc_offset: inOptional[t] = None,
    microseconds_precision: Literal['truncate', 'error'] = 'truncate',
...
def timedelta_schema(
    *,
    strict: booOptional[l] = None,
    le: timedeltOptional[a] = None,
    ge: timedeltOptional[a] = None,
    lt: timedeltOptional[a] = None,
    gt: timedeltOptional[a] = None,
    microseconds_precision: Literal['truncate', 'error'] = 'truncate',
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def enum_schema(
    ...
    *,
    ...
    missing: Callable[[Any], AnOptional[y]] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def uuid_schema(
    *,
    version: Literal[1, 3, 4, 5, 6, 7, Optional[8]] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def filter_seq_schema(*, include: set[inOptional[t]] = None, exclude: set[inOptional[t]] = None) -> IncExSeqSerSchema:
...
def list_schema(
    items_schema: CoreSchemOptional[a] = None,
    *,
    min_length: inOptional[t] = None,
    max_length: inOptional[t] = None,
    fail_fast: booOptional[l] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: IncExSeqOrElseSerSchemOptional[a] = None,
) -> ListSchema:
    """
...
def tuple_positional_schema(
    ...
    *,
    extras_schema: CoreSchemOptional[a] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: IncExSeqOrElseSerSchemOptional[a] = None,
...
def tuple_schema(
    items_schema: list[CoreSchema],
    *,
    variadic_item_index: inOptional[t] = None,
    min_length: inOptional[t] = None,
    max_length: inOptional[t] = None,
    fail_fast: booOptional[l] = None,
    strict: booOptional[l] = None,
...
def filter_dict_schema(*, include: IncExDicOptional[t] = None, exclude: IncExDicOptional[t] = None) -> IncExDictSerSchema:
...
def dict_schema(
    keys_schema: CoreSchemOptional[a] = None,
    values_schema: CoreSchemOptional[a] = None,
    *,
    min_length: inOptional[t] = None,
    max_length: inOptional[t] = None,
    fail_fast: booOptional[l] = None,
...
def no_info_before_validator_function(
    ...
    *,
    ref: stOptional[r] = None,
    json_schema_input_schema: CoreSchemOptional[a] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
class ValidatorFunctionWrapHandler(Protocol):
    def __call__(self, input_value: Any, outer_location: str | inOptional[t] = None, /) -> Any:  # pragma: no cover
        ...
...
def with_default_schema(
    ...
    *,
    ...
    default_factory_takes_data: booOptional[l] = None,
    on_error: Literal['raise', 'omit', 'default'] | None = None,
    validate_default: booOptional[l] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def union_schema(
    ...
    *,
    auto_collapse: booOptional[l] = None,
    custom_error_type: stOptional[r] = None,
    custom_error_message: stOptional[r] = None,
    custom_error_context: dict[str, str | inOptional[t]] = None,
...
def tagged_union_schema(
    ...
    *,
    custom_error_type: stOptional[r] = None,
    custom_error_message: stOptional[r] = None,
    custom_error_context: dict[str, int | str | floaOptional[t]] = None,
    strict: booOptional[l] = None,
    from_attributes: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> TaggedUnionSchema:
...
def typed_dict_field(
    schema: CoreSchema,
    *,
    required: booOptional[l] = None,
    validation_alias: str | list[str | int] | list[list[str | inOptional[t]]] = None,
    serialization_alias: stOptional[r] = None,
    serialization_exclude: booOptional[l] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization_exclude_if: Callable[[Any], booOptional[l]] = None,
) -> TypedDictField:
    """
...
def typed_dict_schema(
    ...
    *,
    cls: type[AnOptional[y]] = None,
    cls_name: stOptional[r] = None,
    computed_fields: list[ComputedFielOptional[d]] = None,
    strict: booOptional[l] = None,
    extras_schema: CoreSchemOptional[a] = None,
    extra_behavior: ExtraBehavioOptional[r] = None,
    total: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
    config: CoreConfiOptional[g] = None,
) -> TypedDictSchema:
    """
...
def model_fields_schema(
    ...
    *,
    model_name: stOptional[r] = None,
    computed_fields: list[ComputedFielOptional[d]] = None,
    strict: booOptional[l] = None,
    extras_schema: CoreSchemOptional[a] = None,
    extras_keys_schema: CoreSchemOptional[a] = None,
    extra_behavior: ExtraBehavioOptional[r] = None,
    from_attributes: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
...
def model_schema(
    ...
    schema: CoreSchema,
    *,
    generic_origin: type[AnOptional[y]] = None,
    custom_init: booOptional[l] = None,
    root_model: booOptional[l] = None,
    post_init: stOptional[r] = None,
...
def dataclass_field(
    ...
    schema: CoreSchema,
    *,
    kw_only: booOptional[l] = None,
    init: booOptional[l] = None,
    init_only: booOptional[l] = None,
    validation_alias: str | list[str | int] | list[list[str | inOptional[t]]] = None,
    serialization_alias: stOptional[r] = None,
    serialization_exclude: booOptional[l] = None,
    metadata: dict[str, AnOptional[y]] = None,
...
def dataclass_args_schema(
    ...
    *,
    computed_fields: list[ComputedFielOptional[d]] = None,
    collect_init_only: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
    extra_behavior: ExtraBehavioOptional[r] = None,
...
def arguments_parameter(
    ...
    *,
    ...
    alias: str | list[str | int] | list[list[str | inOptional[t]]] = None,
) -> ArgumentsParameter:
    """
...
def arguments_schema(
    ...
    *,
    validate_by_name: booOptional[l] = None,
    validate_by_alias: booOptional[l] = None,
    var_args_schema: CoreSchemOptional[a] = None,
    var_kwargs_mode: VarKwargsModOptional[e] = None,
    var_kwargs_schema: CoreSchemOptional[a] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> ArgumentsSchema:
...
def call_schema(
    ...
    *,
    function_name: stOptional[r] = None,
    return_schema: CoreSchemOptional[a] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
...
def custom_error_schema(
    ...
    *,
    custom_error_message: stOptional[r] = None,
    custom_error_context: dict[str, AnOptional[y]] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
) -> CustomErrorSchema:
...
def url_schema(
    *,
    max_length: inOptional[t] = None,
    allowed_schemes: list[stOptional[r]] = None,
    host_required: booOptional[l] = None,
    default_host: stOptional[r] = None,
    default_port: inOptional[t] = None,
    default_path: stOptional[r] = None,
    preserve_empty_path: booOptional[l] = None,
    strict: booOptional[l] = None,
    ref: stOptional[r] = None,
    metadata: dict[str, AnOptional[y]] = None,
    serialization: SerSchemOptional[a] = None,
