...
export class ExportService {
  ...
  static async exportSessionsWithDetails(sessions: any[]): Promise<void> {
    try {
      console.log('📊 [Export] Exporting sessions with details...');
      ...
      console.error('❌ [Export] Failed to export sessions with details:', error);
      throw error;
    }
  }
  ...
  static async exportVarianceReport(sessions: any[]): Promise<void> {
    try {
      console.log('📊 [Export] Exporting variance report...');
  ...
  static async exportSummaryReport(sessions: any[]): Promise<void> {
    try {
      console.log('📊 [Export] Exporting summary report...');
